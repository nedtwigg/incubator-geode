...
public class PRBasicIndexCreationDUnitTest extends PartitionedRegionDUnitTestCase {
  ...
  public void testPRBasicIndexCreate() throws Exception {
    ...
    vm0.invoke(
        PRQHelp.getCacheSerializableRunnableForPRAccessorCreate(
    ...
    vm1.invoke(
        PRQHelp.getCacheSerializableRunnableForDuplicatePRIndexCreate(
            name, "PrIndexOnStatus", "p.status", null, "p"));
    vm2.invoke(
        PRQHelp.getCacheSerializableRunnableForDuplicatePRIndexCreate(
            name, "PrIndexOnStatus", "p.status", null, "p"));
  ...
  public void testPRMultiIndexCreationAndGetIndex() throws Exception {
    ...
    SerializableRunnable getIndexCheck =
        new CacheSerializableRunnable("Get Index Check") {
  ...
  public void testCreatePartitionedRegionThroughXMLAndAPI() {
    ...
    vm0.invoke(
        PRQHelp.getCacheSerializableRunnableForPRIndexCreate(
            name, "PrIndexOnPKID", "p.pkid", null, "p"));
  ...
  public void testCreatePartitionedIndexWithNoAliasBeforePuts() throws Exception {
    ...
    vm1.invoke(
        PRQHelp.getCacheSerializableRunnableForPRIndexCreate(
            name, "PrIndexOnStatus", "status", null, ""));
    // putting some data in.
    final PortfolioData[] portfolio = createPortfolioData(cnt, cntDest);
    // Putting the data into the PR's created
    vm1.invoke(PRQHelp.getCacheSerializableRunnableForPRPuts(name, portfolio, cnt, cntDest));
  ...
  public void testPartitionedIndexCreationDuringPersistentRecovery() throws Throwable {
    ...
    vm0.invoke(
        PRQHelp.getCacheSerializableRunnableForPersistentPRCreate(
            name, redundancy, PortfolioData.class));
    vm1.invoke(
        PRQHelp.getCacheSerializableRunnableForPersistentPRCreate(
            name, redundancy, PortfolioData.class));
  ...
  public void testCreatePartitionedIndexWithKeysValuesAndFunction() throws Exception {
    ...
    vm0.invoke(
        PRQHelp.getCacheSerializableRunnableForPRIndexCreate(
            name, "index8", "k", "/PartionedPortfolios.keys k", ""));
    vm1.invoke(
        PRQHelp.getCacheSerializableRunnableForPRIndexCreate(
            name,
            "index7",
            "nvl(k.status.toString(),'nopes')",
            "/PartionedPortfolios.values k",
            ""));
  ...
  public void testIndexQueryingWithOrderBy() throws Exception {
    ...
    vm0.invoke(
        PRQHelp.getCacheSerializableRunnableForPRPutsKeyValue(
            name, portfoliosAndPositions, 0, step));
    vm1.invoke(
        PRQHelp.getCacheSerializableRunnableForPRPutsKeyValue(
            name, portfoliosAndPositions, step, (2 * step)));
    vm2.invoke(
        PRQHelp.getCacheSerializableRunnableForPRPutsKeyValue(
            name, portfoliosAndPositions, (2 * step), (3 * step)));
    vm3.invoke(
        PRQHelp.getCacheSerializableRunnableForPRPutsKeyValue(
            name, portfoliosAndPositions, (3 * (step)), dataSize));
    LogWriterUtils.getLogWriter()
        .info(
    ...
    vm0.invoke(
        PRQHelp.getCacheSerializableRunnableForPRPutsKeyValue(
            localName, portfoliosAndPositions, i, dataSize));
    ...
    vm1.invoke(
        PRQHelp.getCacheSerializableRunnableForPRIndexCreate(
            name, "PrIndexOnKeyID", "key.ID", "/" + name + ".keys key", null));
  ...
  public void testIndexQueryingWithOrderByLimit() throws Exception {
    ...
    vm1.invoke(
        PRQHelp.getCacheSerializableRunnableForPRIndexCreate(
            name, "PrIndexOnKeyStatus", "key.status", "/" + name + ".keys key", null));

    vm1.invoke(
        PRQHelp.getCacheSerializableRunnableForPRIndexCreate(
            name, "PrIndexOnsecID", "p.position1.secId", "/" + name + " p", null));

    vm0.invoke(
        PRQHelp.getCacheSerializableRunnableForRRIndexCreate(
            localName, "rrIndexOnStatus", "p.status", null, "p"));

    vm0.invoke(
        PRQHelp.getCacheSerializableRunnableForRRIndexCreate(
            localName, "rrIndexOnID", "p.ID", null, "p"));

    vm0.invoke(
        PRQHelp.getCacheSerializableRunnableForRRIndexCreate(
            localName, "rrIndexOnKeyID", "key.ID", "/" + localName + ".keys key", null));

    vm0.invoke(
        PRQHelp.getCacheSerializableRunnableForRRIndexCreate(
            localName, "rrIndexOnsecID", "p.position1.secId", "/" + localName + " p", null));

    vm0.invoke(
        PRQHelp.getCacheSerializableRunnableForRRIndexCreate(
            localName, "rrIndexOnKeyStatus", "key.status", "/" + localName + ".keys key", null));
