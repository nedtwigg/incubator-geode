...
public class ConnectionPoolDUnitTest extends JUnit4CacheTestCase {
  ...
  public void waitForBlacklistToClear(final PoolImpl pool) {
    ...
    assertEquals("unexpected blacklistedServers=" + pool.getBlacklistedServers(), 0, pool.getBlacklistedServers().size());
  }
  ...
  protected void validateDS() {
    ...
    if (l.size() > 1) {
      getSystem().getLogWriter().info("validateDS: size=" + l.size() + " isDedicatedAdminVM=" + DistributionManager.isDedicatedAdminVM + " l=" + l);
    }
  ...
  public void test026DPEmptyInterestListRegistrationWithCallbackArg() throws CacheException {
    ...
    SerializableRunnable createPublisher = new CacheSerializableRunnable("Create publisher region") {
      public void run2() throws CacheException {
        getLonerSystem();
        AttributesFactory factory = new AttributesFactory();
        factory.setScope(Scope.LOCAL);
  ...
  */
  ...
  public void test037Bug39526part1() throws CacheException, InterruptedException {
    ...
    SerializableRunnable validateClient = new CacheSerializableRunnable("Validate Cache Server Client") {
      public void run2() throws CacheException {
