 ...
 *
 * <p>Test uses Groboutils TestRunnable objects to achieve multi threading behavior in the test.
 */
...
public class ConnectionPoolDUnitTest extends JUnit4CacheTestCase {
  ...
  public void verifyBalanced(
      final PoolImpl pool, int expectedServer, final int expectedConsPerServer) {
    ...
    WaitCriterion ev =
        new WaitCriterion() {
          ...
          public String description() {
            return "expected "
                + expectedConsPerServer
                + " but endpoints="
                + outOfBalanceReport(pool);
          }
        };
    Wait.waitForCriterion(ev, 2 * 60 * 1000, 200, true);
    assertEquals(
        "expected " + expectedConsPerServer + " but endpoints=" + outOfBalanceReport(pool),
        true,
  ...
  public void waitForBlacklistToClear(final PoolImpl pool) {
    ...
    assertEquals(
        "unexpected blacklistedServers=" + pool.getBlacklistedServers(),
        0,
  ...
  public void test001CallbackArg() throws CacheException {
        ...
        new CacheSerializableRunnable("Create region") {
          public void run2() throws CacheException {
            ...
            ClientServerTestCase.configureConnectionPool(
                factory, NetworkUtils.getServerHostName(host), port, -1, true, -1, -1, null);
            createRegion(name, factory.create());
          }
        };
    ...
    vm1.invoke(create);
    vm1.invoke(
        new CacheSerializableRunnable("Add entries") {
          public void run2() throws CacheException {
    ...
    vm0.invoke(
        new CacheSerializableRunnable("Check cache writer") {
          public void run2() throws CacheException {
            Region region = getRootRegion().getSubregion(name);
    ...
    SerializableRunnable createClient =
        new CacheSerializableRunnable("Create Cache Server Client") {
          public void run2() throws CacheException {
            ...
            ClientServerTestCase.configureConnectionPool(
                factory, host0, vm0Port, vm1Port, true, -1, -1, null);
            createRegion(name, factory.create());
          }
        };
  ...
  public void test004ForCacheLoaderException() throws CacheException, InterruptedException {
        ...
        new CacheSerializableRunnable("Create Cache Server Client") {
          public void run2() throws CacheException {
            ...
            ClientServerTestCase.configureConnectionPoolWithName(
                factory, host0, port, true, -1, -1, null, poolName);
            createRegion(name, factory.create());
          }
        };
    getSystem().getLogWriter().info("before create client");
    ...
    ThreadUtils.join(inv2, 30 * 1000);
    SerializableRunnable stopServer =
        new SerializableRunnable("stop CacheServer") {
          public void run() {
            stopBridgeServer(getCache());
          }
  ...
  public void test006Pool() throws CacheException {
    ...
    vm1.invoke(
        new CacheSerializableRunnable("Get values") {
          public void run2() throws CacheException {
            Region region = getRootRegion().getSubregion(name);
            for (int i = 0; i < 10; i++) {
    ...
    vm1.invoke(
        new CacheSerializableRunnable("Update values") {
          public void run2() throws CacheException {
            Region region = getRootRegion().getSubregion(name);
    ...
    vm2.invoke(create);
    vm2.invoke(
        new CacheSerializableRunnable("Validate values") {
          public void run2() throws CacheException {
            Region region = getRootRegion().getSubregion(name);
            for (int i = 0; i < 10; i++) {
              Object value = region.get(new Integer(i));
    ...
    SerializableRunnable create =
        new CacheSerializableRunnable("Create region") {
          public void run2() throws CacheException {
            ...
            factory.setConcurrencyChecksEnabled(false);
            ClientServerTestCase.configureConnectionPool(
                factory, host0, port0, port1, true, -1, cnxCount, null, 100);
  ...
  private void basicTestLifetimeExpire(final boolean threadLocal) throws CacheException {
    ...
    try {
            ...
            public void run2() throws CacheException {
              ...
              assertTrue(
                  "baselineLifetimeCheck="
                      + baselineLifetimeCheck
                      + " but stats.getLoadConditioningCheck()="
      ...
      vm2.invoke(
          new SerializableRunnable("Stop Putters") {
            public void run() {
        ...
        if (putAI != null) {
          ...
          if (putAI.exceptionOccurred()) {
            org.apache.geode.test.dunit.Assert.fail(
                "While putting entries: ", putAI.getException());
          }
        }
    ...
    SerializableRunnable create =
        new CacheSerializableRunnable("Create region") {
          public void run2() throws CacheException {
            ...
            factory.setConcurrencyChecksEnabled(false);
            ClientServerTestCase.configureConnectionPool(
                factory, host0, port, -1, false, -1, -1, null);
            createRegion(name, factory.create());
          }
        };
  ...
  public void test012PoolPut() throws CacheException {
    ...
    vm1.invoke(
        new CacheSerializableRunnable("Put values") {
          public void run2() throws CacheException {
            Region region = getRootRegion().getSubregion(name);
            for (int i = 0; i < 10; i++) {
              // put string values
    ...
    vm2.invoke(
        new CacheSerializableRunnable("Get / validate string values") {
          public void run2() throws CacheException {
            Region region = getRootRegion().getSubregion(name);
            for (int i = 0; i < 10; i++) {
    ...
    vm2.invoke(
        new CacheSerializableRunnable("Get / validate object values") {
          public void run2() throws CacheException {
            Region region = getRootRegion().getSubregion(name);
            for (int i = 0; i < 10; i++) {
    ...
    vm2.invoke(
        new CacheSerializableRunnable("Get / validate byte[] values") {
          public void run2() throws CacheException {
            Region region = getRootRegion().getSubregion(name);
            for (int i = 0; i < 10; i++) {
  ...
  public void test014InvalidateAndDestroyPropagation() throws CacheException {
    ...
    SerializableRunnable create =
        new CacheSerializableRunnable("Create region") {
          public void run2() throws CacheException {
            ...
            ClientServerTestCase.configureConnectionPool(
                factory, host0, port, -1, true, -1, -1, null);
            CertifiableTestCacheListener l =
    ...
    vm1.invoke(
        new CacheSerializableRunnable("Turn on history") {
          public void run2() throws CacheException {
            Region region = getRootRegion().getSubregion(name);
    ...
    vm1.invoke(
        new CacheSerializableRunnable("Verify invalidates") {
          public void run2() throws CacheException {
            Region region = getRootRegion().getSubregion(name);
            CertifiableTestCacheListener ctl =
                (CertifiableTestCacheListener) region.getAttributes().getCacheListener();
    ...
    vm2.invoke(
        new CacheSerializableRunnable("Validate original and destroy") {
          public void run2() throws CacheException {
            Region region = getRootRegion().getSubregion(name);
            for (int i = 0; i < 10; i++) {
              Object key = new Integer(i);
    ...
    vm1.invoke(
        new CacheSerializableRunnable("Verify destroys") {
          public void run2() throws CacheException {
            Region region = getRootRegion().getSubregion(name);
            CertifiableTestCacheListener ctl =
                (CertifiableTestCacheListener) region.getAttributes().getCacheListener();
    ...
    vm1.invoke(
        new CacheSerializableRunnable("Verify creates") {
          public void run2() throws CacheException {
            Region region = getRootRegion().getSubregion(name);
            CertifiableTestCacheListener ctl =
                (CertifiableTestCacheListener) region.getAttributes().getCacheListener();
        ...
        new CacheSerializableRunnable("Create region") {
          public void run2() throws CacheException {
            ...
            factory.setSubscriptionAttributes(
                new SubscriptionAttributes(InterestPolicy.CACHE_CONTENT));
            Region rgn = createRegion(name, factory.create());
            rgn.registerInterestRegex(".*", false, false);
          }
        };
  ...
  public void test017ExpireDestroyHasEntryInCallback() throws CacheException {
    ...
    vm1.invoke(
        new CacheSerializableRunnable("Create entries") {
          public void run2() throws CacheException {
            Region region = getRootRegion().getSubregion(name);
            for (int i = 0; i < 5; i++) {
    ...
    vm1.invoke(
        new CacheSerializableRunnable("Validate listener events") {
          public void run2() throws CacheException {
            Region region = getRootRegion().getSubregion(name);
            CertifiableTestCacheListener ctl =
                (CertifiableTestCacheListener) region.getAttributes().getCacheListener();
  ...
  public AttributesFactory getBridgeServerMirroredAckRegionAttributes(
      CacheLoader cl, CacheWriter cw) {
    AttributesFactory ret = new AttributesFactory();
    if (cl != null) {
      ret.setCacheLoader(cl);
    }
  ...
  public void test018OnlyRequestedUpdates() throws Exception {
    ...
    vm1.invoke(
        new CacheSerializableRunnable("Create regions") {
          public void run2() throws CacheException {
            getLonerSystem();
            getCache();
            AttributesFactory factory = new AttributesFactory();
  ...
  public void test019InterestKeyRegistration() throws CacheException {
    ...
    vm1.invoke(
        new CacheSerializableRunnable("Create Entries and Register Interest") {
          public void run2() throws CacheException {
            LocalRegion region = (LocalRegion) getRootRegion().getSubregion(name);
    ...
    vm1.invoke(
        new CacheSerializableRunnable("Put New Values") {
          public void run2() throws CacheException {
            LocalRegion region = (LocalRegion) getRootRegion().getSubregion(name);
    ...
    Wait.pause(500);
    vm2.invoke(
        new CacheSerializableRunnable("Validate Entries") {
          public void run2() throws CacheException {
            LocalRegion region = (LocalRegion) getRootRegion().getSubregion(name);
    ...
    // Unregister interest
    vm1.invoke(
        new CacheSerializableRunnable("Unregister Interest") {
          public void run2() throws CacheException {
            LocalRegion region = (LocalRegion) getRootRegion().getSubregion(name);
            try {
   ...
   */
  public void createBridgeServer(
      VM vm, final String rName, final int port, final boolean notifyBySubscription) {
    vm.invoke(
        new CacheSerializableRunnable("Create Region on Server") {
          public void run2() {
            try {
              AttributesFactory factory = new AttributesFactory();
              factory.setScope(Scope.DISTRIBUTED_ACK);
              ...
              region.put(
                  "BridgeServer",
                  new Integer(port)); // A unique key/value to identify the BridgeServer
            } catch (Exception e) {
  ...
  public void test021ClientGetOfInvalidServerEntry() throws CacheException {
    ...
    SerializableRunnable createPool2 =
        new CacheSerializableRunnable("Create region 2") {
          public void run2() throws CacheException {
            ...
            ClientServerTestCase.configureConnectionPool(
                regionFactory, host0, port, -1, false, -1, -1, null);
            org.apache.geode.test.dunit.LogWriterUtils.getLogWriter()
    ...
    client.invoke(
        new CacheSerializableRunnable("get values on client") {
          public void run2() throws CacheException {
            Region region1 = getRootRegion().getSubregion(regionName1);
    ...
    SerializableRunnable createPool =
        new CacheSerializableRunnable("Create region") {
          public void run2() throws CacheException {
            ...
            ClientServerTestCase.configureConnectionPool(
                regionFactory, host0, port, -1, true, -1, -1, null);
          ...
          public void run2() throws CacheException {
            for (Iterator bi = getCache().getCacheServers().iterator(); bi.hasNext(); ) {
              ...
              WaitCriterion ev =
                  new WaitCriterion() {
                    public boolean done() {
                      return ccnStats.getClientRegisterRequests()
                          == ccnStats.getClientUnRegisterRequests();
                    }
              ...
              assertEquals(
                  "HealthMonitor Client Register/UnRegister mismatch.",
                  ccnStats.getClientRegisterRequests(),
                  ccnStats.getClientUnRegisterRequests());
            }
          }
        };
  ...
  public void test023ContainsKeyOnServer() throws CacheException {
    ...
    final String key2 = "0";
    vm2.invoke(
        new CacheSerializableRunnable("Contains key on server") {
          public void run2() throws CacheException {
            Region region = getRootRegion().getSubregion(name);
  ...
  public void test024CreateNullValue() throws CacheException {
    ...
    vm2.invoke(create);
    vm2.invoke(
        new CacheSerializableRunnable("Create nulls") {
          public void run2() throws CacheException {
            Region region = getRootRegion().getSubregion(name);
            for (int i = 0; i < 10; i++) {
    ...
    vm1.invoke(
        new CacheSerializableRunnable("Attempt to create values") {
          public void run2() throws CacheException {
            Region region = getRootRegion().getSubregion(name);
            for (int i = 0; i < 10; i++) {
  ...
  public void test025Destroy() throws CacheException {
    ...
    vm2.invoke(create);
    vm2.invoke(
        new CacheSerializableRunnable("Load region") {
          public void run2() throws CacheException {
            Region region = getRootRegion().getSubregion(name);
            for (int i = 0; i < 10; i++) {
    ...
    vm1.invoke(
        new CacheSerializableRunnable("Local destroy") {
          public void run2() throws CacheException {
            Region region = getRootRegion().getSubregion(name);
            for (int i = 0; i < 10; i++) {
    ...
    vm2.invoke(
        new CacheSerializableRunnable("No destroy propagate") {
          public void run2() throws CacheException {
            Region region = getRootRegion().getSubregion(name);
            for (int i = 0; i < 10; i++) {
              assertEquals(String.valueOf(i), region.get(new Integer(i)));
    ...
    vm1.invoke(
        new CacheSerializableRunnable("Fetch from server") {
          public void run2() throws CacheException {
            Region region = getRootRegion().getSubregion(name);
            for (int i = 0; i < 10; i++) {
              assertEquals(String.valueOf(i), region.get(new Integer(i)));
    ...
    vm0.invoke(
        new CacheSerializableRunnable("Check no server cache writer") {
          public void run2() throws CacheException {
            Region region = getRootRegion().getSubregion(name);
            TestCacheWriter writer = getTestWriter(region);
            writer.wasInvoked();
    ...
    vm1.invoke(
        new CacheSerializableRunnable("Distributed destroy") {
          public void run2() throws CacheException {
            Region region = getRootRegion().getSubregion(name);
            for (int i = 0; i < 10; i++) {
    ...
    vm1.invoke(
        new CacheSerializableRunnable("Attempt get from server") {
          public void run2() throws CacheException {
            Region region = getRootRegion().getSubregion(name);
            for (int i = 0; i < 10; i++) {
    ...
    vm2.invoke(
        new CacheSerializableRunnable("Validate destroy propagate") {
          public void run2() throws CacheException {
            Region region = getRootRegion().getSubregion(name);
            for (int i = 0; i < 10; i++) {
              assertNull(region.getEntry(new Integer(i)));
  ...
  public void testDestroyRegion() throws CacheException {
    ...
    vm1.invoke(
        new CacheSerializableRunnable("Distributed destroy region") {
          public void run2() throws CacheException {
            Region region = getRootRegion().getSubregion(name);
            assertNotNull(region);
    ...
    vm2.invoke(
        new CacheSerializableRunnable("Verify destroy propagate") {
          public void run2() throws CacheException {
            Region region = getRootRegion().getSubregion(name);
            assertNull(region);
  ...
  public void test026DPEmptyInterestListRegistrationWithCallbackArg() throws CacheException {
    ...
    vm2.invoke(
        new CacheSerializableRunnable("Put Value") {
          public void run2() throws CacheException {
            LocalRegion region = (LocalRegion) getRootRegion().getSubregion(name);
        ...
        new CacheSerializableRunnable("Verify events") {
          public void run2() throws CacheException {
            ...
            ControlListener listener =
                (ControlListener) region.getAttributes().getCacheListeners()[0];
            Wait.pause(
                1000); // we should not get any events but give some time for the server to send them
   ...
   *
   * <p>Also tests the reverse situation, a dynamic region is created on the bridge server expecting
   * the same region to be created on the client.
   *
   * <p>Note: This test re-creates Distributed Systems for its own purposes and uses a Loner
  ...
  public void test028DynamicRegionCreation() throws Exception {
    ...
    try {
      ...
      client1.invoke(
          new CacheSerializableRunnable("Create Cache Client") {
            public void run2() throws CacheException {
              createLonerDS();
              AttributesFactory factory = new AttributesFactory();
              factory.setConcurrencyChecksEnabled(false);
              Pool cp =
                  ClientServerTestCase.configureConnectionPool(
                      factory, srv1Host, srv1Port, srv2Port, true, -1, -1, null);
              {
                ...
                assertTrue(
                    "backups=" + pool.getRedundants() + " expected=" + 1,
              ...
              region.registerInterestRegex(
                  ".*", InterestResultPolicy.KEYS_VALUES); // this should match the key
              ...
              assertEquals(
                  ...
                  region
                      .getEntry(k2)
                      .getValue()); // Ensure that the notifier didn't un-do the put, bug 35355
      ...
      srv1.invoke(
          new CacheSerializableRunnable("Validate Server1 update") {
            public void run2() throws CacheException {
              ...
              assertEquals(
                  v2,
                  r.getEntry(k2)
                      .getValue()); // Validate the Pool worked, getEntry works because of the mirror
              assertEquals(
                  v3,
                  r.getEntry(k3)
                      .getValue()); // Make sure we have the other entry to use for notification
      ...
      srv2.invoke(
          new CacheSerializableRunnable("Validate Server2 update") {
            public void run2() throws CacheException {
              Region r = getRootRegion(name);
              assertNotNull(r);
              assertEquals(
      ...
      client1.invoke(
          new CacheSerializableRunnable("Validate Client notification") {
            public void run2() throws CacheException {
              Region r = getRootRegion(name);
              assertNotNull(r);
              CertifiableTestCacheListener ctl =
              ...
              assertEquals(
                  v1, r.getEntry(k3).getValue()); // Ensure that the notifier updated the entry
            }
          });
      ...
      client1.invoke(
          new CacheSerializableRunnable("Client dynamic region creation") {
            public void run2() throws CacheException {
              assertTrue(DynamicRegionFactory.get().isOpen());
              Region r = getRootRegion(name);
              assertNotNull(r);
              ...
              assertNull(
                  dr.get(k1)); // This should be enough to validate the creation on the server
              dr.put(k1, v1Dynamic);
      ...
      client1.invoke(
          new CacheSerializableRunnable("Client dynamic region destruction") {
            public void run2() throws CacheException {
      ...
      // has it
      srv2.invoke(
          new CacheSerializableRunnable("Server dynamic region creation") {
            public void run2() throws CacheException {
              Region r = getRootRegion(name);
              assertNotNull(r);
      ...
      client1.invoke(
          new CacheSerializableRunnable("Validate dynamic region creation on client") {
            public void run2() throws CacheException {
              Region r = getRootRegion(name);
              assertNotNull(r);
              long end = System.currentTimeMillis() + 10000;
      ...
      srv2.invoke(
          new CacheSerializableRunnable("Server dynamic region destruction") {
            public void run2() throws CacheException {
              assertTrue(DynamicRegionFactory.get().isActive());
              Region r = getRootRegion(name);
              assertNotNull(r);
      ...
      client1.invoke(
          new CacheSerializableRunnable("Validate dynamic region destruction on client") {
            public void run2() throws CacheException {
              Region r = getRootRegion(name);
              assertNotNull(r);
              String drName = r.getFullPath() + Region.SEPARATOR + dynFromServerName;
  ...
  public void test029EmptyByteArray() throws CacheException {
    ...
    vm1.invoke(create);
    vm1.invoke(
        new CacheSerializableRunnable("Create empty byte array") {
          public void run2() throws CacheException {
            Region region = getRootRegion().getSubregion(name);
            for (int i = 0; i < 1; i++) {
    ...
    vm1.invoke(
        new CacheSerializableRunnable("Verify values on client") {
          public void run2() throws CacheException {
            Region region = getRootRegion().getSubregion(name);
            for (int i = 0; i < 1; i++) {
              Region.Entry entry = region.getEntry(new Integer(i));
    ...
    vm0.invoke(
        new CacheSerializableRunnable("Verify values on server") {
          public void run2() throws CacheException {
            Region region = getRootRegion().getSubregion(name);
            for (int i = 0; i < 1; i++) {
              Region.Entry entry = region.getEntry(new Integer(i));
  ...
  public void test031KeySetOnServer() throws CacheException {
    ...
    vm2.invoke(
        new CacheSerializableRunnable("Get keys on server") {
          public void run2() throws CacheException {
            Region region = getRootRegion().getSubregion(name);
  ...
  public void test033NotSerializableException() throws CacheException {
    ...
    vm1.invoke(
        new CacheSerializableRunnable("Attempt to create a non-serializable value") {
          public void run2() throws CacheException {
            Region region = getRootRegion().getSubregion(name);
            try {
    ...
    vm1.invoke(
        new CacheSerializableRunnable("Attempt to put a non-serializable value") {
          public void run2() throws CacheException {
            Region region = getRootRegion().getSubregion(name);
            try {
    ...
    vm1.invoke(
        new CacheSerializableRunnable("Attempt to get a non-serializable key") {
          public void run2() throws CacheException {
            Region region = getRootRegion().getSubregion(name);
            try {
  ...
  public void test034NotifyAllUpdates() throws CacheException {
    ...
    vm2.invoke(
        new CacheSerializableRunnable("Add CacheListener 1") {
          public void run2() throws CacheException {
            LocalRegion region = (LocalRegion) getRootRegion().getSubregion(name);
    ...
    vm3.invoke(
        new CacheSerializableRunnable("Add CacheListener 2") {
          public void run2() throws CacheException {
            LocalRegion region = (LocalRegion) getRootRegion().getSubregion(name);
            CacheListener listener =
                new CacheListenerAdapter() {
    ...
    assertTrue(
        "VM2 should not have received any afterInvalidate messages", vm2AfterInvalidates == 0);
    assertTrue(
        "VM2 received "
            + vm2AfterUpdates
            + " afterUpdate messages. It should have received "
            + numberOfKeys,
    ...
    assertTrue(
        "VM3 received "
            + vm3AfterInvalidates
            + " afterInvalidate messages. It should have received "
            + numberOfKeys,
    ...
    SerializableRunnable createClient =
        new CacheSerializableRunnable("Create Cache Server Client") {
          public void run2() throws CacheException {
            ...
            // create bridge writer
            ClientServerTestCase.configureConnectionPool(
                factory, host0, vm0Port, -1, true, -1, -1, null);
            createRegion(name, factory.create());
            LocalRegion region = (LocalRegion) getRootRegion().getSubregion(name);
            region.registerInterestRegex(".*");
          }
