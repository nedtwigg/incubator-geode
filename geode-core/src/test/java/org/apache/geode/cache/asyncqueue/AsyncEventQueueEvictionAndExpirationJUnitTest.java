...
public class AsyncEventQueueEvictionAndExpirationJUnitTest {
  ...
  public void evictionDestroyOpEventsNotPropogatedByDefault() {
    ...
    createRegionAeqAndPopulate(false /*isPR */, false /* forwardExpirationDestroy */, true /* eviction */, false /* evictionOverflow */, false /* expirationDestroy */, false /* expirationInvalidate */);
  ...
  public void evictionDestroyOpEventsNotPropogatedByDefaultForPR() {
    ...
    // Number of expected events 2. Two for create and none for eviction destroy.
    createRegionAeqAndPopulate(true /*isPR */, false /* forwardExpirationDestroy */, true /* eviction */, false /* evictionOverflow */, false /* expirationDestroy */, false /* expirationInvalidate */);
  ...
  public void expirationDestroyOpEventsNotPropogatedByDefault() {
    ...
    // Number of expected events 2. Two for create and none for eviction destroy.
    createRegionAeqAndPopulate(false /*isPR */, false /* forwardExpirationDestroy */, false /* eviction */, false /* evictionOverflow */, true /* expirationDestroy */, false /* expirationInvalidate */);
  ...
  public void expirationDestroyOpEventsNotPropogatedByDefaultForPR() {
    ...
    // Number of expected events 2. Two for create and none for eviction destroy.    
    createRegionAeqAndPopulate(true /*isPR */, false /* forwardExpirationDestroy */, false /* eviction */, false /* evictionOverflow */, true /* expirationDestroy */, false /* expirationInvalidate */);
  ...
  public void expirationInvalidOpEventsNotPropogatedByDefault() {
    ...
    // Number of expected events 2. Two for create and none for eviction destroy.    
    createRegionAeqAndPopulate(false /*isPR */, false /* forwardExpirationDestroy */, false /* eviction */, false /* evictionOverflow */, false /* expirationDestroy */, true /* expirationInvalidate */);
  ...
  public void expirationInvalidOpEventsNotPropogatedByDefaultForPR() {
    // For Replicated Region with expiration-invalid op.
    // Number of expected events 2. Two for create and none for eviction destroy.
    createRegionAeqAndPopulate(true /*isPR */, false /* forwardExpirationDestroy */, false /* eviction */, false /* evictionOverflow */, false /* expirationDestroy */, true /* expirationInvalidate */);
  ...
  public void evictionNotPropogatedUsingForwardExpirationDestroyAttribute() {
    // For Replicated Region with eviction-destroy op.
    // Number of expected events 2. Two for create and none for eviction destroy.
    createRegionAeqAndPopulate(false /*isPR */, true /* forwardExpirationDestroy */, true /* eviction */, false /* evictionOverflow */, false /* expirationDestroy */, false /* expirationInvalidate */);
  ...
  public void evictionNotPropogatedUsingForwardExpirationDestroyAttributeForPR() {
    ...
    createRegionAeqAndPopulate(true /*isPR */, true /* forwardExpirationDestroy */, true /* eviction */, false /* evictionOverflow */, false /* expirationDestroy */, false /* expirationInvalidate */);
  ...
  public void overflowNotPropogatedUsingForwardExpirationDestroyAttribute() {
    ...
    createRegionAeqAndPopulate(false /*isPR */, true /* forwardExpirationDestroy */, false /* eviction */, true /* evictionOverflow */, false /* expirationDestroy */, false /* expirationInvalidate */);
  ...
  public void overflowNotPropogatedUsingForwardExpirationDestroyAttributeForPR() {
    ...
    // Number of expected events 2. Two for create and non for eviction overflow.
    createRegionAeqAndPopulate(true /*isPR */, true /* forwardExpirationDestroy */, false /* eviction */, true /* evictionOverflow */, false /* expirationDestroy */, false /* expirationInvalidate */);
  ...
  public void expirationDestroyPropogatedUsingForwardExpirationDestroyAttribute() {
    ...
    createRegionAeqAndPopulate(false /*isPR */, true /* forwardExpirationDestroy */, false /* eviction */, false /* evictionOverflow */, true /* expirationDestroy */, false /* expirationInvalidate */);
  ...
  public void expirationDestroyPropogatedUsingForwardExpirationDestroyAttributeForPR() {
    // For PR with expiration-destroy op.
    // Number of expected events 4. Two for create and Two for expiration destroy.
    createRegionAeqAndPopulate(true /*isPR */, true /* forwardExpirationDestroy */, false /* eviction */, false /* evictionOverflow */, true /* expirationDestroy */, false /* expirationInvalidate */);
  ...
  public void expirationInvalidateNotPropogatedUsingForwardExpirationDestroyAttribute() {
    ...
    createRegionAeqAndPopulate(false /*isPR */, true /* forwardExpirationDestroy */, false /* eviction */, false /* evictionOverflow */, false /* expirationDestroy */, true /* expirationInvalidate */);
  ...
  public void expirationInvalidateNotPropogatedUsingForwardExpirationDestroyAttributeForPR() {
    ...
    // Invalidates are not sent to AEQ.
    // Number of expected events 2. None for expiration invalidate.
    createRegionAeqAndPopulate(true /*isPR */, true /* forwardExpirationDestroy */, false /* eviction */, false /* evictionOverflow */, false /* expirationDestroy */, true /* expirationInvalidate */);
  ...
  private void createRegionAeqAndPopulate(boolean isPR, boolean forwardExpirationDestroy, boolean eviction, boolean evictionOverflow, boolean expirationDestroy, boolean expirationInvalidate) {
  ...
  private void createAsyncEventQueue(String id, boolean forwardExpirationDestroy, List<AsyncEvent> storeEvents) {
    ...
    aeq = cache.createAsyncEventQueueFactory().setParallel(false).setForwardExpirationDestroy(forwardExpirationDestroy).setBatchSize(1).setBatchTimeInterval(1).create(id, al);
  }

  private Region createRegion(String name, boolean isPR, String aeqId, boolean evictionDestroy, boolean evictionOverflow, boolean expirationDestroy, boolean expirationInvalidate) {
    RegionFactory rf;
    if (isPR) {
