...
public class AsyncEventQueueEvictionAndExpirationJUnitTest {
  ...
  public void evictionDestroyOpEventsNotPropogatedByDefault() {
    ...
    createRegionAeqAndPopulate(
        false /*isPR */,
        false /* forwardExpirationDestroy */,
        true /* eviction */,
        false /* evictionOverflow */,
        false /* expirationDestroy */,
  ...
  private void createRegionAeqAndPopulate(
      boolean isPR,
      boolean forwardExpirationDestroy,
      boolean eviction,
      boolean evictionOverflow,
      boolean expirationDestroy,
    ...
    region =
        createRegion(
            "ReplicatedRegionForAEQ",
            isPR,
            aeqId,
            eviction,
            evictionOverflow,
            expirationDestroy,
            expirationInvalidate);
  ...
  private void createAsyncEventQueue(
      String id, boolean forwardExpirationDestroy, List<AsyncEvent> storeEvents) {
