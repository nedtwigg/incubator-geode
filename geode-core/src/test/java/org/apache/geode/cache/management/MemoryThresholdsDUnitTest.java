...
public class MemoryThresholdsDUnitTest extends ClientServerTestCase {
  ...
  private void doDistributedRegionRemotePutRejection(boolean localDestroy, boolean cacheClose)
    ...
    ServerPorts ports1 =
        startCacheServer(
            server1, 0f, 0f, regionName, false /*createPR*/, false /*notifyBySubscription*/, 0);
    ServerPorts ports2 =
        startCacheServer(
            server2, 0f, 90f, regionName, false /*createPR*/, false /*notifyBySubscription*/, 0);

    registerTestMemoryThresholdListener(server1);
    registerTestMemoryThresholdListener(server2);

    doPuts(
        server1, regionName, false /*catchRejectedException*/, false /*catchLowMemoryException*/);
    doPutAlls(
        server1,
        regionName,
        false /*catchRejectedException*/,
        false /*catchLowMemoryException*/,
        Range.DEFAULT);
    ...
    doPuts(server1, regionName, false /*catchRejectedException*/, true /*catchLowMemoryException*/);
    ...
    if (localDestroy) {
      ...
      server2.invoke(
          new SerializableCallable("local destroy") {
            public Object call() throws Exception {
                ...
                new WaitCriterion() {
                  ...
                  public boolean done() {
                    DistributedRegion dr =
                        (DistributedRegion) getRootRegion().getSubregion(regionName);
  ...
  public void testDistributedRegionRemoteClientPutRejection() throws Exception {
    ...
    doPuts(client, regionName, false /*catchRejectedException*/, false /*catchLowMemoryException*/);
    doPutAlls(
        client,
        regionName,
        false /*catchRejectedException*/,
    ...
    doPuts(client, regionName, true /*catchRejectedException*/, false /*catchLowMemoryException*/);
    doPutAlls(
        client,
        regionName,
        true /*catchRejectedException*/,
        false /*catchLowMemoryException*/,
        new Range(Range.DEFAULT, Range.DEFAULT.width() + 1));
  }
  ...
  public void testDisabledThresholds() throws Exception {
    ...
    ServerPorts ports1 =
        startCacheServer(
            server1, 0f, 0f, regionName, true /*createPR*/, false /*notifyBySubscription*/, 0);
    ServerPorts ports2 =
        startCacheServer(
            server2, 0f, 0f, regionName, true /*createPR*/, false /*notifyBySubscription*/, 0);
  ...
  public void testEventDelivery() throws Exception {
    ...
    ServerPorts ports2 =
        startCacheServer(
            server2, 80f, 90f, regionName, false /*createPR*/, false /*notifyBySubscription*/, 0);
    ...
    //NORMAL -> CRITICAL
    server2.invoke(
        new SerializableCallable("NORMAL->CRITICAL") {
          public Object call() throws Exception {
    ...
    //CRITICAL -> EVICTION
    server2.invoke(
        new SerializableCallable("CRITICAL->EVICTION") {
          public Object call() throws Exception {
            GemFireCacheImpl gfCache = (GemFireCacheImpl) getCache();
    ...
    //EVICTION -> EVICTION
    server2.invoke(
        new SerializableCallable("EVICTION->EVICTION") {
          public Object call() throws Exception {
            GemFireCacheImpl gfCache = (GemFireCacheImpl) getCache();
    ...
    //EVICTION -> NORMAL
    server2.invoke(
        new SerializableCallable("EVICTION->NORMAL") {
          public Object call() throws Exception {
            GemFireCacheImpl gfCache = (GemFireCacheImpl) getCache();
    ...
    server2.invoke(
        new SerializableCallable("NORMAL->CRITICAL->NORMAL") {
          public Object call() throws Exception {
            GemFireCacheImpl gfCache = (GemFireCacheImpl) getCache();
            gfCache.getResourceManager().getHeapMonitor().updateStateAndSendEvent(950);
            gfCache.getResourceManager().getHeapMonitor().updateStateAndSendEvent(750);
    ...
    //NORMAL -> EVICTION
    server2.invoke(
        new SerializableCallable("NORMAL->EVICTION") {
          public Object call() throws Exception {
            GemFireCacheImpl gfCache = (GemFireCacheImpl) getCache();
            gfCache.getResourceManager().getHeapMonitor().updateStateAndSendEvent(850);
            return null;
  ...
  public void testCleanAdvisorClose() throws Exception {
    ...
    ServerPorts ports2 =
        startCacheServer(
            server2, 0f, 0f, regionName, false /*createPR*/, false /*notifyBySubscription*/, 0);
    ...
    startCacheServer(
        server3, 0f, 0f, regionName, false /*createPR*/, false /*notifyBySubscription*/, 0);
  ...
  @Category(
      FlakyTest
          .class) // GEODE-987: random ports, failed to throw expected ResourceException, overly complex expected exception handling, memory and GC sensitive, expiration, waitForCriterion
  @Test
  ...
  private void prRemotePutRejection(boolean cacheClose, boolean localDestroy, final boolean useTx)
                  ...
                  public boolean done() {
                    ...
                    for (int i = 0; i < 20; i++) {
                      ...
                      Set<InternalDistributedMember> owners =
                          pr.getRegionAdvisor().getBucketOwners(hKey);
    ...
    if (localDestroy) {
      //local destroy the region on sick member
      server1.invoke(
          new SerializableCallable("local destroy sick member") {
            public Object call() throws Exception {
              Region r = getRootRegion().getSubregion(regionName);
      ...
      server1.invoke(
          new SerializableCallable("close cache sick member") {
            public Object call() throws Exception {
              getCache().close();
              return null;
            }
    ...
    accessor.invoke(
        new SerializableCallable("Put in a loop") {
          public Object call() throws Exception {
  ...
  @Ignore(
      "this test is DISABLED due to test issues.  It sometimes fails with a TransactionDataNotColocatedException.  See bug #52222")
  @Test
  ...
  public void testDRFunctionExecutionRejection() throws Exception {
    ...
    ServerPorts ports1 =
        startCacheServer(
            server1, 80f, 90f, regionName, false /*createPR*/, false /*notifyBySubscription*/, 0);
    ServerPorts ports2 =
        startCacheServer(
            server2, 80f, 90f, regionName, false /*createPR*/, false /*notifyBySubscription*/, 0);
    ...
    Invoke.invokeInEveryVM(
        new SerializableCallable("register function") {
          public Object call() throws Exception {
  ...
  public void testPRFunctionExecutionRejection() throws Exception {
    ...
    final ServerPorts ports1 =
        startCacheServer(
            server1, 80f, 90f, regionName, true /*createPR*/, false /*notifyBySubscription*/, 0);
    ServerPorts ports2 =
        startCacheServer(
            server2, 80f, 90f, regionName, true /*createPR*/, false /*notifyBySubscription*/, 0);
    accessor.invoke(
        new SerializableCallable() {
          public Object call() throws Exception {
            getSystem(getServerProperties());
  ...
  SerializableCallable getDistributedMember =
      new SerializableCallable() {
        public Object call() throws Exception {
          return ((GemFireCacheImpl) getCache()).getMyId();
        };
  ...
  private void startClient(
      VM client, final VM server, final int serverPort, final String regionName) {
  ...
  private void doPuts(
      VM vm,
      final String regionName,
      final boolean catchServerException,
  ...
  private void setThresholds(
      VM server, final float evictionThreshold, final float criticalThreshold) {
   ...
   */
  private void verifyListenerValue(
      VM vm, final MemoryState state, final int value, final boolean useWaitCriterion) {
    vm.invoke(
        new SerializableCallable() {
          public Object call() throws Exception {
  ...
  private SerializableCallable setHeapMemoryMonitorTestMode =
      new SerializableCallable() {
        public Object call() throws Exception {
  ...
  private SerializableCallable resetResourceManager =
      new SerializableCallable() {
        public Object call() throws Exception {
          InternalResourceManager irm = ((GemFireCacheImpl) getCache()).getResourceManager();
    ...
    WaitCriterion wc =
        new WaitCriterion() {
          ...
          public String description() {
            return "Waiting for "
                + tenuredPoolName
                + " statistics to be added to create listener for";
          }
        };
    Wait.waitForCriterion(wc, 5000, 10, true);

    assertTrue(
        "expected at least one stat listener, found " + sampler.getLocalListeners().size(),
  ...
  public void testLRLoadRejection() throws Exception {
    ...
    vm.invoke(
        new CacheSerializableRunnable("test LocalRegion load passthrough when critical") {
          @Override
          public void run2() throws CacheException {
            InternalResourceManager irm = (InternalResourceManager) getCache().getResourceManager();
            HeapMemoryMonitor hmm = irm.getHeapMonitor();
            long fakeHeapUsage =
                Math.round(fakeHeapMaxSize * (criticalHeapThresh - 0.5f)); // below critical by 50%
            ...
            fakeHeapUsage =
                Math.round(
                    fakeHeapMaxSize * (criticalHeapThresh + 0.1f)); // usage above critical by 10%
            ...
            fakeHeapUsage =
                Math.round(fakeHeapMaxSize * (criticalHeapThresh - 0.3f)); // below critical by 30%
            assertTrue(fakeHeapMaxSize > 0);
            getCache().getLoggerI18n().fine(addExpectedBelow);
            hmm.updateStateAndSendEvent(fakeHeapUsage);
            getCache().getLoggerI18n().fine(removeExpectedBelow);
  ...
  public void testDRLoadRejection() throws Exception {
    ...
    final Integer expected =
        (Integer)
            replicate1.invoke(
                new SerializableCallable("test Local DistributedRegion Load") {
                  public Object call() throws Exception {
                    ...
                    am.setCacheLoader(
                        new CacheLoader<Integer, String>() {
                          ...
                          public String load(LoaderHelper<Integer, String> helper)
                            ...
                            final int actualInvocations =
                                this.numLoaderInvocations.getAndIncrement();
                            if (expectedInvocations.intValue() != actualInvocations) {
                              throw new CacheLoaderException(
                                  "Expected "
                                      + expectedInvocations
                                      + " invocations, actual is "
                                      + actualInvocations);
                            }
                            return helper.getKey().toString();
                          }
                    ...
                    long newfakeHeapUsage =
                        Math.round(
                            fakeHeapMaxSize
                                * (criticalHeapThresh + 0.1f)); // usage above critical by 10%
                    ...
                    newfakeHeapUsage =
                        Math.round(
                            fakeHeapMaxSize * (criticalHeapThresh - 0.3f)); // below critical by 30%
                    assertTrue(fakeHeapMaxSize > 0);
                    getCache().getLoggerI18n().fine(addExpectedBelow);
                    hmm.updateStateAndSendEvent(newfakeHeapUsage);
                    getCache().getLoggerI18n().fine(removeExpectedBelow);
    ...
    replicate2.invoke(
        new SerializableCallable("test DistributedRegion netLoad") {
          public Object call() throws Exception {
            Region<Integer, String> r = getCache().getRegion(rName);
            HeapMemoryMonitor hmm =
  ...
  public void testPRLoadRejection() throws Exception {
    ...
    Integer ex =
        (Integer)
            accessor.invoke(
                new SerializableCallable("Invoke loader from accessor, non-critical") {
                  public Object call() throws Exception {
                    Region<Integer, String> r = getCache().getRegion(rName);
                    Integer k = new Integer(1);
                    Integer expectedInvocations0 =
                        new Integer(expectedInvocations.getAndIncrement());
                    assertEquals(
                        k.toString(), r.get(k, expectedInvocations0)); // should load for new key
                    assertTrue(r.containsKey(k));
    ...
    ex =
        (Integer)
            ds1.invoke(
                new SerializableCallable("Invoke loader from datastore, non-critical") {
                  public Object call() throws Exception {
                    Region<Integer, String> r = getCache().getRegion(rName);
                    Integer k = new Integer(2);
                    Integer expectedInvocations1 =
                        new Integer(expectedInvocations.getAndIncrement());
                    assertEquals(
                        k.toString(), r.get(k, expectedInvocations1)); // should load for new key
                    assertTrue(r.containsKey(k));
    ...
    ex =
        (Integer)
            ds1.invoke(
                new SerializableCallable("Set critical state, assert local load behavior") {
                  public Object call() throws Exception {
                    long newfakeHeapUsage =
                        Math.round(
                            fakeHeapMaxSize
                    ...
                    final Integer expectedInvocations3 =
                        new Integer(expectedInvocations.getAndIncrement());
                    Region<Integer, String> r = getCache().getRegion(rName);
                    assertEquals(k.toString(), r.get(k, expectedInvocations3)); // load
                    assertFalse(r.containsKey(k));
                    Integer expectedInvocations4 =
                        new Integer(expectedInvocations.getAndIncrement());
        ...
        (Integer)
            accessor.invoke(
                new SerializableCallable(
                  ...
                  public Object call() throws Exception {
                    final Integer k = new Integer(2); // reload with same key again and again
                    Integer expectedInvocations6 =
                        new Integer(expectedInvocations.incrementAndGet());
                    Region<Integer, String> r = getCache().getRegion(rName);
                    assertEquals(k.toString(), r.get(k, expectedInvocations6)); // load
                    assertFalse(r.containsKey(k));
                    Integer expectedInvocations7 =
                        new Integer(expectedInvocations.incrementAndGet());
    ...
    ex =
        (Integer)
            ds1.invoke(
                new SerializableCallable(
                    "Set safe state on datastore, assert local load behavior") {
                  public Object call() throws Exception {
                    HeapMemoryMonitor hmm =
                        ((InternalResourceManager) getCache().getResourceManager())
                            .getHeapMonitor();
                    int newfakeHeapUsage =
                        Math.round(
                            fakeHeapMaxSize * (criticalHeapThresh - 0.3f)); // below critical by 30%
                    assertTrue(fakeHeapMaxSize > 0);
                    getCache().getLoggerI18n().fine(addExpectedBelow);
                    ...
                    assertFalse(hmm.getState().isCritical());
                    Integer k =
                        new Integer(3); // same key as previously used, this time is should stick
                    Integer expectedInvocations8 =
                        new Integer(expectedInvocations.incrementAndGet());
                    Region<Integer, String> r = getCache().getRegion(rName);
  ...
  private CacheSerializableRunnable createPR(
      ...
      final int fakeHeapMaxSize,
      final float criticalHeapThresh) {
  ...
  private SerializableRunnable addExpectedException =
