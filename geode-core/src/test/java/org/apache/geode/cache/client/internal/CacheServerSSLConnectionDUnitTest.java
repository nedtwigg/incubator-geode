...
public class CacheServerSSLConnectionDUnitTest extends JUnit4DistributedTestCase {
  ...
  public void setUpServerVM(final boolean cacheServerSslenabled, final boolean legacy)
    ...
    if (!legacy) {
      ...
      gemFireProps.put(
          CLUSTER_SSL_REQUIRE_AUTHENTICATION, String.valueOf(cacheServerSslRequireAuth));
  ...
  public static void setUpClientVMTask(
    ...
    instance.setUpClientVM(
        host, port, cacheServerSslenabled, cacheServerSslRequireAuth, keyStore, trustStore, true);
  }

  public static void setUpClientVMTaskNoSubscription(
      String host,
      int port,
      boolean cacheServerSslenabled,
      boolean cacheServerSslRequireAuth,
      ...
      throws Exception {
    instance.setUpClientVM(
        host, port, cacheServerSslenabled, cacheServerSslRequireAuth, keyStore, trustStore, false);
  }
    ...
    clientVM.invoke(
        () ->
            setUpClientVMTask(
                hostName,
                port,
                cacheClientSslenabled,
                cacheClientSslRequireAuth,
                CLIENT_KEY_STORE,
                CLIENT_TRUST_STORE));
  ...
  public void testNonSSLClient() throws Exception {
    ...
    try {
      clientVM.invoke(
          () ->
              setUpClientVMTaskNoSubscription(
                  hostName,
                  port,
                  cacheClientSslenabled,
                  cacheClientSslRequireAuth,
