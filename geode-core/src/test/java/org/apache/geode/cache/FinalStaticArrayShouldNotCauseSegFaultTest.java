 ...
 *
 * <p>Asserts fixes for bug JDK-8076152 in JDK 1.8.0u20 to 1.8.0.u45.
 * http://bugs.java.com/bugdatabase/view_bug.do?bug_id=8076152
 *
 * <p>The JVM crashes when hotspot compiling a method that uses an array consisting of objects of a
 ...
 *
 * <p>This test and its corrections can be removed after the release of JDK 1.8.0u60 if we choose to
