...
public class ConcurrentIndexInitOnOverflowRegionDUnitTest extends JUnit4CacheTestCase {
    ...
    vm1.invoke(
        new CacheSerializableRunnable("Change value in region") {
          ...
          public void run2() throws CacheException {
            ...
            // Do a put in region.
            Region r =
                clientCache.createClientRegionFactory(ClientRegionShortcut.PROXY).create(name);
  ...
  public void testIndexUpdateWithRegionClear() {
    ...
    vm0.invoke(
        new CacheSerializableRunnable("Create region and index") {
          ...
          public void run2() throws CacheException {
            ...
            try {
              ...
              qService.createIndex(
                  "secIdIndex", "pos.secId", "/" + regionName + " p, p.positions.values pos");
            } catch (Exception e) {
    ...
    AsyncInvocation indexUpdateAsysnch =
        vm0.invokeAsync(
            new CacheSerializableRunnable("index updates") {
    ...
    vm0.invoke(
        new CacheSerializableRunnable("Clear the region") {
    ...
    vm0.invoke(
        new CacheSerializableRunnable("Check region size") {
          ...
          public void run2() throws CacheException {
            ...
            if (region.size() > 50) {
              fail(
                  "After clear region size is supposed to be 50 as all index updates are blocked "
                      + region.size());
            }
          }
        });
