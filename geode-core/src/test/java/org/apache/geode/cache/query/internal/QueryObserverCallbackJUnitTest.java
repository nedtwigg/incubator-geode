...
public class QueryObserverCallbackJUnitTest {
  ...
  public void testBeforeAndAfterCutDownAndExpansionOfSingleIndexResult() {
    try {
      ...
      query.execute();
      assertTrue(
          "beforeCutDownAndExpansionOfSingleIndexResult callbak not received",
          inst.bfrCutDownAndExpansionOfSingleIndexResult);
      assertTrue(
          "afterCutDownAndExpansionOfSingleIndexResult callbak not received",
  ...
  public void testBeforeAndAfterMergeJoinOfDoubleIndexResults() {
    try {
      ...
      query.execute();
      assertTrue(
          "beforeMergeJoinOfDoubleIndexResults callbak not received",
          inst.bfrMergeJoinOfDoubleIndexResults);
      assertTrue(
          "afterMergeJoinOfDoubleIndexResults callbak not received",
  ...
  class MyQueryObserverImpl implements QueryObserver {
    ...
    public void beforeCutDownAndExpansionOfSingleIndexResult(
        Index index, Collection initialResult) {
