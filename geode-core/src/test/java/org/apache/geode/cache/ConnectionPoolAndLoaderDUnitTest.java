...
public class ConnectionPoolAndLoaderDUnitTest extends JUnit4CacheTestCase {
   ...
   *
   * <p>Anything that is loaded on the client is put on the server..
   */
  @Test
   ...
   *
   * <p>The expected order of operations for put is: local writer put on server
   */
  @Test
   ...
   *
   * <p>Expected order 1 localCache 2 peer 3 server 4 loader
   */
  @Test
  public void testPoolLoadAndPeer() throws Exception {
    ...
    SerializableCallable createClient1 =
        new SerializableCallable() {
          public Object call() {
    ...
    SerializableCallable createClient2 =
        new SerializableCallable() {
          public Object call() {
            //Make sure we get a distributed system that has the locator
            useLocator = true;
