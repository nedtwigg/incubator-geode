...
public class PRColocatedEquiJoinDUnitTest extends PartitionedRegionDUnitTestCase {
  ...
  public void testPRLocalQuerying() throws Exception {
    ...
    vm0.invoke(
        PRQHelp.getCacheSerializableRunnableForLocalRegionCreation(
            coloLocalName, NewPortfolio.class));
    ...
    vm0.invoke(
        PRQHelp.getCacheSerializableRunnableForPRColocatedDataSetQueryAndCompareResults(
  ...
  public void testNonColocatedPRLocalQuerying() throws Exception {
    ...
    vm0.invoke(
        new CacheSerializableRunnable(coloName) {
          @Override
          ...
          public void run2() throws CacheException {
              ...
              public void execute(FunctionContext context) {
                ...
                try {
                  ...
                  context
                      ...
                      .sendResult(
                          (ArrayList)
                              ((SelectResults) query.execute((RegionFunctionContext) context))
                                  .asList());
            ...
            try {
              ...
              if (e.getCause() instanceof UnsupportedOperationException) {
                LogWriterUtils.getLogWriter()
                    .info(
                        "Query received FunctionException successfully while using QueryService.");
              } else {
  ...
  public void testPRLocalQueryingWithIndexes() throws Exception {
    ...
    vm0.invoke(PRQHelp.getCacheSerializableRunnableForPRCreate(name, redundancy, Portfolio.class));
    vm0.invoke(
        PRQHelp.getCacheSerializableRunnableForPRIndexCreate(
            name, "IdIndex1", "r1.ID", "/" + name + " r1", null));
    ...
    vm0.invoke(
        PRQHelp.getCacheSerializableRunnableForPRIndexCreate(
            coloName, "IdIndex2", "r2.id", "/" + coloName + " r2", null));
  ...
  public void testPRLocalQueryingWithIndexOnOneRegion() throws Exception {
    ...
    vm0.invoke(
        PRQHelp.getCacheSerializableRunnableForPRIndexCreate(
            name, "IdIndex11", "r1.status", "/" + name + " r1", null));
  ...
  public void testRRPRLocalQueryingWithIndexes() throws Exception {
    ...
    vm0.invoke(
        PRQHelp.getCacheSerializableRunnableForPRIndexCreate(
            coloName, "IdIndex1", "r2.id", "/" + coloName + " r2", null));
    ...
    vm0.invoke(
        PRQHelp.getCacheSerializableRunnableForPRIndexCreate(
            name, "IdIndex2", "r1.ID", "/" + name + " r1", null));
  ...
  public void testPRRRLocalQueryingWithHetroIndexes() throws Exception {
    ...
    vm0.invoke(
        PRQHelp.getCacheSerializableRunnableForPRIndexCreate(
            coloName, "IdIndex2", "r2.id", "/" + coloName + " r2, r2.positions.values pos2", null));
    //vm0.invoke(PRQHelp.getCacheSerializableRunnableForPRIndexCreate(coloName, "IdIndex22", "r2.status", "/"+coloName+" r2", null));
    ...
    // querying the VM for data
    vm0.invoke(
        PRQHelp.getCacheSerializableRunnableForPRAndRRQueryAndCompareResults(
            name, coloName, localName, coloLocalName));
  ...
  public void testRRPRLocalQueryingWithHetroIndexes() throws Exception {
    ...
    vm0.invoke(
        PRQHelp.getCacheSerializableRunnableForPRIndexCreate(
            name, "IdIndex2", "r1.ID", "/" + name + " r1, r1.positions.values pos1", null));
    //vm0.invoke(PRQHelp.getCacheSerializableRunnableForPRIndexCreate(coloName, "IdIndex22", "r2.status", "/"+coloName+" r2", null));
    ...
    // querying the VM for data
    vm0.invoke(
        PRQHelp.getCacheSerializableRunnableForRRAndPRQueryAndCompareResults(
            name, coloName, localName, coloLocalName));
  ...
  public void testPRRRCompactRangeAndNestedRangeIndexQuerying() throws Exception {
    ...
    vm0.invoke(
        PRQHelp.getCacheSerializableRunnableForPRIndexCreate(
            ...
            "IdIndex2",
            "pos2.id",
            "/" + coloName + " r2, r2.positions.values pos2",
            null));
    //vm0.invoke(PRQHelp.getCacheSerializableRunnableForPRIndexCreate(coloName, "IdIndex22", "r2.status", "/"+coloName+" r2", null));
  ...
  public void testPRRRIndexQueryWithSameTypeIndexQueryResults() throws Exception {
    ...
    vm0.invoke(
        PRQHelp.getCacheSerializableRunnableForLocalRegionWithAsyncIndexCreation(
    ...
    vm0.invoke(
        PRQHelp.getCacheSerializableRunnableForPRIndexCreate(
            name, "IdIndex3", "r1.ID", "/" + localName + " r1", null));
    ...
    vm0.invoke(
        PRQHelp.getCacheSerializableRunnableForPRIndexCreate(
            coloName, "IdIndex4", "r2.id", "/" + coloLocalName + " r2", null));
    // Generating portfolio object array to be populated across the PR's & Local
    // Regions
