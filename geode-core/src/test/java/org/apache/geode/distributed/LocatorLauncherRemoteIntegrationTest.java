...
public class LocatorLauncherRemoteIntegrationTest
  ...
  @Category(
      FlakyTest.class) // GEODE-473: random ports, BindException, forks JVM, uses ErrorCollector
  @Test
  ...
  public void testStartUsingPortInUseFails() throws Throwable {
    ...
    this.errorCollector.checkThat(
        status.getStatus(), is(equalTo(getExpectedStopStatusForNotRunning())));
  }
  ...
  @Category(
      FlakyTest.class) // GEODE-847: random ports, BindException, forks JVM, uses ErrorCollector
  @Test
  ...
  /**
   * Used only by {@link
   * LocatorLauncherRemoteIntegrationTest#testRunningLocatorOutlivesForkingProcess}
   */
  public static class LocatorLauncherForkingProcess {
    ...
    public static void main(final String... args) throws FileNotFoundException {
      ...
      try {
        ...
        ProcessStreamReader processOutReader =
            new ProcessStreamReader.Builder(forkedProcess)
                .inputStream(forkedProcess.getInputStream())
                .build()
                .start();
        @SuppressWarnings("unused")
        ProcessStreamReader processErrReader =
            new ProcessStreamReader.Builder(forkedProcess)
                .inputStream(forkedProcess.getErrorStream())
                .build()
                .start();

        logWriter.info(
            LocatorLauncherForkingProcess.class.getSimpleName()
        ...
        logWriter.info(
            LocatorLauncherForkingProcess.class.getSimpleName() + "#main error: " + t, t);
        System.exit(-1);
      }
    }
  }
