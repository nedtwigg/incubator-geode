...
public class SharedConfigurationJUnitTest {
  ...
  public void testCreateAndUpgradeDocumentFromXml() throws Exception {
    Document doc =
        SharedConfiguration.createAndUpgradeDocumentFromXml(
            IOUtils.toString(
                this.getClass().getResourceAsStream("SharedConfigurationJUnitTest.xml")));
    ...
    assertEquals(
        CacheXml.VERSION_LATEST, XmlUtils.getAttribute(doc.getDocumentElement(), "version"));
  }
}
