...
public class PRBucketSynchronizationDUnitTest extends JUnit4CacheTestCase {
  ...
  private boolean isPrimaryForBucket0(VM vm) {
    return (Boolean)
        vm.invoke(
            new SerializableCallable("is primary?") {
              public Object call() {
  ...
  private boolean createEntry2(
      VM vm, final InternalDistributedMember primary, final VersionSource primaryVersionID) {
    return (Boolean)
        vm.invoke(
              ...
              public Object call() {
                ...
                EntryEventImpl event =
                    EntryEventImpl.create(
                        bucket, Operation.CREATE, "Object3", true, primary, true, false);
                ...
                event =
                    EntryEventImpl.create(
                        bucket, Operation.CREATE, "Object5", true, primary, true, false);
                ...
                LogWriterUtils.getLogWriter()
                    .info(
                        "bucket version vector is now " + bucket.getVersionVector().fullToString());
