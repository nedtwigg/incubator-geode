...
public abstract class ClientServerTestCase extends JUnit4CacheTestCase {
  ...
  public static Pool configureConnectionPool(
    ...
    return configureConnectionPool(
        factory,
        host,
        ports,
        establish,
  ...
  public static Pool configureConnectionPoolWithName(
      ...
      String serverGroup,
      String poolName) {
    return configureConnectionPoolWithNameAndFactory(
        factory,
        host,
        ports,
        establish,
  ...
  public static Pool configureConnectionPool(
      ...
      boolean threadLocalCnxs,
      int lifetimeTimeout) {
    return configureConnectionPoolWithName(
        factory,
        host,
        ports,
        establish,
  ...
  public static class CacheServerCacheLoader extends TestCacheLoader implements Declarable {
    ...
    public Object load2(LoaderHelper helper) {
      ...
      if (ret instanceof String) {
        if (ret != null && ret.equals(NON_EXISTENT_KEY)) return null; //return null
      }
      return ret;
    }
        ...
        new CacheSerializableRunnable("Create Region on Server") {
          ...
          public void run2() {
            try {
              AttributesFactory factory = new AttributesFactory();
              factory.setScope(
                  Scope.DISTRIBUTED_ACK); // can't be local since used with registerInterest
