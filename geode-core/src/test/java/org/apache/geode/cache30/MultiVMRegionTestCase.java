...
public abstract class MultiVMRegionTestCase extends RegionTestCase {
  ...
  public void concurrentMapTest(final String rName) {
     ...
     */
    vm0.invoke(
        new CacheSerializableRunnable("destroyRegionOp") {
  ...
  public void testDistributedUpdate() throws Exception {
    ...
    vm1.invoke(
        new CacheSerializableRunnable("Validate update") {
          @Override
          public void run2() throws CacheException {
            Region region = getRootRegion().getSubregion(name);
   ...
   *
   * <p>Note that this test does not make sense for regions that are {@link
   * Scope#DISTRIBUTED_NO_ACK} for which we do not guarantee the ordering of updates for a single
   * producer/single consumer.
   *
   * <p>DISABLED 4-16-04 - the current implementation assumes events are processed synchronously,
   * which is no longer true.
   */
  @Ignore(
      "TODO: test is DISABLED 4-16-04 - the current implementation assumes events are processed synchronously, which is no longer true")
  @Test
  public void testOrderedUpdates() throws Exception {
    ...
    vm1.invoke(
        new CacheSerializableRunnable("Set listener") {
          @Override
          public void run2() throws CacheException {
            Region region = getRootRegion().getSubregion(name);
    ...
    AsyncInvocation ai1 =
        vm1.invokeAsync(
            new CacheSerializableRunnable("Verify") {
              @Override
              public void run2() throws CacheException {
                Region region = getRootRegion().getSubregion(name);
    ...
    AsyncInvocation ai0 =
        vm0.invokeAsync(
            new CacheSerializableRunnable("Populate") {
              @Override
              public void run2() throws CacheException {
                Region region = getRootRegion().getSubregion(name);
                for (int i = 0; i <= lastNumber; i++) {
  ...
  public void testDistributedGet() throws Exception {
    ...
    SerializableRunnable get =
        new CacheSerializableRunnable("Distributed get") {
          @Override
          public void run2() throws CacheException {
            Region region = createRegion(name);
  ...
  public void testDistributedPutNoUpdate() throws Exception {
    ...
    vm1.invoke(
        new CacheSerializableRunnable("Verify no update") {
          @Override
          public void run2() throws CacheException {
            Region region = getRootRegion().getSubregion(name);
            Region.Entry entry = region.getEntry(key);
  ...
  public void testDefinedEntryUpdated() throws Exception {
    ...
    vm0.invoke(
        new CacheSerializableRunnable("Create and populate") {
          @Override
          public void run2() throws CacheException {
            Region region = getRootRegion().getSubregion(name);
            region.put(key, oldValue);
    ...
    vm1.invoke(
        new CacheSerializableRunnable("Define entry") {
          ...
          public void run2() throws CacheException {
            Region region = getRootRegion().getSubregion(name);
            if (!getRegionAttributes().getDataPolicy().withReplication()) region.create(key, null);
          }
        });
    vm0.invoke(
    ...
    Invoke.invokeRepeatingIfNecessary(
        vm1,
        new CacheSerializableRunnable("Get entry") {
          @Override
          public void run2() throws CacheException {
            Region region = getRootRegion().getSubregion(name);
  ...
  public void testDistributedRegionDestroy() throws Exception {
    ...
    Invoke.invokeInEveryVM(
        new CacheSerializableRunnable("Verify region destruction") {
          @Override
          public void run2() throws CacheException {
            WaitCriterion ev =
                new WaitCriterion() {
  ...
  public void testLocalDestroy() throws Exception {
    ...
    vm0.invoke(
        new CacheSerializableRunnable("Local Destroy Entry") {
          @Override
          public void run2() throws CacheException {
            Region region = getRootRegion().getSubregion(name);
  ...
  public void testLocalRegionDestroy() throws Exception {
    ...
    vm0.invoke(
        new CacheSerializableRunnable("Local Destroy Region") {
          @Override
          public void run2() throws CacheException {
            Region region = getRootRegion().getSubregion(name);
  ...
  public void testDistributedRegionInvalidate() throws Exception {
    ...
    vm0.invoke(
        new CacheSerializableRunnable("Invalidate Region") {
          @Override
          public void run2() throws CacheException {
            Region region = getRootRegion().getSubregion(name);
  ...
  @Category(
      FlakyTest
          .class) // GEODE-153 & GEODE-932: time sensitive, waitForInvocation (waitForCriterion), 3 second timeouts
  @Test
  public void testRemoteCacheListener() throws Exception {
                ...
                new TestCacheListener() {
                  ...
                  public void afterUpdate2(EntryEvent event) {
                    ...
                    if (event.getRegion().getAttributes().getOffHeap()) {
                      ...
                      assertEquals(
                          null,
                          event.getSerializedOldValue()); // since it was put originally in this VM
                    }
                    DataInputStream dis =
                        new DataInputStream(
                ...
                new TestCacheListener() {
                  ...
                  public void afterInvalidate2(EntryEvent event) {
                    ...
                    DataInputStream dis =
                        new DataInputStream(
                            new ByteArrayInputStream(
                                event.getSerializedOldValue().getSerializedValue()));
                    try {
                      assertEquals(newValue, DataSerializer.readObject(dis));
                    } catch (Exception e) {
                      fail("Unexpected Exception", e);
    ...
    vm0.invoke(
        new CacheSerializableRunnable("Destroy") {
          @Override
          public void run2() throws CacheException {
            Region region = getRootRegion().getSubregion(name);
    ...
    vm1.invoke(
        new CacheSerializableRunnable("Verify Destroy") {
          @Override
          public void run2() throws CacheException {
            listener.waitForInvocation(3000, 10);
    ...
    vm1.invoke(
        new CacheSerializableRunnable("Verify Invalidate Region") {
          @Override
          public void run2() throws CacheException {
            listener.waitForInvocation(3000, 10);
    ...
    vm1.invoke(
        new CacheSerializableRunnable("Verify Destroy Region") {
          @Override
          public void run2() throws CacheException {
            listener.waitForInvocation(3000, 10);
          }
  ...
  public void testRemoteCacheListenerInSubregion() throws Exception {
    ...
    vm0.invoke(
        new CacheSerializableRunnable("Invalidate Root Region") {
          @Override
          public void run2() throws CacheException {
    ...
    vm0.invoke(
        new CacheSerializableRunnable("Destroy Root Region") {
          @Override
          public void run2() throws CacheException {
  ...
  /**
   * Tests that a {@link CacheLoader} is invoked in a remote VM. This essentially tests <code>
   * netLoad</code>.
   */
  @Test
  public void testRemoteCacheLoader() throws Exception {
    ...
    vm1.invoke(
        new CacheSerializableRunnable("Set CacheLoader") {
          @Override
          public void run2() throws CacheException {
            final Region region = getRootRegion().getSubregion(name);
            loader =
    ...
    vm0.invoke(
        new CacheSerializableRunnable("Remote load") {
          @Override
          public void run2() throws CacheException {
            Region region = getRootRegion().getSubregion(name);
            assertEquals(value, region.get(key));
    ...
    vm1.invoke(
        new SerializableRunnable("Verify loader") {
          @Override
          public void run() {
  ...
  public void testCacheLoaderWithNetSearch() throws Exception {
    ...
    VM vm1 = host.getVM(1);
    vm1.invoke(
        new CacheSerializableRunnable("set remote value") {
          @Override
          public void run2() throws CacheException {
    ...
    vm1.invoke(
        new CacheSerializableRunnable("verify remote value") {
          @Override
          public void run2() throws CacheException {
  ...
  public void testCacheLoaderWithNetLoad() throws Exception {
    ...
    VM vm1 = host.getVM(1);
    vm1.invoke(
        new CacheSerializableRunnable("set up remote loader") {
          @Override
          public void run2() throws CacheException {
            final TestCacheLoader remoteloader =
                new TestCacheLoader() {
                  @Override
                  public Object load2(LoaderHelper helper) throws CacheLoaderException {
  ...
  public void testNoLoaderWithInvalidEntry() throws Exception {
    ...
    vm1.invoke(
        new CacheSerializableRunnable("Create invalid entry") {
          @Override
          public void run2() throws CacheException {
            Region region = getRootRegion().getSubregion(name);
            region.create(key, null);
    ...
    vm0.invoke(
        new CacheSerializableRunnable("Remote get") {
          @Override
          public void run2() throws CacheException {
            Region region = getRootRegion().getSubregion(name);
            assertEquals(value, region.get(key));
  ...
  public void testRemoteCacheWriter() throws Exception {
    ...
    vm1.invoke(
        new CacheSerializableRunnable("Set Writer") {
          @Override
          public void run2() throws CacheException {
            final Region region = getRootRegion().getSubregion(name);
            writer =
    ...
    vm0.invoke(
        new CacheSerializableRunnable("Create with Exception") {
          @Override
          public void run2() throws CacheException {
            Region region = getRootRegion().getSubregion(name);
            try {
    ...
    vm1.invoke(
        new SerializableRunnable("Verify callback") {
          @Override
          public void run() {
    ...
    vm0.invoke(
        new CacheSerializableRunnable("Create with Argument") {
          @Override
          public void run2() throws CacheException {
            Region region = getRootRegion().getSubregion(name);
    ...
    vm0.invoke(
        new CacheSerializableRunnable("Update with Exception") {
          @Override
          public void run2() throws CacheException {
            Region region = getRootRegion().getSubregion(name);
            try {
    ...
    vm0.invoke(
        new CacheSerializableRunnable("Update with Argument") {
          @Override
          public void run2() throws CacheException {
            Region region = getRootRegion().getSubregion(name);
    ...
    vm0.invoke(
        new CacheSerializableRunnable("Destroy with Exception") {
          @Override
          public void run2() throws CacheException {
            Region region = getRootRegion().getSubregion(name);
            try {
    ...
    vm0.invoke(
        new CacheSerializableRunnable("Destroy with Argument") {
          @Override
          public void run2() throws CacheException {
            Region region = getRootRegion().getSubregion(name);
        ...
        new CacheSerializableRunnable("Destroy with Argument") {
          ...
          public void run2() throws CacheException {
            ...
            if (region.getAttributes().getOffHeap() && !(region instanceof PartitionedRegion)) {
              ...
              WaitCriterion waitForStatChange =
                  new WaitCriterion() {
                    @Override
                    public boolean done() {
  ...
  public void testLocalAndRemoteCacheWriters() throws Exception {
    ...
    SerializableRunnable verify =
        new SerializableRunnable("Verify no callback") {
          @Override
          public void run() {
    ...
    vm0.invoke(
        new CacheSerializableRunnable("Create entry") {
          @Override
          public void run2() throws CacheException {
            Region region = getRootRegion().getSubregion(name);
            region.put(key, oldValue);
  ...
  public void testCacheLoaderModifyingArgument() throws Exception {
    ...
    CacheSerializableRunnable setLoader =
        new CacheSerializableRunnable("Set CacheLoader") {
          @Override
          public void run2() throws CacheException {
            final Region region = getRootRegion().getSubregion(name);
    ...
    vm1.invoke(
        new CacheSerializableRunnable("Conditionally create second loader") {
          @Override
          public void run2() throws CacheException {
            final Region region = getRootRegion().getSubregion(name);
    ...
    vm1.invoke(
        new CacheSerializableRunnable("Set CacheWriter") {
          @Override
          public void run2() throws CacheException {
            final Region region = getRootRegion().getSubregion(name);
            writer =
    ...
    vm1.invoke(
        new CacheSerializableRunnable("Validate callback") {
          @Override
          public void run2() throws CacheException {
            assertTrue(writer.wasInvoked());
          }
  ...
  public void testRemoteLoaderNetSearch() throws Exception {
    ...
    SerializableRunnable create =
        new CacheSerializableRunnable("Get value") {
          @Override
          public void run2() throws CacheException {
            Region region = createRegion(name);
            assertEquals(value, region.get(key));
  ...
  public void testLocalCacheLoader() throws Exception {
    ...
    SerializableRunnable create =
        new CacheSerializableRunnable("Create \"remote\" region") {
          @Override
          public void run2() throws CacheException {
            Region region = createRegion(name);
            loader =
    ...
    vm0.invoke(
        new CacheSerializableRunnable("Get") {
          @Override
          public void run2() throws CacheException {
            Region region = getRootRegion().getSubregion(name);
            assertEquals(value, region.get(key));
    ...
    vm1.invoke(
        new SerializableRunnable("Verify loader not invoked") {
          @Override
          public void run() {
            assertFalse(loader.wasInvoked());
          }
  ...
  public void testDistributedPut() throws Exception {
    ...
    SerializableRunnable create =
        new SerializableRunnable("testDistributedPut: Create Region") {
          @Override
          public void run() {
            try {
    ...
    SerializableRunnable newKey =
        new SerializableRunnable("testDistributedPut: Create Key") {
          @Override
          public void run() {
            try {
              if (!getRegionAttributes().getDataPolicy().withReplication()
  ...
  public void testReplicate() throws Exception {
    ...
    vm0.invoke(
        new CacheSerializableRunnable("Put data") {
          @Override
          public void run2() throws CacheException {
            Region region = getRootRegion().getSubregion(name);
            region.put(key1, value1);
    ...
    Invoke.invokeRepeatingIfNecessary(
        vm2,
        new CacheSerializableRunnable("Wait for update") {
          @Override
          public void run2() throws CacheException {
            Region region = getRootRegion().getSubregion(name);
            assertNotNull(region.getEntry(key1));
    ...
    // a netSearch
    vm0.invoke(
        new CacheSerializableRunnable("Remove local entries") {
          @Override
          public void run2() throws CacheException {
            Region region = getRootRegion().getSubregion(name);
            region.localDestroyRegion();
    ...
    Invoke.invokeRepeatingIfNecessary(
        vm2,
        new CacheSerializableRunnable("Verify keys") {
          @Override
          public void run2() throws CacheException {
            Region region = getRootRegion().getSubregion(name);
  ...
  public void testGetInitialImage() throws Exception {
    ...
    vm2.invoke(
        new CacheSerializableRunnable("Verify keys/values") {
          @Override
          public void run2() throws CacheException {
            Region region = getRootRegion().getSubregion(name);
  ...
  public void testMirroredDataFromNonMirrored() throws Exception {
    ...
    SerializableRunnable create =
        new CacheSerializableRunnable("Populate non-mirrored region") {
          @Override
          public void run2() throws CacheException {
            RegionAttributes ra = getRegionAttributes();
    ...
    class MirroredDataFromNonMirroredListener extends TestCacheListener {
      ...
      public synchronized void afterCreate2(EntryEvent event) {
        ...
        org.apache.geode.test.dunit.LogWriterUtils.getLogWriter()
            .info(
                "afterCreate called in "
                    + "MirroredDataFromNonMirroredListener for key:"
                    + event.getKey());
      }
    }
    ...
    vm0.invoke(
        new CacheSerializableRunnable("Verify keys/values and listener") {
          @Override
          public void run2() throws CacheException {
            Region region = getRootRegion().getSubregion(name);
            ...
            assertTrue(
                "expectedKeys should be empty, but was: " + lsnr.expectedKeys,
  ...
  public void testNoMirroredDataToNonMirrored() throws Exception {
    ...
    vm0.invoke(
        new CacheSerializableRunnable("Create Non-mirrored Region") {
          @Override
          public void run2() throws CacheException {
    ...
    SerializableRunnable create =
        new CacheSerializableRunnable("Populate mirrored region") {
          @Override
          public void run2() throws CacheException {
            RegionAttributes ra = getRegionAttributes();
            AttributesFactory factory = new AttributesFactory(ra);
  ...
  public void testMirroredLocalLoad() throws Exception {
    ...
    vm0.invoke(
        new CacheSerializableRunnable("Create region with loader") {
          @Override
          public void run2() throws CacheException {
            RegionAttributes ra = getRegionAttributes();
            AttributesFactory factory = new AttributesFactory(ra);
    ...
    SerializableRunnable create =
        new CacheSerializableRunnable("Create region with bad loader") {
          @Override
          public void run2() throws CacheException {
            RegionAttributes ra = getRegionAttributes();
            AttributesFactory factory = new AttributesFactory(ra);
    ...
    vm2.invoke(
        new CacheSerializableRunnable("Verify no load") {
          @Override
          public void run2() throws CacheException {
            assertFalse(loader.wasInvoked());
          }
  ...
  public void testNoRegionKeepAlive() throws Exception {
    ...
    vm0.invoke(
        new CacheSerializableRunnable("Re-create cache") {
          @Override
          public void run2() throws CacheException {
            Region region = createRegion(name);
  ...
  public void testNetSearchObservesTtl() throws Exception {
    ...
    SerializableRunnable create =
        new CacheSerializableRunnable("Create with TTL") {
          @Override
          public void run2() throws CacheException {
            AttributesFactory factory = new AttributesFactory(getRegionAttributes());
    ...
    vm0.invoke(
        new CacheSerializableRunnable("get(key), expect null") {
          @Override
          public void run2() throws CacheException {
            Region region = getRootRegion().getSubregion(name);
    ...
    vm1.invoke(
        new CacheSerializableRunnable("get(key), expect value") {
          @Override
          public void run2() throws CacheException {
            Region region = getRootRegion().getSubregion(name);
            Object got = region.get(key);
  ...
  public void testNetSearchObservesIdleTime() throws Exception {
    ...
    SerializableRunnable create =
        new CacheSerializableRunnable("Create with IdleTimeout") {
          @Override
          public void run2() throws CacheException {
            AttributesFactory factory = new AttributesFactory(getRegionAttributes());
            factory.setStatisticsEnabled(true);
   ...
   */
  @Category(
      FlakyTest.class) // GEODE-583: time sensitive, expiration, waitForCriterion, short timeouts
  @Test
  public void testEntryTtlDestroyEvent() throws Exception {
    ...
    SerializableRunnable createRegion =
        new CacheSerializableRunnable("Create with Listener") {
          @Override
          public void run2() throws CacheException {
    ...
    try {
      ...
      vm0.invoke(
          new CacheSerializableRunnable("Check create received from vm1") {
            @Override
            public void run2() throws CacheException {
              final Region region = getRootRegion().getSubregion(name);
              WaitCriterion waitForCreate =
                  new WaitCriterion() {
                    @Override
                    public boolean done() {
      ...
      vm0.invoke(
          new CacheSerializableRunnable("resume expiration") {
            @Override
            public void run2() throws CacheException {
    ...
    vm0.invoke(
        new CacheSerializableRunnable("Check local destroy") {
          @Override
          public void run2() throws CacheException {
            final Region region = getRootRegion().getSubregion(name);
            WaitCriterion waitForExpire =
                new WaitCriterion() {
                  @Override
                  public boolean done() {
                    return region.getEntry(key) == null;
    ...
    vm1.invoke(
        new CacheSerializableRunnable("Verify destroyed and event") {
          @Override
          public void run2() throws CacheException {
            final Region region = getRootRegion().getSubregion(name);
            WaitCriterion waitForExpire =
  ...
  @Category(
      FlakyTest
          .class) // GEODE-671: time sensitive, expiration, retry loop, async actions, waitForCriterion
  @Test
  public void testEntryTtlLocalDestroy() throws Exception {
    ...
    vm0.invoke(
        new CacheSerializableRunnable("Create with TTL") {
          ...
          public void run2() throws CacheException {
            ...
            /**
             * Crank up the expiration so test runs faster. This property only needs to be set while
                  ...
                  new WaitCriterion() {
                        ...
                        if (eet != null) {
                          long stopTime =
                              ((InternalDistributedSystem)
                                  ...
                                  .getStopTime();
                          logger.info(
                              "DEBUG: waiting for expire destroy expirationTime= "
                                  + eet.getExpirationTime()
                                  + " now="
                                  + eet.getNow()
                                  + " stopTime="
                                  + stopTime
                    ...
                    public String description() {
                      ...
                      return "Entry for key "
                          + key
                          + " never expired (since it still exists) "
                          + expiryInfo;
                    }
                  };
    ...
    vm1.invoke(
        new CacheSerializableRunnable("Verify local") {
          @Override
          public void run2() throws CacheException {
            Region region = getRootRegion().getSubregion(name);
            Region.Entry entry = region.getEntry(key);
  ...
  public void testUpdateResetsIdleTime() throws Exception {
    ...
    vm0.invoke(
        new CacheSerializableRunnable("Create with Idle") {
          @Override
          public void run2() throws CacheException {
            AttributesFactory factory = new AttributesFactory(getRegionAttributes());
            factory.setStatisticsEnabled(true);
    ...
    vm1.invoke(
        new CacheSerializableRunnable("Create Region " + name) {
          @Override
          public void run2() throws CacheException {
            AttributesFactory factory = new AttributesFactory(getRegionAttributes());
            factory.setStatisticsEnabled(true);
    ...
    vm0.invoke(
        new CacheSerializableRunnable("Verify reset") {
          @Override
          public void run2() throws CacheException {
            ...
            if (updateExpiryTime - createExpiryTime <= 0L) {
              fail(
                  "update did not reset the expiration time. createExpiryTime="
                      + createExpiryTime
                      + " updateExpiryTime="
                      + updateExpiryTime);
            }
  ...
  private static final int NB1_CHUNK_SIZE =
      500 * 1024; // == InitialImageOperation.CHUNK_SIZE_IN_BYTES
  ...
  public void testNonblockingGetInitialImage() throws Exception {
    ...
    vm0.invoke(
        new CacheSerializableRunnable("Create Nonmirrored Region") {
          @Override
          public void run2() throws CacheException {
            { // root region must be DACK because its used to sync up async subregions
              AttributesFactory factory = new AttributesFactory();
    ...
    AsyncInvocation async =
        vm0.invokeAsync(
            new CacheSerializableRunnable("Do Nonblocking Operations") {
              @Override
              public void run2() throws CacheException {
                Region region = getRootRegion().getSubregion(name);
                    ...
                    new WaitCriterion() {
                      ...
                      public boolean done() {
                        ...
                        if (currentPolicy == DataPolicy.PRELOADED) {
                          return (adv.advisePreloadeds().size() + adv.adviseReplicates().size())
                              >= expectedProfiles;
                        } else {
    ...
    org.apache.geode.test.dunit.LogWriterUtils.getLogWriter()
        .info(
            "Before GetInitialImage, data policy is "
                + getRegionAttributes().getDataPolicy()
                + ", scope is "
                + getRegionAttributes().getScope());
    ...
    // a netSearch
    vm0.invoke(
        new CacheSerializableRunnable("Locally destroy region") {
          @Override
          public void run2() throws CacheException {
            Region region = getRootRegion().getSubregion(name);
            region.localDestroyRegion();
    ...
    vm2.invokeRepeatingIfNecessary(
            ...
            for (int i = 5; i < NB1_NUM_ENTRIES; i += 6) {
              try {
                logger.info(
                    i
                        + "-->"
                        + ((org.apache.geode.internal.cache.LocalRegion) region)
    ...
    vm2.invoke(
        new CacheSerializableRunnable("Verify keys/values & Nonblocking") {
          @Override
          public void run2() throws CacheException {
            Region region = getRootRegion().getSubregion(name);
            // expected entry count (subtract entries destroyed)
            ...
            if (region.getAttributes().getScope().isGlobal()) {
              assertTrue(
                  "Too many concurrent updates when expected to block: " + numConcurrent,
                  numConcurrent < 10);
            } else {
              int min = 30;
              assertTrue(
                  ...
                  switch (i % 6) {
                    ...
                    case 3: // INVALIDATE
                      ...
                      if (getRegionAttributes().getScope().isDistributedAck()) {
                        ...
                        assertNull(
                            "Expected null value for key: " + i + " but got " + value, value);
                      }
                      break;
                    case 5: // DESTROY
                      region.destroy(key);
          ...
          public void run2() throws CacheException {
            ...
            for (int i = 0; i < NB1_NUM_ENTRIES; i++) {
              ...
              if (i < 301) {
                if (i % 6 == 5) {
                  assertNull(
                      "Expected entry for " + i + " to be destroyed but it is " + entry,
                      entry); // destroyed
                } else {
                  assertNotNull(entry);
                  Object v = entry.getValue();
  ...
  public void testNoDataSerializer() throws Exception {
    ...
    try {
      vm0.invoke(
          new CacheSerializableRunnable("Put int") {
            @Override
            public void run2() throws CacheException {
      ...
      SerializableRunnable get =
          new CacheSerializableRunnable("Get int") {
            @Override
            public void run2() throws CacheException {
              Region region = getRootRegion().getSubregion(name);
      ...
      // serializer
      vm2.invoke(
          new SerializableRunnable("Connect to DS") {
            @Override
            public void run() {
      ...
      vm2.invoke(
          new CacheSerializableRunnable("Put long") {
            @Override
            public void run2() throws CacheException {
              Region region = getRootRegion().getSubregion(name);
      ...
      SerializableRunnable get2 =
          new CacheSerializableRunnable("Get long") {
            @Override
            public void run2() throws CacheException {
              Region region = getRootRegion().getSubregion(name);
      ...
      SerializableRunnable get2 =
          new CacheSerializableRunnable("Get long") {
            ...
            public void run2() throws CacheException {
              ...
              inst =
                  (DSLongWrapper.DSLongWrapperInstantiator)
  ...
  public class MyTransactionListener implements TransactionListener {
    ...
    public void assertCounts(
        int commitCount, int failedCommitCount, int rollbackCount, int closeCount1) {
  ...
  class CountingDistCacheListener extends CacheListenerAdapter {
    ...
    public synchronized void assertCount(
        int expectedCreate, int expectedUpdate, int expectedInvalidate, int expectedDestroy) {
  ...
  public static void assertCacheCallbackEvents(
      String regionName, TransactionId txId, Object key, Object oldValue, Object newValue) {
  ...
  public void testTXSimpleOps() throws Exception {
    ...
    SerializableRunnable create =
        new SerializableRunnable("testTXSimpleOps: Create Region") {
          @Override
          public void run() {
  ...
  public void testTXMultiRegion() throws Exception {
    ...
    SerializableRunnable create1 =
        new SerializableRunnable("testTXMultiRegion: Create Region") {
          @Override
          public void run() {
            CacheTransactionManager txMgr2 = getCache().getCacheTransactionManager();
            MyTransactionListener tl = new MyTransactionListener();
    ...
    SerializableRunnable newKey1 =
        new SerializableRunnable("testTXMultiRegion: Create Key") {
          @Override
          public void run() {
            try {
    ...
    SerializableRunnable check1_3 =
        new SerializableRunnable("testTXMultiRegion: check") {
          @Override
          public void run() {
  ...
  public void testTXRmtMirror() throws Exception {
    ...
    SerializableRunnable checkExists =
        new SerializableRunnable("textTXRmtMirror: checkExists") {
          @Override
          public void run() {
    ...
    SerializableRunnable checkNoKey =
        new SerializableRunnable("textTXRmtMirror: checkNoKey") {
          @Override
          public void run() {
            Region rgn = getRootRegion().getSubregion(rgnName);
            {
  ...
  public void testTXAlgebra() throws Exception {
    ...
    SerializableRunnable create =
        new SerializableRunnable("testTXAlgebra: Create Region") {
          @Override
          public void run() {
            CacheTransactionManager txMgr2 = getCache().getCacheTransactionManager();
            MyTransactionListener tl = new MyTransactionListener();
    ...
    try {
      ...
      Invoke.invokeInEveryVM(
          new CacheSerializableRunnable("testTXAlgebra: check: C+P->C") {
            @Override
            public void run2() {
              Region rgn1 = getRootRegion().getSubregion(rgnName);
              CacheTransactionManager txMgr2 = getCache().getCacheTransactionManager();
      ...
      //// callbackVal.reAssert();
      Invoke.invokeInEveryVM(
          new CacheSerializableRunnable("testTXAlgebra: check: C+DD->DD") {
            @Override
            public void run2() {
              Region rgn1 = getRootRegion().getSubregion(rgnName);
              CacheTransactionManager txMgr2 = getCache().getCacheTransactionManager();
      ...
      if (!getRegionAttributes().getDataPolicy().withReplication()) {
        ...
        Invoke.invokeInEveryVM(
            new CacheSerializableRunnable("testTXAlgebra: C+LI-> entry creation") {
              @Override
              public void run2() {
                Region rgn1 = getRootRegion().getSubregion(rgnName);
                try {
  ...
  public void versionTestGIISendsTombstones() throws Exception {
    ...
    SerializableRunnable asserter =
        new SerializableRunnable("ensure tombstone has been received") {
          @Override
          public void run() {
    ...
    vm0.invoke(createRegion);
    vm0.invoke(
        new SerializableRunnable("create some tombstones") {
          @Override
          public void run() {
  ...
  public void versionTestConcurrentEvents() throws Exception {
    ...
    SerializableRunnable performOps =
        new SerializableRunnable("perform concurrent ops") {
          @Override
          public void run() {
            try {
    ...
    for (int i = 0; i < 10; i++) {
      String key = "cckey" + i;
      assertEquals(
          "region contents are not consistent for " + key,
          r0Contents.get(key),
          r1Contents.get(key));
      assertEquals(
          "region contents are not consistent for " + key,
    ...
    if (!getRegionAttributes().getScope().isDistributedNoAck()) { // no-ack doesn't support deltas
      ...
      performOps =
          new SerializableRunnable("perform concurrent delta ops") {
            @Override
            public void run() {
              try {
      ...
      for (int i = 0; i < 10; i++) {
        String key = "cckey" + i;
        assertEquals(
            "region contents are not consistent", r0Contents.get(key), r1Contents.get(key));
        assertEquals(
            "region contents are not consistent", r1Contents.get(key), r2Contents.get(key));
        for (int subi = 1; subi < 3; subi++) {
          String subkey = key + "-" + subi;
          if (r0Contents.containsKey(subkey)) {
            assertEquals(
                "region contents are not consistent",
                r0Contents.get(subkey),
                r1Contents.get(subkey));
            assertEquals(
                "region contents are not consistent",
    ...
    for (int i = 0; i < 10; i++) {
      ...
      for (int subi = 1; subi < 3; subi++) {
        ...
        if (r0Contents.containsKey(subkey)) {
          ...
          assertTrue(
              "expected containsKey(" + subkey + ") to return false",
  ...
  public void versionTestTombstones() {
    ...
    try {
      SerializableRunnable setTimeout =
          new SerializableRunnable() {
            ...
            public void run() {
              ...
              TombstoneService.GC_MEMORY_THRESHOLD =
                  0; // turn this off so heap profile won't cause test to fail
      ...
      vm0.invoke(
          new SerializableRunnable("destroy entries and check tombstone count") {
            @Override
            public void run() {
              try {
                for (int i = 0; i < numEntries; i++) {
      ...
      vm1.invoke(
          new SerializableRunnable("check tombstone count(2)") {
            @Override
            public void run() {
              checkCCRegionTombstoneCount("after destroys in other vm ", numEntries);
              WaitCriterion waitForExpiration =
                  new WaitCriterion() {
                    @Override
                    public boolean done() {
              ...
              try {
                Wait.waitForCriterion(
                    ...
                    TombstoneService.REPLICATE_TOMBSTONE_TIMEOUT
                        + (TombstoneService.MAX_SLEEP_TIME * 9),
                    100,
                    true);
              } catch (AssertionError e) {
      ...
      vm0.invoke(
          new SerializableRunnable("create/destroy entries and check tombstone count") {
            @Override
            public void run() {
              ...
              try {
                ...
                Wait.waitForCriterion(
                    ...
                    true);
                logger.debug(
                    "creating tombstones.  current count={}", CCRegion.getTombstoneCount());
                for (int i = 0; i < numEntries; i++) {
                  CCRegion.create("cckey" + i, i);
                  CCRegion.destroy("cckey" + i);
                }
                logger.debug(
                    "done creating tombstones.  current count={}", CCRegion.getTombstoneCount());
      ...
      vm1.invoke(
          new SerializableRunnable("check tombstone count and install listener") {
            @Override
            public void run() {
              ...
              try {
                ...
                WaitCriterion waitForExpiration =
                    new WaitCriterion() {
                      @Override
                      public boolean done() {
                        return CCRegion.getCache()
                                .getTombstoneService()
                                .getScheduledTombstoneCount()
                            == 0;
                      }
                ...
                Wait.waitForCriterion(
                    waitForExpiration, TombstoneService.REPLICATE_TOMBSTONE_TIMEOUT * 5, 100, true);
              } catch (CacheException e) {
      ...
      vm1.invoke(
          new SerializableRunnable("check afterCreate and tombstone count") {
            @Override
            public void run() {
      ...
      SerializableRunnable resetTimeout =
          new SerializableRunnable() {
            @Override
            public void run() {
  ...
  public void versionTestConcurrentEventsOnNonReplicatedRegion() {
    ...
    vm0.invoke(
        new SerializableRunnable("add cache loader and create destroyed entry") {
          @Override
          public void run() {
                ...
                .setCacheLoader(
                    new CacheLoader() {
                      ...
                      public Object load(LoaderHelper helper) throws CacheLoaderException {
                        org.apache.geode.test.dunit.LogWriterUtils.getLogWriter()
                            .info(
                                "The test CacheLoader has been invoked for key '"
                                    + helper.getKey()
                                    + "'");
                        return "loadedValue";
                      }
    ...
    vm1.invoke(
        new SerializableRunnable("confirm tombstone") {
          @Override
          public void run() {
    ...
    vm0.invoke(
        new SerializableRunnable("use cache loader") {
          @Override
          public void run() {
    ...
    if (!noAck) { // might be 3 or 4 with no-ack
      vm1.invoke(
          new SerializableRunnable("verify version number") {
            @Override
            public void run() {
              assertEquals("loadedValue", CCRegion.get(loadKey));
              assertEquals(
                  3, (CCRegion.getRegionEntry(loadKey)).getVersionStamp().getEntryVersion());
            }
          });
    }
  }
  ...
  public void versionTestGetAllWithVersions() {
    assumeTrue(
        getRegionAttributes().getScope().isAck()); // this test has timing issues in no-ack scopes
    ...
    vm1.invoke(createRegion);
    vm1.invoke(
        new SerializableRunnable("Populate region and perform some ops") {
          @Override
          public void run() {
            for (int i = 0; i < 100; i++) {
    ...
    vm0.invoke(
        new SerializableRunnable("Perform getAll") {
          @Override
          public void run() {
  ...
  public static void assertNoClearTimeouts() {
    ...
    assertEquals(
        "expected there to be no timeouts - something is broken",
        0,
    ...
    org.apache.geode.test.dunit.LogWriterUtils.getLogWriter()
        .info(
            "vm"
                ...
                + id
                + " copying "
                + CCRegion.getVersionVector().fullToString());
