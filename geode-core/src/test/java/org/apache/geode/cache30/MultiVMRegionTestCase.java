...
public abstract class MultiVMRegionTestCase extends RegionTestCase {
  ...
  public void testMirroredDataFromNonMirrored() throws Exception {
    ...
    class MirroredDataFromNonMirroredListener extends TestCacheListener {
      ...
      public synchronized void afterCreate2(EntryEvent event) {
        ...
        org.apache.geode.test.dunit.LogWriterUtils.getLogWriter().info("afterCreate called in " + "MirroredDataFromNonMirroredListener for key:" + event.getKey());
      }
    }
    ...
    vm0.invoke(new CacheSerializableRunnable("Verify keys/values and listener") {
      ...
      public void run2() throws CacheException {
        ...
        assertTrue("expectedKeys should be empty, but was: " + lsnr.expectedKeys, lsnr.expectedKeys.isEmpty());
      }
    });
  }
    ...
    try {
      ...
      SerializableRunnable get2 = new CacheSerializableRunnable("Get long") {
        ...
        public void run2() throws CacheException {
          ...
          inst = (DSLongWrapper.DSLongWrapperInstantiator) InternalInstantiator.getInstantiator(inst.getId());
          assertNotNull(inst);
  ...
  private void checkCCRegionTombstoneCount(String msg, int expected) {
    ...
    if (expected != actual) {
      assertEquals(msg + " region tombstone count was " + actual + " expected=" + expected + " TombstoneService=" + CCRegion.getCache().getTombstoneService(), expected, actual);
    }
  }
