...
public class GlobalRegionDUnitTest extends MultiVMRegionTestCase {
  ...
  public void testRemoteFetch() throws CacheException {
    ...
    vm0.invoke(create);
    vm0.invoke(
        new CacheSerializableRunnable("Put") {
          public void run2() throws CacheException {
  ...
  public void testSynchronousIncrements() throws InterruptedException {
    ...
    vm0.invoke(
        new CacheSerializableRunnable("Verify final value") {
          public void run2() throws CacheException {
            Region region = getRootRegion().getSubregion(name);
            Integer value = (Integer) region.get(key);
            assertNotNull(value);
  ...
  public void testPutGetTimeout() {
    ...
    vm0.invoke(
        new CacheSerializableRunnable("Lock entry") {
          public void run2() throws CacheException {
            Region region = getRootRegion().getSubregion(name);
            Lock lock = region.getDistributedLock(key);
            lock.lock();
    ...
    vm1.invoke(
        new CacheSerializableRunnable("Attempt get/put") {
          public void run2() throws CacheException {
    ...
    vm0.invoke(
        new CacheSerializableRunnable("Unlock entry") {
          public void run2() throws CacheException {
            Region region = getRootRegion().getSubregion(name);
            Lock lock = region.getDistributedLock(key);
            lock.unlock();
