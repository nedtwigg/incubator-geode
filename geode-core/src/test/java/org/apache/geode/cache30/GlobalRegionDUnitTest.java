              ...
              try {
                ...
                try {
                  ...
                  for (int j = 0; j < incrementsPerThread; j++) {
                    ...
                    LogWriterUtils.getLogWriter().info("testSynchronousIncrements." + this + ": " + key + " -> " + value);
                    lock.unlock();
                  }
                ...
                LogWriterUtils.getLogWriter().info("testSynchronousIncrements." + this + " caught Throwable", t);
              }
            }
          }, "Incrementer " + i);
          threads[i] = thread;
