...
public abstract class ClientAuthenticationTestCase extends JUnit4DistributedTestCase {
  ...
  protected void doTestValidCredentials(final boolean multiUser) throws Exception {
    ...
    int port1 =
        server1.invoke(
            () -> createCacheServer(locPort1, locString, authenticator, extraProps, javaProps));
    int port2 =
        server2.invoke(
            () -> createCacheServer(locPort2, locString, authenticator, extraProps, javaProps));
    ...
    getLogWriter()
        .info(
            "testValidCredentials: For first client credentials: "
                + credentials1
                + " : "
                + javaProps1);
    ...
    createClientsNoException(
        multiUser, authInit, port1, port2, credentials1, javaProps1, credentials2, javaProps2);
  ...
  protected void doTestNoCredentials(final boolean multiUser) throws Exception {
    ...
    getLogWriter()
        .info(
            "testNoCredentials: For first client credentials: "
                + credentials1
                + " : "
                + javaProps1);
  ...
  protected void doTestInvalidAuthInit(final boolean multiUser) throws Exception {
    ...
    getLogWriter()
        .info(
            "testInvalidAuthInit: For first client credentials: "
                + credentials
                + " : "
                + javaProps);
  ...
  protected void doTestNoAuthInitWithCredentials(final boolean multiUser) throws Exception {
    ...
    client1.invoke(
        () ->
            createCacheClient(
                null, credentials1, javaProps1, port1, port2, 0, multiUser, AUTHREQ_EXCEPTION));
    client2.invoke(
        () ->
            createCacheClient(
                null, credentials2, javaProps2, port1, port2, 0, multiUser, AUTHREQ_EXCEPTION));
    ...
    client2.invoke(
        () ->
            createCacheClient(
                null, credentials3, javaProps3, port1, port2, 0, multiUser, AUTHREQ_EXCEPTION));
  }
  ...
  protected void doTestCredentialsWithFailover(final boolean multiUser) throws Exception {
    ...
    if (gen.classCode().equals(CredentialGenerator.ClassCode.SSL)) {
      ...
      client2.invoke(
          () ->
              createCacheClient(
                  null, null, null, port1, port2, 0, multiUser, NOFORCE_AUTHREQ_EXCEPTION));
      client2.invoke(() -> doPuts(2, OTHER_EXCEPTION));
  ...
  protected void doTestCredentialsForNotifications(final boolean multiUser) throws Exception {
    ...
    int zeroConns = 0;
    createClient2NoException(
        multiUser, authInit, port1, port2, credentials2, javaProps2, zeroConns);
    ...
    if (gen.classCode().equals(CredentialGenerator.ClassCode.SSL)) {
      ...
      client1.invoke(
          () ->
              createCacheClient(
                  null, null, null, p, port2, zeroConns, multiUser, NOFORCE_AUTHREQ_EXCEPTION));
      ...
      client1.invoke(
          () ->
              createCacheClient(
                  null, null, null, p, port2, zeroConns, multiUser, AUTHREQ_EXCEPTION));
    }
    ...
    if (authInit != null && authInit.length() > 0) {
      ...
      client1.invoke(
          () ->
              createCacheClient(
                  null, credentials1, javaProps1, p1, p2, 0, multiUser, AUTHREQ_EXCEPTION));
    ...
    if (authenticator != null && authenticator.length() > 0) {
      final int p1 =
          server1.invoke(
              () -> createCacheServer(locPort1, locString, 0, null, extraProps, javaProps));
      final int p2 =
          server2.invoke(
              () -> createCacheServer(locPort2, locString, 0, null, extraProps, javaProps));
  ...
  private void createClient1NoException(
      final boolean multiUser,
      final String authInit,
      final int port1,
      final int port2,
      final Properties credentials2,
      final Properties javaProps2) {
    client1.invoke(
        () ->
            createCacheClient(
                authInit, credentials2, javaProps2, port1, port2, 0, multiUser, NO_EXCEPTION));
  }

  private void createClient2AuthReqException(
      final boolean multiUser,
      final int port1,
      final int port2,
      final Properties credentials2,
  ...
  private void createClient1WithException(
      final boolean multiUser,
      final String authInit,
      final int port1,
      final int port2,
  ...
  private void createClient2WithException(
      final boolean multiUser,
      final String authInit,
      final int port1,
      final int port2,
  ...
  private void createClientsNoException(
      final boolean multiUser,
      final String authInit,
      final int port1,
      final int port2,
      final Properties credentials1,
      final Properties javaProps1,
      final Properties credentials2,
      final Properties javaProps2) {
    createClient1NoException(multiUser, authInit, port1, port2, credentials1, javaProps1);
    client2.invoke(
