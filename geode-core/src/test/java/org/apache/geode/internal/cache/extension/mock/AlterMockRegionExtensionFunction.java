 ...
 *         <dd>Name of region on which to create {@link MockCacheExtension}.
 *         <dt>{@link String} value
 *         <dd>Value to set. See {@link MockCacheExtension#setValue(String)}.
 *       </dl>
 *
 * </dl>
 *
  ...
  public void execute(FunctionContext context) {
    ...
    resultSender.lastResult(
        new CliFunctionResult(
            ...
            xmlEntity,
            CliStrings.format(
                "Mock region extension \"{0}\" altered on \"{1}\"",
