...
public class ClientServerTransactionDUnitTest extends RemoteTransactionDUnitTest {
  ...
  private Integer createRegionsAndStartServerWithTimeout(
      VM vm, boolean accessor, int txTimeoutSecs) {
    return createRegionOnServerWithTimeout(vm, true, accessor, txTimeoutSecs);
  }

  private Integer createRegionOnServerWithTimeout(
      VM vm, final boolean startServer, final boolean accessor, final int txTimeoutSecs) {
  ...
  private Integer createRegionOnServer(
      VM vm, final boolean startServer, final boolean accessor, final int redundantCopies) {
        ...
        new SerializableCallable() {
          public Object call() throws Exception {
            ...
            ClientRegionFactory<Integer, String> crf =
                cCache.createClientRegionFactory(
  ...
  private void createSubscriptionRegion(
      boolean isOffHeap, String regionName, int copies, int totalBuckets) {
  ...
  private void createClient(int port, String regionName) throws Exception {
    ...
    Region r =
        cCache
            ...
            .addCacheListener(new ClientCacheListener())
            .create(regionName);
    r.registerInterestRegex(".*");
  }
  ...
  public void testTwoPoolsNotAllowed() {
    ...
    SerializableCallable disconnect =
        new SerializableCallable("disconnect") {
          public Object call() throws Exception {
  ...
  public void testCleanupAfterClientFailure() {
    ...
    SerializableCallable verifyExpired =
        new SerializableCallable("verify txstate is expired") {
          public Object call() throws Exception {
  ...
  public void testFailoverAfterProxyFailure() throws InterruptedException {
    ...
    final DistributedMember myId = cCache.getDistributedSystem().getDistributedMember();
    final DistributedMember accessorId =
        (DistributedMember)
            accessor.invoke(() -> ClientServerTransactionDUnitTest.getVMDistributedMember());
    final DistributedMember accessor2Id =
        (DistributedMember)
            accessor2.invoke(() -> ClientServerTransactionDUnitTest.getVMDistributedMember());
    ...
    SerializableCallable getProxyServer =
        new SerializableCallable("get proxy server") {
          public Object call() throws Exception {
            final TXManagerImpl txmgr = getGemfireCache().getTxManager();
  ...
  private void doBasicTransaction(
      final boolean prePopulateData, final boolean useJTA, final boolean isCommit) {
    Host host = Host.getHost(0);
    ...
    client.invoke(
        new SerializableCallable() {
          public Object call() throws Exception {
            ...
            org.apache.geode.test.dunit.LogWriterUtils.getLogWriter()
                .info("done starting transaction");
  ...
  private void doBasicChecks(final boolean commit) throws Exception {
    ...
    server.invoke(
        new SerializableCallable("verify tx") {
          public Object call() throws Exception {
            TXManagerImpl mgr = getGemfireCache().getTxManager();
  ...
  public void testGetAllRollbackInServer() throws Exception {
    ...
    server.invoke(
        new SerializableCallable("verify getAll tx") {
          public Object call() throws Exception {
            TXManagerImpl mgr = getGemfireCache().getTxManager();
            Region<OrderId, Order> orderRegion = getCache().getRegion(ORDER);
            orderRegion
  ...
  public void testGetAllRollbackInClient() throws Exception {
    ...
    server.invoke(
        new SerializableCallable("add cache loader") {
          public Object call() throws Exception {
            Region<OrderId, Order> orderRegion = getCache().getRegion(ORDER);
            orderRegion
                .getAttributesMutator()
    ...
    client.invoke(
        new SerializableCallable("verify getAll uses tx") {
          public Object call() throws Exception {
            Region<OrderId, Order> orderRegion = getCache().getRegion(ORDER);
            TXManagerImpl mgr = getGemfireCache().getTxManager();
            mgr.begin();
  ...
  SerializableCallable validateNoEvents =
      new SerializableCallable() {
        public Object call() throws Exception {
          Region<CustId, Customer> custRegion = getCache().getRegion(CUSTOMER);
          //          Region<OrderId, Order> orderRegion = getCache().getRegion(ORDER);
  ...
  SerializableCallable doAPutInTx =
      new SerializableCallable() {
        public Object call() throws Exception {
          Region<CustId, Customer> custRegion = getCache().getRegion(CUSTOMER);
          //          Region<OrderId, Order> orderRegion = getCache().getRegion(ORDER);
  ...
  SerializableCallable doAnInvalidateInTx =
      new SerializableCallable() {
        public Object call() throws Exception {
          Region<CustId, Customer> custRegion = getCache().getRegion(CUSTOMER);
          //          Region<OrderId, Order> orderRegion = getCache().getRegion(ORDER);
  ...
  private void doTxWithPRAccessor(final boolean commit) {
    ...
    SerializableCallable countActiveTx =
        new SerializableCallable() {
          public Object call() throws Exception {
            TXManagerImpl mgr = getGemfireCache().getTxManager();
  ...
  public void testConnectionAffinity() throws Exception {
    ...
    SerializableCallable hostedSize =
        new SerializableCallable() {
          public Object call() throws Exception {
            TXManagerImpl mgr = getGemfireCache().getTxManager();
            return mgr.hostedTransactionsInProgressForTest();
  ...
  @Category(
      FlakyTest
          .class) // GEODE-1933: IllegalStateException: Thread does not have an active transaction
  @Test
  ...
  private void doFailoverWork(
      VM accessor1,
      VM accessor2,
      VM datastore,
      VM client,
      boolean serverOnDatastore,
      final boolean cachingProxy) {
    ...
    final int port3 =
        serverOnDatastore
            ? createRegionsAndStartServer(datastore, false)
            : createRegionOnServer(datastore, false, false);

    /*final TXId txid = (TXId) */ client.invoke(
        new SerializableCallable() {
          public Object call() throws Exception {
            System.setProperty(
                DistributionConfig.GEMFIRE_PREFIX + "bridge.disableShufflingOfEndpoints", "true");
  ...
  public void testGetEntry() {
    ...
    datastore.invoke(
        new SerializableCallable() {
          public Object call() throws Exception {
            Region<CustId, Customer> pr = getGemfireCache().getRegion(CUSTOMER);
            pr.getAttributesMutator()
                .setCacheLoader(
                    new CacheLoader<CustId, Customer>() {
                      public void close() {}
  ...
  public void testTXListenerOnRedundant() {
    ...
    SerializableCallable registerTxListener =
        new SerializableCallable() {
          public Object call() throws Exception {
    ...
    SerializableCallable listenerInvoked =
        new SerializableCallable() {
          public Object call() throws Exception {
            RedundantListener l =
        ...
        new SerializableCallable() {
          public Object call() throws Exception {
            ...
            FunctionService.onRegion(pr)
                .withFilter(filter)
                .execute(BasicTransactionalFunction.ID)
                .getResult();
            ...
            txState.setAfterSend(
                new Runnable() {
                  public void run() {
                    ...
                    System.setProperty(
                        DistributionConfig.GEMFIRE_PREFIX + "no-flush-on-close", "true");
                    try {
    ...
    client.invoke(
        new SerializableCallable() {
          public Object call() throws Exception {
            ...
            List result =
                (List)
                    FunctionService.onRegion(cust)
                        .withArgs(args)
                        .execute(new TXFunction())
                        .getResult();
            ...
            result =
                (List)
                    FunctionService.onServer(getCache())
                        .withArgs(txId)
                        .execute(new CommitFunction())
                        .getResult();
  ...
  private void doFunctionWork(final boolean commit) {
    ...
    SerializableRunnable suspectStrings =
        new SerializableRunnable("suspect string") {
          public void run() {
            InternalDistributedSystem.getLoggerI18n()
                ...
                .info(
                    "<ExpectedException action=add>"
                        ...
                        + "</ExpectedException>"
                        + "<ExpectedException action=add>"
                        + "TransactionDataNodeHasDeparted"
                        + "</ExpectedException>");
          }
        };
          ...
          new SerializableCallable() {
            public Object call() throws Exception {
              ...
              try {
                if (commit) {
                  FunctionService.onServer(getCache())
                      .withArgs(new CustId(0))
                      .execute(new CommitFunction())
                      .getResult();
                } else {
                  FunctionService.onServer(getCache())
                      .withArgs(new CustId(0))
                      .execute(new RollbackFunction())
                      .getResult();
                }
                fail("expected exception not thrown");
            ...
            client.invoke(
                new SerializableCallable() {
                  ...
                  public Object call() throws Exception {
                    ...
                    WaitCriterion waitForTxTimeout =
                        new WaitCriterion() {
                          public boolean done() {
        ...
        (TXId)
            client.invoke(
                new SerializableCallable() {
                  ...
                  public Object call() throws Exception {
                    System.setProperty(
                        DistributionConfig.GEMFIRE_PREFIX + "bridge.disableShufflingOfEndpoints",
                        "true");
                    ClientCacheFactory ccf = new ClientCacheFactory();
                    ccf.addPoolServer("localhost" /*getServerHostName(Host.getHost(0))*/, port1);
                    if (port2 != 0) ccf.addPoolServer("localhost", port2);
  ...
  public void testAdjunctMessage() {
    ...
    SerializableCallable createServerRegionWithInterest =
        new SerializableCallable() {
          @Override
          public Object call() throws Exception {
  ...
  private void testSubscriptionEventsWhenBucketRegionIsDestroyed(boolean offheap, forop op) {
    ...
    server2.invoke(
        () -> {
          ...
          arm.setARMLockTestHook(
              new ARMLockTestHookAdapter() {
                @Override
