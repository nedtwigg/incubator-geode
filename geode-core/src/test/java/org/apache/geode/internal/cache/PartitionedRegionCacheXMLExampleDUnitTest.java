...
public class PartitionedRegionCacheXMLExampleDUnitTest extends PartitionedRegionDUnitTestCase {
  ...
  public void testExampleWithBothRootRegion() {
    ...
    CacheSerializableRunnable createCache =
    ...
    CacheSerializableRunnable validateRegion =
        new CacheSerializableRunnable("validateRegion") {
          public void run2() throws CacheException {
    ...
    CacheSerializableRunnable disconnect =
        new CacheSerializableRunnable("disconnect") {
          public void run2() throws CacheException {
            closeCache();
            disconnectFromDS();
          }
  ...
  public void testExampleWithSubRegion() {
    ...
    CacheSerializableRunnable validateSubRegion =
        new CacheSerializableRunnable("validateRegion") {
          public void run2() throws CacheException {
            PartitionedRegion pr =
                (PartitionedRegion)
                    cache.getRegion(
                        Region.SEPARATOR + "root" + Region.SEPARATOR + "PartitionedSubRegion");
