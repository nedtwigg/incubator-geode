...
public class DistrbutedRegionProfileOffHeapDUnitTest extends JUnit4CacheTestCase {
  ...
  public void testPartitionedRegionProfileWithConflict() throws Exception {
    ...
    Host.getHost(0)
        .getVM(0)
        .invoke(
            new CacheSerializableRunnable("createRegionNoException") {
    ...
    Host.getHost(0)
        .getVM(1)
        .invoke(
            new CacheSerializableRunnable("createRegionException") {
              private static final long serialVersionUID = 1L;
          ...
          .invoke(
              new CacheSerializableRunnable("createRegionNoException") {
                ...
                public void run2() throws CacheException {
                  ...
                  assertNotNull("Region is null", region);
                  assertNotNull(
                      "Cache does not contain region", cache.getRegion(offHeapRegionName));
