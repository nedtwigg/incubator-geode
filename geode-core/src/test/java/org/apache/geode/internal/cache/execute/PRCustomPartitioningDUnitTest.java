...
public class PRCustomPartitioningDUnitTest extends PartitionedRegionDUnitTestCase {
  ...
  public void partitionedRegionTest(final String prName) {
    ...
    vm0.invoke(
        new CacheSerializableRunnable("verifyKeysonVM0") {
          public void run2() throws CacheException {
                ...
                .visitBuckets(
                    new BucketVisitor() {
                      public void visit(Integer bucketId, Region r) {
                        ...
                        while (it.hasNext()) {
                          EntryOperation eo =
                              new EntryOperationImpl(pr, null, it.next(), null, null);
    ...
    vm1.invoke(
        new CacheSerializableRunnable("verifyKeysonVM1") {
          public void run2() throws CacheException {
    ...
    vm2.invoke(
        new CacheSerializableRunnable("verifyKeysonVM2") {
          public void run2() throws CacheException {
    ...
    vm3.invoke(
        new CacheSerializableRunnable("verifyKeysonVM3") {
          public void run2() throws CacheException {
...
class SerializableMonth implements DataSerializable {
  ...
  public int hashCode() {
    ...
    else if (this.month >= 4 && this.month < 8) return 2;
    else return 3;
  }
}
