...
public class ColocatedRegionDetailsJUnitTest {
   ...
   * org.apache.geode.internal.cache.partitioned.ColocatedRegionDetails#ColocatedRegionDetails(java.lang.String,
  ...
  /**
   * Test method for {@link
   * org.apache.geode.internal.cache.partitioned.ColocatedRegionDetails#ColocatedRegionDetails()}.
   */
  @Test
  ...
  /**
   * Test method for {@link
   * org.apache.geode.internal.cache.partitioned.ColocatedRegionDetails#toData(java.io.DataOutput)}.
   *
   * @throws IOException
  ...
  public final void testToString() {
    ColocatedRegionDetails crd =
        new ColocatedRegionDetails("host1", "member name", "parent region", "child region");
    assertEquals(
        "[host:host1, member:member name, parent:parent region, child:child region]",
        crd.toString());
  }
