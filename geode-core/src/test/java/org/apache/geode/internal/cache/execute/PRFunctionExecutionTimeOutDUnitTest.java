...
public class PRFunctionExecutionTimeOutDUnitTest extends PartitionedRegionDUnitTestCase {
        ...
        accessor.invoke(
            new SerializableCallable("Create data, invoke exectuable") {
              public Object call() throws Exception {
                ...
                assertEquals(
                    Boolean.TRUE, ((List) rs3.getResult(4000, TimeUnit.MILLISECONDS)).get(0));
                try {
                  rs1.getResult();
                  fail("Did not get the expected exception.");
                } catch (FunctionException fe) {
  ...
  @Category(
      FlakyTest
          .class) // GEODE-1020: suspect string: BucketMovedException, missing fail in expected exception, eats exceptions
  @Test
                      ...
                      expected
                          ...
                          .contains(
                              "No target node found for KEY = "
                                  + testKey)); // TODO: eats exception with new AssertionError if it doesn't match
                }
                ...
                try {
                  ...
                  assertTrue(
                      ...
                      fe.getMessage()
                          .contains(
                              LocalizedStrings
                                  .ExecuteFunction_RESULTS_NOT_COLLECTED_IN_TIME_PROVIDED
                                  .toLocalizedString()));
                }
                      ...
                      fe.getMessage()
                          .contains(
                              LocalizedStrings.ExecuteFunction_RESULTS_ALREADY_COLLECTED
                                  .toLocalizedString())); // TODO: eats exception with new AssertionError if fails
                }
