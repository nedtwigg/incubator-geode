...
public class PRClientServerRegionFunctionExecutionSingleHopDUnitTest
  ...
  public void testServerAllKeyExecution_byInstance() {
    ...
    client.invoke(
        () ->
            PRClientServerRegionFunctionExecutionSingleHopDUnitTest.serverAllKeyExecution(
                isByName));
  }
  ...
  public void testServerSingleKeyExecution_byName() {
    ...
    client.invoke(
        () ->
            PRClientServerRegionFunctionExecutionSingleHopDUnitTest.serverSingleKeyExecution(
                isByName));
  }
  ...
  public void testserverMultiKeyExecution_byName() {
    ...
    client.invoke(
        () ->
            PRClientServerRegionFunctionExecutionSingleHopDUnitTest.serverMultiKeyExecution(
                isByName));
    server1.invoke(
  ...
  public void testserverMultiKeyExecutionNoResult_byName() {
    ...
    client.invoke(
        () ->
            PRClientServerRegionFunctionExecutionSingleHopDUnitTest.serverMultiKeyExecutionNoResult(
                isByName));
  }
  ...
  public void testServerFailoverWithTwoServerAliveHA() throws InterruptedException {
    ...
    client.invoke(
        () ->
            PRClientServerRegionFunctionExecutionDUnitTest.verifyDeadAndLiveServers(
  ...
  public void testServerCacheClosedFailoverWithTwoServerAliveHA() throws InterruptedException {
    ...
    client.invoke(
        () ->
            PRClientServerRegionFunctionExecutionSingleHopDUnitTest.verifyDeadAndLiveServers(
                new Integer(1), new Integer(2)));
  ...
  public void testBug40714() {
    createScenario();
    server1.invoke(
        () -> PRClientServerRegionFunctionExecutionSingleHopDUnitTest.registerFunction());
    server1.invoke(
        () -> PRClientServerRegionFunctionExecutionSingleHopDUnitTest.registerFunction());
    server1.invoke(
        () -> PRClientServerRegionFunctionExecutionSingleHopDUnitTest.registerFunction());
  ...
  private static ResultCollector executeOnAll(
      Execution dataSet, Serializable args, Function function, Boolean isByName) throws Exception {
    if (isByName.booleanValue()) { // by name
