...
public class ConcurrentAsyncEventQueueDUnitTest extends AsyncEventQueueTestBase {
    ...
    vm1.invoke(
        () ->
            AsyncEventQueueTestBase.createConcurrentAsyncEventQueue(
                "ln", false, 100, 150, true, true, "testDS", true, 5, OrderPolicy.THREAD));

    vm1.invoke(
        () ->
            AsyncEventQueueTestBase.validateConcurrentAsyncEventQueueAttributes(
                "ln",
                100,
                150,
  ...
  public void testConcurrentParallelAsyncEventQueueAttributesOrderPolicyKey() {
    ...
    vm1.invoke(
        () ->
            AsyncEventQueueTestBase.createConcurrentAsyncEventQueue(
                "ln", true, 100, 150, true, true, "testDS", true, 5, OrderPolicy.KEY));
  ...
  public void testConcurrentParallelAsyncEventQueueAttributesOrderPolicyPartition() {
    ...
    vm1.invoke(
        () ->
            AsyncEventQueueTestBase.createConcurrentAsyncEventQueue(
                "ln", true, 100, 150, true, true, "testDS", true, 5, OrderPolicy.PARTITION));
  ...
  public void testReplicatedSerialAsyncEventQueueWithMultipleDispatcherThreadsOrderPolicyKey() {
    ...
    vm1.invoke(
        () ->
            AsyncEventQueueTestBase.createConcurrentAsyncEventQueue(
                "ln", false, 100, 10, true, false, null, false, 3, OrderPolicy.KEY));
    vm2.invoke(
        () ->
            AsyncEventQueueTestBase.createConcurrentAsyncEventQueue(
                "ln", false, 100, 10, true, false, null, false, 3, OrderPolicy.KEY));
    ...
    vm1.invoke(
        () -> AsyncEventQueueTestBase.validateAsyncEventListener("ln", 100)); // primary sender
   ...
   * Test configuration::
   *
   * <p>Region: Replicated WAN: Serial Dispatcher threads: more than 1 Order policy: Thread ordering
   */
  @Test
  public void testReplicatedSerialAsyncEventQueueWithMultipleDispatcherThreadsOrderPolicyThread() {
    ...
    vm1.invoke(
        () ->
            AsyncEventQueueTestBase.createConcurrentAsyncEventQueue(
                "ln", false, 100, 10, true, false, null, false, 3, OrderPolicy.THREAD));
    vm2.invoke(
        () ->
            AsyncEventQueueTestBase.createConcurrentAsyncEventQueue(
                "ln", false, 100, 10, true, false, null, false, 3, OrderPolicy.THREAD));
    ...
    vm1.invoke(
        () -> AsyncEventQueueTestBase.validateAsyncEventListener("ln", 150)); // primary sender
    vm2.invoke(() -> AsyncEventQueueTestBase.validateAsyncEventListener("ln", 0)); // secondary
    vm3.invoke(() -> AsyncEventQueueTestBase.validateAsyncEventListener("ln", 0)); // secondary
    vm4.invoke(() -> AsyncEventQueueTestBase.validateAsyncEventListener("ln", 0)); // secondary
  }
   ...
   * Test configuration::
   *
   * <p>Region: PartitionedRegion WAN: Parallel Dispatcher threads: more than 1 Order policy: key
   * based ordering
   */
  ...
  public void testPartitionedParallelAsyncEventQueueWithMultipleDispatcherThreadsOrderPolicyKey() {
    ...
    vm1.invoke(
        () ->
            AsyncEventQueueTestBase.createConcurrentAsyncEventQueue(
                "ln", true, 100, 10, true, false, null, false, 3, OrderPolicy.KEY));
    vm2.invoke(
        () ->
            AsyncEventQueueTestBase.createConcurrentAsyncEventQueue(
                "ln", true, 100, 10, true, false, null, false, 3, OrderPolicy.KEY));
   ...
   * Test configuration::
   *
   * <p>Region: PartitionedRegion WAN: Parallel Dispatcher threads: more than 1 Order policy:
   * PARTITION based ordering
   */
  // Disabled test for bug #48323
  @Test
  public void
      testPartitionedParallelAsyncEventQueueWithMultipleDispatcherThreadsOrderPolicyPartition() {
    Integer lnPort =
        (Integer) vm0.invoke(() -> AsyncEventQueueTestBase.createFirstLocatorWithDSId(1));
    ...
    vm1.invoke(
        () ->
            AsyncEventQueueTestBase.createConcurrentAsyncEventQueue(
                "ln", true, 100, 10, true, false, null, false, 3, OrderPolicy.PARTITION));
    vm2.invoke(
        () ->
            AsyncEventQueueTestBase.createConcurrentAsyncEventQueue(
                "ln", true, 100, 10, true, false, null, false, 3, OrderPolicy.PARTITION));
