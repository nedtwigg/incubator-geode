...
public class PartitionedRegionMultipleDUnitTest extends PartitionedRegionDUnitTestCase {
   ...
   */
  private void createMultiplePartitionRegion(
   ...
   */
  private void putDestroyedEntryInMultiplePartitionedRegion(
      VM vm0, VM vm1, VM vm2, VM vm3, int startIndexForRegion, int endIndexForRegion)
      throws Throwable {
    int AsyncInvocationArrSize = 4;
    AsyncInvocation[] async = new AsyncInvocation[AsyncInvocationArrSize];
