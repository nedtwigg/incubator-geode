...
public class RemoteTransactionDUnitTest extends JUnit4CacheTestCase {
  ...
  private final SerializableCallable verifyNoTxState =
      new SerializableCallable() {
        public Object call() throws Exception {
          //TXManagerImpl mgr = getGemfireCache().getTxManager();
  ...
  protected void initAccessorAndDataStore(
      VM accessor, VM datastore1, VM datastore2, final int redundantCopies) {
    datastore2.invoke(
        new SerializableCallable() {
          public Object call() throws Exception {
            createRegion(false /*accessor*/, redundantCopies, null);
  ...
  private void initAccessorAndDataStoreWithInterestPolicy(
      VM accessor, VM datastore1, VM datastore2, final int redundantCopies) {
    datastore2.invoke(
        new SerializableCallable() {
          public Object call() throws Exception {
  ...
  void validateContains(
      CustId custId, Set<OrderId> ordersSet, boolean containsKey, boolean containsValue) {
    Region<CustId, Customer> custRegion = getCache().getRegion(CUSTOMER);
    Region<OrderId, Order> orderRegion = getCache().getRegion(ORDER);
    ...
    if (containsKey) {
      ...
      try {
        for (OrderId o : ordersSet) {
          assertNull(
              "should have had an EntryNotFoundException:" + orderRegion.getEntry(o),
            ...
            accessor.invoke(
                new SerializableCallable() {
                  public Object call() throws Exception {
                    ...
                    assertTrue(
                        "expected:" + expectedCust + " but was " + old, expectedCust.equals(old));
                    ...
                    Order oldOrder =
                        order.putIfAbsent(new OrderId(10, newCustId), new Order("order10"));
                    assertNull(old);
                    assertNull(oldOrder);
    ...
    datastore.invoke(
        new SerializableCallable() {
          public Object call() throws Exception {
            ...
            int hash10 =
                PartitionedRegionHelper.getHashKey((PartitionedRegion) cust, new CustId(10));
            TXManagerImpl mgr = getGemfireCache().getTxManager();
            assertTrue(mgr.isHostedTxInProgress(txId));
            TXStateProxy tx = mgr.getHostedTXState(txId);
            assertEquals(
                3 + (hash1 == hash10 ? 0 : 1),
                tx.getRegions().size()); // 2 buckets for the two puts we
            ...
            accessor.invoke(
                new SerializableCallable() {
                  public Object call() throws Exception {
                    ...
                    try {
                      cust.removeAll(
                          Arrays.asList(custId0, custId4, custId1, custId2, custId3, custId20));
                      fail("expected exception not thrown");
  ...
  public void testTxRemoveAllWithRedundancy() {
    ...
    SerializableCallable checkArtifacts =
        new SerializableCallable() {
          public Object call() throws Exception {
  ...
  private void doTestListeners(final OP op) {
    ...
    SerializableCallable addListenersToDataStore =
        new SerializableCallable() {
          public Object call() throws Exception {
            Region ref = getCache().getRegion(D_REFERENCE);
    ...
    SerializableCallable verifyListeners =
        new SerializableCallable() {
          public Object call() throws Exception {
            Region cust = getCache().getRegion(CUSTOMER);
            Region order = getCache().getRegion(ORDER);
        ...
        new SerializableCallable() {
          public Object call() throws Exception {
            ...
            getCache()
                .getLogger()
                .info(
                    "Putting " + custId + ", keyInfo:" + custPR.getKeyInfo(new CustId(remoteKey)));
  ...
  public void testIllegalIteration() {
    ...
    SerializableCallable doIllegalIteration =
        new SerializableCallable() {
          public Object call() throws Exception {
    ...
    accessor.invoke(
        new SerializableCallable() {
          public Object call() throws Exception {
            ...
            switch (e) {
              case OnRegion:
                FunctionService.onRegion(custRegion)
                    .withFilter(filter)
                    .execute(TXFunction.id)
                    .getResult();
                break;
              case OnMember:
                DistributedMember owner =
                    custRegion.getOwnerForKey(custRegion.getKeyInfo(expectedCustId));
                FunctionService.onMember(basicGetSystem(), owner)
                    .execute(TXFunction.id)
                    .getResult();
                break;
            }
    ...
    accessor.invoke(
        new SerializableCallable() {
          public Object call() throws Exception {
            ...
            assertNull(
                "expected null but was:" + custRegion.get(expectedCustId),
  ...
  public void testTxFunctionWithOtherOps() {
    ...
    //test onMembers
    SerializableCallable getMember =
        new SerializableCallable() {
          public Object call() throws Exception {
    ...
    accessor.invoke(
        new SerializableCallable() {
          public Object call() throws Exception {
            ...
            members.add(ds2);
            try {
              FunctionService.onMembers(basicGetSystem(), members)
                  .execute(TXFunction.id)
                  .getResult();
              fail("expected exception not thrown");
            } catch (TransactionException expected) {
    ...
    SerializableCallable testFnOnDs =
        new SerializableCallable() {
          public Object call() throws Exception {
            TXManagerImpl mgr = getGemfireCache().getTXMgr();
            PartitionedRegion pr = (PartitionedRegion) getGemfireCache().getRegion(CUSTOMER);
    ...
    if (owner.equals(ds1)) {
      ...
      final Integer txOnDatastore2_2 = (Integer) datastore2.invoke(getNumberOfTXInProgress);
      assertEquals(
          0, txOnDatastore1_2 + txOnDatastore2_2); //ds1 has a local transaction, not remote
  ...
  public void testOriginRemoteIsTrueForRemoteReplicatedRegions() {
    ...
    datastore.invoke(
        new SerializableCallable() {
          ...
          public Object call() throws Exception {
            Region refRegion = getCache().getRegion(D_REFERENCE);
            OriginRemoteRRWriter w =
                (OriginRemoteRRWriter) refRegion.getAttributes().getCacheWriter();
   ...
   */
  @Ignore(
      "TODO: disabled because rather than throwing an exception, getAll catches all exceptions and logs a warning message")
  @Test
                    ...
                    for (int i = 10; i < 20; i++) {
                      int hash =
                          PartitionedRegionHelper.getHashKey(
                              i, pr.getPartitionAttributes().getTotalNumBuckets());
        ...
        new SerializableCallable() {
          ...
          public Object call() throws Exception {
            ...
            for (int i = 20; i < 30; i++) {
              int hash =
                  PartitionedRegionHelper.getHashKey(
                      i, custRegion.getAttributes().getPartitionAttributes().getTotalNumBuckets());
  ...
  protected void createClientRegion(
    ...
    client.invoke(
        new SerializableCallable() {
          public Object call() throws Exception {
            ...
            WaitCriterion waitForListenerInvocation =
                new WaitCriterion() {
                  public boolean done() {
                    return cl.invoked;
                  }
  ...
  public void testListenersNotInvokedOnSecondary() {
    ...
    SerializableCallable registerListener =
        new SerializableCallable() {
          public Object call() throws Exception {
            Region<CustId, Customer> custRegion = getCache().getRegion(CUSTOMER);
    ...
    SerializableCallable getListenerCount =
        new SerializableCallable() {
          public Object call() throws Exception {
            Region<CustId, Customer> custRegion = getCache().getRegion(CUSTOMER);
    ...
    int totalInvocation =
        (Integer) datastore1.invoke(getListenerCount)
          ...
          public Object call() throws Exception {
            ...
            WaitCriterion wc2 =
                new WaitCriterion() {
                  ...
                  @Override
                  public String description() {
                    return "did not expire containsKey(key)="
                        + r.containsKey("key")
    ...
    vm1.invoke(
        new SerializableCallable() {
          ...
          public Object call() throws Exception {
            ...
            af.setScope(Scope.DISTRIBUTED_ACK);
            DistributedRegion r =
                (DistributedRegion) getCache().createRegion(regionName, af.create());
  ...
  public void testNonInlineRemoteEvents() {
    ...
    SerializableCallable createRegionWithListener =
        new SerializableCallable() {
          @Override
          public Object call() throws Exception {
            createRegion(false, 0, null);
            getCache()
                .getRegion(D_REFERENCE)
    ...
    SerializableCallable verifyAssert =
        new SerializableCallable() {
          @Override
          public Object call() throws Exception {
