...
public class AsyncEventListenerDUnitTest extends AsyncEventQueueTestBase {
  ...
  public void testSerialAsyncEventQueueAttributes() {
    ...
    vm1.invoke(() -> AsyncEventQueueTestBase.createAsyncEventQueue("ln", false, 100, 150, true, true, "testDS", true));
  ...
  public void testParallelAsyncEventQueueWithFixedPartition() {
    ...
    vm2.invoke(() -> AsyncEventQueueTestBase.createAsyncEventQueue("ln", true, 100, 100, false, false, null, false));
  ...
  protected SerializableRunnableIF createAsyncEventQueueRunnable() {
    return () -> AsyncEventQueueTestBase.createAsyncEventQueue("ln", false, 100, 100, false, false, null, false);
  }
  ...
  public void testConcurrentSerialAsyncEventQueueSize() {
    ...
    vm1.invoke(() -> AsyncEventQueueTestBase.createConcurrentAsyncEventQueue("ln", false, 100, 150, true, false, null, false, 2, OrderPolicy.KEY));
    vm2.invoke(() -> AsyncEventQueueTestBase.createConcurrentAsyncEventQueue("ln", false, 100, 150, true, false, null, false, 2, OrderPolicy.KEY));
  ...
  public void testReplicatedSerialAsyncEventQueueWithCacheLoader() {
    ...
    vm1.invoke(() -> AsyncEventQueueTestBase.createAsyncEventQueue("ln", false, 100, 100, false, false, null, false, "MyAsyncEventListener_CacheLoader"));
    vm2.invoke(() -> AsyncEventQueueTestBase.createAsyncEventQueue("ln", false, 100, 100, false, false, null, false, "MyAsyncEventListener_CacheLoader"));
    vm3.invoke(() -> AsyncEventQueueTestBase.createAsyncEventQueue("ln", false, 100, 100, false, false, null, false, "MyAsyncEventListener_CacheLoader"));
    vm4.invoke(() -> AsyncEventQueueTestBase.createAsyncEventQueue("ln", false, 100, 100, false, false, null, false, "MyAsyncEventListener_CacheLoader"));
  ...
  public void testReplicatedSerialAsyncEventQueue_ExceptionScenario() {
    ...
    vm1.invoke(() -> AsyncEventQueueTestBase.createAsyncEventQueueWithCustomListener("ln", false, 100, 100, false, false, null, false, 1));
    vm2.invoke(() -> AsyncEventQueueTestBase.createAsyncEventQueueWithCustomListener("ln", false, 100, 100, false, false, null, false, 1));
    vm3.invoke(() -> AsyncEventQueueTestBase.createAsyncEventQueueWithCustomListener("ln", false, 100, 100, false, false, null, false, 1));
    vm4.invoke(() -> AsyncEventQueueTestBase.createAsyncEventQueueWithCustomListener("ln", false, 100, 100, false, false, null, false, 1));
  ...
  public void testReplicatedSerialAsyncEventQueueWithConflationEnabled() {
    ...
    vm2.invoke(() -> AsyncEventQueueTestBase.createAsyncEventQueue("ln", false, 100, 100, true, false, null, false));
    vm3.invoke(() -> AsyncEventQueueTestBase.createAsyncEventQueue("ln", false, 100, 100, true, false, null, false));
    vm4.invoke(() -> AsyncEventQueueTestBase.createAsyncEventQueue("ln", false, 100, 100, true, false, null, false));
  ...
  public void testReplicatedSerialAsyncEventQueueWithPeristenceEnabled_Restart() {
    ...
    String firstDStore = (String) vm1.invoke(() -> AsyncEventQueueTestBase.createAsyncEventQueueWithDiskStore("ln", false, 100, 100, true, null));
  ...
  public void testReplicatedSerialAsyncEventQueueWithPeristenceEnabled_Restart2() {
    ...
    // -----------------------------------------------------------------------------------
    vm2.invoke(() -> AsyncEventQueueTestBase.waitForSenderToBecomePrimary(AsyncEventQueueImpl.getSenderIdFromAsyncEventQueueId("ln")));
    ...
    assertTrue("Total number of entries in events map on vm1 and vm2 should be at least 2000", (vm1size + vm2size) >= 2000);
  }
  ...
  public void testConcurrentSerialAsyncEventQueueWithReplicatedRegion() {
    ...
    vm1.invoke(() -> AsyncEventQueueTestBase.createConcurrentAsyncEventQueue("ln", false, 100, 100, true, false, null, false, 3, OrderPolicy.KEY));
    vm2.invoke(() -> AsyncEventQueueTestBase.createConcurrentAsyncEventQueue("ln", false, 100, 100, true, false, null, false, 3, OrderPolicy.KEY));
    vm3.invoke(() -> AsyncEventQueueTestBase.createConcurrentAsyncEventQueue("ln", false, 100, 100, true, false, null, false, 3, OrderPolicy.KEY));
    vm4.invoke(() -> AsyncEventQueueTestBase.createConcurrentAsyncEventQueue("ln", false, 100, 100, true, false, null, false, 3, OrderPolicy.KEY));
  ...
  public void testConcurrentSerialAsyncEventQueueWithReplicatedRegion_2() {
    ...
    vm1.invoke(() -> AsyncEventQueueTestBase.createConcurrentAsyncEventQueue("ln", false, 100, 100, true, false, null, false, 3, OrderPolicy.THREAD));
    vm2.invoke(() -> AsyncEventQueueTestBase.createConcurrentAsyncEventQueue("ln", false, 100, 100, true, false, null, false, 3, OrderPolicy.THREAD));
    vm3.invoke(() -> AsyncEventQueueTestBase.createConcurrentAsyncEventQueue("ln", false, 100, 100, true, false, null, false, 3, OrderPolicy.THREAD));
    vm4.invoke(() -> AsyncEventQueueTestBase.createConcurrentAsyncEventQueue("ln", false, 100, 100, true, false, null, false, 3, OrderPolicy.THREAD));
    ...
    vm1.invokeAsync(() -> AsyncEventQueueTestBase.doNextPuts(getTestMethodName() + "_RR", 500, 1000));
  ...
  public void testConcurrentSerialAsyncEventQueueWithoutOrderPolicy() {
    ...
    vm1.invoke(() -> AsyncEventQueueTestBase.createConcurrentAsyncEventQueue("ln", false, 100, 100, true, false, null, false, 3, null));
    vm2.invoke(() -> AsyncEventQueueTestBase.createConcurrentAsyncEventQueue("ln", false, 100, 100, true, false, null, false, 3, null));
    vm3.invoke(() -> AsyncEventQueueTestBase.createConcurrentAsyncEventQueue("ln", false, 100, 100, true, false, null, false, 3, null));
    vm4.invoke(() -> AsyncEventQueueTestBase.createConcurrentAsyncEventQueue("ln", false, 100, 100, true, false, null, false, 3, null));
  ...
  public void testPartitionedSerialAsyncEventQueueWithConflationEnabled() {
    ...
    vm1.invoke(() -> AsyncEventQueueTestBase.putGivenKeyValue(getTestMethodName() + "_PR", keyValues));
    ...
    // Put the update events and check the queue size.
    // There should be no conflation with the previous create events.
    vm2.invoke(() -> AsyncEventQueueTestBase.putGivenKeyValue(getTestMethodName() + "_PR", updateKeyValues));

    vm2.invoke(() -> AsyncEventQueueTestBase.checkAsyncEventQueueSize("ln", keyValues.size() + updateKeyValues.size()));
  ...
  public void testPartitionedSerialAsyncEventQueueWithPeristenceEnabled() {
    ...
    vm1.invoke(() -> AsyncEventQueueTestBase.createAsyncEventQueue("ln", false, 100, 100, false, true, null, false));
    vm2.invoke(() -> AsyncEventQueueTestBase.createAsyncEventQueue("ln", false, 100, 100, false, true, null, false));
    vm3.invoke(() -> AsyncEventQueueTestBase.createAsyncEventQueue("ln", false, 100, 100, false, true, null, false));
    vm4.invoke(() -> AsyncEventQueueTestBase.createAsyncEventQueue("ln", false, 100, 100, false, true, null, false));
  ...
  public void testParallelAsyncEventQueueWithReplicatedRegion() {
    try {
      ...
      vm1.invoke(() -> AsyncEventQueueTestBase.createAsyncEventQueue("ln", true, 100, 100, true, false, null, false));
      vm2.invoke(() -> AsyncEventQueueTestBase.createAsyncEventQueue("ln", true, 100, 100, true, false, null, false));
      vm3.invoke(() -> AsyncEventQueueTestBase.createAsyncEventQueue("ln", true, 100, 100, true, false, null, false));
      vm4.invoke(() -> AsyncEventQueueTestBase.createAsyncEventQueue("ln", true, 100, 100, true, false, null, false));
  ...
  public void testParallelAsyncEventQueue() {
    ...
    vm1.invoke(() -> AsyncEventQueueTestBase.createAsyncEventQueue("ln", true, 100, 100, false, false, null, false));
    vm2.invoke(() -> AsyncEventQueueTestBase.createAsyncEventQueue("ln", true, 100, 100, false, false, null, false));
    vm3.invoke(() -> AsyncEventQueueTestBase.createAsyncEventQueue("ln", true, 100, 100, false, false, null, false));
    vm4.invoke(() -> AsyncEventQueueTestBase.createAsyncEventQueue("ln", true, 100, 100, false, false, null, false));
  ...
  public void testParallelAsyncEventQueueWithSubstitutionFilter() {
    ...
    vm1.invoke(() -> AsyncEventQueueTestBase.createAsyncEventQueue("ln", true, 100, 100, false, false, null, false, "MyAsyncEventListener", "MyGatewayEventSubstitutionFilter"));
  ...
  public void testParallelAsyncEventQueueWithSubstitutionFilterNoSubstituteValueToDataInvocations() {
    ...
    vm1.invoke(() -> AsyncEventQueueTestBase.createAsyncEventQueue("ln", true, 100, 100, false, false, null, false, "MyAsyncEventListener", "SizeableGatewayEventSubstitutionFilter"));
  ...
  public void testParallelAsyncEventQueueWithCacheLoader() {
    ...
    vm1.invoke(() -> AsyncEventQueueTestBase.createAsyncEventQueue("ln", true, 100, 100, false, false, null, false, "MyAsyncEventListener_CacheLoader"));
    vm2.invoke(() -> AsyncEventQueueTestBase.createAsyncEventQueue("ln", true, 100, 100, false, false, null, false, "MyAsyncEventListener_CacheLoader"));
    vm3.invoke(() -> AsyncEventQueueTestBase.createAsyncEventQueue("ln", true, 100, 100, false, false, null, false, "MyAsyncEventListener_CacheLoader"));
    vm4.invoke(() -> AsyncEventQueueTestBase.createAsyncEventQueue("ln", true, 100, 100, false, false, null, false, "MyAsyncEventListener_CacheLoader"));
  ...
  public void testConcurrentParallelAsyncEventQueueSize() {
    ...
    vm1.invoke(() -> AsyncEventQueueTestBase.createConcurrentAsyncEventQueue("ln", true, 100, 100, false, false, null, false, 2, OrderPolicy.KEY));
    vm2.invoke(() -> AsyncEventQueueTestBase.createConcurrentAsyncEventQueue("ln", true, 100, 100, false, false, null, false, 2, OrderPolicy.KEY));
    vm3.invoke(() -> AsyncEventQueueTestBase.createConcurrentAsyncEventQueue("ln", true, 100, 100, false, false, null, false, 2, OrderPolicy.KEY));
    vm4.invoke(() -> AsyncEventQueueTestBase.createConcurrentAsyncEventQueue("ln", true, 100, 100, false, false, null, false, 2, OrderPolicy.KEY));
  ...
  public void testParallelAsyncEventQueueWithConflationEnabled() {
    ...
    vm1.invoke(() -> AsyncEventQueueTestBase.putGivenKeyValue(getTestMethodName() + "_PR", updateKeyValues));

    vm1.invoke(() -> AsyncEventQueueTestBase.waitForAsyncEventQueueSize("ln", keyValues.size() + updateKeyValues.size())); // no conflation of creates

    vm1.invoke(() -> AsyncEventQueueTestBase.putGivenKeyValue(getTestMethodName() + "_PR", updateKeyValues));

    vm1.invoke(() -> AsyncEventQueueTestBase.waitForAsyncEventQueueSize("ln", keyValues.size() + updateKeyValues.size())); // conflation of updates
  ...
  public void testParallelAsyncEventQueueWithOneAccessor() {
    ...
    vm1.invoke(() -> AsyncEventQueueTestBase.createPartitionedRegionAccessorWithAsyncEventQueue(getTestMethodName() + "_PR", "ln"));
    vm2.invoke(() -> AsyncEventQueueTestBase.createPartitionedRegionWithAsyncEventQueue(getTestMethodName() + "_PR", "ln", isOffHeap()));
    vm3.invoke(() -> AsyncEventQueueTestBase.createPartitionedRegionWithAsyncEventQueue(getTestMethodName() + "_PR", "ln", isOffHeap()));
    vm4.invoke(() -> AsyncEventQueueTestBase.createPartitionedRegionWithAsyncEventQueue(getTestMethodName() + "_PR", "ln", isOffHeap()));
  ...
  public void testParallelAsyncEventQueueWithPersistence() {
    ...
    vm1.invoke(() -> AsyncEventQueueTestBase.createAsyncEventQueue("ln", true, 100, 100, false, true, null, false));
    vm2.invoke(() -> AsyncEventQueueTestBase.createAsyncEventQueue("ln", true, 100, 100, false, true, null, false));
    vm3.invoke(() -> AsyncEventQueueTestBase.createAsyncEventQueue("ln", true, 100, 100, false, true, null, false));
    vm4.invoke(() -> AsyncEventQueueTestBase.createAsyncEventQueue("ln", true, 100, 100, false, true, null, false));
  ...
  public void testParallelAsyncEventQueueHA_Scenario1() {
    ...
    vm1.invoke(() -> AsyncEventQueueTestBase.verifyAsyncEventListenerForPossibleDuplicates("ln", primaryBucketsvm2, 5));
  }
  ...
  public void testParallelAsyncEventQueueHA_Scenario2() {
    ...
    vm3.invoke(() -> AsyncEventQueueTestBase.verifyAsyncEventListenerForPossibleDuplicates("ln", primaryBucketsvm3, 5));
  }
  ...
  public void testParallelAsyncEventQueueAttachedToChildRegionButNotToParentRegion() {
    ...
    vm3.invoke(() -> AsyncEventQueueTestBase.createColocatedPartitionedRegionWithAsyncEventQueue(getTestMethodName() + "CHILD_PR", "ln", 100, parentRegionFullPath));
