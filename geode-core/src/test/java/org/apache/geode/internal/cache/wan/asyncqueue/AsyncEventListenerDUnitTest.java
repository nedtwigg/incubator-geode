...
public class AsyncEventListenerDUnitTest extends AsyncEventQueueTestBase {
    ...
    vm1.invoke(
        () ->
            AsyncEventQueueTestBase.createAsyncEventQueue(
                "ln", false, 100, 150, true, true, "testDS", true));

    vm1.invoke(
        () ->
            AsyncEventQueueTestBase.validateAsyncEventQueueAttributes(
                "ln",
                100,
                150,
  ...
  public void testParallelAsyncEventQueueWithFixedPartition() {
    ...
    vm1.invoke(
        () ->
            AsyncEventQueueTestBase.createFixedPartitionedRegionWithAsyncEventQueue(
  ...
  public void testConcurrentSerialAsyncEventQueueSize() {
    ...
    vm1.invoke(
        () ->
            AsyncEventQueueTestBase.createConcurrentAsyncEventQueue(
                "ln", false, 100, 150, true, false, null, false, 2, OrderPolicy.KEY));
    vm2.invoke(
        () ->
            AsyncEventQueueTestBase.createConcurrentAsyncEventQueue(
                "ln", false, 100, 150, true, false, null, false, 2, OrderPolicy.KEY));
   ...
   * Test configuration::
   *
   * <p>Region: Replicated WAN: Serial Region persistence enabled: false Async channel persistence
   * enabled: false
   */
  @Test
  ...
  public void testReplicatedSerialAsyncEventQueueWithCacheLoader() {
    ...
    vm1.invoke(
        () ->
            AsyncEventQueueTestBase.validateAsyncEventForOperationDetail(
                "ln", 10, true, false)); // primary sender
    vm2.invoke(
        () ->
            AsyncEventQueueTestBase.validateAsyncEventForOperationDetail(
                "ln", 0, true, false)); // secondary
    vm3.invoke(
        () ->
            AsyncEventQueueTestBase.validateAsyncEventForOperationDetail(
                "ln", 0, true, false)); // secondary
   ...
   * Test configuration::
   *
   * <p>Region: Replicated WAN: Serial Region persistence enabled: false Async queue persistence
   * enabled: false
   *
   * <p>Error is thrown from AsyncEventListener implementation while processing the batch. Added to
  ...
  public void testReplicatedSerialAsyncEventQueue_ExceptionScenario() {
    ...
    vm1.invoke(
        () ->
            AsyncEventQueueTestBase.createAsyncEventQueueWithCustomListener(
                "ln", false, 100, 100, false, false, null, false, 1));
    vm2.invoke(
        () ->
            AsyncEventQueueTestBase.createAsyncEventQueueWithCustomListener(
                "ln", false, 100, 100, false, false, null, false, 1));
    ...
    vm1.invoke(
        () ->
            AsyncEventQueueTestBase.validateCustomAsyncEventListener("ln", 100)); // primary sender
    vm2.invoke(
        () -> AsyncEventQueueTestBase.validateCustomAsyncEventListener("ln", 0)); // secondary
    vm3.invoke(
        () -> AsyncEventQueueTestBase.validateCustomAsyncEventListener("ln", 0)); // secondary
    vm4.invoke(
        () -> AsyncEventQueueTestBase.validateCustomAsyncEventListener("ln", 0)); // secondary
   ...
   * Test configuration::
   *
   * <p>Region: Replicated WAN: Serial Region persistence enabled: false Async event queue
   * persistence enabled: false
   *
   * <p>Note: The test doesn't create a locator but uses MCAST port instead.
   */
   ...
   * enabled: true
   *
   * <p>There is only one vm in the site and that vm is restarted
   */
  ...
  public void testReplicatedSerialAsyncEventQueueWithPeristenceEnabled_Restart() {
    ...
    String firstDStore =
        (String)
            vm1.invoke(
                () ->
                    AsyncEventQueueTestBase.createAsyncEventQueueWithDiskStore(
                        "ln", false, 100, 100, true, null));
    ...
    vm1.invoke(
        () ->
            AsyncEventQueueTestBase.createAsyncEventQueueWithDiskStore(
                "ln", false, 100, 100, true, firstDStore));
    vm1.invoke(createReplicatedRegionRunnable());
    // -----------------------------------------------------------------------------------
   ...
   * enabled: true
   *
   * <p>There are 3 VMs in the site and the VM with primary sender is shut down.
   */
  @Ignore("TODO: Disabled for 52351")
  @Test
  public void testReplicatedSerialAsyncEventQueueWithPeristenceEnabled_Restart2() {
    ...
    vm2.invoke(
        () ->
            AsyncEventQueueTestBase.waitForSenderToBecomePrimary(
                AsyncEventQueueImpl.getSenderIdFromAsyncEventQueueId("ln")));
   ...
   * Test configuration::
   *
   * <p>Region: Replicated WAN: Serial Dispatcher threads: more than 1 Order policy: key based
   * ordering
   */
  @Test
  public void testConcurrentSerialAsyncEventQueueWithReplicatedRegion() {
    ...
    vm1.invoke(
        () ->
            AsyncEventQueueTestBase.createConcurrentAsyncEventQueue(
                "ln", false, 100, 100, true, false, null, false, 3, OrderPolicy.KEY));
    vm2.invoke(
        () ->
            AsyncEventQueueTestBase.createConcurrentAsyncEventQueue(
                "ln", false, 100, 100, true, false, null, false, 3, OrderPolicy.KEY));
  ...
  public void testConcurrentSerialAsyncEventQueueWithReplicatedRegion_2() {
    ...
    vm1.invoke(
        () ->
            AsyncEventQueueTestBase.createConcurrentAsyncEventQueue(
                "ln", false, 100, 100, true, false, null, false, 3, OrderPolicy.THREAD));
    vm2.invoke(
        () ->
            AsyncEventQueueTestBase.createConcurrentAsyncEventQueue(
                "ln", false, 100, 100, true, false, null, false, 3, OrderPolicy.THREAD));
  ...
  public void testConcurrentSerialAsyncEventQueueWithoutOrderPolicy() {
    ...
    vm1.invoke(
        () ->
            AsyncEventQueueTestBase.createConcurrentAsyncEventQueue(
                "ln", false, 100, 100, true, false, null, false, 3, null));
    vm2.invoke(
        () ->
            AsyncEventQueueTestBase.createConcurrentAsyncEventQueue(
                "ln", false, 100, 100, true, false, null, false, 3, null));
   ...
   * Test configuration::
   *
   * <p>Region: Partitioned WAN: Serial Region persistence enabled: false Async channel persistence
   * enabled: false
   */
  @Test
  ...
  public void testPartitionedSerialAsyncEventQueueWithConflationEnabled() {
    ...
    vm2.invoke(
        () ->
            AsyncEventQueueTestBase.putGivenKeyValue(getTestMethodName() + "_PR", updateKeyValues));
  ...
  public void testPartitionedSerialAsyncEventQueueWithPeristenceEnabled() {
    ...
    vm1.invoke(
        () ->
            AsyncEventQueueTestBase.createAsyncEventQueue(
                "ln", false, 100, 100, false, true, null, false));
    vm2.invoke(
        () ->
            AsyncEventQueueTestBase.createAsyncEventQueue(
                "ln", false, 100, 100, false, true, null, false));
  ...
  @Test
  public void
      testParallelAsyncEventQueueWithSubstitutionFilterNoSubstituteValueToDataInvocations() {
    Integer lnPort =
        (Integer) vm0.invoke(() -> AsyncEventQueueTestBase.createFirstLocatorWithDSId(1));
    ...
    vm1.invoke(
        () ->
            AsyncEventQueueTestBase.createAsyncEventQueue(
                ...
                false,
                "MyAsyncEventListener",
                "SizeableGatewayEventSubstitutionFilter"));
  ...
  public void testParallelAsyncEventQueueWithCacheLoader() {
    ...
    vm1.invoke(
        () ->
            AsyncEventQueueTestBase.createPartitionedRegionWithCacheLoaderAndAsyncQueue(
  ...
  public void testConcurrentParallelAsyncEventQueueSize() {
    ...
    vm1.invoke(
        () ->
            AsyncEventQueueTestBase.createConcurrentAsyncEventQueue(
                "ln", true, 100, 100, false, false, null, false, 2, OrderPolicy.KEY));
    vm2.invoke(
        () ->
            AsyncEventQueueTestBase.createConcurrentAsyncEventQueue(
                "ln", true, 100, 100, false, false, null, false, 2, OrderPolicy.KEY));
  ...
  public void testParallelAsyncEventQueueWithConflationEnabled() {
    ...
    vm1.invoke(
        () ->
            AsyncEventQueueTestBase.waitForAsyncEventQueueSize(
  ...
  public void testParallelAsyncEventQueueWithPersistence() {
    ...
    vm1.invoke(
        () ->
            AsyncEventQueueTestBase.createAsyncEventQueue(
                "ln", true, 100, 100, false, true, null, false));
    vm2.invoke(
        () ->
            AsyncEventQueueTestBase.createAsyncEventQueue(
                "ln", true, 100, 100, false, true, null, false));
  ...
  public void testParallelAsyncEventQueueHA_Scenario1() {
    ...
    vm1.invoke(
        () ->
            AsyncEventQueueTestBase.createAsyncEventQueueWithListener2(
                "ln", true, 100, 5, false, null));
    vm2.invoke(
        () ->
            AsyncEventQueueTestBase.createAsyncEventQueueWithListener2(
                "ln", true, 100, 5, false, null));
    ...
    Set<Integer> primaryBucketsvm2 =
        (Set<Integer>)
            vm2.invoke(
                () ->
                    AsyncEventQueueTestBase.getAllPrimaryBucketsOnTheNode(
  ...
  public void testParallelAsyncEventQueueAttachedToChildRegionButNotToParentRegion() {
    ...
    vm3.invoke(
        () ->
            AsyncEventQueueTestBase.createAsyncEventQueue(
                "ln", true, 100, 10, false, false, null, true));

    // create leader (parent) PR on node
    vm3.invoke(
        () ->
            AsyncEventQueueTestBase.createPartitionedRegion(
                getTestMethodName() + "PARENT_PR", null, 0, 100));
    String parentRegionFullPath =
        (String)
            vm3.invoke(
                () -> AsyncEventQueueTestBase.getRegionFullPath(getTestMethodName() + "PARENT_PR"));
    ...
    vm1.invoke(
        () ->
            AsyncEventQueueTestBase.createAsyncEventQueue(
                ...
                null,
                false,
                new BucketMovingAsyncEventListener(member2)));
    ...
    vm2.invoke(
        () ->
            AsyncEventQueueTestBase.createAsyncEventQueue(
                ...
                null,
                false,
                new BucketMovingAsyncEventListener(member1)));
