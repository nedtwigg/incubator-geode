...
public class ValueMonitorIntegrationTest {
  ...
  public void testAddRemoveListener() throws Exception {
    ...
    StatisticsManager mockStatisticsManager =
        this.mockContext.mock(
            StatisticsManager.class, testName.getMethodName() + "$StatisticsManager");
    this.mockContext.checking(
        new Expectations() {
          {
    ...
    StatisticsSampler mockStatisticsSampler =
        this.mockContext.mock(
            StatisticsSampler.class, testName.getMethodName() + "$StatisticsSampler");
    this.mockContext.checking(
        new Expectations() {
          {
    ...
    StatisticsListener listener =
        (final StatisticsNotification notification) -> {
  ...
  public void testValueMonitorListener() throws Exception {
    ...
    StatisticDescriptor[] statsST1 =
        new StatisticDescriptor[] {
          manager.createDoubleCounter(
              "double_counter_1", "double_counter_1_desc", "double_counter_1_units"),
  ...
  private StatisticId createStatisticId(
