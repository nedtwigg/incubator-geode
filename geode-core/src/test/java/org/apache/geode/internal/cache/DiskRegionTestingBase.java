...
public abstract class DiskRegionTestingBase {
  ...
  protected void closeDown() {
    try {
      ...
      this.logWriter.error(
          "DiskRegionTestingBase::closeDown:Exception in destroyiong the region", e);
    }
  }
  ...
  protected void compareVersionTags(
      HashMap<String, VersionTag> map1, HashMap<String, VersionTag> map2) {
