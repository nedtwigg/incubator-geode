                  ...
                  public void run() {
                    ...
                    synchronized (re) {
                      ...
                      try {
                        ...
                        testFailed = true;
                        failureCause =
                            "Exception occured when it was not supposed to occur, Exception is "
                                + e
                          ...
                          new Runnable() {
                            public void run() {
                              ...
                              try {
                                val_on_disk =
                                    (byte[])
                                        ((LocalRegion) region).getValueOnDisk("key" + (num + 1));
                                assertTrue(
                                ...
                                throw new AssertionError(
                                    " Test failed as could not obtain value from disk.Exception = ",
                                    e);
                              }
                            }
                          });
