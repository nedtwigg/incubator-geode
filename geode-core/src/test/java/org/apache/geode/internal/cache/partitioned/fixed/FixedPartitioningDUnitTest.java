...
public class FixedPartitioningDUnitTest extends FixedPartitioningTestBase {
      ...
      member1.invoke(
          () ->
              FixedPartitioningTestBase.createRegionWithPartitionAttributes(
                  "Quarter", fpaList, 0, 40, 3, new QuarterPartitionResolver(), null, false));
  ...
  public void testFixedPartitionAttributes_Accessor() {
    try {
      ...
      member1.invoke(
          () ->
              FixedPartitioningTestBase.createRegionWithPartitionAttributes(
                  "Quarter", fpaList, 0, 0, 3, new QuarterPartitionResolver(), null, false));
      fail("IllegalStateException Expected");
    } catch (Exception illegal) {
      if (!((illegal.getCause() instanceof IllegalStateException)
  ...
  public void testSamePartitionName_Primary_OnTwoMembers() {
    ...
    try {
      ...
      member1.invoke(
          () ->
              FixedPartitioningTestBase.createRegionWithPartitionAttributes(
                  "Quarter", fpaList, 0, 40, 9, new QuarterPartitionResolver(), null, false));
  ...
  public void testSamePartitionName_DifferentNumBuckets() {
    ...
    try {
      ...
      member1.invoke(
          () ->
              FixedPartitioningTestBase.createRegionWithPartitionAttributes(
                  "Quarter", fpaList, 1, 40, 9, new QuarterPartitionResolver(), null, false));
  ...
  public void testNumberOfPartitions() {
    ...
    try {
      ...
      member1.invoke(
          () ->
              FixedPartitioningTestBase.createRegionWithPartitionAttributes(
                  "Quarter", null, 1, 0, 9, new QuarterPartitionResolver(), null, false));
  ...
  public void testNumBuckets_totalNumBuckets() {
    ...
    try {
      ...
      member1.invoke(
          () ->
              FixedPartitioningTestBase.createRegionWithPartitionAttributes(
                  "Quarter", null, 1, 0, 5, new QuarterPartitionResolver(), null, false));
      ...
      member2.invoke(
          () ->
              FixedPartitioningTestBase.createRegionWithPartitionAttributes(
                  "Quarter", fpaList, 1, 40, 5, new QuarterPartitionResolver(), null, false));
  ...
  public void testPut_PartitionNotAvailableException() {
    try {
      ...
      member1.invoke(
          () ->
              FixedPartitioningTestBase.createRegionWithPartitionAttributes(
                  "Quarter", null, 1, 0, 12, new QuarterPartitionResolver(), null, false));
      ...
      member2.invoke(
          () ->
              FixedPartitioningTestBase.createRegionWithPartitionAttributes(
                  "Quarter", fpaList, 1, 40, 12, new QuarterPartitionResolver(), null, false));
  ...
  public void test_DataStoreWithoutPartition_DataStoreWithPartition() {
    ...
    try {
      ...
      member1.invoke(
          () ->
              FixedPartitioningTestBase.createRegionWithPartitionAttributes(
                  "Quarter", null, 1, 40, 12, new QuarterPartitionResolver(), null, false));
  ...
  public void testPut_ValidateDataOnMember_OnlyPrimary_Accessor() {
    ...
    member1.invoke(
        () ->
            FixedPartitioningTestBase.createRegionWithPartitionAttributes(
                "Quarter", null, 0, 0, 12, new QuarterPartitionResolver(), null, false));
    ...
    member2.invoke(
        () ->
            FixedPartitioningTestBase.createRegionWithPartitionAttributes(
                "Quarter", fpaList, 0, 40, 12, new QuarterPartitionResolver(), null, false));
  ...
  @Category(
      FlakyTest
          .class) // GEODE-567: async actions, waitForCriterion, time sensitive, non-thread-safe test hook, eats exceptions (partially fixed)
  @Test
  ...
  public void testPut_NoResolver() {
    ...
    member1.invoke(
        () ->
            FixedPartitioningTestBase.createRegionWithPartitionAttributes(
                "Quarter", fpaList, 0, 40, 12, null, null, false));
  ...
  public void testPut_WithResolver_NoFPAs() {
    ...
    member1.invoke(
        () ->
            FixedPartitioningTestBase.createRegionWithPartitionAttributes(
                "Quarter", null, 0, 40, 12, new QuarterPartitionResolver(), null, false));
  ...
  public void testPut_FixedPartitionResolver_NoResolver() {
    ...
    try {
      member1.invoke(
          () ->
              FixedPartitioningTestBase.putThroughDataStore_FixedPartitionResolver_NoResolver(
                  "Quarter"));
      fail("IllegalStateException expected");
    } catch (Exception ex) {
      if (!((ex.getCause() instanceof IllegalStateException))) {
  ...
  public void testPut_ValidateDataOnMember_PrimarySecondary_Accessor() {
    createCacheOnMember();
    createRegionWithPartitionAttributes(
        "Quarter", null, 3, 0, 12, new QuarterPartitionResolver(), null, false);
    ...
    member1.invoke(
        () ->
            FixedPartitioningTestBase.createRegionWithPartitionAttributes(
                "Quarter", fpaList, 3, 40, 12, new QuarterPartitionResolver(), null, false));
   ...
   *
   * <p>Primary Secondary Member1 = Q1(0,1,2) Q3(3,4,5), Q4(6,7,8) Member2 = Q2(9,10,11), Q4(6,7,8)
   * Q3(3,4,5) Member3 = Q3(3,4,5) Q1(0,1,2), Q2(9,10,11)
   *
   * <p>Put happens considering Member2 is holding primary for Q4.
   *
   * <p>Member4 comes again, then Memeber4 should do the GII from member2 for buckets 6,7,8 and
   * should acqiure primary status Member1 = Q1(0,1,2) Q3(3,4,5), Q4(6,7,8) Member2 = Q2(9,10,11)
   ...
   *
   * <p>Primary Secondary Member1 = Q1(0,1,2) Q2(3,4,5) Member2 = Q2(3,4,5) Q3(6,7,8) Member3 =
   * Q3(6,7,8), Q4(9,10,11)
   *
   * <p>Put happens considering Member3 is holding primary for Q4.
   *
   * <p>Member4 comes again, then Memeber4 should do the GII from member2 for buckets 6,7,8 and
   * should acqiure primary status Datastores Primary Secondary Member1 = Q1(0,1,2) Q2(3,4,5)
   * Member2 = Q2(3,4,5) Q3(6,7,8) Member3 = Q3(6,7,8) Q4(9,10,11) Member4 = Q4(9,10,11) Q1(0,1,2)
   */
  @Test
   ...
   * Q3(6,7,8)
   *
   * <p>Put happens for all buckets
   *
   * <p>Member 3 goes down, then either member1 or member2 holds primary for member4
   *
   * <p>Primary Secondary Member1 = Q1(0,1,2),Q2(3,4,5) Q3(6,7,8), Q4(9,10,11) Member2 =
   * Q3(6,7,8),Q4(9,10,11) Q1(0,1,2), Q2(3,4,5)
   *
   * <p>Member 3 comes again then it should be same as it was before member 3 went down
   *
   * <p>Member1 = Q1(0,1,2) Q2(3,4,5),Q3(6,7,8),Q4(9,10,11) Member2 = Q3(6,7,8) Q1(0,1,2),
  ...
  public void testPut_ValidateDataOnMember_MultiplePrimaries_Datastore_CacheClosed() {
    ...
    member1.invoke(
        () ->
            FixedPartitioningTestBase.createRegionWithPartitionAttributes(
                "Quarter", fpaList, 2, 40, 12, new QuarterPartitionResolver(), null, false));
