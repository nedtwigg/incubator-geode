...
public class BlobHelperWithThreadContextClassLoaderTest {
  ...
  public void tcclLoadsSerializableImpl() throws Exception {
    Class loadedClass =
        Class.forName(
            CLASS_NAME_SERIALIZABLE_IMPL, true, Thread.currentThread().getContextClassLoader());
  ...
  public void tcclLoadsSerializableImplWithValue() throws Exception {
    Class loadedClass =
        Class.forName(
            CLASS_NAME_SERIALIZABLE_IMPL_WITH_VALUE,
            true,
    ...
    private Class<?> generateSerializableImplWithValue() throws ClassNotFoundException {
      ...
      MethodGen ctorMethod =
          new MethodGen(
              ...
              new String[] {"arg0"},
              "<init>",
              "org.apache.geode.internal.util.bcel.SerializableImplWithValue",
              ctor,
              cp);
      ...
      ctor.append(
          fac.createFieldAccess(
              CLASS_NAME_SERIALIZABLE_IMPL_WITH_VALUE, "value", Type.OBJECT, Constants.PUTFIELD));
      ...
      InstructionHandle getter_ih_1 =
          getter.append(
              fac.createGetField(
                  cg.getClassName(), field.getName(), Type.getType(field.getSignature())));
