...
public class PdxSerializableJUnitTest {
  ...
  public void testPdxPersistentKeysDefDS() throws Exception {
    ...
    try {
      ...
      this.c =
          (GemFireCacheImpl)
              new CacheFactory().set(MCAST_PORT, "0").setPdxPersistent(true).create();
      this.c.createDiskStoreFactory().create("r2DS");
      r1 =
          this.c
              .createRegionFactory(RegionShortcut.LOCAL_PERSISTENT)
  ...
  public void testByteFormatForSimpleClass() throws Exception {
    ...
    assertTrue(
        "Mismatch in length, actual.length: "
            + actual.length
            + " and expected length: "
            + expected.length,
  ...
  public void testByteFormatForStrings() throws Exception {
    ...
    Byte[] expected =
        new Byte[] {
          ...
          (byte) (length >> 16),
          (byte) (length >> 8),
          (byte) length, // int - length of byte stream
          (byte) (typeId >> 24),
          (byte) (typeId >> 16),
          (byte) (typeId >> 8),
          (byte) typeId, // int - typeId
          ...
          (byte) (myLong >> 16),
          (byte) (myLong >> 8),
          (byte) myLong, // long - myLong
          (byte) (myInt >> 24),
          (byte) (myInt >> 16),
          (byte) (myInt >> 8),
          (byte) myInt, // int - myInt
          (byte) (floatBytes >> 24),
          (byte) (floatBytes >> 16),
          (byte) (floatBytes >> 8),
    ...
    for (int i = (str1Bytes.length - 1); i >= 0; i--) {
      expected =
          (Byte[])
              ArrayUtils.insert(
                  expected, offset1 + PdxWriterImpl.HEADER_SIZE, str1Bytes[i]); // + 5 for: 1 for
    ...
    try {
      ...
      assertEquals(
          ByteSourceFactory.wrap(new byte[] {(byte) (pdx.isMyFlag() ? 1 : 0)}), reader.getRaw(0));
      assertEquals(
          ByteSourceFactory.wrap(
              new byte[] {(byte) (pdx.getMyShort() >> 8), (byte) pdx.getMyShort()}),
          reader.getRaw(1));
      assertEquals(ByteSourceFactory.wrap(str1Bytes), reader.getRaw(2));
      assertEquals(
          ByteSourceFactory.wrap(
              new byte[] {
                (byte) (pdx.getMyLong() >> 56),
                (byte) (pdx.getMyLong() >> 48),
                (byte) (pdx.getMyLong() >> 40),
                (byte) (pdx.getMyLong() >> 32),
                (byte) (pdx.getMyLong() >> 24),
                (byte) (pdx.getMyLong() >> 16),
                (byte) (pdx.getMyLong() >> 8),
                (byte) pdx.getMyLong(),
              }),
          reader.getRaw(3));
      ...
      assertEquals(
          ByteSourceFactory.wrap(
              new byte[] {
                (byte) (pdx.getMyInt() >> 24),
                (byte) (pdx.getMyInt() >> 16),
                (byte) (pdx.getMyInt() >> 8),
                (byte) pdx.getMyInt()
              }),
          reader.getRaw(6));
  ...
  public void testByteFormatForLongStrings() throws Exception {
    ...
    int length =
        1 /* myFlag */
            ...
            + str2Bytes.length
            + str3Bytes.length
            + (2 * 2) /* short offset for 3 strings */;
  ...
  public static class BasicAllFieldTypes implements PdxSerializerObject {
    ...
    public String toString() {
      return getClass().getName()
          ...
          + this.aCollection
          + ", aBooleanArray="
          + Arrays.toString(this.aBooleanArray)
          + ", aCharArray="
          + Arrays.toString(this.aCharArray)
          + ", aByteArray="
          + Arrays.toString(this.aByteArray)
          + ", aShortArray="
          + Arrays.toString(this.aShortArray)
          + ", anIntArray="
          + Arrays.toString(this.anIntArray)
          + ", aLongArray="
          + Arrays.toString(this.aLongArray)
          + ", aFloatArray="
          + Arrays.toString(this.aFloatArray)
          + ", aDoubleArray="
          + Arrays.toString(this.aDoubleArray)
          + ", aStringArray="
          + Arrays.toString(this.aStringArray)
          + ", anObjectArray="
          + Arrays.toString(this.anObjectArray)
          + ", anArrayOfByteArray="
