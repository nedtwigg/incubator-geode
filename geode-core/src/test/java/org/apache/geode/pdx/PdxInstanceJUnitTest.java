...
public class PdxInstanceJUnitTest {
  ...
  public void setUp() {
    // make it a loner
    this.c = (GemFireCacheImpl) new CacheFactory().set(MCAST_PORT, "0").set(DISTRIBUTED_SYSTEM_ID, "255").setPdxReadSerialized(true).create();
  }
  ...
  private PdxSerializable getSeparateClassLoadedPdx(boolean field1First) throws ClassNotFoundException, NoSuchMethodException, InstantiationException, IllegalAccessException, InvocationTargetException {
