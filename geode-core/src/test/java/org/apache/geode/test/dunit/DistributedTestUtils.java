 ...
 *
 * <p>These methods can be used directly: <code>DistributedTestUtils.crashDistributedSystem(...)
 * </code>, however, they are intended to be referenced through static import:
 *
 * <pre>
...
public class DistributedTestUtils {
  ...
  public static void addHydraProperties(final Properties properties) {
    ...
    for (Iterator<Map.Entry<Object, Object>> iter = dsProperties.entrySet().iterator();
        iter.hasNext();
        ) {
   ...
   *
   * <p>NOTE: if you use this method be sure that you clean up the VM before the end of your test
   * with disconnectFromDS() or disconnectAllFromDS().
   */
  ...
  public static final Properties getAllDistributedSystemProperties(final Properties properties) {
    Properties dsProperties = DUnitEnv.get().getDistributedSystemProperties();
    ...
    for (Iterator<Map.Entry<Object, Object>> iterator = properties.entrySet().iterator();
        iterator.hasNext();
        ) {
