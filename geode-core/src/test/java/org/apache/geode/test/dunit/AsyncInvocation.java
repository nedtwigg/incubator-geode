...
public class AsyncInvocation<V> implements Future<V> {
  ...
  /**
   * Throws {@code AssertionError} wrapping any {@code Exception} thrown by this {@code
   * AsyncInvocation}.
   *
  ...
  public AsyncInvocation<V> checkException() {
    if (this.resultThrowable.get() != null) {
      throw new AssertionError(
          "An exception occurred during asynchronous invocation.", getException());
    }
    return this;
  }
   ...
   *     fails to complete within the default timeout of 60 seconds as defined by {@link
   *     #DEFAULT_JOIN_MILLIS}.
  ...
  /**
   * Waits at most {@code millis} milliseconds plus {@code nanos} nanoseconds for this {@code
  ...
  /**
   * Waits for this thread to die up to a default of 60 seconds as defined by {@link
   * #DEFAULT_JOIN_MILLIS}.
   *
   * @return this {@code AsyncInvocation}
   * @throws InterruptedException if the current thread is interrupted.
  ...
  /**
   * Waits if necessary for the work to complete, and then returns the result of this {@code
   * AsyncInvocation}.
   *
   * @return the result of this {@code AsyncInvocation}
   * @throws AssertionError wrapping any {@code Exception} thrown by this {@code AsyncInvocation}.
  ...
  /**
   * Throws {@code AssertionError} wrapping a {@code TimeoutException} if this {@code
   * AsyncInvocation} fails to complete within the default timeout of 60 seconds as defined by
  ...
  /**
   * Returns the name of a {@code AsyncInvocation} based on its {@code targetObject} and {@code
   * methodName}.
   */
