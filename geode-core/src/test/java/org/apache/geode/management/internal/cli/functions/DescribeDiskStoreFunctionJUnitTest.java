...
public class DescribeDiskStoreFunctionJUnitTest {
  ...
  private void assertAsyncEventQueueDetails(
    ...
    for (final DiskStoreDetails.AsyncEventQueueDetails actualAsyncEventQueueDetails :
        diskStoreDetails.iterateAsyncEventQueues()) {
      final DiskStoreDetails.AsyncEventQueueDetails expectedAsyncEventQueueDetails =
          CollectionUtils.findBy(
              expectedAsyncEventQueueDetailsSet,
              new Filter<DiskStoreDetails.AsyncEventQueueDetails>() {
                ...
                public boolean accept(
                  ...
                  return ObjectUtils.equals(
                      asyncEventQueueDetails.getId(), actualAsyncEventQueueDetails.getId());
                }
              });
  ...
  private void assertGatewayDetails(
    ...
    for (final DiskStoreDetails.GatewayDetails actualGatewayDetails :
        diskStoreDetails.iterateGateways()) {
      DiskStoreDetails.GatewayDetails expectedGatewayDetails =
          CollectionUtils.findBy(
              expectedGatewayDetailsSet,
  ...
  private void assertRegionDetails(
    ...
    for (final DiskStoreDetails.RegionDetails actualRegionDetails :
        diskStoreDetails.iterateRegions()) {
      final DiskStoreDetails.RegionDetails expectedRegionDetails =
          CollectionUtils.findBy(
              expectedRegionDetailsSet,
              new Filter<DiskStoreDetails.RegionDetails>() {
                public boolean accept(final DiskStoreDetails.RegionDetails regionDetails) {
                  return ObjectUtils.equals(
                      regionDetails.getFullPath(), actualRegionDetails.getFullPath());
                }
              });
      ...
      assertEquals(
          expectedRegionDetails.isOverflowToDisk(), actualRegionDetails.isOverflowToDisk());
  ...
  private DiskStoreDetails.CacheServerDetails createCacheServerDetails(
      final String bindAddress, final int port, final String hostname) {
    final DiskStoreDetails.CacheServerDetails cacheServerDetails =
  ...
  private DiskStoreDetails.GatewayDetails createGatewayDetails(
      final String id, final boolean persistent) {
  ...
  private DiskStore createMockDiskStore(
      final UUID diskStoreId,
      final String name,
  ...
  private DiskStoreDetails.RegionDetails createRegionDetails(
      final String fullPath, final String name, final boolean persistent, final boolean overflow) {
  ...
  private Set<DiskStoreDetails.RegionDetails> setupRegionsForTestExecute(
    ...
    return CollectionUtils.asSet(
        createRegionDetails("/UserRegion", "UserRegion", true, false),
            ...
            will(
                returnValue(
                    CollectionUtils.asSet(
                        mockAsyncEventQueue1, mockAsyncEventQueue2, mockAsyncEventQueue3)));
  ...
  public void testExecute() throws Throwable {
    ...
    final DiskStore mockDiskStore =
        createMockDiskStore(
            ...
            10240,
            createFileArray(
                "/export/disk/backup", "/export/disk/overflow", "/export/disk/persistence"),
  ...
  private void doTestExecuteWithDiskDirsAndDiskSizesMismatch() throws Throwable {
    ...
    final DiskStore mockDiskStore =
        createMockDiskStore(
            ...
            300l,
            8192,
            createFileArray("/export/disk0/gemfire/backup"),
            new int[0],
            50,
            75);
  ...
  public void testSetRegionDetails() {
        ...
        new Expectations() {
          {
            ...
            will(
                returnValue(
                    CollectionUtils.asSet(
                        mockCompanyRegion, mockPartnersRegion, mockCustomersRegion)));
    ...
    final Set<DiskStoreDetails.RegionDetails> expectedRegionDetails =
        CollectionUtils.asSet(
            ...
            createRegionDetails(
                "/CompanyRegion/EmployeeRegion/RolesRegion", "RolesRegion", true, false),
            createRegionDetails(
                "/CompanyRegion/ContractorsRegion", "ContractorsRegion", false, true));
  ...
  public void testGetCacheServerDiskStoreNameWhenUnspecified() {
    ...
    assertEquals(
        DiskStoreDetails.DEFAULT_DISK_STORE_NAME, function.getDiskStoreName(mockCacheServer));
  }
  ...
  public void testGetGatewaySenderDiskStoreNameWhenUnspecified() {
    ...
    assertEquals(
        DiskStoreDetails.DEFAULT_DISK_STORE_NAME, function.getDiskStoreName(mockGatewaySender));
  }
