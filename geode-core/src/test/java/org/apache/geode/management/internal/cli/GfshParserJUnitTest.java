...
public class GfshParserJUnitTest {
  ...
  public void setUp() throws Exception {
    methodCommand1 =
        Commands.class
            .getMethod(
                "command1", String.class, String.class, String.class, String.class, String.class);
    methodTestParamConcat =
        Commands.class
            .getMethod(
                "testParamConcat",
                String.class,
  ...
  /**
   * Tests the auto-completion capability of {@link GfshParser} with the method {@link
   * GfshParser#complete(String, int, List)}
   */
  @Test
  ...
  private void clearAndSimpleComplete(
  ...
  /**
   * Tests the auto-completion capability of {@link GfshParser} with the method {@link
   * GfshParser#completeAdvanced(String, int, List)}
   */
  @Test
  public void testCompleteAdvanced() throws Exception {
    ...
    completionValues.add(
        new Completion(
            " " + SyntaxConstants.LONG_OPTION_SPECIFIER + OPTION2_NAME, OPTION2_NAME, null, 0));
    completionValues.add(
        new Completion(
            " " + SyntaxConstants.LONG_OPTION_SPECIFIER + OPTION3_NAME, OPTION3_NAME, null, 0));
    assertAdvancedCompletionValues(completionValues, completionCandidates);
  ...
  private void clearAndAdvancedComplete(
  ...
  private void assertAdvancedCompletionValues(List<Completion> expected, List<Completion> actual) {
    ...
    for (int i = 0; i < expected.size(); i++) {
      ...
      if (expected.get(i).getFormattedValue() != null) {
        assertEquals(
            "Check completion formatted value no."
                + i
                + ". Expected("
                + expected.get(i).getFormattedValue()
                + ") & Actual("
   ...
   *
   * <p>Does not include testing for multiple values as this change is still pending in spring-shell
   */
  @Test
  public void testParse() throws Exception {
    ...
    try {
      ...
      assertNotNull(
          "Expecting a "
              ...
              + " for an invalid command name: "
              + input,
          expectedException);
      assertEquals(
          "CommandProcessingException type doesn't match. "
              + "Actual("
    ...
    try {
      ...
      assertNotNull(
          "Expecting a "
              + CommandProcessingException.class
              + " for an invalid/incomplete command name: "
              + input,
          expectedException);
      assertEquals(
  ...
  public void testDefaultAvailabilityMessage() throws Exception {
    checkAvailabilityMessage(
        ...
        AvailabilityCommands.C2_NAME,
        AvailabilityCommands.C2_MSG_UNAVAILABLE,
        AvailabilityCommands.C2_PROP);
  }
  ...
  public void testCustomAvailabilityMessage() throws Exception {
    checkAvailabilityMessage(
        new AvailabilityCommands(),
        AvailabilityCommands.C1_NAME,
        AvailabilityCommands.C1_MSG_UNAVAILABLE,
        AvailabilityCommands.C1_PROP);
  }

  public void checkAvailabilityMessage(
      CommandMarker availabilityCommands,
      String commandString,
      String unavailableMessage,
      String availabiltyBooleanProp)
      throws Exception {
  ...
  static class Commands implements CommandMarker {
    ...
    public static String command1(
        @CliArgument(
              name = ARGUMENT1_NAME,
              argumentContext = ARGUMENT1_CONTEXT,
              help = ARGUMENT1_HELP,
              mandatory = true
            )
            String argument1,
        @CliArgument(
              name = ARGUMENT2_NAME,
              argumentContext = ARGUMENT2_CONTEXT,
              help = ARGUMENT2_HELP,
              mandatory = false,
            ...
            String argument2,
        @CliOption(
              key = {OPTION1_NAME, OPTION1_SYNONYM},
              help = OPTION1_HELP,
              mandatory = true,
        ...
        @CliOption(
              ...
              specifiedDefaultValue = OPTION2_SPECIFIED_DEFAULT_VALUE
            )
            String option2,
        @CliOption(
              key = {OPTION3_NAME, OPTION3_SYNONYM},
              help = OPTION3_HELP,
              mandatory = false,
