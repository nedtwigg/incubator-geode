...
public class CommandManagerJUnitTest {
      ...
      for (Annotation ann : annotation) {
        if (ann instanceof CliOption) {
          ...
          if (((CliOption) ann).specifiedDefaultValue() != null
            ...
            assertEquals(
                ((CliOption) ann).specifiedDefaultValue().trim(),
  ...
  public static class Commands implements CommandMarker {
    ...
    @CliMetaData(
      shellOnly = true,
      relatedTopic = {"relatedTopicOfCommand1"}
    )
    ...
    public static String command1(
        ...
        @CliOption(
              ...
              specifiedDefaultValue = OPTION1_SPECIFIED_DEFAULT_VALUE
            )
            String option1,
        @CliOption(
              key = {OPTION2_NAME},
        ...
        @CliOption(
              ...
              specifiedDefaultValue = OPTION3_SPECIFIED_DEFAULT_VALUE
            )
            String option3) {
      return null;
    }
