...
public class SharedConfigurationCommandsDUnitTest extends CliCommandTestBase {
  ...
  public void testExportImportSharedConfiguration() throws IOException {
                ...
                new SerializableCallable() {
                  ...
                  public Object call() {
                    ...
                    locatorProps.setProperty(
                        JMX_MANAGER_BIND_ADDRESS, String.valueOf(locator1JmxHost));
    ...
    commandStringBuilder.addOption(
        ALTER_RUNTIME_CONFIG__STATISTIC__ARCHIVE__FILE, this.startArchiveFileName);
        ...
        new SerializableRunnable() {
          ...
          public void run() {
            ...
            try {
              ...
              assertTrue(
                  clusterConfig.getGemfireProperties().getProperty(LOG_LEVEL).equals(logLevel));
              assertTrue(
                  clusterConfig
                      .getGemfireProperties()
                      .getProperty(STATISTIC_ARCHIVE_FILE)
