...
public class CacheElementJUnitTest {
  ...
  public void testCacheDefinedAsNestedComplexType8_1() throws Exception {
    ...
    final Node cacheType =
        XmlUtils.querySingleElement(
            doc.getFirstChild(), CacheElement.CACHE_TYPE_EMBEDDED, xPathContext);
    ...
    final Document doc =
        XmlUtils.createDocumentFromReader(
            new InputStreamReader(
                this.getClass().getResourceAsStream("CacheElementJUnitTest.xml")));
  ...
  private void assertEntry(
      final String expectedName, final int expectedOrder, final Entry<String, CacheElement> entry) {
