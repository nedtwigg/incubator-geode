...
public class AbstractCommandsSupportJUnitTest {
  ...
  public void testConvertDefaultValue() {
    ...
    assertEquals(
        "tested",
        AbstractCommandsSupport.convertDefaultValue(
            CliMetaData.ANNOTATION_DEFAULT_VALUE, "tested"));
  }
  ...
  public void testGetMemberThrowsMemberNotFoundException() {
    ...
    try {
      ...
      assertEquals(
          CliStrings.format(CliStrings.MEMBER_NOT_FOUND_ERROR_MESSAGE, "zero"),
          expected.getMessage());
      throw expected;
    }
  }
