 ...
 *
 * <p>Introduced for GEODE-213 "JMX -http manager treats "start gateway-sender" as "start
 * gateway-receiver"
 */
...
public class WanCommandsControllerJUnitTest {
  ...
  public void shouldDefineStartGatewayReceiverCommandWithGroupsAndMembers(
      ...
      final boolean containsGroups,
      final boolean containsMembers) {
   ...
   *
   * <p>This test verifies that the class under test allows null value which would only be rejected
   * at runtime by the overall framework and is tested within an integration test.
   *
   * <p>see WanCommandGatewaySenderStartDUnitTest
   */
  @Test
   ...
   *
   * <p>This test verifies that the class under test allows empty value which would only be rejected
   * at runtime by the overall framework and is tested within an integration test.
   *
   * <p>see WanCommandGatewaySenderStartDUnitTest
   */
