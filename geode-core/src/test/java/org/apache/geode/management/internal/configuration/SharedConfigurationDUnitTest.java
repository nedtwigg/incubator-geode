...
/**
 * Tests the starting up of shared configuration, installation of {@link
          ...
          public Object call() {
            ...
            try {
              final InternalLocator locator =
                  (InternalLocator)
                      Locator.startLocatorAndDS(locator1Port, locatorLogFile, null, locatorProps);
    ...
    locator2Vm.invoke(
        new SerializableCallable() {
          ...
          public Object call() throws IOException {
            ...
            final InternalLocator locator =
                (InternalLocator)
                    Locator.startLocatorAndDS(locator2Port, locatorLogFile, null, locatorProps);
    ...
    dataMemberVm.invoke(
        new SerializableCallable() {
          ...
          public Object call() {
            ...
            assertTrue(
                scw.modifyPropertiesAndCacheAttributes(clusterProperties, cacheEntity, null));

            clusterProperties.setProperty(LOG_LEVEL, groupLogLevel);
            assertTrue(
                scw.modifyPropertiesAndCacheAttributes(
                    clusterProperties, cacheEntity, new String[] {testGroup}));
        ...
        new SerializableCallable() {
          ...
          public Object call() throws Exception {
            ...
            Configuration clusterConfig =
                entireConfiguration.get(SharedConfiguration.CLUSTER_CONFIG);
    ...
    dataMemberVm.invoke(
        new SerializableCallable() {
          ...
          public Object call() throws IOException, ClassNotFoundException {
            ...
            scw.deleteXmlEntity(
                new XmlEntity(CacheXml.REGION, "name", REGION1), new String[] {testGroup});
            ...
            ConfigurationResponse configResponse =
                (ConfigurationResponse)
                    new TcpClient()
                        .requestToServer(
                            InetAddress.getByName("localhost"), locator2Port, configRequest, 1000);
