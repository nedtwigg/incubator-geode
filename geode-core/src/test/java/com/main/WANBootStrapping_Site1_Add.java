 ...
 *
 * <p>On this member a locator with distributed-system-id = 1 is created. On this member a cache is
 * created.
 *
 * <p>A Region and a GatewaySender is created on this member through
 ...
 *
 * <p>This member does put for 100 keys on the region. (We have to check that this data for 100
 * entries are sent to remote site)
 *
 * <p>This member also check for the sender's running status.
 *
 * <p>A GatewaySender will be stopped through MyDistributedSustemListener#removedDistributedSystem
