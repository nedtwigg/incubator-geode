 ...
 * {@link PdxInstance#createWriter()} to create subsequent instances. Using {@link
 * PdxInstance#createWriter()} is usually faster.
 *
 * @since GemFire 6.6.2
 */
public interface PdxInstanceFactory {
   ...
   * @since GemFire 6.6.2
   */
  public PdxInstanceFactory writeObjectArray(
      String fieldName, Object[] value, boolean checkPortability);
   ...
   * @throws PdxSerializationException if serialization of the field fails.
   */
  public <CT, VT extends CT> PdxInstanceFactory writeField(
   ...
   * checks.
   *
   * <p>The identity fields should make marked after they are written using a write* method.
   *
