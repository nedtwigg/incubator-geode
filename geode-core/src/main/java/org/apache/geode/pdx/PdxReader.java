...
/**
 * A PdxReader will be passed to {@link PdxSerializable#fromData(PdxReader) fromData} or {@link
 * PdxSerializer#fromData(Class, PdxReader) PdxSerializer fromData} by GemFire during
 ...
 *
 * <p>The methods on this interface are not thread safe so do not call them concurrently, on the
 * same instance, from more than one thread.
 *
 * @since GemFire 6.6
 */
public interface PdxReader {
   ...
   * @param fieldName the name of the field to read
   * @return the value of the field if the field exists; otherwise a default value
   * @throws PdxFieldTypeMismatchException if the named field exists and is not a <code>boolean
   *     </code> field.
   * @throws PdxSerializationException if deserialization of the field fails.
   */
   ...
   * @param fieldName the name of the field to read
   * @return the value of the field if the field exists; otherwise a default value
   * @throws PdxFieldTypeMismatchException if the named field exists and is not a <code>double
   *     </code> field.
   * @throws PdxSerializationException if deserialization of the field fails.
   */
   ...
   * @param fieldName the name of the field to read
   * @return the value of the field if the field exists; otherwise a default value
   * @throws PdxFieldTypeMismatchException if the named field exists and is not a <code>String
   *     </code> field.
   * @throws PdxSerializationException if deserialization of the field fails.
   */
   ...
   * @return the value of the field if the field exists; otherwise a default value
   * @throws PdxSerializationException if deserialization of the field fails.
   * @throws PdxFieldTypeMismatchException if the named field exists and is not an <code>Object
   *     </code> field.
   */
   ...
   * @return the value of the field if the field exists; otherwise a default value
   * @throws PdxSerializationException if deserialization of the field fails.
   * @throws PdxFieldTypeMismatchException if the named field exists and is not a <code>char[]
   *     </code> field.
   */
   ...
   * @return the value of the field if the field exists; otherwise a default value
   * @throws PdxSerializationException if deserialization of the field fails.
   * @throws PdxFieldTypeMismatchException if the named field exists and is not a <code>byte[]
   *     </code> field.
   */
   ...
   * @return the value of the field if the field exists; otherwise a default value
   * @throws PdxSerializationException if deserialization of the field fails.
   * @throws PdxFieldTypeMismatchException if the named field exists and is not a <code>short[]
   *     </code> field.
   */
   ...
   * @return the value of the field if the field exists; otherwise a default value
   * @throws PdxSerializationException if deserialization of the field fails.
   * @throws PdxFieldTypeMismatchException if the named field exists and is not a <code>long[]
   *     </code> field.
   */
   ...
   * @return the value of the field if the field exists; otherwise a default value
   * @throws PdxSerializationException if deserialization of the field fails.
   * @throws PdxFieldTypeMismatchException if the named field exists and is not a <code>float[]
   *     </code> field.
   */
   ...
   * @return the value of the field if the field exists; otherwise a default value
   * @throws PdxSerializationException if deserialization of the field fails.
   * @throws PdxFieldTypeMismatchException if the named field exists and is not a <code>Object[]
   *     </code> field.
   */
   ...
   *
   * <p>Note that if {@link org.apache.geode.cache.CacheFactory#setPdxIgnoreUnreadFields(boolean)
   * setPdxIgnoreUnreadFields} or {@link
   * org.apache.geode.cache.client.ClientCacheFactory#setPdxIgnoreUnreadFields(boolean) client
   * setPdxIgnoreUnreadFields} are set to <code>true</code> then this method will always return an
   * object that has no unread fields.
   *
