 ...
 *
 * <p>It can also be caused by a field name being spelled one way when written and a different way
 * when read. Field names are case sensitive.
 *
 * <p>It can also be caused by {@link PdxWriter#writeUnreadFields(PdxUnreadFields)
 * writeUnreadFields} being called after a field is written.
 *
 * @since GemFire 6.6
 */
