 ...
 *
 * <p>A <code>StatisticsTypeFactory</code> can create a {@link StatisticDescriptor statistic} of
 * three numeric types: <code>int</code>, <code>long</code>, and <code>double</code>. A statistic (
 ...
 *
 * <p>The following code is an example of how to create a type using XML. In this example the type
 ...
 * </pre>
 *
 * <p>The following is an example of how to create the same type using XML. The XML data:
 *
 * <pre>
...
public interface StatisticsTypeFactory {
  ...
  /**
   * Creates and returns an int counter {@link StatisticDescriptor} with the given <code>name</code>
   * , <code>description</code>, <code>units</code>, and with larger values indicating better
   * performance.
   */
  public StatisticDescriptor createIntCounter(String name, String description, String units);

  /**
   * Creates and returns a long counter {@link StatisticDescriptor} with the given <code>name</code>
   * , <code>description</code>, <code>units</code>, and with larger values indicating better
   * performance.
   */
  ...
  /**
   * Creates and returns a double counter {@link StatisticDescriptor} with the given <code>name
   * </code>, <code>description</code>, <code>units</code>, and with larger values indicating better
   * performance.
   */
  ...
  /**
   * Creates and returns a double gauge {@link StatisticDescriptor} with the given <code>name</code>
   * , <code>description</code>, <code>units</code>, and with smaller values indicating better
   * performance.
   */
  ...
  /**
   * Creates and returns a double counter {@link StatisticDescriptor} with the given <code>name
   * </code>, <code>description</code>, <code>largerBetter</code>, and <code>units</code>.
   */
  ...
  /**
   * Creates or finds and returns a {@link StatisticsType} with the given <code>name</code>, <code>
   * description</code>, and {@link StatisticDescriptor statistic descriptions}.
   *
   ...
   *
   * @param reader The source of the XML data which must comply with the <code>statisticsType.dtd
   *     </code>.
