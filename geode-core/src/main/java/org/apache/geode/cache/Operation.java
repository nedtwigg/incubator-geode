...
public final class Operation implements java.io.Serializable {
   ...
   *
   * <p>If this operation is for a Partitioned Region, then true will be returned if the loader ran
   * in the same VM as where the data is hosted. If true is returned, and {@link
  ...
  public boolean isSearchOrLoad() {
    return (this.opDetails & (OP_DETAILS_SEARCH | OP_DETAILS_LOCAL_LOAD | OP_DETAILS_NET_LOAD))
        != 0;
  }
