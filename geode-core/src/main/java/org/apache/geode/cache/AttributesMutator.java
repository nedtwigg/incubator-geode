 ...
 *
 * <p>The setter methods all return the previous value of the attribute.
 *
...
public interface AttributesMutator<K, V> {
  ...
  /**
   * Changes the CacheListener for the region. Removes listeners already added and calls {@link
   ...
   * specified listener has not been added. If the specified listener has been added then {@link
   * CacheCallback#close} will be called on it; otherwise does nothing.
   *
   ...
   *
   * <p>Changing the cache loader for partitioned regions is not recommended due to the fact that it
