 ...
 * or more generically to peers in a {@link DistributedSystem} or servers in a {@link Pool}.
 *
 * @since GemFire 6.0
 */
public class FunctionService {
   ...
   */
  public static Execution onMembers(
   ...
   *
   * <p>If one of the members goes down while dispatching or executing the function on the member,
   * an Exception will be thrown.
   *
   ...
   *     execute the function. Function will be executed on all members of each group
   * @return Execution
   ...
   *
   * @param groups list of GemFire configuration property "groups" (see <a
   *     href="../../distributed/DistributedSystem.html#groups"><code>groups</code></a>) on which to
   *     execute the function. Function will be executed on one member of each group
   * @return Execution
   * @throws FunctionException if no members are found belonging to the provided groups
   * @since GemFire 7.0
   */
