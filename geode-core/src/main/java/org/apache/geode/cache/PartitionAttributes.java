 ...
 * for the discovery of Partitioned Region attributes using {@link
 * org.apache.geode.cache.RegionAttributes#getPartitionAttributes()} as well as the configuration of
 * a Partitioned Region using {@link
 * org.apache.geode.cache.AttributesFactory#setPartitionAttributes(PartitionAttributes)}.
 *
 * <p>PartitionAttributes are created using the {@link
 * org.apache.geode.cache.PartitionAttributesFactory}
 *
 * <p>The default PartitionAttributes can be determined using {@link
 * org.apache.geode.cache.PartitionAttributesFactory#create()} with out calling any of its mutator
 * methods e.g. {@link org.apache.geode.cache.PartitionAttributesFactory#setLocalMaxMemory(int)}
 *
 * <p>Also see {@link org.apache.geode.cache.DataPolicy#PARTITION}.
 *
 * @since GemFire 5.0
 */
