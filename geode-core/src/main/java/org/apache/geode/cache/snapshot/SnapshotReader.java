...
public class SnapshotReader {
   ...
   *
   * <p>Prior to invoking <code>read</code> all necessary serializers (either {@link DataSerializer}
   * or {@link PdxSerializer}) and any {@link Instantiator} should have been registered.
   *
