 ...
 * <p><b>Configuration: </b>
 *
 * <p>The <code>client queue</code> is configurable declaratively or programmatically. Declarative
 * configuration is achieved through defining the configuration parameters in a <code>cache.xml
 * </code> file. Programmatic configuration may be achieved by first instantiating a <code>
 * CacheServer</code> object and get {@link CacheServer#getClientSubscriptionConfig} <code>
 * ClientSubscriptionConfig</code> object and modify each desired parameter and value.
 *
 * <p>
 *
 * <p>If you are using a <code>cache.xml</code> file to create a <code>CacheServer</code>
