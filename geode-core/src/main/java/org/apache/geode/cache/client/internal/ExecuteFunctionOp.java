...
public class ExecuteFunctionOp {
  ...
  public static void execute(
    ...
    if (allServers && groups.length == 0) {
      ...
      if (function.isHA()) maxRetryAttempts = pool.getRetryAttempts();
  ...
  public static void reexecute(
    ...
    do {
      ...
      AbstractOp reExecuteOp =
          new ExecuteFunctionOpImpl(
              function,
              serverExecutor.getArguments(),
              serverExecutor.getMemberMappedArgument(),
              hasResult,
              resultCollector,
              isFnSerializationReqd,
              (byte) 1,
