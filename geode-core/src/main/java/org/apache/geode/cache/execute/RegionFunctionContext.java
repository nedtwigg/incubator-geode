 ...
 *
 * <p>Applications can use the methods provided to retrieve the Region and context specific routing
 * objects. When the function is executed using {@link FunctionService#onRegion(Region)}, the {@link
 * Function#execute(FunctionContext) FunctionContext} can be typecast to this type.
 *
 * <p>If the region is a partitioned region, {@link PartitionRegionHelper} can be used to get local
 * and {@linkplain PartitionAttributesFactory#setColocatedWith(String) colocated} data references.
 *
 * @since GemFire 6.0
 * @see FunctionContext
