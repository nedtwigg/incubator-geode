...
/**
 * Allows data from outside of the VM to be placed into a region. When {@link
 * org.apache.geode.cache.Region#get(Object)} is called for a region entry that has a <code>null
 * </code> value, the {@link CacheLoader#load load} method of the region's cache loader is invoked.
 * The <code>load</code> method creates the value for the desired key by performing an operation
 * such as a database query. The <code>load</code> may also perform a {@linkplain
 * LoaderHelper#netSearch net search} that will look for the value in a cache instance hosted by
...
public interface CacheLoader<K, V> extends CacheCallback {
   ...
   *     <code>null</code> causes {@link Region#get(Object, Object)} to return <code>null</code>.
