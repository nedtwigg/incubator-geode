...
public class PutOperationContext extends KeyValueOperationContext {
   ...
   * @since GemFire 6.5
   */
  public PutOperationContext(
      Object key, Object value, boolean isObject, byte opType, boolean isPostOperation) {
   ...
   *
   * <p>The user should check against {@link PutOperationContext#CREATE}, {@link
   * PutOperationContext#UPDATE}, {@link PutOperationContext#UNKNOWN}. For the {@link
   * PutOperationContext#UNKNOWN} case, the authorization callback should explicitly invoke {@link
   * Region#containsKey} to determine if it is create or update when required.
   *
   * @return one of {@link PutOperationContext#CREATE}, {@link PutOperationContext#UPDATE}, {@link
   *     PutOperationContext#UNKNOWN}
   */
