...
/**
 * Defines attributes for configuring a region. These are <code>EvictionAttributes</code>, <code>
 * CacheListener</code>, <code>CacheLoader</code>, <code>CacheWriter</code>, scope, data policy, and
 * expiration attributes for the region itself, expiration attributes for the region entries, and
 * whether statistics are enabled for the region and its entries.
 *
 * <p>To create an instance of this interface use {@link AttributesFactory#createRegionAttributes}.
 *
 * <p>For compatibility rules and default values, see {@link AttributesFactory}.
 *
...
public interface RegionAttributes<K, V> {
   ...
   *
   * <p>This attribute does not indicate whether or not this member is currently lock grantor. It
   * only indicates that at the time of region creation, this member should attempt to become lock
   ...
   * clients.
   *
   * <p>Note: This parameter is only valid for cache server to client communication. It has no
  ...
  /**
   * Returns the name of the {@link DiskStore} that this region belongs to, if any. Returns <code>
   * null</code> if this region belongs to default {@link DiskStore}.
   *
   ...
   *
   * <p>When this is enabled, concurrent updates will be conflated if they are applied out of order.
   *
   * <p>All members must set this attribute the same.
   *
   * <p>Default is set to true.
   *
   * @since GemFire 7.0
