...
/**
 * Represents the results of a CQ query that is executed using {@linkplain
 * org.apache.geode.cache.query.CqQuery#executeWithInitialResults()} The result will contain the
 * instances of {@link Struct} having key and value of the region entry that satisfy the CQ query
 * condition.
 *
 * <pre>
 * ClientCache cache = ...
