...
public enum ClientRegionShortcut {
   ...
   * contain the server result. The actual RegionAttributes for a CACHING_PROXY set the {@link
   * DataPolicy} to {@link DataPolicy#NORMAL}.
   */
  CACHING_PROXY,
   ...
   * CACHING_PROXY_OVERFLOW set the {@link DataPolicy} to {@link DataPolicy#NORMAL}. and {@link
   * EvictionAttributes} are set to {@link EvictionAlgorithm#LRU_HEAP} with {@link
   ...
   * {@link DataPolicy#NORMAL} and {@link EvictionAttributes} are set to {@link
