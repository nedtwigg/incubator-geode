...
public class CompiledUndefined extends AbstractCompiledValue implements Negatable, Indexable {
   ...
   *
   * <p>param intermediateResults if this parameter is provided, and we have to iterate, then
   * iterate over this result set instead of the entire base collection.
   */
  @Override
  public SelectResults filterEvaluate(ExecutionContext context, SelectResults iterationLimit)
    ...
    return filterEvaluate(
        context,
        iterationLimit,
        true /* Complete Expansion needed */,
        null,
        null,
        true,
        isConditioningNeededForIndex(null, context, true),
        false);
  }
  ...
  public void generateCanonicalizedExpression(StringBuffer clauseBuffer, ExecutionContext context)
    ...
    if (_is_defined) clauseBuffer.insert(0, "IS_DEFINED(");
    else clauseBuffer.insert(0, "IS_UNDEFINED(");
  }
