 ...
 *     <p>Enumerated type for types of {@linkplain Index indexes}
 * @since GemFire 4.0
 */
public class IndexType {
   ...
   *
   * <p>The indexedExpression for a functional index can be any Comparable or any of the following
   * primitive types:<br>
   ...
   *
   * <p>The indexedExpression for a hash index can be any Comparable or any of the following
   * primitive types:<br>
   * <code>long int short byte char float double</code>
   *
   * @see QueryService#createIndex(String, IndexType, String, String)
   ...
   *
   * <p>The type of the indexedExpression for a primary key index can be any object type. Just as in
   * a Region, the lookup is based on the implementation of the <code>equals</code> and <code>
   * hashCode</code> methods in the object.
   *
   * @see QueryService#createIndex(String, IndexType, String, String)
   */
