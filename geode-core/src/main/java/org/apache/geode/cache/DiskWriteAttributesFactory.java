...
public final class DiskWriteAttributesFactory implements java.io.Serializable {
  ...
  /**
   * Creates a new instance of DiskWriteAttributesFactory ready to create a <code>
   * DiskWriteAttributes</code> with default settings. The default <code>DiskWriteAttributes</code>
  ...
  /**
   * Creates a new instance of DiskWriteAttributesFactory Factory ready to create a <code>
   * DiskWriteAttributes</code> with the same settings as those in the specified <code>
   * DiskWriteAttributes</code>.
   *
  ...
  public DiskWriteAttributesFactory(DiskWriteAttributes dwa) {
    ...
    this.props.setProperty(
        DiskWriteAttributesImpl.SYNCHRONOUS_PROPERTY, String.valueOf(dwa.isSynchronous()));
  ...
  public void setSynchronous(boolean isSynchronous) {
    this.props.setProperty(
        DiskWriteAttributesImpl.SYNCHRONOUS_PROPERTY, String.valueOf(isSynchronous));
  }
   ...
   *
   * <p>Examples: A threshold of 100 causes any oplog that is no longer being written to to be
    ...
    if (compactionThreshold < 0) {
      throw new IllegalArgumentException(
          LocalizedStrings
              ...
              .toLocalizedString(
                  new Object[] {
                    CacheXml.COMPACTION_THRESHOLD, Integer.valueOf(compactionThreshold)
                  }));
   ...
   * will be created.
   *
   * <p>Note that this method sets the same attribute as {@link #setMaxOplogSize}. The last set of
   * the attribute determines its value.
   *
   ...
   *
   * <p>Note that this method sets the same attribute as {@link #setMaxOplogSizeInBytes}. The last
   * set of the attribute determines its value.
   *
