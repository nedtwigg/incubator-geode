 ...
 * roles while sending the operation to them. This exception will contain one {@link
 * RegionDistributionException} for every region that had a reliability failure. Details of the
 * failed {@link MembershipAttributes#getRequiredRoles required roles} are provided in each
