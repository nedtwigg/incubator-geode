...
/**
 * Thrown to indicate an error or exceptional condition during the execution of {@linkplain
 * Function}s in GemFire. This exception can be thrown by GemFire as well as user code, in the
 * implementation of {@linkplain Function#execute(FunctionContext)}. When FunctionException is
 * thrown in an implementation of {@linkplain Function#execute(FunctionContext)}, GemFire will
