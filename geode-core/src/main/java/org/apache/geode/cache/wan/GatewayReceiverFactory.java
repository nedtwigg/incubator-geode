...
public interface GatewayReceiverFactory {
   ...
   *     automatically once created. Ideal default value should be false to match with GatewaySender
   *     counterpart. But to not to break the existing functionality default value is set to true.
   *     For next major releases, default value will be changed to false.
