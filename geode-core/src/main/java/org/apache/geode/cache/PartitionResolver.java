 ...
 *
 * <p>1. The key class can implement the PartitionResolver interface to enable custom partitioning.
 * OR <br>
 ...
 * Region Javadocs.
 *
 * <p>GemFire uses the routing object's hashCode to determine where the data is being managed. Say,
 * for example, you want to colocate all Trades by month and year.The key is implemented by TradeKey
 * class which also implements the PartitionResolver interface. public class TradeKey implements
 * PartitionResolver {<br>
