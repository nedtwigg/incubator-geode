...
class NumericComparator implements Comparator {
  ...
  public int compare(Object obj1, Object obj2) {
    ...
    if (num1 instanceof Double)
      ...
      else return ((Double) num1).compareTo(Double.valueOf(num2.doubleValue()));
    else if (num2 instanceof Double)
      return Double.valueOf(num1.doubleValue()).compareTo((Double) num2);

    if (num1 instanceof Float)
      if (num2 instanceof Float) return ((Float) num1).compareTo((Float) num2);
      else return ((Float) num1).compareTo(new Float(num2.doubleValue()));
    else if (num2 instanceof Float) return new Float(num1.doubleValue()).compareTo((Float) num2);

    if (num1 instanceof Long)
      if (num2 instanceof Long) return ((Long) num1).compareTo((Long) num2);
      else {
