 ...
 * this interface can be created using region shortcuts by calling {@link
 * ClientCache#createClientRegionFactory(ClientRegionShortcut)} or using named region attributes by
 * calling {@link ClientCache#createClientRegionFactory(String)}.
 *
 * <p>The factory can then be customized using its methods.
 *
 * <p>The final step is to produce a {@link Region} by calling {@link #create(String)}.
 *
 * <p>Client regions may be:
 *
 * <ul>
 ...
 *
 * <p>Example: Create a client region with a CacheListener
 *
 * <PRE>
