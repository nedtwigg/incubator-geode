 ...
 * #create} to produce a disk store instance.
 *
 * @since GemFire 6.5
 */
public interface DiskStoreFactory {
  ...
  public static final long DEFAULT_MAX_OPLOG_SIZE =
      Long.getLong(DistributionConfig.GEMFIRE_PREFIX + "DEFAULT_MAX_OPLOG_SIZE", 1024L)
  ...
  /**
   * Set to <code>true</code> to cause the disk files to be automatically compacted. Set to <code>
   * false</code> if no compaction is needed or manual compaction will be used.
   *
   ...
   * to disk.
   *
   * <p>For how to configure a region to be asynchronous see: {@link
   * AttributesFactory#setDiskSynchronous}.
   *
