 ...
 * Java virtual machine. Users must create either a {@link Cache} for a peer/server JVM or a {@link
 * ClientCache} for a client JVM. Instances of this interface are created using one of the following
 * methods:
 *
 * <ul>
...
public interface GemFireCache extends RegionService {
  ...
  /**
   * Returns the distributed system used by this cache. This method does not throw <code>
   * CacheClosedException</code> if the cache is closed.
   */
   ...
   * . However, changing the mapping will not effect existing regions.
   *
   * @param id The id of the region attributes
   * @param attrs The attributes to associate with <code>id</code>. If <code>attrs</code> is <code>
   *     null</code>, any existing <code>RegionAttributes</code> associated with <code>id</code>
   *     will be removed.
  ...
  /**
   * Returns an unmodifiable mapping of ids to region attributes. The keys of the map are {@link
   * String}s and the values of the map are {@link RegionAttributes}.
   *
   * @since GemFire 4.1
   */
   ...
   * href="package-summary.html#declarative">declarative caching XML file</a> into this cache. If
   ...
   *
   * <p>Because this method may perform a {@link Region#put(Object, Object) put} on a <code>Region
   * </code>, it declares that it throws a <code>TimeoutException</code>, <code>CacheWriterException
   * </code>, <code>GatewayException</code>, or <code>RegionExistsException</code>.
   *
  ...
  /**
   * Gets the logging object for GemFire. This method does not throw <code>CacheClosedException
  ...
  /**
   * Gets the security logging object for GemFire. This method does not throw <code>
   * CacheClosedException</code> if the cache is closed.
   *
