...
public interface SnapshotFilter<K, V> extends Serializable {
  /**
   * Returns true if the entry passes the filter criteria; false otherwise. Invoking <code>
   * Entry.getValue</code> may incur additional overhead to deserialize the entry value.
   *
