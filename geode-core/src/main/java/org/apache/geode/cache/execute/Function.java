 ...
 *
 * <p>Even though this interface extends Serializable, functions will only be serialized if they are
...
public interface Function extends Identifiable<String> {
   ...
   *
   * <p>If {@link Function#hasResult()} returns false, {@link ResultCollector#getResult()} throws
   * {@link FunctionException}.
   *
   * <p>If {@link Function#hasResult()} returns true, {@link ResultCollector#getResult()} blocks and
   ...
   *
   * <p>Returning false will optimize for read behavior on the targeted {@link
