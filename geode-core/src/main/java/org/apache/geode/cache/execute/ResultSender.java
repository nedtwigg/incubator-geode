...
public interface ResultSender<T> {
  /**
   * Sends a result back to the FunctionService calling thread and invokes {@link
  ...
  /**
   * Sends a result back to the FunctionService calling thread and invokes {@link
   * ResultCollector#addResult(org.apache.geode.distributed.DistributedMember, Object)} and then
   * {@link ResultCollector#endResults()} if it is the last instance of the Function to report
