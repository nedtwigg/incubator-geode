...
public class OQLParser extends org.apache.geode.cache.query.internal.parse.UtilParser implements OQLLexerTokenTypes {
  ...
  public final void queryProgram() throws RecognitionException, TokenStreamException {
    ...
    if (inputState.guessing == 0) {
      ...
      queryProgram_AST = (AST) astFactory.make((new ASTArray(2)).add((AST) astFactory.create(QUERY_PROGRAM, "queryProgram", "org.apache.geode.cache.query.internal.parse.GemFireAST")).add(queryProgram_AST));
      currentAST.root = queryProgram_AST;
      currentAST.child = queryProgram_AST != null && queryProgram_AST.getFirstChild() != null ? queryProgram_AST.getFirstChild() : queryProgram_AST;
  ...
  public final void loneFromClause() throws RecognitionException, TokenStreamException {
    ...
    if (inputState.guessing == 0) {
      ...
      loneFromClause_AST = (AST) astFactory.make((new ASTArray(2)).add((AST) astFactory.create(LITERAL_from, "from", "org.apache.geode.cache.query.internal.parse.ASTCombination")).add(loneFromClause_AST));
      currentAST.root = loneFromClause_AST;
      currentAST.child = loneFromClause_AST != null && loneFromClause_AST.getFirstChild() != null ? loneFromClause_AST.getFirstChild() : loneFromClause_AST;
      currentAST.advanceChildToEnd();
    }
    loneFromClause_AST = (AST) currentAST.root;
  ...
  public final void iteratorDef() throws RecognitionException, TokenStreamException {
    ...
    if (synPredMatched153) {
      ...
      if (inputState.guessing == 0) {
        ...
        currentAST.child = iteratorDef_AST != null && iteratorDef_AST.getFirstChild() != null ? iteratorDef_AST.getFirstChild() : iteratorDef_AST;
        currentAST.advanceChildToEnd();
      }
...

    {
      if ((_tokenSet_4.member(LA(1)))) {
        ...
        if (inputState.guessing == 0) {
          ...
          currentAST.child = projectionAttributes_AST != null && projectionAttributes_AST.getFirstChild() != null ? projectionAttributes_AST.getFirstChild() : projectionAttributes_AST;
          currentAST.advanceChildToEnd();
        }
  ...
  public final void loneImports() throws RecognitionException, TokenStreamException {
    ...
    if (inputState.guessing == 0) {
      ...
      currentAST.child = loneImports_AST != null && loneImports_AST.getFirstChild() != null ? loneImports_AST.getFirstChild() : loneImports_AST;
      currentAST.advanceChildToEnd();
    }
    loneImports_AST = (AST) currentAST.root;
  ...
  public final void queryParam() throws RecognitionException, TokenStreamException {
    ...
    if (inputState.guessing == 0) {
      ...
      currentAST.child = queryParam_AST != null && queryParam_AST.getFirstChild() != null ? queryParam_AST.getFirstChild() : queryParam_AST;
      currentAST.advanceChildToEnd();
    }
    ...
    match(LITERAL_limit);
    {
      if ((LA(1) == TOK_DOLLAR)) {
        ...
        if (inputState.guessing == 0) {
          ...
          currentAST.child = limitClause_AST != null && limitClause_AST.getFirstChild() != null ? limitClause_AST.getFirstChild() : limitClause_AST;
          currentAST.advanceChildToEnd();
        }
  ...
  public final void projection() throws RecognitionException, TokenStreamException {
    ...
    if ((LA(1) == QuotedIdentifier || LA(1) == Identifier) && (LA(2) == TOK_COLON)) {
      ...
      if (inputState.guessing == 0) {
        ...
        currentAST.child = projection_AST != null && projection_AST.getFirstChild() != null ? projection_AST.getFirstChild() : projection_AST;
        currentAST.advanceChildToEnd();
      }
  ...
  public final void aggregateExpr() throws RecognitionException, TokenStreamException {
    ...
    case LITERAL_avg: {
      ...
      if (inputState.guessing == 0) {
        ...
        currentAST.child = aggregateExpr_AST != null && aggregateExpr_AST.getFirstChild() != null ? aggregateExpr_AST.getFirstChild() : aggregateExpr_AST;
        currentAST.advanceChildToEnd();
      }
      break;
    }
  ...
  public final void hintIdentifier() throws RecognitionException, TokenStreamException {
    ...
    if (inputState.guessing == 0) {
      ...
      currentAST.child = hintIdentifier_AST != null && hintIdentifier_AST.getFirstChild() != null ? hintIdentifier_AST.getFirstChild() : hintIdentifier_AST;
      currentAST.advanceChildToEnd();
    }
    hintIdentifier_AST = (AST) currentAST.root;
  ...
  public final void sortCriterion() throws RecognitionException, TokenStreamException {
    ...
    if (inputState.guessing == 0) {
      ...
      currentAST.child = sortCriterion_AST != null && sortCriterion_AST.getFirstChild() != null ? sortCriterion_AST.getFirstChild() : sortCriterion_AST;
      currentAST.advanceChildToEnd();
    }
    {
      switch (LA(1)) {
  ...
  public final void orExpr() throws RecognitionException, TokenStreamException {
    ...
    if (inputState.guessing == 0) {
      ...
      currentAST.child = orExpr_AST != null && orExpr_AST.getFirstChild() != null ? orExpr_AST.getFirstChild() : orExpr_AST;
      currentAST.advanceChildToEnd();
    }
    orExpr_AST = (AST) currentAST.root;
  ...
  public final void orelseExpr() throws RecognitionException, TokenStreamException {
    ...
    if (inputState.guessing == 0) {
      ...
      if (cmplx) {
        orelseExpr_AST = (AST) astFactory.make((new ASTArray(2)).add(astFactory.create(LITERAL_orelse, "or")).add(orelseExpr_AST));
      }
      currentAST.root = orelseExpr_AST;
      currentAST.child = orelseExpr_AST != null && orelseExpr_AST.getFirstChild() != null ? orelseExpr_AST.getFirstChild() : orelseExpr_AST;
      currentAST.advanceChildToEnd();
    }
    orelseExpr_AST = (AST) currentAST.root;
  ...
  public final void andExpr() throws RecognitionException, TokenStreamException {
    ...
    if (inputState.guessing == 0) {
      ...
      currentAST.child = andExpr_AST != null && andExpr_AST.getFirstChild() != null ? andExpr_AST.getFirstChild() : andExpr_AST;
      currentAST.advanceChildToEnd();
    }
    andExpr_AST = (AST) currentAST.root;
  ...
  public final void andthenExpr() throws RecognitionException, TokenStreamException {
    ...
    if (inputState.guessing == 0) {
      ...
      if (cmplx) {
        andthenExpr_AST = (AST) astFactory.make((new ASTArray(2)).add(astFactory.create(LITERAL_andthen, "andthen")).add(andthenExpr_AST));
      }
      currentAST.root = andthenExpr_AST;
      currentAST.child = andthenExpr_AST != null && andthenExpr_AST.getFirstChild() != null ? andthenExpr_AST.getFirstChild() : andthenExpr_AST;
      currentAST.advanceChildToEnd();
    }
    andthenExpr_AST = (AST) currentAST.root;
  ...
  public final void postfixExpr() throws RecognitionException, TokenStreamException {
    ...
    if (inputState.guessing == 0) {
      ...
      currentAST.child = postfixExpr_AST != null && postfixExpr_AST.getFirstChild() != null ? postfixExpr_AST.getFirstChild() : postfixExpr_AST;
      currentAST.advanceChildToEnd();
    }
    postfixExpr_AST = (AST) currentAST.root;
  ...
  public final void methodInvocation(boolean implicitReceiver) throws RecognitionException, TokenStreamException {
    ...
    if (inputState.guessing == 0) {
      ...
      methodInvocation_AST = (AST) astFactory.make((new ASTArray(3)).add((AST) astFactory.create(METHOD_INV, "methodInv", "org.apache.geode.cache.query.internal.parse.ASTMethodInvocation")).add(methodName_AST).add(args_AST));
      ((ASTMethodInvocation) methodInvocation_AST).setImplicitReceiver(implicitReceiver);
      currentAST.root = methodInvocation_AST;
      currentAST.child = methodInvocation_AST != null && methodInvocation_AST.getFirstChild() != null ? methodInvocation_AST.getFirstChild() : methodInvocation_AST;
      currentAST.advanceChildToEnd();
    }
  ...
  public final void fieldList() throws RecognitionException, TokenStreamException {
    ...
    if (inputState.guessing == 0) {
      ...
      currentAST.child = fieldList_AST != null && fieldList_AST.getFirstChild() != null ? fieldList_AST.getFirstChild() : fieldList_AST;
      currentAST.advanceChildToEnd();
    }
    fieldList_AST = (AST) currentAST.root;
