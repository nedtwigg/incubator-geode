 ...
 * contains a partitioned region. The snapshot behavior can be changed using {@link
...
public interface CacheSnapshotService {
   ...
   * import error.
   *
   * <p>Prior to loading data, all regions should have been created and any necessary serializers
