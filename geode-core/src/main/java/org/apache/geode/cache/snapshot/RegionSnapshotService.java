 ...
 * region is a partitioned region. The snapshot behavior can be changed using {@link
...
public interface RegionSnapshotService<K, V> {
   ...
   *
   * <p>Prior to loading data, the region should have been created and any necessary serializers
