 ...
 *
 * <p>This interface is implemented by GemFire. To obtain an instance of it use {@link
 * FunctionService}.
 *
 * @since GemFire 6.0
 * @see FunctionService
...
public interface Execution {
   ...
   * function on.
   *
   * <p>Applicable only for regions with {@link DataPolicy#PARTITION} DataPolicy. If the filter is
   ...
   * @throws UnsupportedOperationException if not called after {@link
   ...
   * executed. Collector will receive results as they are sent from the {@link
   * Function#execute(FunctionContext)} using {@link ResultSender}.
   *
   ...
   *
   * <p>{@link Function#execute(FunctionContext)} is called on the instance retrieved using {@link
   * FunctionService#getFunction(String)} on the executing member.
   *
   ...
   *     ResultCollector provided in {@link Execution#withCollector(ResultCollector)}. User has to
   *     use this reference to retrieve results.
   * @since GemFire 6.0
   */
   ...
   *
   * <p>{@link Function#execute(FunctionContext)} is called on the de-serialized instance on the
   * executing member.
   *
   ...
   *
   * <p>{@link Function#execute(FunctionContext)} is called on the de-serialized instance on the
   * executing member. Function should be registered on the executing member using {@link
   * FunctionService#registerFunction(Function)} method before calling this method.
   *
   * <p>As of 6.6, this is deprecated, since users can pass different value for the hasResult
   * parameter that than the boolean value returned from {@link Function#hasResult()}.
   *
   * @param functionId the {@link Function#getId()} of the function
   ...
   * FunctionService#registerFunction(Function)} method before calling this method.
   *
   * <p>As of 6.6, this is deprecated, since users can pass different value for the hasResult, isHA
   * parameter that than the boolean values returned from {@link Function#hasResult()}, {@link
   * Function#isHA()}.
   *
   * @param functionId the {@link Function#getId()} of the function
   * @param hasResult Whether the function returns any result
   ...
   *
   * <p>As of 6.6, this is deprecated, since users can pass different value for the hasResult, isHA,
   * optimizeForWrite parameters that than the boolean values returned from {@link
   * Function#hasResult()}, {@link Function#isHA()}, {@link Function#optimizeForWrite()}.
   *
   * @param functionId the {@link Function#getId()} of the function
   * @param hasResult Whether the function returns any result
   * @param isHA Whether the given function is HA
  ...
  public ResultCollector<?, ?> execute(
      String functionId, boolean hasResult, boolean isHA, boolean optimizeForWrite)
      throws FunctionException;
}
