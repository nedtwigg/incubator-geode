...
public class ASTUnary extends GemFireAST {
  ...
  public void compile(QCompiler compiler) {
    if (this.getType() == OQLLexerTokenTypes.TOK_MINUS) {
      ...
      if (tokenType == OQLLexerTokenTypes.NUM_INT || tokenType == OQLLexerTokenTypes.NUM_LONG || tokenType == OQLLexerTokenTypes.NUM_FLOAT || tokenType == OQLLexerTokenTypes.NUM_DOUBLE) {
