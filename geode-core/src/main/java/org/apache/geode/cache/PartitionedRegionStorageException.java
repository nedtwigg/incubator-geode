 ...
 *
 * <p>When a <code>PartitionedRegionStorageException</code> message contains the string:
 *
 * <pre>
 ...
 *
 * <ol>
 *   <li>The amount of storage allocated to the partitioned region on that distributed member
 *       exceeds its localMaxMemory setting.
 *   <li>The partitioned region instance on that distributed member has been closed or destroyed.
 *   <li>The cache on that distributed member has been closed.
 *   <li>The distributed system on that member has been disconnected.
 * </ol>
 *
 * <p>When a <code>PartitionedRegionStorageException</code> message contains the string:
 *
