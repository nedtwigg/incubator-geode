...
/**
 * Information describing the data storage and distribution of a partitioned region. The {@link
 * PartitionRegionHelper} is used to gather <code>PartitionRegionInfo</code>. Each instance
 * describes a single partitioned region identified by {@link #getRegionPath()}.
 *
 * <p>This is an immutable snapshot of the information.
 *
 * @since GemFire 6.0
 */
public interface PartitionRegionInfo {
   ...
   * #getConfiguredRedundantCopies() configured redundant copies} for this partitioned region.
   *
  ...
  /**
   * Returns the {@link org.apache.geode.cache.Region#getFullPath() full path} of the partitioned
   * region that this region has been configured to be {@link
   * org.apache.geode.cache.PartitionAttributes#getColocatedWith() colocated with} or null if it is
   * not colocated.
   *
