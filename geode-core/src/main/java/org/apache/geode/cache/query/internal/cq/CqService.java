...
public interface CqService {
   ...
   *     in the query are not supported for the initial release.
   */
  public abstract ClientCQ newCq(
      String cqName,
      String queryString,
  ...
  public abstract void closeAllCqs(
   ...
   * @param value
   */
  public abstract void dispatchCqListeners(
