 ...
 *
 * <p>Once a <code>RegionAttributes</code> is created, it can only be modified after it has been
 * used to create a <code>Region</code>, and then only by using an {@link AttributesMutator}
 ...
 *
 * <dl>
 *   <dt>{@link CacheLoader} [<em>default:</em> <code>null</code>, meaning no loader]
 *   <dd>User-implemented plug-in for loading data on cache misses.<br>
 *       {@link #setCacheLoader} {@link RegionAttributes#getCacheLoader} {@link
 *       AttributesMutator#setCacheLoader}
 *   <dt>{@link CacheWriter} [<em>default:</em> <code>null</code>, meaning no writer]
 *   <dd>User-implemented plug-in for intercepting cache modifications, e.g. for writing to an
 *       external data source.<br>
 *       {@link #setCacheWriter} {@link RegionAttributes#getCacheWriter} {@link
 *       AttributesMutator#setCacheWriter}
 *   <dt>{@link CacheListener} [<em>default:</em> <code>null</code>, meaning no listener ]
 *   <dd>User-implemented plug-in for receiving and handling cache related events.<br>
 *       {@link #addCacheListener} {@link #initCacheListeners} {@link #initCacheListeners} {@link
 *       RegionAttributes#getCacheListeners} {@link AttributesMutator#initCacheListeners} {@link
 *       AttributesMutator#addCacheListener} {@link AttributesMutator#removeCacheListener}
 * </dl>
 *
 * <h4>Expiration</h4>
 *
 * <dl>
 *   <dt>RegionTimeToLive [<em>default:</em> no expiration]
 *   <dd>Expiration configuration for the entire region based on the {@link
 *       CacheStatistics#getLastModifiedTime lastModifiedTime}.<br>
 *       {@link #setRegionTimeToLive} {@link RegionAttributes#getRegionTimeToLive} {@link
 *       AttributesMutator#setRegionTimeToLive}
 *   <dt>RegionIdleTimeout [<em>default:</em> no expiration]
 *   <dd>Expiration configuration for the entire region based on the {@link
 *       CacheStatistics#getLastAccessedTime lastAccessedTime}.<br>
 *       {@link #setRegionIdleTimeout} {@link RegionAttributes#getRegionIdleTimeout} {@link
 *       AttributesMutator#setRegionIdleTimeout}
 *   <dt>EntryTimeToLive [<em>default:</em> no expiration]
 *   <dd>Expiration configuration for individual entries based on the {@link
 *       CacheStatistics#getLastModifiedTime lastModifiedTime}.<br>
 *       {@link #setEntryTimeToLive} {@link RegionAttributes#getEntryTimeToLive} {@link
 *       AttributesMutator#setEntryTimeToLive}
 *   <dt>EntryIdleTimeout [<em>default:</em> no expiration]
 *   <dd>Expiration configuration for individual entries based on the {@link
 *       CacheStatistics#getLastAccessedTime lastAccessedTime}.<br>
 *       {@link #setEntryIdleTimeout} {@link RegionAttributes#getEntryIdleTimeout} {@link
 ...
 *   <dt>EarlyAck [<em>default:</em> <code>false</code>]
 *   <dd>Whether or not acks required by <code>Scope.DISTRIBUTED_ACK</code> are sent after an
 *       operation is processed. If <code>true</code> then remote caches will ACK before processing
 *       an operation sent by the cache that has set earlyAck to <code>true</code>. Note that this
 *       attribute is only meaningful on the cache that is initiating an operation; it does not
 *       matter what it is set to on the cache that receives the operation.<br>
 *       {@link #setEarlyAck} {@link RegionAttributes#getEarlyAck}
 *   <dt>{@link SubscriptionAttributes} [<em>default:</em> {@link InterestPolicy#DEFAULT}]
 ...
 *   <dt>EnableAsyncConflation [<em>default:</em> <code>false</code>]
 ...
 *       AsyncConflation is ignored if the scope is <code>DISTRIBUTED_ACK</code> or <code>GLOBAL
 *       </code>. Conflation is only done on entry update operations. It is done by dropping the
 *       earlier update from the message queue. {@link #setEnableAsyncConflation} {@link
 *       RegionAttributes#getEnableAsyncConflation}
 *   <dt>poolName [<em>default:</em> <code>null</code>, meaning no pool]
 *   <dd>Whether or not this region is a client that is to use connections from the named pool to
 *       communicate with servers. If <code>null</code>, then it is not a client. If <code>non-null
 *       </code>, then the named pool will be used. {@link #setPoolName} {@link
 *       RegionAttributes#getPoolName}
 *   <dt>EnableSubscriptionConflation [<em>default:</em> <code>false</code>]
 *   <dd>Whether or not conflation is enabled for sending messages from a cache server to its
 *       clients. Note: This parameter is only valid for cache server to client communication. It
 *       has no effect in peer to peer communication. If <code>true</code>, messages will be
 *       conflated before they are sent from a cache server to its clients. Only the latest value
 *       will be sent. Note that this attribute is only meaningful in a client server topology.
 *       {@link #setEnableSubscriptionConflation} {@link
 *       RegionAttributes#getEnableSubscriptionConflation}
 *   <dt>Publisher [<em>default:</em> <code>false</code>]
 *   <dd>Whether or not a region is a publisher. Publishers are regions that will have distributed
 *       write operations done on them. If a publisher is also a replicate then it will be used as
 *       the preferred source for initializing other replicates. {@link #setPublisher} {@link
 *       RegionAttributes#getPublisher}
 *   <dt>isCloningEnabled [<em>default:</em> <code>false</code>]
 *   <dd>Whether or not value is cloned before appling <code>Delta</code>s If <code>false</code>,
 *       value will not be cloned {@link #setCloningEnabled} {@link
 ...
 *
 * <dl>
 *   <dt>{@link DataPolicy} [<em>default:</em> <code>DataPolicy.NORMAL</code>]
 *   <dd>Specifies the data storage policy.<br>
 *       {@link #setDataPolicy} {@link RegionAttributes#getDataPolicy}
 *   <dt>{@link MirrorType} [<em>default:</em> <code>MirrorType.NONE</code>]
 *   <dd><em>Deprecated</em>, use DataPolicy instead.
 *   <dt>{@link #setEvictionAttributes(EvictionAttributes) EvictionAttributes}
 *   <dd>{@link EvictionAttributes} are the replacement for the deprecated and removed
 *       CapacityController interface. EvictionAttributes describe the {@link EvictionAlgorithm} and
 *       the {@link EvictionAction} as well as the various conditions under which the algorithm
 *       perform the action e.g. when the maximum number of entries has been reached or the maximum
 *       percentage of JVM heap has been consumed. Setting <code>EvictionAttributes</code> installs
 *       an eviction controller on the Region instantiated with the associated RegionAttributes
 *   <dt>KeyConstraint [<em>default:</em> <code>null</code>, meaning no constraint]
 *   <dd>The Class to constrain the keys to in the region.<br>
 *       {@link #setKeyConstraint} {@link RegionAttributes#getKeyConstraint}
 *   <dt>ValueConstraint [<em>default:</em> <code>null</code>, meaning no constraint]
 *   <dd>The Class to constrain the values to in the region. In addition to the utility of this for
 *       applications in general, a <code>valueConstraint</code> is helpful for compiling queries.
 *       <br>
 *       {@link #setValueConstraint} {@link RegionAttributes#getValueConstraint}
 *   <dt>InitialCapacity [<em>default:</em> <code>16</code>]
 *   <dd>The initial capacity of the map used for storing the entries. <br>
 *       {@link java.util.HashMap} {@link #setInitialCapacity} {@link
 *       RegionAttributes#getInitialCapacity}
 *   <dt>LoadFactor [<em>default:</em> <code>0.75</code>]
 ...
 *   <dt>ConcurrencyLevel [<em>default:</em> <code>16</code>]
 *   <dd>The allowed concurrency among updates to values in the region is guided by the
 *       <tt>concurrencyLevel</tt>, which is used as a hint for internal sizing. The actual
 *       concurrency will vary. Ideally, you should choose a value to accommodate as many threads as
 *       will ever concurrently modify values in the region. Using a significantly higher value than
 *       you need can waste space and time, and a significantly lower value can lead to thread
 *       contention. But overestimates and underestimates within an order of magnitude do not
 *       usually have much noticeable impact. A value of one is appropriate when it is known that
 *       only one thread will modify and all others will only read. <br>
 *       {@link #setConcurrencyLevel} {@link RegionAttributes#getConcurrencyLevel}
 *   <dt>ConcurrencyChecksEnabled [<em>default:</em> <code>false</code>]
 *   <dd>Enables a distributed versioning algorithm that detects concurrency conflicts in regions
 *       and ensures that changes to an entry are not applied in a different order in other members.
 *       This can cause operations to be conflated, so that some cache listeners may see an event
 *       while others do not, but it guarantees that the system will be consistent.
 *   <dt>StatisticsEnabled [<em>default:</em> <code>false</code>]
 ...
 *   <dt>IgnoreJTA [<em>default:</em> <code>false</code>]
 *   <dd>Whether JTA transactions are ignored for this region. The default is to look for and join
 *       JTA transactions for operations performed on a region.
 *   <dt>DiskStoreName [<em>default:</em> <code>null</code>, meaning no disk store]
 *   <dd>If not <code>null</code> then this region will write its data to the named {@link
 *       DiskStore}.<br>
 *       {@link #setDiskStoreName} {@link RegionAttributes#getDiskStoreName}
 *   <dt>DiskSynchronous [<em>default:</em> <code>true</code>]
 *   <dd>If <code>true</code> then any writes to disk done for this region will be done
 *       synchronously. This means that they will be in the file system buffer before the operation
 *       doing the write returns.<br>
 *       If <code>false</code> then any writes to disk done for this region will be done
 *       asynchronously. This means that they are queued up to be written and when they are actually
 *       written to the file system buffer is determined by the region's {@link DiskStore}
 *       configuration. Asynchronous writes will be conflated if the same entry is written while a
 ...
 *   <dt>PersistBackup [<em>default:</em> <code>false</code>]
 ...
 *   <dd><em>Deprecated</em>, use {@link DataPolicy#PERSISTENT_REPLICATE} or {@link
 *       DataPolicy#PERSISTENT_PARTITION} instead.
 *   <dt>DiskWriteAttributes [<em>default:</em> Asynchronously write to disk every second (a <code>
 *       timeInterval</code> of 1000 and a <code>byteThreshold</codE> of 0). <code>rollOplogs</code>
 *       is set to true and <code>maxOplogSize</code> is set to 1024 MB]
 *   <dd>How region data should be written to disk. Determines whether data should be written
 *       synchronously or asynchronously. Data that is written asynchronously can be written at a
 *       certain {@linkplain DiskWriteAttributes#getTimeInterval time interval} or once a certain
 *       number of {@linkplain DiskWriteAttributes#getBytesThreshold bytes of data} have been
 *       enqueued.<br>
 *       {@link DiskWriteAttributes} {@link #setDiskWriteAttributes} {@link
 *       RegionAttributes#getDiskWriteAttributes}
 *   <dd><em>Deprecated</em>, use {@link #setDiskStoreName} and {@link #setDiskSynchronous} instead.
 *   <dt>DiskDirs [<em>default:</em> Current working directory (<code>user.dir</code> {@linkplain
 *       System#getProperties system property})]
 ...
 *   <dd><em>Deprecated</em>, use {@link #setDiskStoreName} instead.
 *   <dt>DiskDirSizes [<em>default:</em> 10240 MB]
 ...
 *   <dt>{@link MembershipAttributes} [<em>default:</em> no required roles]
 ...
 *   <dd><em>Deprecated</em>, this API is scheduled to be removed
 * </dl>
 *
 * <h4>Locking</h4>
 *
 * <dl>
 *   <dt>LockGrantor [<em>default:</em> <code>false</code>]
 *   <dd>Should this process become lock grantor for the region?<br>
 *       {@link #setLockGrantor} {@link RegionAttributes#isLockGrantor} {@link
 ...
 *
 * <dl>
 *   <dt>IndexMaintenanceSynchronous [<em>default:</em> <code>false</code>]
 ...
 *
 * If any of the following compatibility rules are violated when {@link #create}</code> is called
 * then an {@link IllegalStateException} is thrown. See {@link #validateAttributes}.
 *
 * <p><a name="creationConstraints">
 *
 ...
 *
 * <ul>
 *   <li>A region with <code>Scope.LOCAL</code> can only have subregions with <code>Scope.LOCAL
 *       </code>.
 *   <li><code>Scope.GLOBAL</code> is illegal if there is any other cache in the distributed system
 *       that has the same region with <code>Scope.DISTRIBUTED_NO_ACK</code> or <code>
 *       Scope.DISTRIBUTED_ACK</code>.
 *   <li><code>Scope.DISTRIBUTED_ACK</code> is illegal if there is any other cache in the
 *       distributed system that has the same region with <code>Scope.DISTRIBUTED_NO_ACK</code> or
 ...
 * @since GemFire 3.0
 * @deprecated as of 6.5 use {@link Cache#createRegionFactory(RegionShortcut)} or {@link
...
public class AttributesFactory<K, V> {
  ...
  public AttributesFactory(RegionAttributes<K, V> regionAttributes) {
    ...
    if (regionAttributes instanceof UserSpecifiedRegionAttributes) {
      this.regionAttributes.setIndexes(
          ((UserSpecifiedRegionAttributes<K, V>) regionAttributes).getIndexes());
    }
  ...
  /**
   * Sets the idleTimeout expiration attributes for region entries for the next <code>
   * RegionAttributes</code> created. Default is 0 which indicates no expiration of this type.
   *
  ...
  /**
   * Sets the timeToLive expiration attributes for region entries for the next <code>
   * RegionAttributes</code> created. Default is 0 which indicates no expiration of this type.
   *
  ...
  /**
   * Sets the idleTimeout expiration attributes for the region itself for the next <code>
   * RegionAttributes</code> created. Default is 0 which indicates no expiration of this type is
   * set.
   *
  ...
  /**
   * Sets the timeToLive expiration attributes for the region itself for the next <code>
   * RegionAttributes</code> created. Default is 0 i.e. no expiration of this type.
   *
   ...
   * creation methods on {@link EvictionAttributes} e.g. {@link
   * EvictionAttributes#createLRUHeapAttributes()} to create the desired instance for this <code>
   * AttributesFactory</code>
   *
  ...
  public void setLoadFactor(float loadFactor) {
    if (loadFactor <= 0)
      throw new IllegalArgumentException(
          LocalizedStrings.AttributesFactory_LOADFACTOR_MUST_BE_0_VALUE_IS_0.toLocalizedString(
   ...
   *     not match to the length of the dir array or the given length is not a valid positive number
   * @since GemFire 5.1
    ...
    if (diskSizes.length != this.regionAttributes.diskDirs.length) {
      throw new IllegalArgumentException(
          LocalizedStrings
              ...
              .toLocalizedString(
                  new Object[] {
                    Integer.valueOf(diskSizes.length), Integer.valueOf(diskDirs.length)
                  }));
    }
   ...
   * members of the distributed system. This also establishes a data policy of {@link
   * DataPolicy#PARTITION PARTITION}, if the data policy has not already been set.
   *
   * @since GemFire 5.0
   */
  public void setPartitionAttributes(PartitionAttributes partition) {
    if (partition != null) {
      ...
      } else if (!PartitionedRegionHelper.ALLOWED_DATA_POLICIES.contains(
   ...
   *
   * <p>If this attribute is set to <code>null</code> or <code>""</code> then the connection pool is
   * disabled causing regions that use these attributes to be communicate with peers instead of
   * servers.
   *
   * <p>The named connection pool must exist on the cache at the time these attributes are used to
   ...
   *       <ul>
   *         <li>ExpirationAction.LOCAL_INVALIDATE on the regionExpirationAction.LOCAL_DESTROY on
   *             the entries
   *         <li>ExpirationAction.LOCAL_INVALIDATE on the entries
   *         <li>An LRU with local destroy eviction action
   *       </ul>
   *
   *   <li>Region or entry expiration is incompatible with disabled statistics on the region
   *   <li>Entry expiration is incompatible with the {@link DataPolicy#EMPTY} data policy
   *   <li>{@link EvictionAttributes Eviction} is incompatible with the {@link DataPolicy#EMPTY}
   *       data policy
   * </ul>
   *
  ...
  private static class RegionAttributesImpl<K, V> extends UserSpecifiedRegionAttributes<K, V>
    ...
    EvictionAttributesImpl evictionAttributes =
        new EvictionAttributesImpl(); // TODO need to determine the constructor
    ...
    public String toString() {
      ...
      buf.append("RegionAttributes@")
          ...
          .append("; publisher=")
          .append(publisher)
          .append("; partitionAttrs=")
          .append(partitionAttributes)
          .append("; membershipAttrs=")
          .append(membershipAttributes)
          .append("; subscriptionAttrs=")
          .append(subscriptionAttributes)
          .append("; regionTTL=")
          .append(regionTimeToLive)
          .append("; action=")
          .append(regionTimeToLiveExpirationAction)
          .append("; regionIdleTimeout=")
          .append(regionIdleTimeout)
          .append("; action=")
          .append(regionIdleTimeoutExpirationAction)
          .append("; TTL=")
          .append(entryTimeToLive)
          .append("; action=")
          .append(entryTimeToLiveExpirationAction)
          .append("; custom=")
          .append(customEntryTimeToLive)
          .append("; idleTimeout=")
          .append(entryIdleTimeout)
          .append("; action=")
          .append(entryIdleTimeoutExpirationAction)
          .append("; custom=")
          .append(customEntryIdleTimeout)
          .append("; dataPolicy=")
          .append(dataPolicy)
          .append("; statisticsEnabled=")
          .append(statisticsEnabled)
          .append("; ignoreJTA=")
          .append(ignoreJTA)
          .append("; isLockGrantor=")
          .append(isLockGrantor)
          .append("; keyConstraint=")
          .append(keyConstraint)
          .append("; valueConstraint=")
          .append(valueConstraint)
          .append("; initialCapacity=")
          .append(initialCapacity)
          .append("; loadFactor=")
          .append(loadFactor)
          .append("; concurrencyLevel=")
          .append(concurrencyLevel)
          .append("; concurrencyChecksEnabled=")
          .append(concurrencyChecksEnabled)
          .append("; enableAsyncConflation=")
          .append(enableAsyncConflation)
          .append("; enableSubscriptionConflation=")
          .append(enableSubscriptionConflation)
          .append("; isBucketRegion=")
          .append(isBucketRegion)
          .append("; poolName=")
          .append(poolName)
          .append("; diskSynchronous=")
          .append(diskSynchronous)
          .append("; multicastEnabled=")
          .append(multicastEnabled)
          .append("; isCloningEnabled=")
          .append(isCloningEnabled);
      if (hasDiskWriteAttributes() || hasDiskDirs()) {
        buf.append("; diskAttrs=")
            .append(diskWriteAttributes)
            .append("; diskDirs=")
            .append(Arrays.toString(diskDirs))
            .append("; diskDirSizes=")
