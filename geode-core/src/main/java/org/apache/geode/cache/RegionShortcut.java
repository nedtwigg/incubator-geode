 ...
 * can be used to create regions using a {@link RegionFactory} obtained by calling {@link
 * Cache#createRegionFactory(RegionShortcut)}.
 *
 * <p>Another way to use predefined region attributes is in cache.xml by setting the refid attribute
 * on a region element or region-attributes element to the string of each value.
 *
 * @since GemFire 6.5
 */
public enum RegionShortcut {
   ...
   * region. The actual RegionAttributes for a PARTITION region set the {@link DataPolicy} to {@link
   ...
   * RegionAttributes for a PARTITION_REDUNDANT region set the {@link DataPolicy} to {@link
   * DataPolicy#PARTITION} and the redundant-copies to 1.
   */
  PARTITION_REDUNDANT,
  /**
   ...
   * created. The actual RegionAttributes for a PARTITION_PERSISTENT region set the {@link
   * DataPolicy} to {@link DataPolicy#PERSISTENT_PARTITION}.
   */
   ...
   * PARTITION_PERSISTENT_OVERFLOW region set the {@link DataPolicy} to {@link
   * DataPolicy#PERSISTENT_PARTITION} and {@link EvictionAttributes} are set to {@link
   * EvictionAlgorithm#LRU_HEAP} with {@link EvictionAction#OVERFLOW_TO_DISK}.
   */
   ...
   * 1, and {@link EvictionAttributes} are set to {@link EvictionAlgorithm#LRU_HEAP} with {@link
   ...
   * to {@link DataPolicy#PARTITION} and {@link EvictionAttributes} are set to {@link
   * EvictionAlgorithm#LRU_HEAP} with {@link EvictionAction#LOCAL_DESTROY}.
   */
  PARTITION_HEAP_LRU,
  /**
   ...
   * RegionAttributes for a PARTITION_REDUNDANT_HEAP_LRU region set the {@link DataPolicy} to {@link
   * DataPolicy#PARTITION}, the redundant-copies to 1, and {@link EvictionAttributes} are set to
   ...
   * {@link DataPolicy} to {@link DataPolicy#PERSISTENT_REPLICATE} and {@link Scope} to {@link
   ...
   * exist in its peers. The actual RegionAttributes for a REPLICATE_OVERFLOW region set the {@link
   * DataPolicy} to {@link DataPolicy#REPLICATE}, the {@link Scope} to {@link Scope#DISTRIBUTED_ACK}
   * and {@link EvictionAttributes} are set to {@link EvictionAlgorithm#LRU_HEAP} with {@link
   * EvictionAction#OVERFLOW_TO_DISK}.
   */
  REPLICATE_OVERFLOW,
  /**
   ...
   * REPLICATE_PERSISTENT_OVERFLOW region set the {@link DataPolicy} to {@link
   * DataPolicy#PERSISTENT_REPLICATE}, the {@link Scope} to {@link Scope#DISTRIBUTED_ACK}, and
   * {@link EvictionAttributes} are set to {@link EvictionAlgorithm#LRU_HEAP} with {@link
   * EvictionAction#OVERFLOW_TO_DISK}.
   */
   ...
   * low of memory. The actual RegionAttributes for a REPLICATE_HEAP_LRU region set the {@link
   * DataPolicy} to {@link DataPolicy#PRELOADED}, the {@link Scope} to {@link
   * Scope#DISTRIBUTED_ACK}, {@link SubscriptionAttributes} to {@link InterestPolicy#ALL}, and
   * {@link EvictionAttributes} are set to {@link EvictionAlgorithm#LRU_HEAP} with {@link
   ...
   * RegionAttributes for a LOCAL_PERSISTENT region set the {@link DataPolicy} to {@link
   ...
   * destroy entries once it detects that the java vm is running low of memory. The actual
   * RegionAttributes for a LOCAL_HEAP_LRU region set the {@link DataPolicy} to {@link
   * DataPolicy#NORMAL} and {@link EvictionAttributes} are set to {@link EvictionAlgorithm#LRU_HEAP}
   ...
   * The actual RegionAttributes for a LOCAL_OVERFLOW region set the {@link DataPolicy} to {@link
   * DataPolicy#NORMAL} and {@link EvictionAttributes} are set to {@link EvictionAlgorithm#LRU_HEAP}
   ...
   * RegionAttributes for a PARTITION_PROXY_REDUNDANT region set the {@link DataPolicy} to {@link
   * DataPolicy#PARTITION}, the local-max-memory to 0, and the redundant-copies to 1.
   */
   ...
   * PROXY region. The actual RegionAttributes for a REPLICATE_PROXY region set the {@link
   * DataPolicy} to {@link DataPolicy#EMPTY} and {@link Scope} to {@link Scope#DISTRIBUTED_ACK}.
   */
  REPLICATE_PROXY,
}
