 ...
 *
 * <p>If any of the following criteria is true, then a cache member is considered to be in {@link
 * GemFireHealth#OKAY_HEALTH OKAY_HEALTH}.
 *
 * <UL>
 *   <LI><code>netSearch</code> operations take {@linkplain #getMaxNetSearchTime too long} to
 *       complete.
 *   <LI>Cache <code>load</code> operations take {@linkplain #getMaxLoadTime too long} to complete.
 *   <LI>The overall cache {@link #getMinHitRatio hitRatio} is too small
 *   <LI>The number of entries in the Cache {@link #getMaxEventQueueSize event delivery queue} is
 *       too large.
 *   <LI>If one of the regions is configured with {@link
 *       org.apache.geode.cache.LossAction#FULL_ACCESS FULL_ACCESS} on role loss.
 * </UL>
 *
 * If any of the following criteria is true, then a cache member is considered to be in {@link
 * GemFireHealth#POOR_HEALTH POOR_HEALTH}.
 *
 * <UL>
 *   <LI>If one of the regions is configured with {@link org.apache.geode.cache.LossAction#NO_ACCESS
 *       NO_ACCESS} on role loss.
 *   <LI>If one of the regions is configured with {@link
 *       org.apache.geode.cache.LossAction#LIMITED_ACCESS LIMITED_ACCESS} on role loss.
 * </UL>
 *
 * <UL>
 * </UL>
