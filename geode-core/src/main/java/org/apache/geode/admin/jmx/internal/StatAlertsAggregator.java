...
public interface StatAlertsAggregator {
   ...
   *
   * <p>A new alert definition will be created if matching one not found.
   *
   ...
   *
   * <p>This method should update the collection maintained at the aggregator and should notify
   * members for the newly added alert definitions.
   *
