...
public interface ManagedEntity {
   ...
   * @throws IllegalStateException If this managed entity resides on a remote machine and a <code>
   *     null</code> or empty (<code>""</code>) {@linkplain ManagedEntityConfig#getRemoteCommand
   *     remote command} has been specified.
   * @see #waitToStart
   */
