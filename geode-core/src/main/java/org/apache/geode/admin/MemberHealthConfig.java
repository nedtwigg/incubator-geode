 ...
 * system.
 *
 * <p>If any of the following criteria is true, then a member is considered to be in {@link
 * GemFireHealth#OKAY_HEALTH OKAY_HEALTH}.
 *
 * <UL>
 *   <LI>The size of the {@linkplain #getMaxVMProcessSize VM process} is too large.
 *   <LI>There are too many {@linkplain #getMaxMessageQueueSize enqueued} incoming/outgoing
 *       messages.
 *   <LI>Too many message sends {@link #getMaxReplyTimeouts timeout} while waiting for a reply.
 * </UL>
 *
 * If any of the following criteria is true, then a member is considered to be in {@link
...
public interface MemberHealthConfig {
   ...
   *
   * <p>A high retransmission ratio may indicate poor network conditions requiring reduced
   * flow-control settings, a udp-fragment-size setting that is too high.
   *
