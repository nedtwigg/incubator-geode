...
/**
 * Administrative interface that represent's the {@link SystemMember}'s view of its {@link
...
public interface SystemMemberCache {
  ...
  /**
   * Returns whether or not this cache acts as a server. This method will always return <code>true
   * </code> for the <code>SystemMemberCache</code> obtained from a {@link CacheServer}. Note that
   * this value will not be updated until {@link #refresh} is invoked.
   *
   * @since GemFire 4.0
   */
