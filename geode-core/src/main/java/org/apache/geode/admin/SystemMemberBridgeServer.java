...
public interface SystemMemberBridgeServer {
   ...
   *
   * <p>Setting a specific bind address will cause the bridge server to always use this address and
   ...
   * requests the key, it goes to the bridge server for the value.
   *
   ...
   *     Modifying this array will not change the server groups that this bridge server belongs to.
   * @since GemFire 5.7
   */
