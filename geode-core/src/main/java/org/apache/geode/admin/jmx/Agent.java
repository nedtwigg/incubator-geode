 ...
 * registers an MBean that represents {@link #getObjectName itself}. Click <A
 * href="doc-files/mbeans-descriptions.html">here</A> for a description of the attributes,
 * operations, and notifications of this and other GemFire JMX MBeans.
 *
 * <p>The GemFire JMX Agent currently supports three JMX "adapters" through which clients can access
 ...
 * management beans. Information about configuring these adapters can be found in {@link
 * AgentConfig}.
 *
 * <p>In most distributed caching architectures, JMX administration agents are run in their own
...
public interface Agent {
  ...
  /**
   * Starts this JMX Agent and its associated adapters. This method does not {@linkplain
   * #connectToSystem connect} to the distributed system.
   */
  public void start();

  /**
   * Returns the JMX <code>MBeanServer</code> with which GemFire MBeans are registered or <code>null
   * </code> if this <code>Agent</code> is not started.
   */
   ...
   * this <code>Agent</code> or <code>null</code> if this <code>Agent</code> has not {@linkplain
