...
class MemberHealthEvaluator extends AbstractHealthEvaluator {
  ...
  /**
   * Checks to make sure that the size of the distribution manager's {@linkplain
   * DMStats#getOverflowQueueSize() overflow} message queue does not exceed the {@linkplain
   * MemberHealthConfig#getMaxMessageQueueSize threshold}. If not, the status is "okay" health.
   */
