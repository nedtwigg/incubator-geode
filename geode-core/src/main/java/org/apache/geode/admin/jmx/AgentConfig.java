 ...
 *
 * <p>An <code>AgentConfig</code> can be modified using a number of mutator methods until it is used
 * to create an <code>Agent</code>. After that, attempts to modify most attributes in the <code>
 * AgentConfig</code> will result in an {@link IllegalStateException} being thrown. If you wish to
 * use the same <code>AgentConfig</code> to configure multiple <code>Agent</code>s, a copy of the
 * <code>AgentConfig</code> object can be made by invoking its {@link #clone} method.
 *
 * <p><B>JMX Administation Agent Configuration Properties</B>
 *
 * <dl>
 *   <a name="auto-connect">
 *   <dt>{@linkplain #AUTO_CONNECT_NAME auto-connect}</a>
 *   <dd><U>Description</U>: whether or not a JMX agent will automatically connect to the
 *       distributed system it is configured to administer.
 *   <dd><U>{@linkplain #DEFAULT_AUTO_CONNECT Default}</U>: false
 * </dl>
 *
 * <B>JMX Agent SSL Configuration Properties</B>
 *
 * <p>These parameters configure sockets that are created by the GemFire JMX Agent regardless of
 * which adapters are enabled. These setting apply to all adapters. For example, if clients connect
 * to the RMI adapter using SSL, then clients must also connect to the HTTP adapter using SSL
 * (HTTPS). Note that these configuration attributes do <b>not</b> effect how the agent connects to
 * the distributed system it administers, only how JMX clients connect to the agent.
 *
 * <dl>
 *   <a name="agent-ssl-enabled">
 *   <dt>{@linkplain #AGENT_SSL_ENABLED_NAME agent-ssl-enabled}</a>
 *   <dd><U>Description</U>: whether or not connections to the JMX agent require SSL
 *   <dd><U>{@linkplain #DEFAULT_AGENT_SSL_ENABLED Default}</U>: false
 * </dl>
 *
 * <dl>
 *   <a name="agent-ssl-protocols">
 *   <dt>{@linkplain #AGENT_SSL_PROTOCOLS_NAME agent-ssl-protocols}</a>
 *   <dd><U>Description</U>: the SSL protocols to be used when connecting to the JMX agent
 *   <dd><U>{@linkplain #DEFAULT_AGENT_SSL_PROTOCOLS Default}</U>: any
 * </dl>
 *
 * <dl>
 *   <a name="agent-ssl-ciphers">
 *   <dt>{@linkplain #AGENT_SSL_CIPHERS_NAME agent-ssl-ciphers}</a>
 *   <dd><U>Description</U>: the SSL ciphers to be used when connecting to the JMX agent
 *   <dd><U>{@linkplain #DEFAULT_AGENT_SSL_CIPHERS Default}</U>: any
 * </dl>
 *
 * <dl>
 *   <a name="agent-ssl-require-authentication">
 *   <dt>{@linkplain #AGENT_SSL_REQUIRE_AUTHENTICATION_NAME agent-ssl-require-authentication}</a>
 *   <dd><U>Description</U>: whether or not SSL connections to the RMI adapter require
 *       authentication
 *   <dd><U>{@linkplain #DEFAULT_AGENT_SSL_REQUIRE_AUTHENTICATION Default}</U>: true
 * </dl>
 *
 * <dl>
 *   <a name="http-ssl-require-authentication">
 *   <dt>{@linkplain #HTTP_SSL_REQUIRE_AUTHENTICATION_NAME http-ssl-require-authentication}</a>
 *   <dd><U>Description</U>: whether or not SSL connections to the HTTP adapter require
 *       authentication
 *   <dd><U>{@linkplain #DEFAULT_HTTP_SSL_REQUIRE_AUTHENTICATION Default}</U>: false
 * </dl>
 *
 ...
 * <dl>
 *   <a name="http-enabled">
 *   <dt>{@linkplain #HTTP_ENABLED_NAME http-enabled}</a>
 *   <dd><U>Description</U>: whether or not the HTTP adapter is enabled in the JMX agent.
 *   <dd><U>{@linkplain #DEFAULT_HTTP_ENABLED Default}</U>: true
 * </dl>
 *
 * <dl>
 *   <a name="http-port">
 *   <dt>{@linkplain #HTTP_PORT_NAME http-port}</a>
 *   <dd><U>Description</U>: the port on which the HTTP adapter should listen for client
 *       connections.
 *   <dd><U>{@linkplain #DEFAULT_HTTP_PORT Default}</U>: 8080
 * </dl>
 *
 * <dl>
 *   <a name="http-bind-address">
 *   <dt>{@linkplain #HTTP_BIND_ADDRESS_NAME http-bind-address}</a>
 *   <dd><U>Description</U>: the machine name or IP address to which the HTTP listening socket
 *       should be bound. If this value is "localhost", then the socket will be bound to the
 *       loopback address (127.0.0.1) and the adapter will only be accessible via the URL <code>
 *       http://localhost:8080</code>.
 *   <dd><U>{@linkplain #DEFAULT_HTTP_BIND_ADDRESS Default}</U>: "" (all network addresses)
 * </dl>
 *
 * <dl>
 *   <a name="http-authentication-enabled">
 *   <dt>{@linkplain #HTTP_AUTHENTICATION_ENABLED_NAME http-authentication-enabled}</a>
 *   <dd><U>Description</U>: Whether or not connections to the HTTP adapter should be authenticated
 *       with a user name and password.
 *   <dd><U>{@linkplain #DEFAULT_HTTP_AUTHENTICATION_ENABLED Default}</U>: false
 * </dl>
 *
 * <dl>
 *   <a name="http-authentication-user">
 *   <dt>{@linkplain #HTTP_AUTHENTICATION_USER_NAME http-authentication-user}</a>
 *   <dd><U>Description</U>: the user name for authenticating secure communication.
 *   <dd><U>{@linkplain #DEFAULT_HTTP_AUTHENTICATION_USER Default}</U>: admin
 * </dl>
 *
 * <dl>
 *   <a name="http-authentication-password">
 *   <dt>{@linkplain #HTTP_AUTHENTICATION_PASSWORD_NAME http-authentication-password}</a>
 *   <dd><U>Description</U>: the password for authenticating secure communication.
 *   <dd><U>{@linkplain #DEFAULT_HTTP_AUTHENTICATION_PASSWORD Default}</U>: password
 * </dl>
 *
 ...
 * <dl>
 *   <a name="rmi-enabled">
 *   <dt>{@linkplain #RMI_ENABLED_NAME rmi-enabled}</a>
 *   <dd><U>Description</U>: whether or not the RMI JMX adapter is enabled
 *   <dd><U>{@linkplain #DEFAULT_RMI_ENABLED Default}</U>: true
 * </dl>
 *
 * <dl>
 *   <a name="rmi-registry-enabled">
 *   <dt>{@linkplain #RMI_REGISTRY_ENABLED_NAME rmi-registry-enabled}</a>
 *   <dd><U>Description</U>: whether or not the JMX agent should start an RMI registry.
 *       Alternatively, a registry outside of the JMX agent VM can be used.
 *   <dd><U>{@linkplain #DEFAULT_RMI_REGISTRY_ENABLED Default}</U>: true
 * </dl>
 *
 * <dl>
 *   <a name="rmi-port">
 *   <dt>{@linkplain #RMI_PORT_NAME rmi-port}</a>
 *   <dd><U>Description</U>: the port of the RMI registry in which the JMX Agent should bind remote
 *       objects.
 *   <dd><U>{@linkplain #DEFAULT_RMI_PORT Default}</U>: 1099
 * </dl>
 *
 * <dl>
 *   <a name="rmi-server-port">
 *   <dt>{@linkplain #RMI_PORT_NAME rmi-server-port}</a>
 *   <dd><U>Description</U>: the port to be used by the RMI Server started by JMX Agent.
 *   <dd><U>{@linkplain #DEFAULT_RMI_SERVER_PORT Default}</U>: 0
 * </dl>
 *
 * <dl>
 *   <a name="rmi-bind-address">
 *   <dt>{@linkplain #RMI_BIND_ADDRESS_NAME rmi-bind-address}</a>
 *   <dd><U>Description</U>: the bind address on which the RMI registry binds its sockets.
 *   <dd><U>{@linkplain #DEFAULT_RMI_BIND_ADDRESS Default}</U>: "" (all network addresses)
 * </dl>
 *
 ...
 * <dl>
 *   <a name="snmp-enabled">
 *   <dt>{@linkplain #SNMP_ENABLED_NAME snmp-enabled}</a>
 *   <dd><U>Description</U>: whether or not the SNMP JMX adapter is enabled
 *   <dd><U>{@linkplain #DEFAULT_SNMP_ENABLED Default}</U>: false
 * </dl>
 *
 * <dl>
 *   <a name="snmp-bind-address">
 *   <dt>{@linkplain #SNMP_BIND_ADDRESS_NAME snmp-bind-address}</a>
 *   <dd><U>Description</U>: the host name to which sockets used by the SNMP adapter should be
 *       bound.
 ...
 *   <dt>{@linkplain #SNMP_DIRECTORY_NAME snmp-directory}</a>
 *   <dd><U>Description</U>: the deployment directory for AdventNet SNMP Adaptor
 *   <dd><U>{@linkplain #DEFAULT_SNMP_DIRECTORY Default}</U>: ""
 * </dl>
 *
 ...
 *   <dt>{@linkplain #EMAIL_NOTIFICATIONS_ENABLED_NAME email-notification-enabled}</a>
 *   <dd><U>Description</U>: Whether or not email notifications are enabled for statistics alerts.
 *   <dd><U>{@linkplain #DEFAULT_EMAIL_NOTIFICATIONS_ENABLED Default}</U>: false
 * </dl>
 *
 * <dl>
 *   <a name="email-notification-from">
 *   <dt>{@linkplain #EMAIL_NOTIFICATIONS_FROM_NAME email-notification-from}</a>
 *   <dd><U>Description</U>: Email address to be used to send email notifications.
 *   <dd><U>{@linkplain #DEFAULT_EMAIL_FROM Default}</U>: ""
 * </dl>
 *
 * <dl>
 *   <a name="email-notification-host">
 *   <dt>{@linkplain #EMAIL_NOTIFICATIONS_HOST_NAME email-notification-host}</a>
 *   <dd><U>Description</U>: The host name of the mail server to be used for email communication.
 *   <dd><U>{@linkplain #DEFAULT_EMAIL_HOST Default}</U>: ""
 * </dl>
 *
 * <dl>
 *   <a name="email-notification-to">
 *   <dt>{@linkplain #EMAIL_NOTIFICATIONS_TO_LIST_NAME email-notification-to}</a>
 *   <dd><U>Description</U>: Email address where the email notifications should be sent.
 *   <dd><U>{@linkplain #DEFAULT_EMAIL_TO_LIST Default}</U>: ""
 * </dl>
 *
 * <dl>
 *   <a name="state-save-file">
 *   <dt>{@linkplain #STATE_SAVE_FILE_NAME state-save-file}</a>
 *   <dd><U>Description</U>: The name of the file to be used for saving agent state. The file is
 *       stored in the same directory in which the agent.properties file is located
 *   <dd><U>{@linkplain #DEFAULT_STATE_SAVE_FILE Default}</U>: ""
 * </dl>
 *
 * @since GemFire 4.0
...
public interface AgentConfig extends DistributedSystemConfig {
   ...
   * administers.
   *
   * <p>See <a href="#auto-connect">description</a> above.
   */
   ...
   *
   * <p>See <a href="#http-enabled">description</a> above.
   */
   ...
   *
   * <p>See <a href="#http-port">description</a> above.
   */
   ...
   *
   * <p>See <a href="#http-bind-address">description</a> above.
   */
   ...
   *
   * <p>See <a href="#http-authentication-enabled">description</a> above.
   */
   ...
   *
   * <p>See <a href="#http-authentication-user">description</a> above.
   */
   ...
   *
   * <p>See <a href="#http-authentication-password">description</a> above.
   */
   ...
   *
   * <p>See <a href="#rmi-enabled">description</a> above.
   */
   ...
   *
   * <p>See <a href="#rmi-registry-enabled">description</a> above.
   */
   ...
   *
   * <p>See <a href="#rmi-port">description</a> above.
   */
   ...
   *
   * <p>See <a href="#rmi-bind-address">description</a> above.
   */
   ...
   *
   * <p>See <a href="#snmp-enabled">description</a> above.
   */
   ...
   *
   * <p>See <a href="#snmp-bind-address">description</a> above.
   */
   ...
   *
   * <p>See <a href="#snmp-directory">description</a> above.
   */
   ...
   *
   * <p>See <a href="#agent-ssl-enabled">description</a> above.
   */
   ...
   *
   * <p>See <a href="#agent-ssl-protocols">description</a> above.
   */
   ...
   *
   * <p>See <a href="#agent-ssl-ciphers">description</a> above.
   */
   ...
   *
   * <p>See <a href="#agent-ssl-require-authentication">description</a> above.
   */
   ...
   *
   * <p>See <a href="#http-ssl-require-authentication">description</a> above.
   */
   ...
   *
   * <p>See <a href="#email-notification-enabled">description</a> above.
   */
   ...
   *
   * <p>See <a href="#email-notification-from">description</a> above.
   */
   ...
   *
   * <p>See <a href="#email-notification-host">description</a> above.
   */
   ...
   *
   * <p>See <a href="#email-notification-to">description</a> above.
   */
   ...
   *
   * <p>See <a href="#state-save-file">description</a> above.
   */
  ...
  /**
   * Returns an <code>AgentConfig</code> with the same configuration as this <code>AgentConfig
   * </code>.
   */
