...
public class ManagementListener implements ResourceEventsListener {
   ...
   *
   * <p>As ManagementService creation logic is called in cache.init() method it leaves a small
   * window of loosing the lock of GemFireCacheImpl.class
   *
   * <p>These checks ensures that something unwanted has not happened during that small window
   *
   ...
   *
   * <p>It checks for race conditions cases by calling shouldProceed();
   *
