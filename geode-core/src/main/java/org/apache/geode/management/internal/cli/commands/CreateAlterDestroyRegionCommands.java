...
public class CreateAlterDestroyRegionCommands extends AbstractCommandsSupport {
  ...
  public Result createRegion(
      @CliOption(
            key = CliStrings.CREATE_REGION__REGION,
            mandatory = true,
          ...
          String regionPath,
      @CliOption(
            key = CliStrings.CREATE_REGION__REGIONSHORTCUT,
            mandatory = false,
            unspecifiedDefaultValue = CliMetaData.ANNOTATION_NULL_VALUE,
      ...
      @CliOption(
            key = CliStrings.CREATE_REGION__USEATTRIBUTESFROM,
      ...
      @CliOption(
            key = CliStrings.CREATE_REGION__GROUP,
          ...
          String[] groups,
      @CliOption(
            key = CliStrings.CREATE_REGION__SKIPIFEXISTS,
      ...
      @CliOption(
            key = CliStrings.CREATE_REGION__VALUECONSTRAINT,
    ...
    try {
      ...
      if (entryExpirationIdleTime != null) {
        entryIdle =
            new RegionFunctionArgs.ExpirationAttrs(
                RegionFunctionArgs.ExpirationAttrs.ExpirationFor.ENTRY_IDLE,
      ...
      if (entryExpirationTTL != null) {
        entryTTL =
            new RegionFunctionArgs.ExpirationAttrs(
                RegionFunctionArgs.ExpirationAttrs.ExpirationFor.ENTRY_TTL,
                entryExpirationTTL,
      ...
      if (regionExpirationIdleTime != null) {
        regionIdle =
            new RegionFunctionArgs.ExpirationAttrs(
                RegionFunctionArgs.ExpirationAttrs.ExpirationFor.REGION_IDLE,
      ...
      if (regionExpirationTTL != null) {
        regionTTL =
            new RegionFunctionArgs.ExpirationAttrs(
                RegionFunctionArgs.ExpirationAttrs.ExpirationFor.REGION_TTL,
                regionExpirationTTL,
      ...
      if (useAttributesFrom != null) {
        ...
        String[] cacheListenerClasses =
            cacheListener != null && cacheListener.length != 0
                ? cacheListener
                : regionAttributesResult.getCacheListenerClasses();
        ...
        if (regionAttributes.getPartitionAttributes() == null
          ...
          throw new IllegalArgumentException(
              CliStrings.format(
                      CliStrings
                          .CREATE_REGION__MSG__OPTION_0_CAN_BE_USED_ONLY_FOR_PARTITIONEDREGION,
                      regionFunctionArgs.getPartitionArgs().getUserSpecifiedPartitionAttributes())
                  + " "
                  + CliStrings.format(
                      CliStrings.CREATE_REGION__MSG__0_IS_NOT_A_PARITIONEDREGION,
                      useAttributesFrom));
        }
      } else {
        regionFunctionArgs =
      ...
      if (groups != null && groups.length != 0) {
        ...
        for (Iterator<DistributedMember> it = membersToCreateRegionOn.iterator(); it.hasNext(); ) {
          ...
          if (((InternalDistributedMember) distributedMember).getVmKind()
      ...
      ResultCollector<?, ?> resultCollector =
          CliUtil.executeFunction(
              RegionCreateFunction.INSTANCE, regionFunctionArgs, membersToCreateRegionOn);
      ...
      for (CliFunctionResult regionCreateResult : regionCreateResults) {
        ...
        tabularResultData.accumulate(
            "Status", (success ? "" : errorPrefix) + regionCreateResult.getMessage());
  ...
  public Result alterRegion(
      @CliOption(
            key = CliStrings.ALTER_REGION__REGION,
            mandatory = true,
            unspecifiedDefaultValue = CliMetaData.ANNOTATION_NULL_VALUE,
          ...
          String regionPath,
      @CliOption(
            key = CliStrings.ALTER_REGION__GROUP,
            optionContext = ConverterHint.MEMBERGROUP,
            unspecifiedDefaultValue = CliMetaData.ANNOTATION_NULL_VALUE,
          ...
          String[] groups,
      @CliOption(
            key = CliStrings.ALTER_REGION__ENTRYEXPIRATIONIDLETIME,
            unspecifiedDefaultValue = CliMetaData.ANNOTATION_NULL_VALUE,
      ...
      @CliOption(
          ...
          String entryExpirationIdleTimeAction,
      @CliOption(
            key = CliStrings.ALTER_REGION__ENTRYEXPIRATIONTIMETOLIVE,
            unspecifiedDefaultValue = CliMetaData.ANNOTATION_NULL_VALUE,
            specifiedDefaultValue = "-1",
          ...
          Integer entryExpirationTTL,
      @CliOption(
            key = CliStrings.ALTER_REGION__ENTRYEXPIRATIONTTLACTION,
            unspecifiedDefaultValue = CliMetaData.ANNOTATION_NULL_VALUE,
            specifiedDefaultValue = "INVALIDATE",
          ...
          String entryExpirationTTLAction,
      @CliOption(
            key = CliStrings.ALTER_REGION__REGIONEXPIRATIONIDLETIME,
            unspecifiedDefaultValue = CliMetaData.ANNOTATION_NULL_VALUE,
            specifiedDefaultValue = "-1",
          ...
          Integer regionExpirationIdleTime,
      @CliOption(
            key = CliStrings.ALTER_REGION__REGIONEXPIRATIONIDLETIMEACTION,
            unspecifiedDefaultValue = CliMetaData.ANNOTATION_NULL_VALUE,
            specifiedDefaultValue = "INVALIDATE",
          ...
          String regionExpirationIdleTimeAction,
      @CliOption(
            key = CliStrings.ALTER_REGION__REGIONEXPIRATIONTTL,
            unspecifiedDefaultValue = CliMetaData.ANNOTATION_NULL_VALUE,
            specifiedDefaultValue = "-1",
          ...
          Integer regionExpirationTTL,
      @CliOption(
            key = CliStrings.ALTER_REGION__REGIONEXPIRATIONTTLACTION,
            unspecifiedDefaultValue = CliMetaData.ANNOTATION_NULL_VALUE,
            specifiedDefaultValue = "INVALIDATE",
          ...
          String regionExpirationTTLAction,
      @CliOption(
            key = CliStrings.ALTER_REGION__CACHELISTENER,
            unspecifiedDefaultValue = CliMetaData.ANNOTATION_NULL_VALUE,
      ...
      @CliOption(
          ...
          String cacheLoader,
      @CliOption(
            key = CliStrings.ALTER_REGION__CACHEWRITER,
            unspecifiedDefaultValue = CliMetaData.ANNOTATION_NULL_VALUE,
            specifiedDefaultValue = "null",
          ...
          String cacheWriter,
      @CliOption(
            key = CliStrings.ALTER_REGION__ASYNCEVENTQUEUEID,
            unspecifiedDefaultValue = CliMetaData.ANNOTATION_NULL_VALUE,
            specifiedDefaultValue = "",
          ...
          String[] asyncEventQueueIds,
      @CliOption(
            key = CliStrings.ALTER_REGION__GATEWAYSENDERID,
            unspecifiedDefaultValue = CliMetaData.ANNOTATION_NULL_VALUE,
            specifiedDefaultValue = "",
          ...
          String[] gatewaySenderIds,
      @CliOption(
            key = CliStrings.ALTER_REGION__CLONINGENABLED,
            unspecifiedDefaultValue = CliMetaData.ANNOTATION_NULL_VALUE,
          ...
          Boolean cloningEnabled,
      @CliOption(
            key = CliStrings.ALTER_REGION__EVICTIONMAX,
            unspecifiedDefaultValue = CliMetaData.ANNOTATION_NULL_VALUE,
        ...
        for (String cacheListener : cacheListenersSet) {
          if (!isClassNameValid(cacheListener)) {
            throw new IllegalArgumentException(
                CliStrings.format(
                    CliStrings
                        .ALTER_REGION__MSG__SPECIFY_VALID_CLASSNAME_FOR_CACHELISTENER_0_IS_INVALID,
  ...
  private void validateRegionPathAndParent(Cache cache, String regionPath) {
    ...
    if (parentRegionPath != null && !Region.SEPARATOR.equals(parentRegionPath)) {
      if (!regionExists(cache, parentRegionPath)) {
        throw new IllegalArgumentException(
            CliStrings.format(
                CliStrings.CREATE_REGION__MSG__PARENT_REGION_FOR_0_DOESNOT_EXIST,
  ...
  private void validateGroups(Cache cache, String[] groups) {
    if (groups != null && groups.length != 0) {
      ...
      if (!groupsList.isEmpty()) {
        throw new IllegalArgumentException(
            CliStrings.format(
                CliStrings.CREATE_REGION__MSG__GROUPS_0_ARE_INVALID,
  ...
  private void validateRegionFunctionArgs(Cache cache, RegionFunctionArgs regionFunctionArgs) {
    ...
    if (useAttributesFrom != null
      ...
      if (!regionFunctionArgs.isSetUseAttributesFrom()
        ...
        throw new IllegalArgumentException(
            CliStrings.format(
                CliStrings
                    .CREATE_REGION__MSG__COULD_NOT_RETRIEVE_REGION_ATTRS_FOR_PATH_0_VERIFY_REGION_EXISTS,
                useAttributesFrom));
      }
    }
    ...
    if (valueConstraint != null && !isClassNameValid(valueConstraint)) {
      throw new IllegalArgumentException(
          CliStrings.format(
              CliStrings
                  .CREATE_REGION__MSG__SPECIFY_VALID_CLASSNAME_FOR_VALUECONSTRAINT_0_IS_INVALID,
      ...
      for (String cacheListener : cacheListeners) {
        if (!isClassNameValid(cacheListener)) {
          throw new IllegalArgumentException(
              CliStrings.format(
                  CliStrings
                      .CREATE_REGION__MSG__SPECIFY_VALID_CLASSNAME_FOR_CACHELISTENER_0_IS_INVALID,
                  new Object[] {cacheListener}));
        }
      }
    }
    ...
    if (regionFunctionArgs.isSetConcurrencyLevel()) {
      ...
      if (concurrencyLevel < 0) {
        throw new IllegalArgumentException(
            CliStrings.format(
                CliStrings
                    .CREATE_REGION__MSG__SPECIFY_POSITIVE_INT_FOR_CONCURRENCYLEVEL_0_IS_NOT_VALID,
      ...
      if (regionShortcut != null && !PERSISTENT_OVERFLOW_SHORTCUTS.contains(regionShortcut)) {
        ...
        String message =
            subMessage
                + ". "
                + CliStrings.format(
                    CliStrings.CREATE_REGION__MSG__USE_ONE_OF_THESE_SHORTCUTS_0,
      ...
      if (regionAttributes != null && !regionAttributes.getDataPolicy().withPersistence()) {
        ...
        String message =
            subMessage
                ...
                + CliStrings.format(
                    CliStrings
                        .CREATE_REGION__MSG__USE_ATTRIBUTES_FROM_REGION_0_IS_NOT_WITH_PERSISTENCE,
    ...
    if (regionFunctionArgs.isSetCompressor()) {
      ...
      if (compressorFailure || !(compressor instanceof Compressor)) {
        throw new IllegalArgumentException(
            CliStrings.format(
                CliStrings.CREATE_REGION__MSG__INVALID_COMPRESSOR,
  ...
  private static <K, V> FetchRegionAttributesFunctionResult<K, V> getRegionAttributes(
    ...
    if (attributes == null) {
      ...
      if (regionAssociatedMembers != null && !regionAssociatedMembers.isEmpty()) {
        ...
        ResultCollector<?, ?> resultCollector =
            CliUtil.executeFunction(
                FetchRegionAttributesFunction.INSTANCE, regionPath, distributedMember);
          ...
          for (int i = 0; i < resultsList.size(); i++) {
            ...
            if (object instanceof IllegalArgumentException) {
              ...
              throw new IllegalArgumentException(
                  CliStrings.format(
                      CliStrings
                          .CREATE_REGION__MSG__COULD_NOT_RETRIEVE_REGION_ATTRS_FOR_PATH_0_REASON_1,
  ...
  private static boolean isClusterwideSameConfig(Cache cache, String regionPath) {
    ...
    for (DistributedMember distributedMember : allMembers) {
      ...
      try {
        regionObjectName =
            dsMXBean.fetchRegionObjectName(
                CliUtil.getMemberNameOrId(distributedMember), regionPath);
        ...
        } else if (!(regionAttributesToValidateAgainst
                .getScope()
                .equals(regionAttributes.getScope())
            || regionAttributesToValidateAgainst
                .getDataPolicy()
  ...
  @CliCommand(
    value = {CliStrings.DESTROY_REGION},
    help = CliStrings.DESTROY_REGION__HELP
  )
  @CliMetaData(
    shellOnly = false,
  ...
  public Result destroyRegion(
      @CliOption(
            key = CliStrings.DESTROY_REGION__REGION,
            optionContext = ConverterHint.REGIONPATH,
            mandatory = true,
    ...
    if (regionPath == null) {
      return ResultBuilder.createInfoResult(
          CliStrings.DESTROY_REGION__MSG__SPECIFY_REGIONPATH_TO_DESTROY);
    }
    ...
    try {
      ...
      if (regionMembersList.size() == 0) {
        return ResultBuilder.createUserErrorResult(
            CliStrings.format(
                CliStrings.DESTROY_REGION__MSG__COULDNOT_FIND_REGIONPATH_0_IN_GEODE,
      ...
      message =
          CliStrings.format(
              CliStrings.DESTROY_REGION__MSG__REGION_0_1_DESTROYED,
  ...
  private Set<DistributedMember> findMembersForRegion(
      Cache cache, ManagementService managementService, String regionPath) {
      ...
      for (ObjectName regionMBeanObjectName : queryNames) {
        try {
          ...
          if (logger.finerEnabled()) {
            logger.finer(
                regionMBeanObjectName + " is not a " + RegionMXBean.class.getSimpleName(), e);
          }
        }
      }
