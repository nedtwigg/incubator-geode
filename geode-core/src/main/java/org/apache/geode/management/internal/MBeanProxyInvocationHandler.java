...
public class MBeanProxyInvocationHandler implements InvocationHandler {
  ...
  public static Object newProxyInstance(
    ...
    Object proxy =
        Proxy.newProxyInstance(
            MBeanProxyInvocationHandler.class.getClassLoader(), interfaces, handler);
   ...
   * @throws ClassNotFoundException
   */
  private MBeanProxyInvocationHandler(
      DistributedMember member,
      ObjectName objectName,
      Region<String, Object> monitoringRegion,
      boolean isMXBean)
   ...
   * federated component.
   *
   * <p>All setters and operations() are delegated to the function service.
   *
   * <p>Notification emmitter methods are also delegated to the function service
   */
  @Override
   ...
   */
  protected Object delegateToFucntionService(
      ObjectName objectName, String methodName, Object[] args, String[] signature)
      throws Throwable {
   ...
   *
   * <p>Moreover it will also add the client to local listener list by adding to the contained
   * emitter.
   *
  ...
  private boolean shouldDoLocally(Object proxy, Method method) {
    ...
    if (methodName.equals("equals")
        && Arrays.equals(method.getParameterTypes(), new Class[] {Object.class})) return true;
    return false;
  }
  ...
  private MXBeanProxyInvocationHandler findMXBeanProxy(
      ObjectName objectName, Class<?> mxbeanInterface, MBeanProxyInvocationHandler handler)
      throws Throwable {
