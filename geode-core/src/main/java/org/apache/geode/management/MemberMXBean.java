...
/**
 * MBean that provides access to information and management functionality for a {@link
 * DistributedMember} of the GemFire distributed system.
 *
 * <p>ObjectName of the MBean :GemFire:type=Member,member=&ltname-or-dist-member-id&gt
 *
 * <p>There will be one instance of this MBean per GemFire node.
 *
 * <p>List of notification emitted by MemberMXBean.
 *
 * <p>
 *
 * <table border="1">
...
public interface MemberMXBean {
   ...
   * ((p2-p1) * 100) / ((t2-t1))
   *
   * <p>ProcessCpuTime is obtained from OperatingSystemMXBean. If process CPU time is not available
   * in the platform it will be shown as -1
   */
