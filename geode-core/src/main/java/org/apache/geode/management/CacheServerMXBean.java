...
public interface CacheServerMXBean {
   ...
   *     copies of the CQ on other servers are not affected. Using the client side CQ methods to
   *     modify a CQ.
   */
  @Deprecated
   ...
   *
   * <p>eventsEnqued,eventsRemoved , eventsConflated ,markerEventsConflated , eventsExpired,
