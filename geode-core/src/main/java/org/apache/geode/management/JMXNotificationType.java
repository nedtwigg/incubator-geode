 ...
 *
 * <p>For detail usage see GemFire quick start.
 *
 * @since GemFire 8.0
 */
public interface JMXNotificationType {
   ...
   * The value of this type string is <CODE>gemfire.distributedsystem.cache.lockservice.created
   * </CODE>.
   */
   ...
   * The value of this type string is <CODE>gemfire.distributedsystem.cache.lockservice.closed
   * </CODE>.
   */
   ...
   * The value of this type string is <CODE>gemfire.distributedsystem.cacheserver.client.joined
   * </CODE>.
   */
   ...
   * The value of this type string is <CODE>gemfire.distributedsystem.cacheserver.client.left</CODE>
   * .
   */
   ...
   * The value of this type string is <CODE>gemfire.distributedsystem.cacheserver.client.crashed
   * </CODE>.
   */
   ...
   * The value of this type string is <CODE>gemfire.distributedsystem.gateway.receiver.created
   * </CODE>.
   */
   ...
   * The value of this type string is <CODE>ggemfire.distributedsystem.asycn.event.queue.created
   * </CODE>.
   */
   ...
   * The value of this type string is <CODE>gemfire.distributedsystem.gateway.receiver.started
   * </CODE>.
   */
   ...
   * The value of this type string is <CODE>gemfire.distributedsystem.gateway.receiver.stopped
   * </CODE>.
   */
