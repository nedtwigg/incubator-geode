...
/**
 * MBean that provides access to information and management functionality for a local {@link
 * Region}.
 *
 * <p>For all the latency related attributes e.g. PutRemoteLatency ,DiskWritesAverageLatency etc..
...
public interface RegionMXBean {
   ...
   *
   * <p>For all partition regions it will show entry size in bytes. It will also include size of all
