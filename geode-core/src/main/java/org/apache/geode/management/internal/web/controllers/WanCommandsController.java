...
public class WanCommandsController extends AbstractCommandsController {
  ...
  public String listGateways(
      ...
      @RequestParam(value = CliStrings.LIST_GATEWAY__MEMBER, required = false)
          final String[] members) {
    CommandStringBuilder command = new CommandStringBuilder(CliStrings.LIST_GATEWAY);

    if (hasValue(groups)) {
      command.addOption(
          CliStrings.LIST_GATEWAY__GROUP, StringUtils.concat(groups, StringUtils.COMMA_DELIMITER));
    }

    if (hasValue(members)) {
      command.addOption(
          CliStrings.LIST_GATEWAY__MEMBER,
  ...
  public String createGatewayReceiver(
      @RequestParam(value = CliStrings.CREATE_GATEWAYRECEIVER__GROUP, required = false)
          final String[] groups,
      @RequestParam(value = CliStrings.CREATE_GATEWAYRECEIVER__MANUALSTART, required = false)
          final Boolean manualStart,
      @RequestParam(value = CliStrings.CREATE_GATEWAYRECEIVER__MEMBER, required = false)
          final String[] members,
      @RequestParam(value = CliStrings.CREATE_GATEWAYRECEIVER__STARTPORT, required = false)
          final Integer startPort,
      @RequestParam(value = CliStrings.CREATE_GATEWAYRECEIVER__ENDPORT, required = false)
          final Integer endPort,
      @RequestParam(value = CliStrings.CREATE_GATEWAYRECEIVER__BINDADDRESS, required = false)
          final String bindAddress,
      @RequestParam(
            value = CliStrings.CREATE_GATEWAYRECEIVER__MAXTIMEBETWEENPINGS,
            required = false
          )
          final Integer maximumTimeBetweenPings,
      @RequestParam(value = CliStrings.CREATE_GATEWAYRECEIVER__SOCKETBUFFERSIZE, required = false)
          final Integer socketBufferSize,
      @RequestParam(
            value = CliStrings.CREATE_GATEWAYRECEIVER__GATEWAYTRANSPORTFILTER,
            required = false
          )
    ...
    if (hasValue(manualStart)) {
      command.addOption(
          CliStrings.CREATE_GATEWAYRECEIVER__MANUALSTART, String.valueOf(manualStart));
    }
    ...
    if (hasValue(socketBufferSize)) {
      command.addOption(
          CliStrings.CREATE_GATEWAYRECEIVER__SOCKETBUFFERSIZE, String.valueOf(socketBufferSize));
    }
  ...
  public String createGatewaySender(
      ...
      @RequestParam(CliStrings.CREATE_GATEWAYSENDER__REMOTEDISTRIBUTEDSYSTEMID)
          final Integer remoteDistributedSystemId,
      @RequestParam(value = CliStrings.CREATE_GATEWAYSENDER__GROUP, required = false)
          final String[] groups,
      @RequestParam(value = CliStrings.CREATE_GATEWAYSENDER__MEMBER, required = false)
          final String[] members,
      @RequestParam(value = CliStrings.CREATE_GATEWAYSENDER__PARALLEL, required = false)
          final Boolean parallel,
      @RequestParam(value = CliStrings.CREATE_GATEWAYSENDER__MANUALSTART, required = false)
          final Boolean manualStart,
      @RequestParam(value = CliStrings.CREATE_GATEWAYSENDER__SOCKETBUFFERSIZE, required = false)
          final Integer socketBufferSize,
      @RequestParam(value = CliStrings.CREATE_GATEWAYSENDER__SOCKETREADTIMEOUT, required = false)
          final Integer socketReadTimeout,
      @RequestParam(
            value = CliStrings.CREATE_GATEWAYSENDER__ENABLEBATCHCONFLATION,
            required = false
          )
          final Boolean enableBatchConflation,
      @RequestParam(value = CliStrings.CREATE_GATEWAYSENDER__BATCHSIZE, required = false)
          final Integer batchSize,
      @RequestParam(value = CliStrings.CREATE_GATEWAYSENDER__BATCHTIMEINTERVAL, required = false)
          final Integer batchTimeInterval,
      @RequestParam(value = CliStrings.CREATE_GATEWAYSENDER__ENABLEPERSISTENCE, required = false)
          final Boolean enablePersistence,
      @RequestParam(value = CliStrings.CREATE_GATEWAYSENDER__DISKSTORENAME, required = false)
          final String diskStoreName,
      @RequestParam(value = CliStrings.CREATE_GATEWAYSENDER__DISKSYNCHRONOUS, required = false)
          final Boolean diskSynchronous,
      @RequestParam(value = CliStrings.CREATE_GATEWAYSENDER__MAXQUEUEMEMORY, required = false)
          final Integer maxQueueMemory,
      @RequestParam(value = CliStrings.CREATE_GATEWAYSENDER__ALERTTHRESHOLD, required = false)
          final Integer alertThreshold,
      @RequestParam(value = CliStrings.CREATE_GATEWAYSENDER__DISPATCHERTHREADS, required = false)
          final Integer dispatcherThreads,
      @RequestParam(value = CliStrings.CREATE_GATEWAYSENDER__ORDERPOLICY, required = false)
          final String orderPolicy,
      @RequestParam(value = CliStrings.CREATE_GATEWAYSENDER__GATEWAYEVENTFILTER, required = false)
          final String[] gatewayEventFilters,
      @RequestParam(
            value = CliStrings.CREATE_GATEWAYSENDER__GATEWAYTRANSPORTFILTER,
            required = false
          )
          final String[] gatewayTransportFilters) {
    ...
    if (hasValue(members)) {
      command.addOption(
          CliStrings.CREATE_GATEWAYSENDER__MEMBER,
          StringUtils.concat(members, StringUtils.COMMA_DELIMITER));
    }
    ...
    if (hasValue(socketBufferSize)) {
      command.addOption(
          CliStrings.CREATE_GATEWAYSENDER__SOCKETBUFFERSIZE, String.valueOf(socketBufferSize));
    }

    if (hasValue(socketReadTimeout)) {
      command.addOption(
          CliStrings.CREATE_GATEWAYSENDER__SOCKETREADTIMEOUT, String.valueOf(socketReadTimeout));
    }
    ...
    if (hasValue(batchTimeInterval)) {
      command.addOption(
          CliStrings.CREATE_GATEWAYSENDER__BATCHTIMEINTERVAL, String.valueOf(batchTimeInterval));
    }

    if (hasValue(enablePersistence)) {
      command.addOption(
          CliStrings.CREATE_GATEWAYSENDER__ENABLEPERSISTENCE, String.valueOf(enablePersistence));
    }
    ...
    if (hasValue(diskSynchronous)) {
      command.addOption(
          CliStrings.CREATE_GATEWAYSENDER__DISKSYNCHRONOUS, String.valueOf(diskSynchronous));
    }

    if (hasValue(maxQueueMemory)) {
      command.addOption(
          CliStrings.CREATE_GATEWAYSENDER__MAXQUEUEMEMORY, String.valueOf(maxQueueMemory));
    }

    if (hasValue(alertThreshold)) {
      command.addOption(
          CliStrings.CREATE_GATEWAYSENDER__ALERTTHRESHOLD, String.valueOf(alertThreshold));
    }

    if (hasValue(dispatcherThreads)) {
      command.addOption(
          CliStrings.CREATE_GATEWAYSENDER__DISPATCHERTHREADS, String.valueOf(dispatcherThreads));
    }
  ...
  @ResponseBody
  public String pauseGatewaySender(
      @PathVariable("id") final String gatewaySenderId,
      @RequestParam(value = CliStrings.PAUSE_GATEWAYSENDER__GROUP, required = false)
          final String[] groups,
      @RequestParam(value = CliStrings.PAUSE_GATEWAYSENDER__MEMBER, required = false)
          final String[] members) {
  ...
  @ResponseBody
  public String resumeGatewaySender(
      @PathVariable("id") final String gatewaySenderId,
      @RequestParam(value = CliStrings.RESUME_GATEWAYSENDER__GROUP, required = false)
          final String[] groups,
      @RequestParam(value = CliStrings.RESUME_GATEWAYSENDER__MEMBER, required = false)
          final String[] members) {
  ...
  public String startGatewayReceiver(
      @RequestParam(value = CliStrings.START_GATEWAYRECEIVER__GROUP, required = false)
          final String[] groups,
      @RequestParam(value = CliStrings.START_GATEWAYRECEIVER__MEMBER, required = false)
          final String[] members) {
  ...
  public String startGatewaySender(
      ...
      @RequestParam(value = CliStrings.START_GATEWAYSENDER__GROUP, required = false)
          final String[] groups,
      @RequestParam(value = CliStrings.START_GATEWAYSENDER__MEMBER, required = false)
          final String[] members) {
    ...
    if (hasValue(groups)) {
      command.addOption(
          CliStrings.START_GATEWAYSENDER__GROUP,
          StringUtils.concat(groups, StringUtils.COMMA_DELIMITER));
    }

    if (hasValue(members)) {
      command.addOption(
          CliStrings.START_GATEWAYSENDER__MEMBER,
          StringUtils.concat(members, StringUtils.COMMA_DELIMITER));
    }
  ...
  public String statusGatewayReceivers(
      @RequestParam(value = CliStrings.STATUS_GATEWAYRECEIVER__GROUP, required = false)
          final String[] groups,
      @RequestParam(value = CliStrings.STATUS_GATEWAYRECEIVER__MEMBER, required = false)
          final String[] members) {
  ...
  @ResponseBody
  public String statusGatewaySenders(
      @PathVariable("id") final String gatewaySenderId,
      @RequestParam(value = CliStrings.STATUS_GATEWAYSENDER__GROUP, required = false)
          final String[] groups,
      @RequestParam(value = CliStrings.STATUS_GATEWAYSENDER__MEMBER, required = false)
          final String[] members) {
  ...
  public String stopGatewayReceiver(
      @RequestParam(value = CliStrings.STOP_GATEWAYRECEIVER__GROUP, required = false)
          final String[] groups,
      @RequestParam(value = CliStrings.STOP_GATEWAYRECEIVER__MEMBER, required = false)
          final String[] members) {
  ...
  @ResponseBody
  public String stopGatewaySender(
      @PathVariable("id") final String gatewaySenderId,
      @RequestParam(value = CliStrings.STOP_GATEWAYRECEIVER__GROUP, required = false)
          final String[] groups,
      @RequestParam(value = CliStrings.STOP_GATEWAYRECEIVER__MEMBER, required = false)
    ...
    if (hasValue(groups)) {
      command.addOption(
          CliStrings.STOP_GATEWAYSENDER__GROUP,
          StringUtils.concat(groups, StringUtils.COMMA_DELIMITER));
    }

    if (hasValue(members)) {
      command.addOption(
          CliStrings.STOP_GATEWAYSENDER__MEMBER,
          StringUtils.concat(members, StringUtils.COMMA_DELIMITER));
    }
