...
public class GemFireProperties {
   ...
   *
   * <p>If "mcast-port" is zero and "locators" is "" then this distributed system will be isolated
   * from all other GemFire processes.
   */
   ...
   * for peers to discover eachother, or for clients to discover peers. By default both are true.
   ...
   *
   * <p>when ack-severe-alert-threshold is used, GemFire will also initiate additional checks to see
   * if the process is alive. These checks will begin when the ack-wait-threshold is reached and
   * will continue until GemFire has been able to communicate with the process and ascertain its
   * status.
   */
  ...
  @Deprecated private boolean jmxManagerSSLEnabled;
  /** @deprecated Geode 1.0 use {@link #clusterSSLProtocols} */
  @Deprecated private String jmxManagerSSLProtocols;
  /** @deprecated Geode 1.0 use {@link #clusterSSLCiphers} */
  @Deprecated private String jmxManagerSSLCiphers;
  /** @deprecated Geode 1.0 use {@link #clusterSSLRequireAuthentication} */
  @Deprecated private boolean jmxManagerSSLRequireAuthentication;
  /** @deprecated Geode 1.0 use {@link #clusterSSLKeyStore} */
  @Deprecated private String jmxManagerSSLKeyStore;
  /** @deprecated Geode 1.0 use {@link #clusterSSLKeyStoreType} */
  @Deprecated private String jmxManagerSSLKeyStoreType;
  /** @deprecated Geode 1.0 use {@link #clusterSSLKeyStorePassword} */
  @Deprecated private String jmxManagerSSLKeyStorePassword;
  /** @deprecated Geode 1.0 use {@link #clusterSSLTrustStore} */
  @Deprecated private String jmxManagerSSLTrustStore;
  /** @deprecated Geode 1.0 use {@link #clusterSSLTrustStorePassword} */
  @Deprecated private String jmxManagerSSLTrustStorePassword;
  ...
  /** @deprecated Geode 1.0 use {@link #clusterSSLEnabled} */
  @Deprecated private boolean serverSSLEnabled;
  /** @deprecated Geode 1.0 use {@link #clusterSSLProtocols} */
  @Deprecated private String serverSSLProtocols;
  /** @deprecated Geode 1.0 use {@link #clusterSSLCiphers} */
  @Deprecated private String serverSSLCiphers;
  /** @deprecated Geode 1.0 use {@link #clusterSSLRequireAuthentication} */
  @Deprecated private boolean serverSSLRequireAuthentication;
  /** @deprecated Geode 1.0 use {@link #clusterSSLKeyStore} */
  @Deprecated private String serverSSLKeyStore;
  /** @deprecated Geode 1.0 use {@link #clusterSSLKeyStoreType} */
  @Deprecated private String serverSSLKeyStoreType;
  /** @deprecated Geode 1.0 use {@link #clusterSSLKeyStorePassword} */
  @Deprecated private String serverSSLKeyStorePassword;
  /** @deprecated Geode 1.0 use {@link #clusterSSLTrustStore} */
  @Deprecated private String serverSSLTrustStore;
  /** @deprecated Geode 1.0 use {@link #clusterSSLTrustStorePassword} */
  @Deprecated private String serverSSLTrustStorePassword;

  private String serverSSLAlias;

  /** @deprecated Geode 1.0 use {@link #clusterSSLEnabled} */
  @Deprecated private boolean gatewaySSLEnabled;
  /** @deprecated Geode 1.0 use {@link #clusterSSLProtocols} */
  @Deprecated private String gatewaySSLProtocols;
  /** @deprecated Geode 1.0 use {@link #clusterSSLCiphers} */
  @Deprecated private String gatewaySSLCiphers;
  /** @deprecated Geode 1.0 use {@link #clusterSSLRequireAuthentication} */
  @Deprecated private boolean gatewaySSLRequireAuthentication;
  /** @deprecated Geode 1.0 use {@link #clusterSSLKeyStore} */
  @Deprecated private String gatewaySSLKeyStore;
  /** @deprecated Geode 1.0 use {@link #clusterSSLKeyStoreType} */
  @Deprecated private String gatewaySSLKeyStoreType;
  /** @deprecated Geode 1.0 use {@link #clusterSSLKeyStorePassword} */
  @Deprecated private String gatewaySSLKeyStorePassword;
  /** @deprecated Geode 1.0 use {@link #clusterSSLTrustStore} */
  @Deprecated private String gatewaySSLTrustStore;
  /** @deprecated Geode 1.0 use {@link #clusterSSLTrustStorePassword} */
  @Deprecated private String gatewaySSLTrustStorePassword;

  private String gatewaySSLAlias;

  /** @deprecated Geode 1.0 use {@link #clusterSSLEnabled} */
  @Deprecated private boolean httpServiceSSLEnabled;
  /** @deprecated Geode 1.0 use {@link #clusterSSLRequireAuthentication} */
  @Deprecated private boolean httpServiceSSLRequireAuthentication;
  /** @deprecated Geode 1.0 use {@link #clusterSSLProtocols} */
  @Deprecated private String httpServiceSSLProtocols;
  /** @deprecated Geode 1.0 use {@link #clusterSSLCiphers} */
  @Deprecated private String httpServiceSSLCiphers;
  /** @deprecated Geode 1.0 use {@link #clusterSSLKeyStore} */
  @Deprecated private String httpServiceSSLKeyStore;
  /** @deprecated Geode 1.0 use {@link #clusterSSLKeyStoreType} */
  @Deprecated private String httpServiceSSLKeyStoreType;
  /** @deprecated Geode 1.0 use {@link #clusterSSLKeyStorePassword} */
  @Deprecated private String httpServiceSSLKeyStorePassword;
  /** @deprecated Geode 1.0 use {@link #clusterSSLTrustStore} */
  @Deprecated private String httpServiceSSLTrustStore;
  /** @deprecated Geode 1.0 use {@link #clusterSSLTrustStorePassword} */
  @Deprecated private String httpServiceSSLTrustStorePassword;
