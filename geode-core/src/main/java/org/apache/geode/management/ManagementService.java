...
public abstract class ManagementService {
   ...
   */
  public abstract <T> void federate(
  ...
  /**
   * Returns an instance of an MBean. This is a reference to the MBean instance and not a {@link
   * ObjectInstance}.
   *
   * @param objectName Object name of the MBean.
   * @param interfaceClass Interface which this MBean exposes.
   ...
   * @param lockServiceName Name of the lock service.
   */
  public abstract ObjectName getLockServiceMBeanName(
   ...
   */
  public abstract ObjectName getGatewaySenderMBeanName(
      DistributedMember member, String gatwaySenderId);
