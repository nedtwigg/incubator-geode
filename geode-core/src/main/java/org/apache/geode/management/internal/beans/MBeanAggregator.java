...
public class MBeanAggregator implements ProxyListener {
  ...
  @Override
  public void afterPseudoCreateProxy(
      ObjectName objectName, Class interfaceClass, Object proxyObject, FederationComponent newVal) {
    if (!distributedMBeanList.contains(interfaceClass)) {
      return;
    }
  ...
  private class CacheServerHandler implements AggregateHandler {
    ...
    public void handleProxyRemoval(
        ObjectName objectName, Class interfaceClass, Object obj, FederationComponent oldVal) {
