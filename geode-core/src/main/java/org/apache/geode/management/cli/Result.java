 ...
 *
 * <p>A string representation of this Result can be iterated over using the methods {@link
 * #hasNextLine()}, {@link #nextLine()} and {@link #resetToFirstLine()}.
 *
 * <p>A Result may have one or more files as part of the command output and if so they can be saved
 * to the file system using {@link #saveIncomingFiles(String)}. To check whether the result has a
 * file in it use {@link #hasIncomingFiles()}.
 *
 * @since GemFire 7.0
 */
