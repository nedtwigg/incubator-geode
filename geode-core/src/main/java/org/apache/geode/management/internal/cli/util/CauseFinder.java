...
public class CauseFinder {
   ...
   *
   * <p>NOTE: It looks for the "nested" causes & doesn't try to match the <code>causeClass</code> of
   * the <code>parent</code>.
   *
   * <p>Returns -1 if a cause with the given Throwable type is not found.
   *
   ...
   *     can't find it.
   */
  public static int indexOfCause(
      Throwable parent, Class<? extends Throwable> causeClass, final boolean isSubtypeOk) {
   ...
   *     can't find it.
   */
  private static int indexOfCause(
      Throwable parent,
  ...
  /**
   * Returns whether the given <code>cause</code> is assignable or has same type as that of <code>
   * causeClass</code> depending on <code>isSubtypeOk</code> value.
   *
   * @param cause parent Throwable instance
   * @param causeClass type of the nested Throwable cause
   * @param isSubtypeOk whether any matching sub-type is required or exact match is required
   * @return true if <code>cause</code> is assignable or has same type as that of <code>causeClass
   *     </code>. false otherwise
   */
  //Note: No not null check on 'Throwable cause' - currently called after null check
  private static boolean isMatching(
      Throwable cause, Class<? extends Throwable> causeClass, final boolean isSubtypeOk) {
  ...
  /**
   * Returns nested 'root' cause of the given parent Throwable. Will return the same Throwable if it
   * has no 'cause'. If <code>depth</code> is 0, does a <code>null</code> check on the given <code>
   * parent Throwable</code> & if <code>parent</code> is <code>null</code>, throws {@link
  ...
  /**
   * Returns cause at the specified depth/index starting from the 'top most' Throwable <code>parent
   * </code> in the stack. Returns <code>null</code> if it can't find it.
   *
   ...
   */
  public static Throwable causeByType(
      Throwable parent, Class<? extends Throwable> causeType, boolean isSubtypeOk) {
