...
public interface DiskStoreMXBean {
   ...
   *
   * <p>Each entry in region has some overhead in terms of number of extra bytes while persisting
   * data. So this rate won't match the number of bytes put in all regions.This is rate of actual
