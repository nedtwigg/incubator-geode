 ...
 *
 * <p>2. Defining Topic constants: 2.1 The constants' names should begin with "TOPIC_" E.g.
 * TOPIC_GEODE_REGION 2.2 Topic brief description should be defined with suffix "__DESC". E.g.
 * TOPIC_GEODE_REGION__DESC
 *
 * <p>3. Order for adding constants: It should be alphabetically sorted at least on the first name
...
public class CliStrings {
  ...
  public static final String
      GFSHPARSER__MSG__AMBIGIOUS_COMMAND_0_FOR_ASSISTANCE_USE_1_OR_HINT_HELP =
  ...
  public static final String ALTER_REGION__ASYNCEVENTQUEUEID__HELP =
      "IDs of the Async Event Queues that will be used for write-behind operations."; // TODO - Abhishek Is this correct?
  ...
  public static final String
      ALTER_REGION__MSG__SPECIFY_VALID_CLASSNAME_FOR_CACHELISTENER_0_IS_INVALID =
          "Specify a valid class name for "
              + CliStrings.CREATE_REGION__CACHELISTENER
              + ". \"{0}\" is not valid.";
  public static final String
      ALTER_REGION__MSG__SPECIFY_VALID_CLASSNAME_FOR_CACHEWRITER_0_IS_INVALID =
          "Specify a valid class name for "
              + CliStrings.CREATE_REGION__CACHEWRITER
              + ". \"{0}\" is not valid.";
  public static final String
      ALTER_REGION__MSG__SPECIFY_VALID_CLASSNAME_FOR_CACHELOADER_0_IS_INVALID =
          "Specify a valid class name for "
  ...
  public static final String
      COMPACT_OFFLINE_DISK_STORE__MSG__DISKSTORE_IN_USE_COMPACT_DISKSTORE_CAN_BE_USED =
          "This disk store is in use by other process. \""
  ...
  public static final String
      CONNECT__MSG__COULD_NOT_CONNECT_TO_LOCATOR_0_POSSIBLY_SSL_CONFIG_ERROR =
          "Could not connect to Locator at {0}."
              + Gfsh.LINE_SEPARATOR
              + "Possible reason: Wrong or no SSL configuration provided.";
  public static final String
      CONNECT__MSG__COULD_NOT_CONNECT_TO_MANAGER_0_POSSIBLY_SSL_CONFIG_ERROR =
          "Could not connect to Manager at {0}."
              + Gfsh.LINE_SEPARATOR
              + "Possible reason: Wrong or no SSL configuration provided.";
  ...
  public static final String
      CREATE_REGION__MSG__SPECIFY_VALID_CLASSNAME_FOR_KEYCONSTRAINT_0_IS_INVALID =
          "Specify a valid class name for "
  ...
  public static final String
      CREATE_REGION__MSG__SPECIFY_VALID_CLASSNAME_FOR_CACHELISTENER_0_IS_INVALID =
          "Specify a valid class name for "
              ...
              + ". \"{0}\" is not valid.";
  public static final String
      CREATE_REGION__MSG__SPECIFY_VALID_CLASSNAME_FOR_CACHEWRITER_0_IS_INVALID =
          "Specify a valid class name for "
              + CliStrings.CREATE_REGION__CACHEWRITER
              + ". \"{0}\" is not valid.";
  public static final String
      CREATE_REGION__MSG__SPECIFY_VALID_CLASSNAME_FOR_CACHELOADER_0_IS_INVALID =
          "Specify a valid class name for "
              + CliStrings.CREATE_REGION__CACHELOADER
              + ". \"{0}\" is not valid.";
  ...
  public static final String
      CREATE_REGION__MSG__SPECIFY_POSITIVE_INT_FOR_CONCURRENCYLEVEL_0_IS_NOT_VALID =
          "Specify positive integer value for "
              + CliStrings.CREATE_REGION__CONCURRENCYLEVEL
              + ".  \"{0}\" is not valid.";
  ...
  public static final String CREATE_REGION__MSG__ERROR_ON_MEMBER_0 =
      "Error on member: {0}. "; // leave space in the end
  // for further message
  public static final String
  ...
  public static final String
      CREATE_REGION__MSG__COULD_NOT_RETRIEVE_REGION_ATTRS_FOR_PATH_0_VERIFY_REGION_EXISTS =
          "Could not retrieve region attributes for given path \"{0}\". Use \""
  ...
  public static final String
      EXECUTE_FUNCTION__MSG__COULD_NOT_EXECUTE_FUNCTION_0_ON_MEMBER_1_ERROR_2 =
  ...
  public static final String
      EXECUTE_FUNCTION__MSG__ERROR_IN_EXECUTING_0_ON_MEMBER_1_ON_REGION_2_DETAILS_3 =
  ...
  public static final String HINT__MSG__TOPICS_AVAILABLE =
      "Hints are available for the following topics. Use \""
          + HINT
  ...
  public static final String QUERY__HELP =
      "Run the specified OQL query as a single quoted string and display the results in one or more pages."
          ...
          + "\" variable."
          + " Page size will default to the value stored in the \""
          + Gfsh.ENV_APP_COLLECTION_LIMIT
          + "\" variable.";
  ...
  public static final String USEFUL_VARIABLES =
      "[A] System Variables\n"
  ...
  public static final String START_LOCATOR__PROPERTIES__HELP =
      "The gemfire.properties file for configuring the Locator's distributed system. The file's path can be absolute or relative to the gfsh working directory (--dir=)."; // TODO:GEODE-1466: update golden file to geode.properties
  ...
  public static final String START_LOCATOR__ENABLE__SHARED__CONFIGURATION__HELP =
      "When "
          + START_LOCATOR__ENABLE__SHARED__CONFIGURATION
  ...
  public static final String START_SERVER__PROPERTIES__HELP =
      "The gemfire.properties file for configuring the Cache Server's distributed system. The file's path can be absolute or relative to the gfsh working directory."; // TODO:GEODE-1466: update golden file to geode.properties
  ...
  public static final String START_SERVER__REDIS_PASSWORD__HELP =
      "Sets the authentication password for GeodeRedisServer"; // TODO:GEODE-1566: update golden file to GeodeRedisServer
  ...
  public static final String
      UPGRADE_OFFLINE_DISK_STORE__MSG__DISKSTORE_IN_USE_COMPACT_DISKSTORE_CAN_BE_USED =
          "The disk is currently being used by another process";
  public static final String
      UPGRADE_OFFLINE_DISK_STORE__MSG__CANNOT_ACCESS_DISKSTORE_0_FROM_1_CHECK_GFSH_LOGS =
          COMPACT_OFFLINE_DISK_STORE__MSG__CANNOT_ACCESS_DISKSTORE_0_FROM_1_CHECK_GFSH_LOGS;
  public static final String
