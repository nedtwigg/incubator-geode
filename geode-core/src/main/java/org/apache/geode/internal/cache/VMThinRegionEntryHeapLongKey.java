...
public class VMThinRegionEntryHeapLongKey extends VMThinRegionEntryHeap {
  ...
  private static final AtomicLongFieldUpdater<VMThinRegionEntryHeapLongKey> lastModifiedUpdater = AtomicLongFieldUpdater.newUpdater(VMThinRegionEntryHeapLongKey.class, "lastModified");
