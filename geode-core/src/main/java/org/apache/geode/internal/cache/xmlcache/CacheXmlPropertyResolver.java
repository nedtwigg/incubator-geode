...
public class CacheXmlPropertyResolver implements PropertyResolver {
  ...
  public CacheXmlPropertyResolver(
      boolean ignoreUnresolvedProperties, int propertyOverridden, Properties props) {
    super();
  ...
  /**
   * Sets <code>propertyOverridden</code> with one of the constants specified in this {@link
   * CacheXmlPropertyResolver} class.
   *
   ...
   * is found then {@link IllegalArgumentException} would be thrown based on <code>
