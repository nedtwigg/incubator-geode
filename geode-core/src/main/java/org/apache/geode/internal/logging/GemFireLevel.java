...
public class GemFireLevel extends Level {
   ...
   *
   * <p>In general ERROR messages should describe events that are of considerable importance but
   * will not prevent program execution. They should be reasonably intelligible to end users and to
    ...
    switch (code) {
      ...
      default:
        throw new IllegalArgumentException(
            LocalizedStrings.GemFireLevel_UNEXPECTED_LEVEL_CODE_0.toLocalizedString(
