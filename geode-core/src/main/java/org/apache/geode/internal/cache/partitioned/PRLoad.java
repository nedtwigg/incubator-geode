...
public final class PRLoad implements DataSerializable {
  ...
  /**
   * Creates a new immutable instance of PRLoad from the provided DataInput. Actually {@link
   * #addBucket(int, float, float)} will allow the bucket loads to be mutated.
   *
