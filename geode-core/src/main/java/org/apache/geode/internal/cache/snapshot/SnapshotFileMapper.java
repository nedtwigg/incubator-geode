...
public interface SnapshotFileMapper extends Serializable {
   ...
   * @param snapshot the path specified in the invocation of {@link RegionSnapshotService#save(File,
   *     org.apache.geode.cache.snapshot.SnapshotOptions.SnapshotFormat)
   *     RegionSnapshotService.load()} or {@link CacheSnapshotService#save(File,
   *     org.apache.geode.cache.snapshot.SnapshotOptions.SnapshotFormat)
   ...
   * @param snapshot the path specified in the invocation of {@link RegionSnapshotService#load(File,
   *     org.apache.geode.cache.snapshot.SnapshotOptions.SnapshotFormat)
   *     RegionSnapshotService.load()} or {@link CacheSnapshotService#load(File,
   *     org.apache.geode.cache.snapshot.SnapshotOptions.SnapshotFormat)
   *     CacheSnapshotService.load()}
