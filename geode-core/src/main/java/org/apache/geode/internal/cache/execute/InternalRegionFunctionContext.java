...
/**
 * Internal interface used to provide for some essential functionality for {@link
 * RegionFunctionContext} invoked by {@link PartitionRegionHelper}.
 */
public interface InternalRegionFunctionContext extends RegionFunctionContext {
   ...
   *
   * <p>Writes using this Region have no constraints and behave the same as the partitioned region.
   *
