...
/**
 * An interface that contains a bunch of static final values used for the implementation of {@link
 * DataSerializer}. It is basically an Enum and could be changed to one once we drop 1.4. The
...
public interface DSCODE {
  ...
  /**
   * Codes for the primitive classes, which cannot be recreated with <code>
   * Class.forName(String,boolean,ClassLoader)</code> like other classes
   */
  ...
  /**
   * A header byte meaning that the next element in the stream is a <code>null</code> <code>String
   * </code>.
   */
