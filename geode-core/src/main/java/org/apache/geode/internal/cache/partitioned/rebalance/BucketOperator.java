...
public interface BucketOperator {
   ...
   *
   * <p>Note that the completion is not required to be threadsafe, so implementors should ensure the
   ...
   * operation finishes.
   *
   * <p>The completions are NOT THREADSAFE.
   *
   * <p>They will be completed when createRedundantBucket or waitForOperations is called.
   */
