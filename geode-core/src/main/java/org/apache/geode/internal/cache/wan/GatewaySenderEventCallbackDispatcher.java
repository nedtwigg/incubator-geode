...
/**
 * Class <code>SerialGatewayEventCallbackDispatcher</code> dispatches batches of <code>GatewayEvent
 * </code>s to <code>AsyncEventListener</code> callback implementers. This dispatcher is used in the
 * write-behind case.
 *
 * @since GemFire 7.0
 */
public class GatewaySenderEventCallbackDispatcher implements GatewaySenderEventDispatcher {
  ...
  /**
   * The <code>AsyncEventListener</code>s registered on this <code>
   * SerialGatewayEventCallbackDispatcher</code>.
   */
