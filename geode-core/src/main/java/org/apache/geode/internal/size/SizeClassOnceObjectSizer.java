 ...
 *
 * <p>This sizer is a compromise between generating accurate sizes for every object and performance.
 * It should work well for objects that are fairly constant in size. For completely accurate sizing,
