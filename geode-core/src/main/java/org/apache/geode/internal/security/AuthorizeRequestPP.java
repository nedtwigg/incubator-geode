...
public class AuthorizeRequestPP {
  ...
  public AuthorizeRequestPP(
      String postAuthzFactoryName, ClientProxyMembershipID id, Principal principal, Cache cache)
  ...
  public GetOperationContext getAuthorize(
      String regionName,
      Object key,
      Object result,
      boolean isObject,
  ...
  public QueryOperationContext executeCQAuthorize(
      String cqName,
      String queryString,
      Set regionNames,
      Object queryResult,
      QueryOperationContext executeCQContext)
      throws NotAuthorizedException {
  ...
  public KeySetOperationContext keySetAuthorize(
      String regionName, Set keySet, KeySetOperationContext keySetContext)
      throws NotAuthorizedException {
