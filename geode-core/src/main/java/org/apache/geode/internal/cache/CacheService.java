 ...
 *
 * <p>These services are loaded during cache initialization using the java ServiceLoader and can be
...
public interface CacheService {
   ...
   *
   * <p>Services are initialized in random order, fairly early on in cache initialization. In
