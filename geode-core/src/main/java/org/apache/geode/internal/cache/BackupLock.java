 ...
 *
 * <p>We need this because our backup process is two phase. In the first phase we aquire the lock
 * and in the second phase we actually do the backup. During the second phase we need to reenter the
...
public class BackupLock extends ReentrantLock {
   ...
   *
   * <p>Updates which update only record changes to the local state on this member(eg, switching
