...
public class VMThinRegionEntryHeapIntKey extends VMThinRegionEntryHeap {
  ...
  private static final AtomicLongFieldUpdater<VMThinRegionEntryHeapIntKey> lastModifiedUpdater = AtomicLongFieldUpdater.newUpdater(VMThinRegionEntryHeapIntKey.class, "lastModified");
