 ...
 *
 * <p>Now also has a bunch of callbacks including for replace/remove etc.
 *
 * @since GemFire 7.0
...
public interface MapCallback<K, V, C, P> {
   ...
   *
   * <p>If this method returns null, then proceed with remove as usual, if this method returns
   ...
   *     (ConcurrentSkipListMap) will return the actual key in the map while others will provide the
   *     passed key
