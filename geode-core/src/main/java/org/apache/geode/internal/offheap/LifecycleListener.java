...
public interface LifecycleListener {
   ...
   *
   * <p>Create occurs during the first initialization of an InternalDistributedSystem within the
   * JVM.
   *
   ...
   *
   * <p>Reuse occurs during any intialization of an InternalDistributedSystem after the first one
   * was connected and then disconnected within the JVM.
   *
   ...
   *
   * <p>Close occurs after the InternalDistributedSystem and DistributionManager have completely
   * disconnected.
   *
