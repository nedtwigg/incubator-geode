...
public final class TransformUtils {
  ...
  public static final Transformer<Map.Entry<PersistentMemberID, Set<Integer>>, String>
      persistentMemberEntryToLogEntryTransformer =
  ...
  /** Transforms PersistentMemberIDs to a user friendly log entry. */
  public static final Transformer<PersistentMemberID, String>
      persistentMemberIdToLogEntryTransformer =
   ...
   */
  public static <T1, T2> void transform(
      Collection<T1> from, Collection<T2> to, Transformer<T1, T2> transformer) {
   ...
   */
  public static <T1, T2> Map<T2, T1> transformAndMap(
      Collection<T1> from, Transformer<T1, T2> transformer) {
