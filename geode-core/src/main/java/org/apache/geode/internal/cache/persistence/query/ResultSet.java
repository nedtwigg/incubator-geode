 ...
 * correct order.
 *
 * <p>The element is allowed to be an object, or a CachedDeserializable.
 *
 * <p>If multiple instances of the same element are required, use SortedResultBag instead.
 *
 * <p>The result set should be closed using the close method to free up resources when it is no
 * longer in use.
 *
 * @since GemFire cedar
 */
