...
public class PersistentMemberID implements DataSerializable {
  ...
  public PersistentMemberID(
      DiskStoreID diskStoreId, InetAddress host, String directory, long timeStamp, short version) {
    this.diskStoreId = diskStoreId;
    this.host = host;
    this.directory = directory;
    this.timeStamp = timeStamp;
   ...
   *
   * <p>This is an older version if it has an older timestamp, or the same timestamp and an older
   * version
   */
