...
public abstract class ThreadUtils {
   ...
   * @return null if {@code throwable} is null and {@code expectNull} is true, "" if {@code
   *     throwable} is null and {@code expectNull} is false, otherwise the stack trace for {@code
   *     throwable}
   */
