...
public class CachePerfStats {
  ...
  static {
    ...
    final String evictByCriteria_evictionsDesc =
        "The total number of entries evicted"; // total actual evictions (entries evicted)
    final String evictByCriteria_evictionTimeDesc =
        "Time taken for eviction process"; // total eviction time including product + user expr.
    final String evictByCriteria_evictionsInProgressDesc = "Total number of evictions in progress";
    final String evictByCriteria_evaluationsDesc =
        "Total number of evaluations for eviction"; // total eviction attempts
    final String evictByCriteria_evaluationTimeDesc =
        "Total time taken for evaluation of user expression during eviction"; // time taken to evaluate user expression.
    ...
    type =
        f.createType(
            ...
            new StatisticDescriptor[] {
              ...
              f.createIntGauge(
                  "cacheWriterCallsInProgress", cacheWriterCallsInProgressDesc, "operations"),
              f.createIntCounter(
                  "cacheWriterCallsCompleted", cacheWriterCallsCompletedDesc, "operations"),
              f.createLongCounter("cacheWriterCallTime", cacheWriterCallTimeDesc, "nanoseconds"),
              f.createIntGauge(
                  "cacheListenerCallsInProgress", cacheListenerCallsInProgressDesc, "operations"),
              f.createIntCounter(
                  "cacheListenerCallsCompleted", cacheListenerCallsCompletedDesc, "operations"),
              f.createLongCounter(
                  "cacheListenerCallTime", cacheListenerCallTimeDesc, "nanoseconds"),
              f.createIntGauge(
                  "indexUpdateInProgress", "Current number of ops in progress", "operations"),
              f.createIntCounter(
                  "indexUpdateCompleted", "Total number of ops that have completed", "operations"),
              f.createLongCounter(
                  "indexUpdateTime", "Total amount of time spent doing this op", "nanoseconds"),
              f.createIntGauge(
                  "indexInitializationInProgress",
                  "Current number of index initializations in progress",
                  "operations"),
              f.createIntCounter(
                  "indexInitializationCompleted",
                  "Total number of index initializations that have completed",
                  "operations"),
              f.createLongCounter(
                  "indexInitializationTime",
                  "Total amount of time spent initializing indexes",
                  "nanoseconds"),
              f.createIntGauge(
                  "getInitialImagesInProgress", getInitialImagesInProgressDesc, "operations"),
              f.createIntCounter(
                  "getInitialImagesCompleted", getInitialImagesCompletedDesc, "operations"),
              f.createIntCounter(
              ...
              f.createIntCounter(
                  "getInitialImageKeysReceived", getInitialImageKeysReceivedDesc, "keys"),
              ...
              f.createLongCounter(
                  "eventQueueThrottleTime", eventQueueThrottleTimeDesc, "nanoseconds", false),
              ...
              f.createIntCounter(
                  "queryResultsHashCollisions", queryResultsHashCollisionsDesc, "operations"),
              f.createLongCounter(
                  "queryResultsHashCollisionProbeTime",
                  queryResultsHashCollisionProbeTimeDesc,
                  "nanoseconds"),
              f.createLongCounter(
                  "partitionedRegionQueryRetries", partitionedRegionOQLQueryRetriesDesc, "retries"),
              ...
              f.createLongCounter(
                  "txRollbackLifeTime", txRollbackLifeTimeDesc, "nanoseconds", false),
              f.createLongCounter(
                  "txConflictCheckTime", txConflictCheckTimeDesc, "nanoseconds", false),
              ...
              f.createIntGauge(
                  ...
                  "regions"),
              f.createIntGauge(
                  "reliableRegionsMissingNoAccess", reliableRegionsMissingNoAccessDesc, "regions"),
              f.createLongGauge(
                  "entries",
              ...
              f.createIntGauge(
                  "evictorQueueSize",
                  "Number of jobs waiting to be picked up by evictor threads",
                  "jobs"),
              f.createLongCounter(
                  "evictWorkTime",
                  "Total time spent doing eviction work in background threads",
                  "nanoseconds",
                  false),
              f.createLongCounter(
                  "nonSingleHopsCount",
              ...
              f.createLongCounter(
                  ...
                  metaDataRefreshCountDesc,
                  "Total number of times the meta data is refreshed due to hopping.",
                  false),
              ...
              f.createLongCounter(
                  "deltasPreparedTime", deltasPreparedTimeDesc, "nanoseconds", false),
              ...
              f.createIntCounter(
                  "deltaFullValuesRequested", deltaFullValuesRequestedDesc, "operations"),
              ...
              f.createLongCounter(
                  "preCompressedBytes", compressionPreCompresssedBytesDesc, "bytes"),
              f.createLongCounter(
                  "postCompressedBytes", compressionPostCompressedBytesDesc, "bytes"),
              f.createLongCounter(
                  "evictByCriteria_evictions", evictByCriteria_evictionsDesc, "operations"),
              f.createLongCounter(
                  "evictByCriteria_evictionTime", evictByCriteria_evictionTimeDesc, "nanoseconds"),
              f.createLongCounter(
                  "evictByCriteria_evictionsInProgress",
                  evictByCriteria_evictionsInProgressDesc,
                  "operations"),
              f.createLongCounter(
                  "evictByCriteria_evaluations", evictByCriteria_evaluationsDesc, "operations"),
              f.createLongCounter(
  ...
  public void endRemoveAll(long start) {
    ...
    if (enableClockStats) stats.incLong(removeAllTimeId, getStatTime() - start);
  }
