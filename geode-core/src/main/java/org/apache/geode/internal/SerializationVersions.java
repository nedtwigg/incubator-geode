...
public interface SerializationVersions {
   ...
   *
   * <p>You are expected to implement toDataPre_GFE_7_0_0_0(), fromDataPre_GFE_7_0_0_0(), ...,
   * toDataPre_GFXD_1_1_0_0, fromDataPre_GFXD_1_1_0_0.
   *
   * <p>The method name is formed with the version's product name and its major, minor, release and
   * patch numbers.
   */
