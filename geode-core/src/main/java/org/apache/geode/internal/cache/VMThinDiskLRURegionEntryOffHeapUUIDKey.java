...
public class VMThinDiskLRURegionEntryOffHeapUUIDKey extends VMThinDiskLRURegionEntryOffHeap {
  public VMThinDiskLRURegionEntryOffHeapUUIDKey(
  ...
  private static final AtomicLongFieldUpdater<VMThinDiskLRURegionEntryOffHeapUUIDKey>
      lastModifiedUpdater =
          AtomicLongFieldUpdater.newUpdater(
              VMThinDiskLRURegionEntryOffHeapUUIDKey.class, "lastModified");
  /**
  ...
  private static final AtomicLongFieldUpdater<VMThinDiskLRURegionEntryOffHeapUUIDKey>
      ohAddrUpdater =
          AtomicLongFieldUpdater.newUpdater(
              VMThinDiskLRURegionEntryOffHeapUUIDKey.class, "ohAddress");
