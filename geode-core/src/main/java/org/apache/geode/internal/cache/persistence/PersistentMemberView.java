...
public interface PersistentMemberView {
   ...
   *
   * <p>It can be called either during a normal region destroy or during a partial region destroy.
   ...
   *
   * <p>This method should NOT prevent this disk region from being initialized later.
   */
