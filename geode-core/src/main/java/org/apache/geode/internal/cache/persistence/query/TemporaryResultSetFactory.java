 ...
 *
 * <p>The result sets will not be recovered when the member restarts. Any temporary results still on
...
public class TemporaryResultSetFactory {
   ...
   *
   * <p>This is useful for cases where the ordering is not important, but the set semantics are. For
