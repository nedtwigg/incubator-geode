 ...
 * org.apache.geode.cache.Region#get(Object)}operation. The reply is sent in a {@link
 * org.apache.geode.internal.cache.RemoteGetMessage.GetReplyMessage}.
 *
 * <p>Replicate regions can use this message to send a Get request to another peer.
 *
 * @since GemFire 6.5
 */
public final class RemoteGetMessage extends RemoteOperationMessageWithDirectReply {
  ...
  protected final boolean operateOnRegion(
      final DistributionManager dm, LocalRegion r, long startTime) throws RemoteOperationException {
    ...
    try {
      ...
      val =
          r.getDataView()
              .getSerializedValue(
                  r, keyInfo, false, this.context, null, false /*for replicate regions*/);
  ...
  public static RemoteGetResponse send(
    ...
    RemoteGetMessage m =
        new RemoteGetMessage(
            recipient, r.getFullPath(), p, key, aCallbackArgument, requestingClient);
  ...
  /**
   * This message is used for the reply to a {@link
   * org.apache.geode.cache.Region#get(Object)}operation This is the reply to a {@link
   * RemoteGetMessage}.
   *
   * <p>Since the {@link org.apache.geode.cache.Region#get(Object)}operation is used <bold>very
   * </bold> frequently the performance of this class is critical.
   *
   * @since GemFire 6.5
   */
  public static final class GetReplyMessage extends ReplyMessage {
    ...
    public static void send(
        InternalDistributedMember recipient, int processorId, RawValue val, ReplySender replySender)
        throws RemoteOperationException {
      Assert.assertTrue(recipient != null, "PRDistribuedGetReplyMessage NULL reply message");
