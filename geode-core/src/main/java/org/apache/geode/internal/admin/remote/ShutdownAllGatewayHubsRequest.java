 ...
 *
 * <p>From 9.0 old wan support is removed. Ideally ShutdownAllGatewayHubsRequest should be removed
 * but it it there for rolling upgrade support when request come from old version member to shut
 * down hubs.
 *
 * @since Geode 1.0
 */
