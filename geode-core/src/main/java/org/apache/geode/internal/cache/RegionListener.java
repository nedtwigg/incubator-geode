 ...
 *
 * <p>If there are multiple listeners added to a cache they are invoked in a random order. See
 * {@link GemFireCacheImpl#addRegionListener(RegionListener)}
 *
 * <p>If any of these callbacks throw an exception, that exception will get thrown out to the user
