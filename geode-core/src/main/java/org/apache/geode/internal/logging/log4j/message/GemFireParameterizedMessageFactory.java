 ...
 *
 * <p>Creates {@link ParameterizedMessage} instances for {@link #newMessage(String, Object...)}.
 *
 * <p>This class is immutable.
 *
 * <p>Copied into Geode from org.apache.logging.log4j.message.ParameterizedMessageFactory
...
public final class GemFireParameterizedMessageFactory extends AbstractMessageFactory {
  ...
  public Message newMessage(final String message, final Object... params) {
    return new GemFireParameterizedMessage(
        message, params); // GEODE: change to construct GemFireParameterizedMessage
  }
}
