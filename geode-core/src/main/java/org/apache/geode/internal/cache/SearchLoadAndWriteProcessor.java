...
public class SearchLoadAndWriteProcessor implements MembershipListener {
  ...
  private Object doLocalLoad(CacheLoader loader, boolean netSearchAllowed) throws CacheLoaderException {
    ...
    if (loader != null && !this.attemptedLocalLoad) {
      ...
      CachePerfStats stats = region.getCachePerfStats();
      LoaderHelper loaderHelper = this.region.loaderHelperFactory.createLoaderHelper(this.key, this.aCallbackArgument, netSearchAllowed, true /*netLoadAllowed*/, this);
  ...
  private boolean netWrite(CacheEvent event, int action, Set writeCandidateSet) throws CacheWriterException, TimeoutException {
    ...
    Collections.shuffle(list);
    InternalDistributedMember[] writeCandidates = (InternalDistributedMember[]) list.toArray(new InternalDistributedMember[list.size()]);
    initRemainingTimeout();
    int index = 0;
    do {
      ...
      if (this.remoteException != null) {
        ...
        if (this.remoteException instanceof CacheWriterException && this.remoteException.getCause() != null) {
          cause = this.remoteException.getCause();
        } else {
          cause = this.remoteException;
        }
  ...
  protected synchronized void incomingResponse(Object obj, long lastModifiedTime, boolean isPresent, boolean serialized, final boolean requestorTimedOut, final InternalDistributedMember sender, DistributionManager dm, VersionTag versionTag) {
    ...
    if (!this.pendingResponders.remove(sender)) {
      ...
      if (logger.isDebugEnabled()) {
        ...
        logger.debug("Processing response for processorId={}, isPresent is {}, sender is {}, key is {}, value is {}, version is {}", this.processorId, isPresent, sender, this.key, serialized, versionTag);
      }
    }
  ...
  protected synchronized void incomingNetSearchReply(byte[] value, long lastModifiedTime, boolean serialized, boolean requestorTimedOut, boolean authorative, VersionTag versionTag) {
  ...
  public static final class QueryMessage extends SerialDistributionMessage {
    ...
    @Override
    public String toString() {
      return "SearchLoadAndWriteProcessor.QueryMessage for \"" + this.key + "\" in region \"" + this.regionName + "\", processorId " + processorId + ", timeoutMs=" + this.timeoutMs + ", ttl=" + this.ttl + ", idleTime=" + this.idleTime;
    }
    ...
    private void doGet(DistributionManager dm) {
      ...
      if (dm.getDMType() == DistributionManager.ADMIN_ONLY_DM_TYPE || getSender().equals(dm.getDistributionManagerId())) {
      ...
      try {
        ...
        LocalRegion region = (LocalRegion) CacheFactory.getInstance(dm.getSystem()).getRegion(this.regionName);
        Object o = null;
        ...
        ResponseMessage.sendMessage(this.key, this.getSender(), processorId, (sendResult ? o : null), lastModifiedCacheTime, isPresent, isSer, requestorTimedOut, dm, tag);
    ...
    private void replyWithNull(DistributionManager dm) {
      ResponseMessage.sendMessage(this.key, this.getSender(), processorId, null, 0, false, false, false, dm, null);
  ...
  public static final class ResponseMessage extends HighPriorityDistributionMessage {
    ...
    public static void sendMessage(Object key, InternalDistributedMember recipient, int processorId, Object result, long lastModified, boolean isPresent, boolean isSerialized, boolean requestorTimedOut, DistributionManager distributionManager, VersionTag versionTag) {
    ...
    protected void process(DistributionManager dm) {
      ...
      processor.incomingResponse(this.result, lastModifiedSystemTime, this.isPresent, this.isSerialized, this.requestorTimedOut, this.getSender(), dm, versionTag);
    }
    ...
    @Override
    public String toString() {
      return "SearchLoadAndWriteProcessor.ResponseMessage for processorId " + processorId + ", blob is " + this.result + ", isPresent is " + isPresent + ", requestorTimedOut is " + requestorTimedOut + ", version is " + versionTag;
    }
  ...
  public static final class NetSearchRequestMessage extends PooledDistributionMessage {
    ...
    @Override
    public String toString() {
      return "SearchLoadAndWriteProcessor.NetSearchRequestMessage for \"" + this.key + "\" in region \"" + this.regionName + "\", processorId " + processorId;
    }
    ...
    private void doGet(DistributionManager dm) {
      ...
      try {
        ...
        NetSearchReplyMessage.sendMessage(NetSearchRequestMessage.this.getSender(), processorId, this.key, ebv, ebvObj, ebvLen, lastModifiedCacheTime, isSer, requestorTimedOut, authoritative, dm, versionTag);
      } catch (RegionDestroyedException rde) {
        replyWithNull(dm);
    ...
    private void replyWithNull(DistributionManager dm) {
      NetSearchReplyMessage.sendMessage(NetSearchRequestMessage.this.getSender(), processorId, this.key, null, null, 0, 0, false, false, false, dm, null);
  ...
  public static final class NetSearchReplyMessage extends HighPriorityDistributionMessage {
    ...
    public static void sendMessage(InternalDistributedMember recipient, int processorId, Object key, byte[] value, Object valueObj, int valueLen, long lastModified, boolean isSerialized, boolean requestorTimedOut, boolean authoritative, DistributionManager distributionManager, VersionTag versionTag) {
      // create a message
    ...
    protected void process(DistributionManager dm) {
      ...
      processor.incomingNetSearchReply(this.value, lastModifiedSystemTime, this.isSerialized, this.requestorTimedOut, this.authoritative, this.versionTag);
    }
    ...
    @Override
    public String toString() {
      return "SearchLoadAndWriteProcessor.NetSearchReplyMessage for processorId " + processorId + ", blob is " +
      //      this.value
          (this.value == null ? "null" : "(" + this.value.length + " bytes)") + " authorative=" + authoritative + " versionTag=" + this.versionTag;
    }
  ...
  public static final class NetLoadRequestMessage extends PooledDistributionMessage {
    ...
    @Override
    public String toString() {
      return "SearchLoadAndWriteProcessor.NetLoadRequestMessage for \"" + this.key + "\" in region \"" + this.regionName + "\", processorId " + processorId;
    }
    ...
    private void doLoad(DistributionManager dm) {
      ...
      try {
        ...
        if (region != null && region.isInitialized() && (dm.cacheTimeMillis() - startTime < timeoutMs)) {
          CacheLoader loader = ((AbstractRegion) region).basicGetLoader();
          if (loader != null) {
            ...
            try {
              ...
              NetLoadReplyMessage.sendMessage(NetLoadRequestMessage.this.getSender(), processorId, o, dm, loaderHelper.getArgument(), null, false, false);
    ...
    void replyWithException(Exception e, DistributionManager dm) {
      NetLoadReplyMessage.sendMessage(NetLoadRequestMessage.this.getSender(), processorId, null, dm, this.aCallbackArgument, e, false, false);
  ...
  public static final class NetLoadReplyMessage extends HighPriorityDistributionMessage {
    ...
    public static void sendMessage(InternalDistributedMember recipient, int processorId, Object obj, DistributionManager distributionManager, Object aCallbackArgument, Exception e, boolean isSerialized, boolean requestorTimedOut) {
      // create a message
    ...
    protected void process(DistributionManager dm) {
      ...
      processor.incomingNetLoadReply(this.result, 0, this.aCallbackArgument, this.e, this.isSerialized, this.requestorTimedOut);
    }
    ...
    @Override
    public String toString() {
      return "SearchLoadAndWriteProcessor.NetLoadReplyMessage for processorId " + processorId + ", blob is " + this.result;
    }
  ...
  public static final class NetWriteRequestMessage extends PooledDistributionMessage {
    ...
    @Override
    public String toString() {
      return "SearchLoadAndWriteProcessor.NetWriteRequestMessage " + " for region \"" + this.regionName + "\", processorId " + processorId;
    }
      ...
      try {
        ...
        if (region != null && region.isInitialized() && (dm.cacheTimeMillis() - startTime < timeoutMs)) {
          ...
          if (this.event instanceof EntryEventImpl) {
            ...
            entryEvtImpl.setOriginRemote(event.getDistributedMember() == null || !event.getDistributedMember().equals(dm.getDistributionManagerId()));
          ...
          if (writer != null) {
            try {
              ...
              NetWriteReplyMessage.sendMessage(NetWriteRequestMessage.this.getSender(), processorId, dm, true, null, false);
            } catch (CacheWriterException cwe) {
              NetWriteReplyMessage.sendMessage(NetWriteRequestMessage.this.getSender(), processorId, dm, false, cwe, true);
            } catch (Exception e) {
              NetWriteReplyMessage.sendMessage(NetWriteRequestMessage.this.getSender(), processorId, dm, false, e, false);
            }

          } else {
            NetWriteReplyMessage.sendMessage(NetWriteRequestMessage.this.getSender(), processorId, dm, false, new TryAgainException(LocalizedStrings.SearchLoadAndWriteProcessor_NO_CACHEWRITER_DEFINED_0.toLocalizedString()), true);
          }

        } else {
          NetWriteReplyMessage.sendMessage(NetWriteRequestMessage.this.getSender(), processorId, dm, false, new TryAgainException(LocalizedStrings.SearchLoadAndWriteProcessor_TIMEOUT_EXPIRED_OR_REGION_NOT_READY_0.toLocalizedString()), true);

        }
      } catch (RegionDestroyedException rde) {
        NetWriteReplyMessage.sendMessage(NetWriteRequestMessage.this.getSender(), processorId, dm, false, null, false);
        ...
        // is still usable:
        SystemFailure.checkFailure();
        NetWriteReplyMessage.sendMessage(NetWriteRequestMessage.this.getSender(), processorId, dm, false, new InternalGemFireException(LocalizedStrings.SearchLoadAndWriteProcessor_ERROR_PROCESSING_REQUEST.toLocalizedString(), t), true);
      } finally {
        LocalRegion.setThreadInitLevelRequirement(oldLevel);
      }
  ...
  public static final class NetWriteReplyMessage extends HighPriorityDistributionMessage {
    ...
    public static void sendMessage(InternalDistributedMember recipient, int processorId, DistributionManager distributionManager, boolean netWriteSucceeded, Exception e, boolean cacheWriterException) {
      // create a message
