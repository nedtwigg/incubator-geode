...
public class VersionedStatsRegionEntryHeapIntKey extends VersionedStatsRegionEntryHeap {
  ...
  private static final AtomicLongFieldUpdater<VersionedStatsRegionEntryHeapIntKey>
      lastModifiedUpdater =
          AtomicLongFieldUpdater.newUpdater(
              VersionedStatsRegionEntryHeapIntKey.class, "lastModified");
  ...
  private static final AtomicIntegerFieldUpdater<VersionedStatsRegionEntryHeapIntKey>
      hitCountUpdater =
          AtomicIntegerFieldUpdater.newUpdater(
              VersionedStatsRegionEntryHeapIntKey.class, "hitCount");
  private static final AtomicIntegerFieldUpdater<VersionedStatsRegionEntryHeapIntKey>
      missCountUpdater =
          AtomicIntegerFieldUpdater.newUpdater(
              VersionedStatsRegionEntryHeapIntKey.class, "missCount");
