...
public class InternalInstantiator {
    ...
    synchronized (InternalInstantiator.class) {
      ...
      logger.info(
          LocalizedMessage.create(
              LocalizedStrings.InternalInstantiator_REGISTERED,
  ...
  private static void sendRegistrationMessageToClients(Instantiator instantiator) {
    ...
    ClientInstantiatorMessage clientInstantiatorMessage =
        new ClientInstantiatorMessage(
            ...
            (ClientProxyMembershipID) instantiator.getContext(),
            (EventID) instantiator.getEventId());
    // Deliver it to all the clients
    CacheClientNotifier.routeClientMessage(clientInstantiatorMessage);
  }

  /**
   * Creates a new <code>Instantiator</code> with the given class and id and {@linkplain
   * #register(Instantiator, boolean) registers} it with the data serialization framework.
   *
   * @throws IllegalArgumentException The instantiator cannot be created
   * @throws IllegalStateException The instantiator cannot be registered
   */
  public static void register(
      Class instantiatorClass, Class instantiatedClass, int id, boolean distribute) {
   ...
   * #register(Instantiator, boolean) registers} it with the data serialization framework.
   *
   * <p>This method is only called when server connection and CacheClientUpdaterThread
   *
   * @throws IllegalArgumentException The instantiator cannot be created
   * @throws IllegalStateException The instantiator cannot be registered
   */
   ...
   */
  public static void register(
      String instantiatorClass, String instantiatedClass, int id, boolean distribute) {

    if (checkForThread()) {
      register(
          instantiatorClass,
          new InstantiatorAttributesHolder(instantiatorClass, instantiatedClass, id),
          distribute);
    }
  }
  ...
  public static void register(
    ...
    register(
        instantiatorClass,
        new InstantiatorAttributesHolder(
            instantiatorClass, instantiatedClass, id, eventId, context),
        distribute);
  }

  private static void register(
      String instantiatorClassName, InstantiatorAttributesHolder holder, boolean distribute) {
    ...
    synchronized (InternalInstantiator.class) {
      ...
      if (inst == null) {
        ...
        logger.info(
            LocalizedMessage.create(
                LocalizedStrings.InternalInstantiator_REGISTERED_HOLDER,
  ...
  public static class InstantiatorAttributesHolder {
    ...
    public InstantiatorAttributesHolder(
        String instantiatorClass, String instantiatedClass, int id) {
    ...
    public String toString() {
      return "InstantiatorAttributesHolder[irName="
          + this.instantiatorName
          + ",idName="
          + this.instantiatedName
          + ",id="
          + this.id
   ...
   *
   * @throws IllegalArgumentException If <code>c</code> was not previously registered with id <code>
   *     classId</code>.
   ...
   */
  protected static Instantiator newInstance(
      Class instantiatorClass, Class instantiatedClass, int id) {
    if (!Instantiator.class.isAssignableFrom(instantiatorClass)) {
      throw new IllegalArgumentException(
          LocalizedStrings.InternalInstantiator_0_DOES_NOT_EXTEND_INSTANTIATOR.toLocalizedString(
   ...
   * Instantiator</code> being registered.
   */
  public static class RegistrationMessage extends SerialDistributionMessage {
     ...
     * Instantiator</code> was registered.
     */
    ...
    protected void process(DistributionManager dm) {
      ...
      if (this.instantiatorClass != null && this.instantiatedClass != null) {
        ...
        InternalInstantiator.register(
            this.instantiatorClassName,
            this.instantiatedClassName,
            this.id,
            false,
            this.eventId,
            null);
      ...
      if (CacheClientNotifier.getInstance() != null) {
        ...
        try {
          this.instantiatorClass =
              InternalDataSerializer.getCachedClass(
                  this.instantiatorClassName); // fix for bug 41206
        } catch (ClassNotFoundException ex) {
          fromDataProblem(
              LocalizedStrings.InternalInstantiator_COULD_NOT_LOAD_INSTANTIATOR_CLASS_0
        ...
        try {
          this.instantiatedClass =
              InternalDataSerializer.getCachedClass(
                  this.instantiatedClassName); // fix for bug 41206
        } catch (ClassNotFoundException ex) {
          fromDataProblem(
    ...
    @Override
    public String toString() {
      String instatiatorName =
          (this.instantiatorClass == null)
              ? this.instantiatorClassName
              : this.instantiatorClass.getName();
      String instatiatedName =
          (this.instantiatedClass == null)
              ? this.instantiatedClassName
  ...
  public static final class RegistrationContextMessage extends RegistrationMessage {
    ...
    /**
     * Creates a new <code>RegistrationContextMessage</code> that broadcasts that the given <code>
     * Instantiator</code> was registered.
     */
    ...
    for (Iterator itr = dsMap.values().iterator(); itr.hasNext(); ) {
      ...
      logger.info(
          LocalizedMessage.create(
              LocalizedStrings.InternalInstantiator_REGISTERED,
              new Object[] {
                Integer.valueOf(instantiator.getId()), instantiator.getInstantiatedClass().getName()
              }));
    }
