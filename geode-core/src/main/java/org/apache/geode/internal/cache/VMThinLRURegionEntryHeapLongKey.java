...
public class VMThinLRURegionEntryHeapLongKey extends VMThinLRURegionEntryHeap {
  ...
  private static final AtomicLongFieldUpdater<VMThinLRURegionEntryHeapLongKey> lastModifiedUpdater = AtomicLongFieldUpdater.newUpdater(VMThinLRURegionEntryHeapLongKey.class, "lastModified");
