...
public final class XmlGeneratorUtils {
   ...
   * Follows the same rules as {@link AttributesImpl#addAttribute(String, String, String, String,
   * String)} .
   *
  ...
  public static void addAttribute(
      final AttributesImpl attributes, final String localName, final Object value) {
    if (null != value) {
   ...
   * if value is not null. Follows the same rules as {@link AttributesImpl#addAttribute(String,
  ...
  public static void addAttribute(
    ...
    if (null != value) {
      attributes.addAttribute(
          XMLConstants.NULL_NS_URI, localName, prefix + ":" + localName, "", value.toString());
    }
  }

  /**
   * Start new element on <code>contentHandler</code> with given <code>prefix</code>, <code>
   * localName</code> and <code>attributes</code>.
   *
  ...
  /**
   * End element on <code>contentHandler</code> with given <code>prefix</code> and <code>localName
   * </code>.
   *
   * @param contentHandler to start element on.
   * @param prefix of element
   * @param localName of element
   * @throws SAXException if {@link ContentHandler#endElement(String, String, String)} throws {@link
   *     SAXException}.
   * @since GemFire 8.1
   */
  public static void endElement(
      final ContentHandler contentHandler, final String prefix, final String localName)
      throws SAXException {
    contentHandler.endElement(XMLConstants.NULL_NS_URI, localName, prefix + ":" + localName);
  }

  /**
   * Creates new empty element on <code>contentHandler</code> with given <code>prefix</code>, <code>
   * localName</code> and <code>attributes</code>.
   *
   ...
   * @param attributes of element
   * @throws SAXException if {@link ContentHandler#startElement(String, String, String, Attributes)}
   *     or {@link ContentHandler#endElement(String, String, String)} throws {@link SAXException}.
   * @since GemFire 8.1
   */
