        ...
        f.createType(
            ...
            new StatisticDescriptor[] {
              ...
              f.createLongCounter(
                  ...
                  false),
              f.createLongCounter(
                  "semphoreOps", "The total number of semaphore operations.", "operations"),
              f.createLongCounter(
                  "softwareLockFaults",
              ...
              f.createLongCounter(
                  ...
                  false),
              f.createLongCounter(
                  "loopbackInputPackets",
                  "The total number of input packets received over the loopback network adaptor.",
                  "packets"),
              f.createLongCounter(
                  "loopbackOutputPackets",
                  "The total number of output packets sent over the loopback network adaptor.",
                  "packets"),
              f.createLongCounter(
                  "inputPackets", "packets received (Solaris kstat 'ipackets')", "packets"),
              f.createLongCounter(
                  "inputErrors", "input errors (Solaris kstat 'ierrors')", "errors", false),
              f.createLongCounter("outputPackets", "Solaris kstat 'opackets'", "packets"),
              f.createLongCounter(
                  "outputErrors", "output errors (Solaris kstat 'oerrors')", "errors", false),
              f.createLongCounter("collisions", "Solaris kstat 'collisions'", "collisions", false),
              f.createLongCounter(
                  "inputBytes", "octets received (Solaris kstat 'rbytes')", "bytes"),
              f.createLongCounter(
                  "outputBytes", "octats transmitted (Solaris kstat 'obytes')", "bytes"),
              f.createLongCounter(
