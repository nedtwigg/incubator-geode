...
public interface RebalanceDirector {
   ...
   *
   * <p>This method is expected to attempt one small unit of rebalancing work. When the method
   * returns, the system will check to see if the model is still accurate. If true is returned, the
   ...
   *
   * <p>It is expected that nextStep will eventually return false.
   *
