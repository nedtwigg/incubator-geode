...
public interface LogMarker {
   ...
   * the objects that are serialized by {@link org.apache.geode.DataSerializer#writeObject(Object,
   * DataOutput)} using standard Java serialization are logged to {@linkplain System#out standard
   * out}. This aids in determining which classes should implement {@link DataSerializable} (or
   * should be special cased by a custom <code>DataSerializer</code>).
   */
