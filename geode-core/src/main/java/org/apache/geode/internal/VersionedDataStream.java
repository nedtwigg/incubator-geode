 ...
 *
 * <p>Internal product classes that implement {@link DataSerializableFixedID} and {@link
 * DataSerializable} and change serialization format must check this on DataInput/DataOutput (see
 * {@link InternalDataSerializer#getVersionForDataStream} methods) and deal with serialization with
 * previous {@link Version}s appropriately.
 *
 * @since GemFire 7.1
 */
