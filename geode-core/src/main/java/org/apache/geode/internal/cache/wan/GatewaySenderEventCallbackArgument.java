 ...
 *
 * <p>This class used to be in package <code>org.apache.geode.util</code>.
 *
 * @since GemFire 7.0
 */
public final class GatewaySenderEventCallbackArgument extends WrappedCallbackArgument
   ...
   * <code>GatewayReceiver</code> s don't resend the event to the same <code>GatewayReceiver</code>
   * s.
   */
   ...
   */
  public GatewaySenderEventCallbackArgument(
      Object originalCallbackArg, int originatingDSId, List<Integer> originalReceivers) {
    super(originalCallbackArg);
  ...
  public String toString() {
    ...
    buffer
        .append("GatewaySenderEventCallbackArgument [")
        .append("originalCallbackArg=")
        .append(getOriginalCallbackArg())
        .append(";originatingSenderId=")
        .append(this.originatingDSId)
        .append(";recipientGatewayReceivers=")
        .append(this.receipientDSIds)
        .append("]");
