...
public enum CacheXmlVersion {
  ...
  GEMFIRE_8_1(
      CacheXml.VERSION_8_1, null, null, CacheXml.SCHEMA_8_1_LOCATION, CacheXml.GEMFIRE_NAMESPACE),
  ...
  GEODE_1_0(
      CacheXml.VERSION_1_0, null, null, CacheXml.SCHEMA_1_0_LOCATION, CacheXml.GEODE_NAMESPACE);
  ...
  private CacheXmlVersion(
      String version, String publicId, String systemId, String schemaLocation, String namespace) {
  ...
  /**
   * Get {@link CacheXmlVersion} for given <code>version</code> string. Use constants from {@link
   * CacheXml} for example: <code>CacheXmlVersion.valueForVersion(CacheXml.GEMFIRE_8_1);</code>
   *
  ...
  public static final CacheXmlVersion valueForVersion(final String version) {
    ...
    if (null == cacheXmlVersion) {
      throw new IllegalArgumentException(
          "No enum constant "
              + CacheXmlVersion.class.getCanonicalName()
              + " for version "
              + version
              + ".");
    }
