 ...
 *
 * <p>A VersionMember could either be an InternalDistributedMember (for an in memory region), or a
 * UUID (for a persistent region).
 *
 * <p>VersionMembers should implement equals and hashcode.
 */
