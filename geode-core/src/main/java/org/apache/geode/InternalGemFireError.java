 ...
 *
 * <p>This is similar to {@link AssertionError}, but these errors are always enabled in a GemFire
 * system.
 *
 * @since GemFire 5.5
 * @see AssertionError
...
public class InternalGemFireError extends Error {
   ...
   * Section 15.18.1.1.
   *
   * <p>If the specified object is an instance of <tt>Throwable</tt>, it becomes the <i>cause</i> of
  ...
  /**
   * Constructs an AssertionError with its detail message derived from the specified <code>boolean
   * </code>, which is converted to a string as defined in <i>The Java Language Specification,
  ...
  /**
   * Constructs an AssertionError with its detail message derived from the specified <code>char
   * </code>, which is converted to a string as defined in <i>The Java Language Specification,
   * Second Edition</i>, Section 15.18.1.1.
   *
   * @param detailMessage value to be used in constructing detail message
  ...
  /**
   * Constructs an AssertionError with its detail message derived from the specified <code>int
   * </code>, which is converted to a string as defined in <i>The Java Language Specification,
   * Second Edition</i>, Section 15.18.1.1.
   *
   * @param detailMessage value to be used in constructing detail message
  ...
  /**
   * Constructs an AssertionError with its detail message derived from the specified <code>long
   * </code>, which is converted to a string as defined in <i>The Java Language Specification,
   * Second Edition</i>, Section 15.18.1.1.
   *
   * @param detailMessage value to be used in constructing detail message
  ...
  /**
   * Constructs an AssertionError with its detail message derived from the specified <code>float
   * </code>, which is converted to a string as defined in <i>The Java Language Specification,
   * Second Edition</i>, Section 15.18.1.1.
   *
   * @param detailMessage value to be used in constructing detail message
  ...
  /**
   * Constructs an AssertionError with its detail message derived from the specified <code>double
   * </code>, which is converted to a string as defined in <i>The Java Language Specification,
   * Second Edition</i>, Section 15.18.1.1.
   *
   * @param detailMessage value to be used in constructing detail message
