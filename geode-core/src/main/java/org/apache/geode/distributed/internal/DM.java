...
public interface DM extends ReplySender {
   ...
   *
   * <p>Note that this method may return null (no valid elders exist).
   *
   ...
   *
   * <p>If useTryLock is true, then it will attempt to get a try-lock and throw
   ...
   * bind-addr[port].
   *
   * <p>This currently only tracks stand-alone/dedicated locators, not embedded locators.
   *
