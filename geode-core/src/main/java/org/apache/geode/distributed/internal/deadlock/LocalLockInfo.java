...
class LocalLockInfo implements Serializable {
  ...
  public boolean equals(Object obj) {
    ...
    if (!(obj instanceof LocalLockInfo)) return false;
    ...
    if (locatility == null) {
      if (other.locatility != null) return false;
    } else if (!locatility.equals(other.locatility)) return false;
    return true;
  }
