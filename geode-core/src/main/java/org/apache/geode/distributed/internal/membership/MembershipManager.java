 ...
 *
 * <p>Note that it is imperative to send a new manager a postConnect message after instantiation.
 */
public interface MembershipManager {
   ...
   * @return list of members who did not receive the message. If {@link
   *     DistributionMessage#ALL_RECIPIENTS} is given as thelist of recipients, this return list is
   *     null (empty). Otherwise, this list is all of those recipients that did not receive the
   *     message because they departed the distributed system.
   * @throws NotSerializableException If content cannot be serialized
   */
  public Set send(
      InternalDistributedMember[] destinations, DistributionMessage content, DMStats stats)
