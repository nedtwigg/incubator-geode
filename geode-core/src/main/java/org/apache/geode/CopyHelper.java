...
public final class CopyHelper {
   ...
   *
   * <p>Copies can only be made if the original is a <tt>Cloneable</tt> or serializable by GemFire.
   ...
   *
   * <p>If the argument o is an instance of {@link java.lang.Cloneable}, a copy is made by invoking
   ...
   *
   * <p>The difference between this method and {@link #deepCopy(Object) deepCopy}, is that this
   * method uses <tt>clone</tt> if available, whereas <tt>deepCopy</tt> does not. As a result, for
          ...
          try {
            ...
            if (cause instanceof CloneNotSupportedException) {
              ...
              throw new CopyException(
                  LocalizedStrings.CopyHelper_CLONE_FAILED.toLocalizedString(),
                  cause != null ? cause : ex);
            }
          }
   ...
   *
   * <p>If o is a {@link #isWellKnownImmutableInstance(Object) well known immutable instance} then
   * it will be returned without copying it.
   *
   * <p>The passed in object is serialized in memory, and then deserialized into a new instance,
   * which is returned. If GemFire serialization is implemented for the object, it is used;
   * otherwise, java serialization is used.
   *
