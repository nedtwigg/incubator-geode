...
public class ClientHttpRequestJUnitTest extends AbstractWebTestCase {
  ...
  public void testGetMethod() throws Exception {
    ...
    link =
        new Link(
            "delete-resource", toUri("http://host.domain.com:8080/app/service"), HttpMethod.HEAD);
    request = new ClientHttpRequest(link);
    ...
    link =
        new Link(
            "delete-resource", toUri("http://host.domain.com:8080/app/resources"), HttpMethod.POST);
    request = new ClientHttpRequest(link);
    ...
    link =
        new Link(
            "delete-resource", toUri("http://host.domain.com:8080/app/resources"), HttpMethod.PUT);
    request = new ClientHttpRequest(link);
  ...
  public void testIsDelete() throws Exception {
    final Link expectedLink =
        new Link(
            "delete", toUri("http://host.domain.com:8080/app/resources/{id}"), HttpMethod.DELETE);
    final ClientHttpRequest request = new ClientHttpRequest(expectedLink);
  ...
  public void testGetURLForGet() throws Exception {
    final Link expectedLink =
        new Link(
            "find",
            toUri("http://host.domain.com:8080/app/libraries/{name}/books"),
            HttpMethod.GET);
    final ClientHttpRequest request = new ClientHttpRequest(expectedLink);
  ...
  public void testGetURLForGetEncoded() throws Exception {
    final Link expectedLink =
        new Link(
            "readValue4Key",
            toUri("http://host.domain.com:8080/app/regions/{region}/keys/{key}"),
            HttpMethod.GET);
    final ClientHttpRequest request = new ClientHttpRequest(expectedLink);
    ...
    assertEquals(expectedLink, request.getLink());
    assertEquals(
        "http://host.domain.com:8080/app/regions/Customers%2FAccounts%2FOrders/keys/123",
  ...
  public void testGetURLForGetWithQueryParametersNoBody() throws Exception {
    final Link expectedLink =
        new Link(
            "find",
            toUri("http://host.domain.com:8080/app/libraries/{name}/books/{author}"),
            HttpMethod.GET);
    final ClientHttpRequest request = new ClientHttpRequest(expectedLink);
  ...
  public void testGetURLForDelete() throws Exception {
    ...
    assertEquals(expectedLink, request.getLink());
    assertEquals(
        "http://host.domain.com:8080/app/libraries/congress/books?category=romance",
  ...
  public void testGetURLForPost() throws Exception {
    ...
    assertEquals(expectedLink, request.getLink());
    assertEquals(
        "http://host.domain.com:8080/app/libraries/royal/books",
  ...
  public void testGetURLForPut() throws Exception {
    final Link expectedLink =
        new Link(
            "put",
            toUri("http://host.domain.com:8080/app/libraries/{name}/books/{isbn}"),
            HttpMethod.PUT);
    final ClientHttpRequest request = new ClientHttpRequest(expectedLink);
    ...
    assertEquals(expectedLink, request.getLink());
    assertEquals(
        "http://host.domain.com:8080/app/libraries/royal/books/0345453743",
        toString(request.getURL(uriVariables)));
  }
  ...
  public void testCreateRequestEntityForPost() throws Exception {
    ...
    request.addHeaderValues(
        HttpHeader.CONTENT_TYPE.getName(), MediaType.APPLICATION_FORM_URLENCODED_VALUE);
    ...
    assertNotNull(requestEntity.getHeaders());
    assertEquals(
        MediaType.APPLICATION_FORM_URLENCODED, requestEntity.getHeaders().getContentType());
  ...
  public void testCreateRequestEntityOnPut() throws Exception {
    ...
    final Link expectedLink =
        new Link(
            "put",
            toUri("http://host.domain.com:8080/app/libraries/{name}/books/{id}"),
            HttpMethod.PUT);
  ...
  public void testSetAndGetHeaderValues() throws Exception {
    ...
    assertEquals(
        MediaType.APPLICATION_JSON_VALUE, request.getHeaderValue(HttpHeader.ACCEPT.getName()));
    assertEquals(3, request.getHeaderValues(HttpHeader.ACCEPT.getName()).size());
    assertTrue(
        request
            .getHeaderValues(HttpHeader.ACCEPT.getName())
            .containsAll(
                Arrays.asList(
                    MediaType.APPLICATION_JSON_VALUE,
                    MediaType.APPLICATION_XML_VALUE,
  ...
  public void testSetAndGetParameterValues() throws Exception {
    ...
    assertTrue(
        request
            .getParameterValues("parameterTwo")
