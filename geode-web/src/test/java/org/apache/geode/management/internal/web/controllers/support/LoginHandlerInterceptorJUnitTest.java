...
public class LoginHandlerInterceptorJUnitTest {
  ...
  public void testPreHandleAfterCompletion() throws Exception {
    ...
    final HttpServletRequest mockHttpRequest =
        mockContext.mock(
            HttpServletRequest.class, "testPreHandleAfterCompletion.HttpServletRequest");
  ...
  private final class HandlerInterceptorThreadSafetyMultiThreadedTestCase
    ...
    public void initialize() {
      ...
      mockHttpRequestOne =
          mockContext.mock(
              HttpServletRequest.class, "testHandlerInterceptorThreadSafety.HttpServletRequest.1");
          ...
          new Expectations() {
            {
              ...
              oneOf(mockHttpRequestOne)
                  .getParameter(with(equal(createEnvironmentVariable("STAGE"))));
              will(returnValue(requestParametersOne.get(createEnvironmentVariable("STAGE"))));
              oneOf(mockHttpRequestOne)
                  .getParameter(with(equal(createEnvironmentVariable("GEMFIRE"))));
      ...
      mockHttpRequestTwo =
          mockContext.mock(
              HttpServletRequest.class, "testHandlerInterceptorThreadSafety.HttpServletRequest.2");
          ...
          new Expectations() {
            {
              ...
              oneOf(mockHttpRequestTwo)
                  .getParameter(with(equal(createEnvironmentVariable("HOST"))));
