...
public class LuceneIndexForPartitionedRegionTest {
  ...
  @Rule public ExpectedException expectedExceptions = ExpectedException.none();
  ...
  private Region initializeScenario(
      final boolean withPersistence, final String regionPath, final Cache cache) {
  ...
  private RegionAttributes createRegionAttributes(
      final boolean withPersistence, PartitionAttributes partitionAttributes) {
  ...
  public void initializeShouldCreatePartitionChunkRegion() {
    ...
    verify(spy)
        .createChunkRegion(
            eq(RegionShortcut.PARTITION),
            eq(index.createFileRegionName()),
            any(),
            eq(index.createChunkRegionName()),
            any());
  }
  ...
  public void initializeShouldCreatePartitionFileRegion() {
    ...
    verify(spy)
        .createFileRegion(
            eq(RegionShortcut.PARTITION), eq(index.createFileRegionName()), any(), any());
  }
  ...
  public void createFileRegionWithPartitionShortcutCreatesRegionUsingCreateVMRegion()
    ...
    indexSpy.createFileRegion(
        RegionShortcut.PARTITION,
        index.createFileRegionName(),
        partitionAttributes,
        regionAttributes);
    String fileRegionName = index.createFileRegionName();
    verify(indexSpy)
