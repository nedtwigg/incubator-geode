...
/**
 * Interface for collection results of a query on an IndexRepository. See {@link
 * IndexRepository#query(org.apache.lucene.search.Query, int, IndexResultCollector)}
 */
@Experimental
