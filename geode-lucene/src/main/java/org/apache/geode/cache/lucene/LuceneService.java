 ...
 *
 * <p>It provides handle for managing the {@link LuceneIndex} and create the {@link LuceneQuery} via
 * {@link LuceneQueryFactory} Example: <br>
 *
 * <pre>
...
public interface LuceneService {
   ...
   *     index. Fields should map to PDX fieldNames if the object is serialized with PDX, or to java
   *     fields on the object otherwise. The special field name {{@link #REGION_VALUE_FIELD}}
   ...
   * @param analyzerPerField A map of fields to analyzers. See {{@link #createIndex(String, String,
   *     String...)}} for details on valid values for fields. Each field will be tokenized using the
   *     provided Analyzer.
   */
  public void createIndex(
      String indexName, String regionPath, Map<String, Analyzer> analyzerPerField);
