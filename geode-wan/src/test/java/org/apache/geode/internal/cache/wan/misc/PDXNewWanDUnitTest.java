...
public class PDXNewWanDUnitTest extends WANTestBase {
  ...
  public void testWANPDX_RR_SerialSender3Sites() {
    ...
    vm3.invoke(() -> WANTestBase.createReplicatedRegion(getTestMethodName() + "_RR", "ny,tk", isOffHeap()));
    vm4.invoke(() -> WANTestBase.createReplicatedRegion(getTestMethodName() + "_RR", "ln,tk", isOffHeap()));
    vm5.invoke(() -> WANTestBase.createReplicatedRegion(getTestMethodName() + "_RR", "ln,ny", isOffHeap()));
  ...
  public void testWANPDX_PR_MultipleVM_SerialSender() {
    ...
    createCacheInVMs(nyPort, vm2);
    vm2.invoke(() -> WANTestBase.createPartitionedRegion(getTestMethodName() + "_PR", null, 1, 5, isOffHeap()));
    vm2.invoke(() -> WANTestBase.createReceiver());
    ...
    vm3.invoke(() -> WANTestBase.createPartitionedRegion(getTestMethodName() + "_PR", "ln", 1, 5, isOffHeap()));
    vm4.invoke(() -> WANTestBase.createPartitionedRegion(getTestMethodName() + "_PR", "ln", 1, 5, isOffHeap()));
  ...
  public void testWANPDX_PR_ParallelSender() {
    ...
    vm2.invoke(() -> WANTestBase.createPartitionedRegion(getTestMethodName() + "_PR", null, 0, 1, isOffHeap()));

    vm3.invoke(() -> WANTestBase.createPartitionedRegion(getTestMethodName() + "_PR", "ln", 0, 1, isOffHeap()));
  ...
  public void testWANPDX_RR_SerialSenderWithFilter() {
    ...
    vm3.invoke(() -> WANTestBase.createSender("ln", 2, false, 100, 10, false, false, new PDXGatewayEventFilter(), true));
  ...
  public void testWANPDX_PR_MultipleVM_ParallelSenderWithFilter() {
    ...
    vm3.invoke(() -> WANTestBase.createSender("ln", 2, true, 100, 10, false, false, new PDXGatewayEventFilter(), true));
    vm4.invoke(() -> WANTestBase.createSender("ln", 2, true, 100, 10, false, false, new PDXGatewayEventFilter(), true));
  ...
  public void testWANPDX_PR_SerialSender_RemoteSite_Bounce() {
    ...
    vm2.invoke(() -> WANTestBase.createPartitionedRegion(getTestMethodName() + "_PR", null, 1, 2, isOffHeap()));
    vm4.invoke(() -> WANTestBase.createPartitionedRegion(getTestMethodName() + "_PR", null, 1, 2, isOffHeap()));
