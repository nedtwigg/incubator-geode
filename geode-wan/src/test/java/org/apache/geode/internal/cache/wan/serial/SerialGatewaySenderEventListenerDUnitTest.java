...
public class SerialGatewaySenderEventListenerDUnitTest extends WANTestBase {
  ...
  public void testGatewaySenderEventListenerInvocationWithoutLocator() {
    ...
    vm4.invoke(() -> WANTestBase.createSenderWithListener("ln", 2, false, 100, 10, false, false, null, false, true));
    vm5.invoke(() -> WANTestBase.createSenderWithListener("ln", 2, false, 100, 10, false, false, null, false, true));
  ...
  public void testGatewaySender2EventListenerInvocation() {
    ...
    vm4.invoke(() -> WANTestBase.createSenderWithListener("ln", 2, false, 100, 10, false, false, null, true, true));
    vm5.invoke(() -> WANTestBase.createSenderWithListener("ln", 2, false, 100, 10, false, false, null, true, true));
  ...
  public void testGatewaySenderEventListenerPoolImpl() {
    ...
    vm4.invoke(() -> WANTestBase.createSenderWithListener("ln", 2, false, 100, 10, false, false, null, false, false));
