...
public class SerialGatewaySenderEventListenerDUnitTest extends WANTestBase {
  ...
  public void testGatewaySenderEventListenerInvocationWithoutLocator() {
    ...
    vm4.invoke(
        () ->
            WANTestBase.createSenderWithListener(
                "ln", 2, false, 100, 10, false, false, null, false, true));
    vm5.invoke(
        () ->
            WANTestBase.createSenderWithListener(
                "ln", 2, false, 100, 10, false, false, null, false, true));
  ...
  public void testGatewaySenderEventListenerInvocation() {
    ...
    vm4.invoke(
        () ->
            SerialGatewaySenderEventListenerDUnitTest.validateReceivedEventsMapSizeListener1(
                "ln", keyValues));
  }
  ...
  public void testGatewaySender2EventListenerInvocation() {
    ...
    vm4.invoke(
        () ->
            WANTestBase.createSenderWithListener(
                "ln", 2, false, 100, 10, false, false, null, true, true));
    vm5.invoke(
        () ->
            WANTestBase.createSenderWithListener(
                "ln", 2, false, 100, 10, false, false, null, true, true));
    ...
    vm4.invoke(
        () ->
            SerialGatewaySenderEventListenerDUnitTest.validateReceivedEventsMapSizeListener2(
                "ln", keyValues));
  }
  ...
  public void testGatewaySenderEventListenerPoolImpl() {
    ...
    vm4.invoke(
        () ->
            WANTestBase.createSenderWithListener(
                "ln", 2, false, 100, 10, false, false, null, false, false));
