...
public class WANTestBase extends JUnit4DistributedTestCase {
  ...
  public static void createLocator(
      int dsId, int port, Set<String> localLocatorsList, Set<String> remoteLocatorsList) {
  ...
  public static Integer createSecondRemoteLocatorWithAPI(
      int dsId, int localPort, int remoteLocPort, String hostnameForClients) throws IOException {
    stopOldLocator();
    WANTestBase test = new WANTestBase();
    int port = AvailablePortHelper.getRandomAvailablePortForDUnitSite();
    Properties props = test.getDistributedSystemProperties();
    ...
    Locator locator =
        Locator.startLocatorAndDS(
            0, null, InetAddress.getByName("localhost"), props, true, true, hostnameForClients);
  ...
  public static void createPersistentReplicatedRegion(
      String regionName, String senderIds, Boolean offHeap) {
    AttributesFactory fact = new AttributesFactory();
    if (senderIds != null) {
      StringTokenizer tokenizer = new StringTokenizer(senderIds, ",");
      while (tokenizer.hasMoreTokens()) {
  ...
  public static void createReplicatedRegion(
      String regionName, String senderIds, Scope scope, DataPolicy policy, Boolean offHeap) {
    AttributesFactory fact = new AttributesFactory();
    if (senderIds != null) {
      StringTokenizer tokenizer = new StringTokenizer(senderIds, ",");
      while (tokenizer.hasMoreTokens()) {
  ...
  public static void createPartitionedRegionWithPersistence(
  ...
  public static void createColocatedPartitionedRegion(
      String regionName,
      String senderIds,
      Integer redundantCopies,
      Integer totalNumBuckets,
  ...
  public static void createCustomerOrderShipmentPartitionedRegion(
      String senderIds, Integer redundantCopies, Integer totalNumBuckets, Boolean offHeap) {
    IgnoredException exp =
        IgnoredException.addIgnoredException(ForceReattemptException.class.getName());
    try {
      AttributesFactory fact = new AttributesFactory();
  ...
  public static void createColocatedPartitionedRegions2(
      String regionName,
      String senderIds,
      Integer redundantCopies,
      Integer totalNumBuckets,
  ...
  public static void longPauseAfterNumEvents(int numEvents, int milliSeconds) {
    ...
    cache
        .getRegion(getTestMethodName() + "_RR_1")
        .getAttributesMutator()
  ...
  protected static void createCacheWithSSL(Integer locPort) {
    ...
    gemFireProps.put(
        ...
        TestUtil.getResourcePath(
            WANTestBase.class, "/org/apache/geode/cache/client/internal/client.keystore"));
    gemFireProps.put(GATEWAY_SSL_KEYSTORE_PASSWORD, "password");
    gemFireProps.put(
        GATEWAY_SSL_TRUSTSTORE,
        TestUtil.getResourcePath(
            WANTestBase.class, "/org/apache/geode/cache/client/internal/client.truststore"));
  ...
  public static void checkQueueStats(
      String senderId,
      final int queueSize,
  ...
  public static void checkGatewayReceiverStatsHA(
      int processBatches, int eventsReceived, int creates) {
    Set<GatewayReceiver> gatewayReceivers = cache.getGatewayReceivers();
    GatewayReceiver receiver = gatewayReceivers.iterator().next();
    CacheServerStats stats = ((CacheServerImpl) receiver.getServer()).getAcceptor().getStats();
  ...
  public static void checkBatchStats(
      String senderId, final boolean batchesDistributed, final boolean batchesRedistributed) {
    Set<GatewaySender> senders = cache.getGatewaySenders();
    GatewaySender sender = null;
    for (GatewaySender s : senders) {
      if (s.getId().equals(senderId)) {
  ...
  public static void checkUnProcessedStats(String senderId, int events) {
    ...
    assertEquals(
        events,
        (statistics.getUnprocessedEventsAddedBySecondary()
    ...
    try {
      ...
      Awaitility.await()
          ...
          .until(
              () ->
                  assertEquals(
                      "Expected sender isRunning state to " + "be true but is false",
                      true,
  ...
  public static void waitForSenderToBecomePrimary(String senderId) {
    ...
    Awaitility.await()
        ...
        .until(
            () ->
                assertEquals(
                    "Expected sender primary state to " + "be true but is false",
                    true,
    ...
    Awaitility.await()
        ...
        .until(
            () -> {
              ...
              secondaryUpdatesMap.put("Destroy", listener1.destroyList);
              assertEquals(
                  "Expected secondary map to be "
                      + primaryUpdatesMap
                      + " but it is "
                      + secondaryUpdatesMap,
                  true,
                  secondaryUpdatesMap.equals(primaryUpdatesMap));
            });
  }
  ...
  public static GatewaySenderFactory configureGateway(
  ...
  public static void createSenderWithMultipleDispatchers(
      String dsName,
      int remoteDsId,
      boolean isParallel,
      Integer maxMemory,
  ...
  public static void createSenderWithoutDiskStore(
      String dsName,
      int remoteDsId,
      Integer maxMemory,
      Integer batchSize,
  ...
  public static void createSenderForValidations(
      String dsName,
      int remoteDsId,
      boolean isParallel,
  ...
  public static String createSenderWithDiskStore(
      String dsName,
      int remoteDsId,
      boolean isParallel,
      Integer maxMemory,
  ...
  public static void createSenderWithListener(
      String dsName,
      int remoteDsName,
      boolean isParallel,
      Integer maxMemory,
  ...
  public static int createReceiverWithSSL(int locPort) {
    ...
    gemFireProps.put(
        GATEWAY_SSL_KEYSTORE,
        TestUtil.getResourcePath(
            WANTestBase.class, "/org/apache/geode/cache/client/internal/cacheserver.keystore"));
    gemFireProps.put(GATEWAY_SSL_KEYSTORE_PASSWORD, "password");
    gemFireProps.put(
        GATEWAY_SSL_TRUSTSTORE,
        TestUtil.getResourcePath(
            WANTestBase.class, "/org/apache/geode/cache/client/internal/cacheserver.truststore"));
    gemFireProps.put(GATEWAY_SSL_TRUSTSTORE_PASSWORD, "password");
  ...
  public static void doMultiThreadedPuts(String regionName, int numPuts) {
    ...
    for (long i = 0; i < 5; i++) tasks.add(new PutTask(r, ai, numPuts));

    try {
      List<Future<Object>> l = execService.invokeAll(tasks);
      for (Future<Object> f : l) f.get();
  ...
  public static void validateRegionSize(
      String regionName, final int regionSize, long waitTimeInMilliSec) {
    IgnoredException exp =
        IgnoredException.addIgnoredException(ForceReattemptException.class.getName());
    IgnoredException exp1 =
        IgnoredException.addIgnoredException(CacheClosedException.class.getName());
    try {
      ...
      if (regionSize != r.keySet().size()) {
        Awaitility.await()
            .atMost(waitTimeInMilliSec, TimeUnit.MILLISECONDS)
            .pollInterval(500, TimeUnit.MILLISECONDS)
            .until(
                () ->
                    assertEquals(
                        "Expected region entries: "
                            + regionSize
                            + " but actual entries: "
                            + r.keySet().size()
                            + " present region keyset "
                            + r.keySet(),
                        regionSize,
                        r.keySet().size()));
      }
      ...
      Awaitility.await()
          ...
          .until(
              () -> {
                ...
                assertEquals(
                    "Expected queue size to be : " + 0 + " but actual entries: " + size, 0, size);
              });
    } else {
      Awaitility.await()
          .atMost(60, TimeUnit.SECONDS)
        ...
        new WaitCriterion() {
          ...
          public boolean done() {
            if (r.keySet().size() == previousSize) {
              ...
              previousSize =
                  r.keySet().size(); //update the previousSize variable with current region size
    ...
    Awaitility.waitAtMost(60, TimeUnit.SECONDS)
        .until(
            () -> {
              ...
              for (Map.Entry<Integer, Set<InetSocketAddress>> entry :
                ...
                final Set<InetSocketAddress> foundLocators =
                    foundLocatorIds
                        .stream()
                        .map(
                            distributionLocatorId ->
                                new InetSocketAddress(
                                    distributionLocatorId.getHostnameForClients(),
  ...
  public static void validateParallelSenderQueueBucketSize(
      final String senderId, final int bucketSize) {
    Set<GatewaySender> senders = cache.getGatewaySenders();
    GatewaySender sender = null;
    for (GatewaySender s : senders) {
      if (s.getId().equals(senderId)) {
    ...
    Set<BucketRegion> buckets =
        ((PartitionedRegion) regionQueue.getRegion())
            .getDataStore()
      ...
      for (final BucketRegion bucket : buckets) {
        Awaitility.await()
            ...
            .until(
                () -> {
                  assertEquals(
                      "Expected bucket entries for bucket: "
                          + bucket.getId()
