...
public class ConcurrentWANPropagation_1_DUnitTest extends WANTestBase {
    ...
    vm4.invoke(
        () ->
            WANTestBase.createConcurrentSender(
                "ln", 2, false, 100, 400, false, false, null, true, 4, OrderPolicy.KEY));
    vm5.invoke(
        () ->
            WANTestBase.createConcurrentSender(
                "ln", 2, false, 100, 400, false, false, null, true, 4, OrderPolicy.KEY));
  ...
  public void testReplicatedSerialPropagationWithLocalRegionDestroy() throws Exception {
    ...
    vm4.invoke(
        () ->
            WANTestBase.createConcurrentSender(
                "ln", 2, false, 100, 20, false, false, null, true, 3, OrderPolicy.THREAD));
    vm5.invoke(
        () ->
            WANTestBase.createConcurrentSender(
                "ln", 2, false, 100, 20, false, false, null, true, 3, OrderPolicy.THREAD));
  ...
  public void testReplicatedSerialPropagationWithRemoteRegionDestroy() throws Exception {
    ...
    vm4.invoke(
        () ->
            WANTestBase.createConcurrentSender(
                "ln", 2, false, 100, 500, false, false, null, true, 5, OrderPolicy.KEY));
    vm5.invoke(
        () ->
            WANTestBase.createConcurrentSender(
                "ln", 2, false, 100, 500, false, false, null, true, 5, OrderPolicy.KEY));
  ...
  public void testReplicatedSerialPropagationWithRemoteRegionDestroy2() throws Exception {
    ...
    vm4.invoke(
        () ->
            WANTestBase.createConcurrentSender(
                "ln", 2, false, 100, 200, false, false, null, true, 5, OrderPolicy.THREAD));
    vm5.invoke(
        () ->
            WANTestBase.createConcurrentSender(
                "ln", 2, false, 100, 200, false, false, null, true, 5, OrderPolicy.THREAD));
  ...
  public void testReplicatedSerialPropagationWithRemoteRegionDestroy3() throws Exception {
    ...
    vm4.invoke(
        () ->
            WANTestBase.createConcurrentSender(
                senderId, 2, false, 100, 200, false, false, null, true, 5, OrderPolicy.THREAD));
    vm5.invoke(
        () ->
            WANTestBase.createConcurrentSender(
                senderId, 2, false, 100, 200, false, false, null, true, 5, OrderPolicy.THREAD));
