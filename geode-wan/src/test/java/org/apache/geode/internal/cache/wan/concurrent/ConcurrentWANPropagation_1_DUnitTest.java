...
public class ConcurrentWANPropagation_1_DUnitTest extends WANTestBase {
  ...
  public void testReplicatedSerialPropagation_withoutRemoteSite() throws Exception {
    ...
    vm4.invoke(() -> WANTestBase.createConcurrentSender("ln", 2, false, 100, 400, false, false, null, true, 4, OrderPolicy.KEY));
    vm5.invoke(() -> WANTestBase.createConcurrentSender("ln", 2, false, 100, 400, false, false, null, true, 4, OrderPolicy.KEY));
  ...
  public void testReplicatedSerialPropagationWithRemoteRegionDestroy() throws Exception {
    ...
    //senders are created on local site
    vm4.invoke(() -> WANTestBase.createConcurrentSender("ln", 2, false, 100, 500, false, false, null, true, 5, OrderPolicy.KEY));
    vm5.invoke(() -> WANTestBase.createConcurrentSender("ln", 2, false, 100, 500, false, false, null, true, 5, OrderPolicy.KEY));
