...
public class ClusterConfigurationDUnitTest extends CliCommandTestBase {
  ...
  public void testConfigDistribution() throws Exception {
    ...
    createGatewayReceiver(
        receiverManualStart, "", gatewayReceiverStartPort, gatewayReceiverEndPort, "20", "");
    createGatewaySender(
        gsId,
        batchSize,
        alertThreshold,
        ...
        new SerializableCallable() {
          ...
          public Object call() throws IOException {
            ...
            for (DiskStoreImpl diskStore : diskStoreList) {
              ...
              assertTrue(
                  Boolean.toString(diskStore.getAllowForceCompaction())
                      .equals(allowForceCompaction));
              assertTrue(
            ...
            locatorAndMgr.invoke(
                new SerializableCallable() {
                  ...
                  public Object call() throws IOException {
                    ...
                    locatorProps.setProperty(
                        CLUSTER_CONFIGURATION_DIR, clusterConfigDir.getCanonicalPath());
                    locatorProps.setProperty(HTTP_SERVICE_PORT, String.valueOf(httpPort));

                    final InternalLocator locator =
                        (InternalLocator)
                            Locator.startLocatorAndDS(
                                locator1Port, locatorLogFile, null, locatorProps);
  ...
  private void createPersistentRegion(
      String regionName, RegionShortcut regionShortCut, String group, String diskStoreName) {
    CommandStringBuilder csb = new CommandStringBuilder(CliStrings.CREATE_REGION);
  ...
  private void alterRegion(
    ...
    csb.addOptionWithValueCheck(
        CliStrings.ALTER_REGION__ENTRYEXPIRATIONIDLETIMEACTION, entryExpIdleTimeAction);
  ...
  private void createDiskStore(
    ...
    csb.addOptionWithValueCheck(
        CliStrings.CREATE_DISK_STORE__ALLOW_FORCE_COMPACTION, allowForceCompaction);
    csb.addOptionWithValueCheck(
        CliStrings.CREATE_DISK_STORE__COMPACTION_THRESHOLD, compactionThreshold);
  ...
  private void createGatewayReceiver(
    ...
    csb.addOptionWithValueCheck(
        CliStrings.CREATE_GATEWAYRECEIVER__MAXTIMEBETWEENPINGS, maxTimeBetweenPings);
    executeAndVerifyCommand(csb.getCommandString());
  }
  ...
  private void createGatewaySender(
    ...
    csb.addOptionWithValueCheck(
        CliStrings.CREATE_GATEWAYSENDER__BATCHTIMEINTERVAL, batchTimeInterval);
    csb.addOptionWithValueCheck(
        CliStrings.CREATE_GATEWAYSENDER__DISPATCHERTHREADS, dispatcherThreads);
    csb.addOptionWithValueCheck(
        CliStrings.CREATE_GATEWAYSENDER__ENABLEBATCHCONFLATION, enableConflation);
    ...
    csb.addOptionWithValueCheck(
        CliStrings.CREATE_GATEWAYSENDER__SOCKETBUFFERSIZE, socketBufferSize);
    csb.addOptionWithValueCheck(
  ...
  private void createAsyncEventQueue(
      String id,
      String persistent,
      String diskStoreName,
      String batchSize,
    ...
    try {
      ...
      csb.addOptionWithValueCheck(
          CliStrings.CREATE_ASYNC_EVENT_QUEUE__LISTENER,
          "com.qcdunit.QueueCommandsDUnitTestListener");
      ...
      csb.addOptionWithValueCheck(
          CliStrings.CREATE_ASYNC_EVENT_QUEUE__MAXIMUM_QUEUE_MEMORY, maxQueueMemory);
      executeAndVerifyCommand(csb.getCommandString());
  ...
  private void configurePDX(
      String autoSerializerClasses,
      String ignoreUnreadFields,
      String persistent,
      String portableAutoSerializerClasses,
      String readSerialized) {
    CommandStringBuilder csb = new CommandStringBuilder(CliStrings.CONFIGURE_PDX);
    csb.addOptionWithValueCheck(
        CliStrings.CONFIGURE_PDX__AUTO__SERIALIZER__CLASSES, autoSerializerClasses);
    csb.addOptionWithValueCheck(
        CliStrings.CONFIGURE_PDX__IGNORE__UNREAD_FIELDS, ignoreUnreadFields);
  ...
  private void alterRuntime(
      String copyOnRead, String lockLease, String lockTimeout, String messageSyncInterval) {
    ...
    csb.addOptionWithValueCheck(
        CliStrings.ALTER_RUNTIME_CONFIG__MESSAGE__SYNC__INTERVAL, messageSyncInterval);
    executeAndVerifyCommand(csb.toString());
  }
