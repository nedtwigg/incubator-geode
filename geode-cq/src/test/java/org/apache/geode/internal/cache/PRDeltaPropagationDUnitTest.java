...
public class PRDeltaPropagationDUnitTest extends JUnit4DistributedTestCase {
  ...
  private void verifyNoCopy() {
    ...
    boolean copy =
        ((LocalRegion) deltaPR).getCompressor() == null
  ...
  public void testDeltaPropagationForPRFailover() throws Exception {
    Object args[] =
        new Object[] {
          REGION_NAME, new Integer(1), new Integer(50), new Integer(8), Boolean.FALSE, null
        };
    Integer port1 =
        (Integer)
            dataStore1.invoke(PRDeltaPropagationDUnitTest.class, "createCacheServerWithPR", args);
    Integer port2 =
        (Integer)
            dataStore2.invoke(PRDeltaPropagationDUnitTest.class, "createCacheServerWithPR", args);
  ...
  public void testDeltaPropagationForPRFailoverWithCompression() throws Exception {
    Object args[] =
        new Object[] {
          REGION_NAME, new Integer(1), new Integer(50), new Integer(8), Boolean.FALSE, compressor
        };
    Integer port1 =
        (Integer)
            dataStore1.invoke(PRDeltaPropagationDUnitTest.class, "createCacheServerWithPR", args);
  ...
  public void testDeltaPropagationPRAccessorAsBridgeServer() throws Exception {
    Object args1[] =
        new Object[] {
          REGION_NAME, new Integer(0), new Integer(0), new Integer(8), Boolean.FALSE, null
        };
    Object args2[] =
        new Object[] {
          REGION_NAME, new Integer(0), new Integer(50), new Integer(8), Boolean.FALSE, null
        };
    Integer port2 =
        (Integer)
    ...
    Integer port1 =
        (Integer)
            dataStore1.invoke(PRDeltaPropagationDUnitTest.class, "createCacheServerWithPR", args1);
    createClientCache(port1, new Boolean(true), new Boolean(false), new Boolean(false));
    client1.invoke(
        () ->
            PRDeltaPropagationDUnitTest.createClientCache(
                port2, new Boolean(true), new Boolean(false), new Boolean(false)));
    int deltaSent = putsWhichReturnsDeltaSent();
  ...
  public void testCqClientConnectAccessorAndDataStore() throws Exception {
    Object args1[] =
        new Object[] {
          REGION_NAME, new Integer(1), new Integer(0), new Integer(8), Boolean.FALSE, null
        };
    Object args2[] =
        new Object[] {
          REGION_NAME, new Integer(1), new Integer(50), new Integer(8), Boolean.FALSE, null
    ...
    client1.invoke(
        () ->
            PRDeltaPropagationDUnitTest.createClientCache(
                port2, new Boolean(false), new Boolean(false), new Boolean(true)));
  ...
  public void testClientOnAccessorReceivesCqEvents() throws Exception {
    ...
    client1.invoke(
        () ->
            PRDeltaPropagationDUnitTest.createClientCache(
                port1, new Boolean(false), new Boolean(false), new Boolean(true)));
  ...
  public void testCQClientOnRedundantBucketReceivesCQEvents() throws Exception {
    ...
    Object args1[] =
        new Object[] {
          REGION_NAME, new Integer(1), new Integer(0), new Integer(2), Boolean.FALSE, null
        };
    // args for dataStore with 2 buckets
    Object args2[] =
        new Object[] {
          REGION_NAME, new Integer(1), new Integer(50), new Integer(2), Boolean.FALSE, null
        };
    ...
    Integer port3 =
        (Integer)
            dataStore3.invoke(PRDeltaPropagationDUnitTest.class, "createCacheServerWithPR", args2);
    ...
    client1.invoke(
        () ->
            PRDeltaPropagationDUnitTest.createClientCache(
                port3, new Boolean(false), new Boolean(false), new Boolean(true)));
  ...
  public void testCQRIClientOnRedundantBucketReceivesDeltaAndCQEvents() throws Exception {
    ...
    client1.invoke(
        () ->
            PRDeltaPropagationDUnitTest.createClientCache(
                port3, new Boolean(true), new Boolean(false), new Boolean(true)));
  ...
  public void testDeltaPropagationWithAdjunctMessaging() throws Exception {
    ...
    client1.invoke(
        () ->
            PRDeltaPropagationDUnitTest.createClientCache(
                port1, new Boolean(true), new Boolean(false), new Boolean(false)));
    int deltaSent = putsWhichReturnsDeltaSent();
  ...
  /**
   * 1) Accessor is a Feeder.From accessor to data store delta gets propagated as part of <code>
   * PutMessage</code> delta. 2) From data store to accessor delta + full value gets propagted as
   * part of Adjunct Message. 3) From accessor to a client with data policy normal delta should get
   * propagated. 4) From accessor to client with data policy empty full value should get propagated.
   */
  @Test
  ...
  public static void checkToDeltaCounter(Integer count) {
    assertTrue(
        "ToDelta counters do not match, expected: "
            + count.intValue()
            + ", actual: "
  ...
  public static void fromDeltaCounter(Integer count) {
    assertTrue(
        "FromDelta counters do not match, expected: "
            + count.intValue()
            + ", but actual: "
  ...
  public static void checkCloning() {
    assertFalse(
        "Cloning is enabled ", cache.getRegion(REGION_NAME).getAttributes().getCloningEnabled());
  }
  ...
  private static void createDeltaPR(Boolean setExpiry) {
    Object args[] =
        new Object[] {
          "DeltaPR", new Integer(1), new Integer(50), new Integer(8), setExpiry, false, null
        };
  ...
  private static void createDeltaPRWithCloning(Boolean setExpiry) {
    Object args[] =
        new Object[] {
          "DeltaPR", new Integer(1), new Integer(50), new Integer(8), setExpiry, true, null
        };
  ...
  public static Integer createCacheServerWithPR(
      String partitionedRegionName,
      Integer redundancy,
      Integer localMaxMemory,
      Integer totalNumBuckets,
      ...
      am.addCacheListener(
          new CacheListenerAdapter() {
            ...
            public void afterCreate(EntryEvent event) {
              if (event.getNewValue() == null) isFailed = true;
  ...
  public static void createClientCache(
      Integer port1, Boolean subscriptionEnable, Boolean isEmpty, Boolean isCq) throws Exception {
  ...
  public static void verifyDeltaSent(Integer deltas) {
    CacheClientNotifier ccn =
        ((CacheServerImpl) cache.getCacheServers().toArray()[0])
            .getAcceptor()
            .getCacheClientNotifier();

    int numOfDeltasSent =
        ((CacheClientProxy) ccn.getClientProxies().toArray()[0])
            .getStatistics()
            .getDeltaMessagesSent();
    assertTrue(
        "Expected " + deltas + " deltas to be sent but " + numOfDeltasSent + " were sent.",
