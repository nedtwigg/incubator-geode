...
public class PRDeltaPropagationDUnitTest extends JUnit4DistributedTestCase {
  ...
  private void verifyNoCopy() {
    ...
    boolean copy = ((LocalRegion) deltaPR).getCompressor() == null && (((LocalRegion) deltaPR).isCopyOnRead() || (fp != null && fp.getCqCount() > 0));
    assertFalse(copy);
  }
  ...
  public void testDeltaPropagationWithAdjunctMessagingAndBadDelta() throws Exception {
    ...
    Integer port1 = (Integer) dataStore1.invoke(PRDeltaPropagationDUnitTest.class, "createCacheServerWithPR", accessor);
  ...
  public static void fromDeltaCounter(Integer count) {
    assertTrue("FromDelta counters do not match, expected: " + count.intValue() + ", but actual: " + DeltaTestImpl.getFromDeltaInvokations(), DeltaTestImpl.getFromDeltaInvokations() == count.intValue());
    DeltaTestImpl.resetDeltaInvokationCounters();
  }
  ...
  public static void checkCloning() {
    assertFalse("Cloning is enabled ", cache.getRegion(REGION_NAME).getAttributes().getCloningEnabled());
  }
  ...
  private static void createDeltaPR(Boolean setExpiry) {
    Object args[] = new Object[] { "DeltaPR", new Integer(1), new Integer(50), new Integer(8), setExpiry, false, null };
  ...
  private static void createDeltaPRWithCloning(Boolean setExpiry) {
    Object args[] = new Object[] { "DeltaPR", new Integer(1), new Integer(50), new Integer(8), setExpiry, true, null };
  ...
  public static Integer createCacheServerWithPR(String partitionedRegionName, Integer redundancy, Integer localMaxMemory, Integer totalNumBuckets, Boolean setExpiry, Compressor compressor) {
    ...
    createPR(partitionedRegionName, redundancy, localMaxMemory, totalNumBuckets, setExpiry, Boolean.FALSE, compressor);
  ...
  public static void checkDeltaInvoked(Integer deltaSent) {
    assertTrue("Delta applied :" + ((PRDeltaTestImpl) deltaPR.get("DELTA_KEY")).getDeltaApplied() + "\n Delta sent :" + deltaSent, ((PRDeltaTestImpl) deltaPR.get("DELTA_KEY")).getDeltaApplied() == deltaSent);
  }
