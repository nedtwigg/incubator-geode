...
public class MultiUserAPIDUnitTest extends ClientAuthorizationTestCase {
          ...
          switch (i) {
            ...
            case 21:
              ...
              CqQuery cqQuery =
                  pool.getQueryService()
                      .newCq(
                          "SELECT * FROM /" + SecurityTestUtils.REGION_NAME,
  ...
  private void setUpVMs(final CredentialGenerator gen, final boolean multiUser) {
    ...
    client1.invoke(
        () ->
            createCacheClient(
                authInit, credentials1, javaProps1, port1, port2, 0, multiUser, NO_EXCEPTION));
  }

  private int createCacheServer(
      final int dsPort,
    ...
    return SecurityTestUtils.createCacheServer(
        authProps, javaProps, dsPort, locatorString, 0, NO_EXCEPTION);
  }
  ...
  protected static void createCacheClient(
    ...
    SecurityTestUtils.createCacheClient(
        ...
        numConnections,
        multiUserMode,
        expectedResult); // invokes SecurityTestUtils 2
  }
