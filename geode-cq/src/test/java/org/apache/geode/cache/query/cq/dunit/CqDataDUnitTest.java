...
public class CqDataDUnitTest extends JUnit4CacheTestCase {
  ...
  public void testCQHAWithState() throws Exception {
    ...
    for (int i = 0; i < numCQs; i++) {
      cqDUnitTest.validateCQ(
          client, "testCQHAWithState_" + i, CqQueryDUnitTest.noTest, resultsCnt[i], 0, 0);
    }
          ...
          public void run2() throws CacheException {
            ...
            EvictionAttributes evictAttrs =
                EvictionAttributes.createLRUEntryAttributes(
                    evictionThreshold, EvictionAction.OVERFLOW_TO_DISK);
        ...
        new CacheSerializableRunnable("createClientWithPool") {
          public void run2() throws CacheException {
            ...
            ClientServerTestCase.configureConnectionPool(
                regionFactory, serverHost, serverPorts[0], -1, false, -1, -1, null);
  ...
  public void testMultipleExecuteWithInitialResults() throws Exception {
    ...
    AsyncInvocation processCqs =
        client.invokeAsync(
            new CacheSerializableRunnable("Execute CQ first") {
              public void run2() throws CacheException {
                SelectResults cqResults = null;
                QueryService cqService = getCache().getQueryService();
                // Get CqQuery object.
    ...
    client.invokeAsync(
        new CacheSerializableRunnable("Execute CQ second") {
          public void run2() throws CacheException {
            try {
              Thread.sleep(2000);
            } catch (InterruptedException e) {
    ...
    client.invokeAsync(
        new CacheSerializableRunnable("Release latch") {
          public void run2() throws CacheException {
