...
public class PdxQueryCQDUnitTest extends PdxQueryCQTestBase {
  ...
  public void testCq() throws CacheException {
    ...
    // Execute CQ
    SerializableRunnable executeCq =
            ...
            try {
              ...
              for (Object o : sr.asSet()) {
                ...
                if (!(value instanceof TestObject)) {
                  fail(
                      "Expected type TestObject, not found in result set. Found type :"
                          + o.getClass());
                }
              }
            } catch (Exception ex) {
    ...
    SerializableRunnable validateCq =
        new CacheSerializableRunnable("Validate CQs") {
          public void run2() throws CacheException {
            ...
            assertEquals(
                "Update Event mismatch",
                numberOfEntries - queryLimit,
  ...
  public void testCqAndInterestRegistrations() throws CacheException {
    ...
    vm3.invoke(
        new CacheSerializableRunnable("init region") {
          public void run2() throws CacheException {
    ...
    vm2.invoke(
        new CacheSerializableRunnable("init region") {
          public void run2() throws CacheException {
            ...
            factory.setScope(Scope.LOCAL);
            ClientServerTestCase.configureConnectionPool(
                factory, host0, port0, -1, true, -1, -1, null);
            Region region = createRegion(regionName, rootRegionName, factory.create());
          }
        });

    SerializableRunnable subscribe =
        new CacheSerializableRunnable("subscribe") {
          public void run2() throws CacheException {
    ...
    vm.invoke(
        new CacheSerializableRunnable("Validate CQs") {
          public void run2() throws CacheException {
            ...
            assertEquals(
                "Total Event Count mismatch", (expectedEvents), listener.getTotalEventCount());
