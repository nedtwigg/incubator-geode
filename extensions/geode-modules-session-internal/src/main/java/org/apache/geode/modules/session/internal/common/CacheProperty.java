...
public enum CacheProperty {
   ...
   * classes
   *
   * <p>delta_queued : QueuedDeltaSessionAttributes delta_immediate : DeltaSessionAttributes
   * immediate : ImmediateSessionAttributes queued : QueuedSessionAttributes
   */
