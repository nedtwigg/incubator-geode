    ...
    if (httpclient != null) {
      try {
        ...
        try {
          ...
          System.out.println(
              "ClusterSelectedRegionsMemberServiceTest :: HTTP request status : "
        ...
        try {
          ...
          while (itrMemberNames.hasNext()) {
            ...
            Assert.assertNotNull(
                ...
                szMemberName);
            Assert.assertTrue(
                "Server did not return member details", jsonObjRegion.has(szMemberName));
