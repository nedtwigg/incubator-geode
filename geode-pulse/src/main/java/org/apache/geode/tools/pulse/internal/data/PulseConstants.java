...
public class PulseConstants {
  ...
  public static final String MBEAN_ATTRIBUTE_CURRENTHEAPSIZE =
      "CurrentHeapSize"; // deprecated in Gemfire8.1
  public static final String MBEAN_ATTRIBUTE_USEDMEMORY = "UsedMemory";
  public static final String MBEAN_ATTRIBUTE_MAXIMUMHEAPSIZE =
      "MaximumHeapSize"; // deprecated in Gemfire8.1
  ...
  public static final String[] CLUSTER_MBEAN_ATTRIBUTES = {
    ...
    MBEAN_ATTRIBUTE_DISTRIBUTEDSYSTEMID,
    MBEAN_ATTRIBUTE_LOCATORCOUNT,
    MBEAN_ATTRIBUTE_TOTALREGIONCOUNT,
    MBEAN_ATTRIBUTE_NUMRUNNIGFUNCTION,
    MBEAN_ATTRIBUTE_REGISTEREDCQCOUNT,
    MBEAN_ATTRIBUTE_NUMSUBSCRIPTIONS,
    MBEAN_ATTRIBUTE_NUMTXNCOMMITTED,
    MBEAN_ATTRIBUTE_NUMTXNROLLBACK,
    MBEAN_ATTRIBUTE_TOTALHEAPSIZE,
    MBEAN_ATTRIBUTE_USEDHEAPSIZE,
    MBEAN_ATTRIBUTE_TOTALREGIONENTRYCOUNT,
    MBEAN_ATTRIBUTE_CURRENTENTRYCOUNT,
    MBEAN_ATTRIBUTE_TOTALDISKUSAGE,
    MBEAN_ATTRIBUTE_DISKWRITESRATE,
    MBEAN_ATTRIBUTE_AVERAGEWRITES,
  ...
  public static final String[] GATEWAY_MBEAN_ATTRIBUTES = {
    MBEAN_ATTRIBUTE_PORT,
    MBEAN_ATTRIBUTE_EVENTRECEIVEDDATE,
    MBEAN_ATTRIBUTE_AVEARGEBATCHPROCESSINGTIME,
    MBEAN_ATTRIBUTE_RUNNING
  };

  public static final String[] GATEWAYSENDER_MBEAN_ATTRIBUTES = {
    MBEAN_ATTRIBUTE_EVENTRECEIVEDDATE,
    MBEAN_ATTRIBUTE_BATCHSIZE,
    MBEAN_ATTRIBUTE_SENDERID,
    MBEAN_ATTRIBUTE_EVENTQUEUESIZE,
    MBEAN_ATTRIBUTE_RUNNING,
    MBEAN_ATTRIBUTE_PRIMARY,
    MBEAN_ATTRIBUTE_PERSISTENCEENABLED,
    MBEAN_ATTRIBUTE_PARALLEL,
    MBEAN_ATTRIBUTE_REMOTE_DS_ID,
    MBEAN_ATTRIBUTE_EVENTS_EXCEEDING_ALERT_THRESHOLD
  };

  public static final String[] ASYNC_EVENT_QUEUE_MBEAN_ATTRIBUTES = {
    MBEAN_ATTRIBUTE_AEQ_ASYNCEVENTID,
    MBEAN_ATTRIBUTE_AEQ_PRIMARY,
    MBEAN_ATTRIBUTE_AEQ_PARALLEL,
    MBEAN_ATTRIBUTE_AEQ_BATCH_SIZE,
    MBEAN_ATTRIBUTE_AEQ_BATCH_TIME_INTERVAL,
    MBEAN_ATTRIBUTE_AEQ_BATCH_CONFLATION_ENABLED,
  ...
  public static final String[] MEMBER_MBEAN_ATTRIBUTES = {
    MBEAN_ATTRIBUTE_MANAGER,
    MBEAN_ATTRIBUTE_TOTALREGIONCOUNT,
    MBEAN_ATTRIBUTE_LOCATOR,
    MBEAN_ATTRIBUTE_TOTALDISKUSAGE,
    MBEAN_ATTRIBUTE_SERVER,
    MBEAN_ATTRIBUTE_TOTALFILEDESCRIPTOROPEN,
    MBEAN_ATTRIBUTE_LOADAVERAGE,
    MBEAN_ATTRIBUTE_DISKWRITESRATE,
    MBEAN_ATTRIBUTE_DISKREADSRATE,
    MBEAN_ATTRIBUTE_JVMPAUSES,
    MBEAN_ATTRIBUTE_USEDMEMORY,
    MBEAN_ATTRIBUTE_MAXMEMORY,
    MBEAN_ATTRIBUTE_NUMTHREADS,
    MBEAN_ATTRIBUTE_MEMBERUPTIME,
    MBEAN_ATTRIBUTE_HOST,
    MBEAN_ATTRIBUTE_HOSTNAMEFORCLIENTS,
    MBEAN_ATTRIBUTE_BINDADDRESS,
    MBEAN_ATTRIBUTE_TOTALBYTESONDISK,
    MBEAN_ATTRIBUTE_CPUUSAGE,
    MBEAN_ATTRIBUTE_HOSTCPUUSAGE,
    MBEAN_ATTRIBUTE_MEMBER,
    MBEAN_ATTRIBUTE_ID,
    MBEAN_ATTRIBUTE_AVERAGEREADS,
    MBEAN_ATTRIBUTE_AVERAGEWRITES,
    MBEAN_ATTRIBUTE_OFFHEAPFREESIZE,
    MBEAN_ATTRIBUTE_OFFHEAPUSEDSIZE,
    MBEAN_ATTRIBUTE_SERVERGROUPS,
    MBEAN_ATTRIBUTE_REDUNDANCYZONES,
    MBEAN_ATTRIBUTE_GEMFIREVERSION
  };

  public static final String[] STATEMENT_MBEAN_ATTRIBUTES = {
    MBEAN_ATTRIBUTE_NAME,
    MBEAN_ATTRIBUTE_NUMTIMESCOMPILED,
    MBEAN_ATTRIBUTE_NUMEXECUTION,
    MBEAN_ATTRIBUTE_NUMEXECUTIONSINPROGRESS,
    MBEAN_ATTRIBUTE_NUMTIMESGLOBALINDEXLOOKUP,
    MBEAN_ATTRIBUTE_NUMROWSMODIFIED,
    MBEAN_ATTRIBUTE_PARSETIME,
    MBEAN_ATTRIBUTE_BINDTIME,
    MBEAN_ATTRIBUTE_OPTIMIZETIME,
    MBEAN_ATTRIBUTE_ROUTINGINFOTIME,
    MBEAN_ATTRIBUTE_GENERATETIME,
    MBEAN_ATTRIBUTE_TOTALCOMPILATIONTIME,
    MBEAN_ATTRIBUTE_EXECUTIONTIME,
    MBEAN_ATTRIBUTE_PROJECTIONTIME,
    MBEAN_ATTRIBUTE_TOTALEXECUTIONTIME,
    MBEAN_ATTRIBUTE_ROWSMODIFICATIONTIME,
    MBEAN_ATTRIBUTE_QNNUMROWSSEEN,
